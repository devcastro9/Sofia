...
Begin VB.Form fw_compras_comex 
   ...
   Begin VB.PictureBox FraAlmacen 
      BackColor       =   &H00808080&
      FillColor       =   &H00FFFFFF&
      Height          =   1300
      Left            =   11640
      ...
      Begin VB.PictureBox BtnGrabar1 
         ...
         Height          =   615
         Left            =   4800
         Picture         =   "fw_compras_comex.frx":12EE
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   106
         Top             =   0
         Width           =   1395
      End
      Begin MSComCtl2.DTPicker DTPFechaIng2 
         Height          =   300
         Left            =   3000
         TabIndex        =   110
         Top             =   360
      ...
      Begin VB.Label Label3 
         ...
         BackColor       =   &H00000000&
         BackStyle       =   0  'Transparent
         Caption         =   "Fecha de Ingreso a Almacen"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.CommandButton BtnAprobar3 
      ...
      Left            =   9360
      MaskColor       =   &H80000014&
      Picture         =   "fw_compras_comex.frx":1ADC
      Style           =   1  'Graphical
      TabIndex        =   104
   ...
   Begin VB.PictureBox Fra_aux1 
      ...
      Begin VB.PictureBox CmdGrabaDet 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_compras_comex.frx":1F1E
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   96
         Top             =   0
      ...
      Begin VB.PictureBox CmdCancelaDet 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_compras_comex.frx":270C
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   95
         Top             =   600
      ...
      Begin MSDataListLib.DataCombo dtc_desc4A 
         Bindings        =   "fw_compras_comex.frx":2FF8
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4A 
         Bindings        =   "fw_compras_comex.frx":3012
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_detalle2"
         Height          =   315
         Left            =   120
   ...
   Begin VB.PictureBox BtnSalir 
      ...
      Height          =   615
      Left            =   18360
      Picture         =   "fw_compras_comex.frx":302C
      ScaleHeight     =   615
      ScaleWidth      =   1245
      TabIndex        =   86
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.PictureBox FraGrabarCancelar 
         ...
         Begin VB.PictureBox BtnGrabar 
            ...
            Height          =   615
            Left            =   3600
            Picture         =   "fw_compras_comex.frx":39EB
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   64
            Top             =   0
         ...
         Begin VB.PictureBox BtnCancelar 
            ...
            Height          =   615
            Left            =   5235
            Picture         =   "fw_compras_comex.frx":41C1
            ScaleHeight     =   615
            ScaleWidth      =   1455
            TabIndex        =   63
            Top             =   0
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "fw_compras_comex.frx":4AAD
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3480
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "fw_compras_comex.frx":4AC7
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "fw_compras_comex.frx":4AE0
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "fw_compras_comex.frx":4AF9
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "fw_compras_comex.frx":4B13
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "fw_compras_comex.frx":4B2C
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "fw_compras_comex.frx":4B45
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4080
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "fw_compras_comex.frx":4B5E
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_desc_ben 
         Bindings        =   "fw_compras_comex.frx":4B77
         DataField       =   "beneficiario_codigo_alm"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5280
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "fw_compras_comex.frx":4B90
         DataField       =   "unidad_codigo_adm"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6840
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "fw_compras_comex.frx":4BA9
         DataField       =   "venta_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4635
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "fw_compras_comex.frx":4BC2
         DataField       =   "unidad_codigo_adm"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3120
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "fw_compras_comex.frx":4BDB
         DataField       =   "poa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3480
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "fw_compras_comex.frx":4BF5
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin VB.PictureBox BtnAddDetalle3 
         ...
         Height          =   735
         Left            =   9360
         Picture         =   "fw_compras_comex.frx":4C0F
         ScaleHeight     =   735
         ScaleWidth      =   1080
         TabIndex        =   85
         Top             =   240
      ...
      Begin VB.PictureBox fraOpcionesDet 
         ...
         Begin VB.PictureBox BtnImprimir2 
            ...
            Height          =   615
            Left            =   3960
            Picture         =   "fw_compras_comex.frx":57CE
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   79
            Top             =   0
         ...
         Begin VB.PictureBox BtnAnlDetalle1 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "fw_compras_comex.frx":609B
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   78
            Top             =   0
         ...
         Begin VB.PictureBox BtnModDetalle1 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "fw_compras_comex.frx":67E7
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   77
            Top             =   0
         ...
         Begin VB.PictureBox BtnAddDetalle1 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "fw_compras_comex.frx":70FC
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   76
            Top             =   0
      ...
      Begin VB.PictureBox Picture2AA 
         ...
         Begin VB.PictureBox BtnImprimir1 
            ...
            Height          =   615
            Left            =   7080
            Picture         =   "fw_compras_comex.frx":78BB
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   101
            Top             =   0
         ...
         Begin VB.PictureBox BtnImprimir3 
            ...
            Height          =   615
            Left            =   3720
            Picture         =   "fw_compras_comex.frx":81E9
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   90
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "fw_compras_comex.frx":8B17
         Height          =   2220
         Left            =   120
         TabIndex        =   50
         Top             =   1080
      ...
      Begin MSDataGridLib.DataGrid dg_det1A 
         Bindings        =   "fw_compras_comex.frx":8B32
         Height          =   2580
         Left            =   10560
         TabIndex        =   53
         Top             =   1080
      ...
      Begin VB.CommandButton BtnDesAprobar3 
         ...
         Height          =   885
         Left            =   9360
         Picture         =   "fw_compras_comex.frx":8B4E
         Style           =   1  'Graphical
         TabIndex        =   54
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.PictureBox FrmABMDet2 
         ...
         Begin VB.PictureBox BtnAprobar4 
            ...
            Height          =   615
            Left            =   4080
            Picture         =   "fw_compras_comex.frx":8F90
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   91
            Top             =   0
         ...
         Begin VB.CommandButton BtnImprimir4 
            ...
            Height          =   615
            Left            =   6720
            Picture         =   "fw_compras_comex.frx":9881
            Style           =   1  'Graphical
            TabIndex        =   89
         ...
         Begin VB.PictureBox BtnAprobar1 
            ...
            Height          =   615
            Left            =   5400
            Picture         =   "fw_compras_comex.frx":A1AF
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   84
         ...
         Begin VB.PictureBox BtnAnlDetalle2 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "fw_compras_comex.frx":AAC6
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   83
            Top             =   0
         ...
         Begin VB.PictureBox BtnModDetalle2 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "fw_compras_comex.frx":B2BE
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   82
            Top             =   0
         ...
         Begin VB.PictureBox BtnAddDetalle2 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "fw_compras_comex.frx":BCD3
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   81
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "fw_compras_comex.frx":C583
         Height          =   2760
         Left            =   120
         TabIndex        =   8
         Top             =   960
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin VB.PictureBox fraOpciones 
         ...
         Begin VB.CommandButton BtnVer 
            ...
            Height          =   600
            Left            =   10800
            Picture         =   "fw_compras_comex.frx":C59E
            Style           =   1  'Graphical
            TabIndex        =   73
         ...
         Begin VB.CommandButton BtnDesAprobar 
            ...
            Height          =   600
            Left            =   11760
            Picture         =   "fw_compras_comex.frx":C9E0
            Style           =   1  'Graphical
            TabIndex        =   72
            Top             =   0
            Visible         =   0   'False
         ...
         Begin VB.PictureBox BtnAñadir 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "fw_compras_comex.frx":CBEA
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   71
            Top             =   0
         ...
         Begin VB.PictureBox BtnModificar 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "fw_compras_comex.frx":D3A9
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   70
            Top             =   0
         ...
         Begin VB.PictureBox BtnEliminar 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "fw_compras_comex.frx":DCBE
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   69
            Top             =   0
         ...
         Begin VB.PictureBox BtnAprobar 
            ...
            Height          =   615
            Left            =   7320
            Picture         =   "fw_compras_comex.frx":E40A
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   68
            Top             =   480
         ...
         Begin VB.PictureBox BtnBuscar 
            ...
            Height          =   615
            Left            =   4080
            Picture         =   "fw_compras_comex.frx":EC3D
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   67
            Top             =   0
         ...
         Begin VB.PictureBox BtnImprimir 
            ...
            Height          =   615
            Left            =   5400
            Picture         =   "fw_compras_comex.frx":F3F2
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   66
...
'    End If
    ...
    rs_det1.Open "select * from av_compra_detalle_tipo where compra_codigo = " & VAR_COMPRA & " AND par_codigo = '39810' AND estado_codigo = 'REG' ", db, adOpenKeyset, adLockOptimistic, adCmdText
...
'            End If
            ...
            rs_compra_det.Open "Select * from ao_compra_adjudica_bienes WHERE compra_codigo = " & VAR_COMPRA & " AND bien_codigo = '" & CodBien & "' ", db, adOpenKeyset, adLockOptimistic
...
'
    Else
        MsgBox "No existen Repuestos Importados para procesar... Revise y vuelva a intentar ...", vbExclamation, "SOFIA"
        Exit Sub
    End If
End Sub
...
'    Timer1.Enabled = False
    ...
    If (Not Ado_datos.Recordset.BOF) And (Not Ado_datos.Recordset.EOF) Then   'EOF
      If Ado_detalle2.Recordset.RecordCount > 0 Then
        ...
        End If
        If (glusuario = "CARIZACA" Or glusuario = "LVASQUEZ" Or glusuario = "ADMIN" Or glusuario = "SPAREDES" Or glusuario = "MVALDIVIA") Then 'And (Ado_detalle2.Recordset!estado_codigo_tes = "APR") Then
...
Private Sub BtnCancelar1_Click()
    FraAlmacen.Visible = False
End Sub

Private Sub BtnGrabar1_Click()
On Error GoTo AddErr
    If glusuario = "LVASQUEZ" Or glusuario = "RCUELA" Or glusuario = "ADMIN" Or glusuario = "CARIZACA" Or glusuario = "SPAREDES" Then
    Else
        MsgBox "El Usuario No tiene Acceso, consulte son el Administrador del Sistema ...", vbExclamation, "SOFIA"
        Exit Sub
    End If
 If Ado_datos.Recordset.RecordCount > 0 Then
    If Ado_detalle2.Recordset.RecordCount = 0 Then
   ...
   End If
   If parametro = "COMEX" Then
     sino = MsgBox("Desea ENVIAR Todos los Bienes, a Almacenes ? (Verifique la Planilla de Costos previamente)", vbYesNo + vbInformation, "Atención")
     If sino = vbYes Then
    If Ado_detalle1.Recordset.RecordCount > 0 Then
        ...
        'If sino = vbYes Then
            ...
            If OptFilGral1.Value = True Or opt_local.Value = True Then
                ...
                VAR_ALMACEN = 1
            Else
                'db.Execute "UPDATE AO_compra_cabecera set depto_codigo = '2' where unidad_codigo = 'DNREP' "
                ...
                If OptFilGral2.Value = True Or opt_directa.Value = True Then
                    VAR_TIPO_ALM = "R"
                    'SOLO A ALMACEN REPUESTOS LA PAZ
                    VAR_ALMACEN = 9
                Else
                    VAR_TIPO_ALM = "Q"
                End If
            ...
            If (IsNull(Ado_detalle2.Recordset!doc_numero_alm) Or (Ado_detalle2.Recordset!doc_numero_alm = 0)) Then
              ...
              If Ado_detalle2.Recordset!codigo_empresa = 2 Then
                rs_aux7.Open "Select numero_correlativo, tipo_tramite FROM fc_correl_2 WHERE tipo_tramite= 'R-114R2' ", db, adOpenKeyset, adLockOptimistic
                '(cta_codigo1 = '" & VAR_DPTO_AUX & "' and cta_codigo2 = '" & VAR_TIPO_ALM & "' ) ", db, adOpenKeyset, adLockOptimistic
              Else
                rs_aux7.Open "Select numero_correlativo, tipo_tramite FROM fc_correl WHERE tipo_tramite= 'R-114R2' ", db, adOpenKeyset, adLockOptimistic
                '(cta_codigo1 = '" & VAR_DPTO_AUX & "' and cta_codigo2 = '" & VAR_TIPO_ALM & "' ) ", db, adOpenKeyset, adLockOptimistic
              End If
           ...
           db.Execute "update ao_compra_adjudica set doc_numero_alm = " & CORRELARTIVO1 & ", doc_numero = " & CORRELARTIVO1 & " where compra_codigo = " & VAR_COD2 & " "
'WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW
        ...
        'If (Ado_datos.Recordset!edif_codigo = "20101-3") Or (Ado_datos.Recordset!edif_codigo = "30101-3") Or (Ado_datos.Recordset!edif_codigo = "70101-3") Or (Ado_datos.Recordset!edif_codigo = "10101-3") Then
           'CORRELARIVO1 = "0"  'CORRELATIVO PARA COMPROBANTE DE SALIDA ALMACEN
           Set rs_det1A = New ADODB.Recordset
           If rs_det1A.State = 1 Then rs_det1A.Close
           'rs_det1.Open "select * from ao_compra_detalle where compra_codigo = " & Ado_datos.Recordset!compra_codigo & " and par_codigo = '43340' ", db, adOpenKeyset, adLockOptimistic, adCmdText
           rs_det1A.Open "select * from ao_compra_adjudica_bienes where compra_codigo = " & VAR_COMPRA & " AND adjudica_codigo = " & Ado_detalle2.Recordset!adjudica_codigo & "", db, adOpenKeyset, adLockOptimistic, adCmdText
'           If rs_det1A.RecordCount > 0 Then
           'Else
           rs_det1A.MoveFirst
           sino = rs_det1A.RecordCount
            While Not rs_det1A.EOF
                CodBien = rs_det1A!bien_codigo
                ...
                rs_aux12.Open "select * from ao_almacen_ingresos where ges_gestion='" & rs_det1A!ges_gestion & "' AND almacen_codigo=" & rs_det1A!almacen_codigo & " AND doc_codigo='R-114' AND doc_numero=" & CORRELARTIVO1 & " AND bien_codigo='" & CodBien & "' ", db, adOpenStatic
                If rs_aux12.RecordCount > 0 Then
                Else
                    'db.Execute "ap_compras_grla 2,'" & rs_det1A!ges_gestion & "'," & rs_det1A!almacen_codigo & ", 'R-114' ," & CORRELARTIVO1 & ",'" & rs_det1A!bien_codigo & "','" & Ado_datos.Recordset!edif_codigo & "'," & VAR_COD2 & ",'" & Ado_detalle2.Recordset!beneficiario_codigo & "','" & Ado_detalle2.Recordset!fecha_compra & "'," & rs_det1A!adjudica_cantidad & "," & rs_det1A!bien_total_adjudica_bs & "," & CDbl(rs_det1A!bien_total_adjudica_bs / GlTipoCambioOficial) & ", 'REG', '" & glusuario & "','" & Ado_datos.Recordset!compra_DESCRIPCION & "'," & rs_det1A!bien_precio_adjudica_bs & ""
                    db.Execute "ap_compras_grla 2,'" & rs_det1A!ges_gestion & "'," & rs_det1A!almacen_codigo & ", 'R-114' ," & CORRELARTIVO1 & ",'" & rs_det1A!bien_codigo & "','" & Ado_datos.Recordset!edif_codigo & "'," & VAR_COD2 & ",'" & Ado_detalle2.Recordset!beneficiario_codigo & "','" & DTPFechaIng2.Value & "'," & rs_det1A!adjudica_cantidad & "," & rs_det1A!bien_total_adjudica_bs & "," & CDbl(rs_det1A!bien_total_adjudica_bs / GlTipoCambioOficial) & ", 'REG', '" & glusuario & "','" & Ado_datos.Recordset!compra_DESCRIPCION & "'," & rs_det1A!bien_precio_adjudica_bs & ""
                End If

                Set rs_aux6 = New ADODB.Recordset
                If rs_aux6.State = 1 Then rs_aux6.Close
                rs_aux6.Open "SELECT * FROM ao_almacen_totales WHERE almacen_codigo =" & rs_det1A!almacen_codigo & " AND bien_codigo = '" & CodBien & "'", db, adOpenStatic
    ...
    End If
    If opt_directa.Value = True Then
        Call opt_directa_Click
    End If
    If opt_local.Value = True Then
        Call opt_local_Click
    End If
     If (dg_datos.SelBookmarks.Count <> 0) Then
        dg_datos.SelBookmarks.Remove 0
     End If
...
'
 If parametro = "COMEX" Then
    Select Case Glaux
        Case "PROVI"    'PROVISION DE EQUIPOS
            ...
            Set rs_det1 = New ADODB.Recordset
            If rs_det1.State = 1 Then rs_det1.Close
            If OptFilGral2.Value = True Or Opt_AMT.Value = True Then
 ...
 If Ado_detalle1.Recordset.RecordCount > 0 Then
    ...
    End If
    If OptFilGral2.Value = True Or opt_directa.Value = True Or Opt_AMT.Value = True Then
        Select Case Glaux
               Case "PROVI"    'PROVEEDOR FABRICA
                   VAR_TIPOSOL = 15
               Case "TRANS"    'TRANSPORTE
...
'End If
  ...
  If Ado_datos.Recordset.BOF = False And Ado_datos.Recordset.EOF = False Then
    If Ado_datos.Recordset.RecordCount > 0 Then
       ...
       Select Case Ado_datos.Recordset!venta_tipo
            ...
            Case "Q"
                LblModalidad.Caption = "QLD.Importacion"
            Case "M"
                LblModalidad.Caption = "AMT.Importacion"
            Case Else
...
Private Sub Opt_AMT_Click()
    ...
    If parametro = "COMEX" Then
      Select Case Glaux
        Case "PROVI"
            ...
            queryinicial = "Select * from ao_compra_cabecera where ((venta_tipo = 'Q' OR venta_tipo = 'M') AND estado_codigo_eqp = 'REG' AND (unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
        Case "TRANS"
            lbl_titulo.Caption = frmMain.Mnu_Transporte.Caption
            'queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'R' AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'DNINS' OR unidad_codigo_adm = 'DNREP') ) "
            queryinicial = "Select * from ao_compra_cabecera where ((venta_tipo = 'Q' OR venta_tipo = 'M')  AND estado_codigo_tra = 'REG' AND (unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
        Case "ADUAN"
            lbl_titulo.Caption = frmMain.Mnu_Nacionalizacion.Caption
            'queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'R' AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'DNINS' OR unidad_codigo_adm = 'DNREP') ) "
            queryinicial = "Select * from ao_compra_cabecera where ((venta_tipo = 'Q' OR venta_tipo = 'M')  AND estado_codigo_NAC = 'REG' AND (unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
        Case "DESCA"
            lbl_titulo.Caption = frmMain.Mnu_Descarguio.Caption
            'queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'R' AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'DNINS' OR unidad_codigo_adm = 'DNREP') ) "
            queryinicial = "Select * from ao_compra_cabecera where ((venta_tipo = 'Q' OR venta_tipo = 'M')  AND estado_codigo_des = 'REG' AND (unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
        Case "CONTR"
            lbl_titulo.Caption = frmMain.Mnu_ContratacionTecnicos.Caption
            'queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'R' AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'DNINS' OR unidad_codigo_adm = 'DNREP') ) "
            queryinicial = "Select * from ao_compra_cabecera where ((venta_tipo = 'Q' OR venta_tipo = 'M') AND estado_codigo = 'REG' AND (unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
        Case "REPTO"
            lbl_titulo.Caption = frmMain.Mnu_ProveedoresEquipos.Caption
            'queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'R' AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'DNINS' OR unidad_codigo_adm = 'DNREP') ) "
            queryinicial = "Select * from ao_compra_cabecera where ((venta_tipo = 'Q' OR venta_tipo = 'M')  AND estado_codigo_eqp = 'REG' AND (unidad_codigo LIKE '%REP%' OR unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
        Case Else
            lbl_titulo.Caption = frmMain.Mnu_ProveedoresEquipos.Caption
            'queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'R' AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'DNINS' OR unidad_codigo_adm = 'DNREP') ) "
            queryinicial = "Select * from ao_compra_cabecera where ((venta_tipo = 'Q' OR venta_tipo = 'M')  AND estado_codigo_eqp = 'REG' AND (unidad_codigo LIKE '%REP%' OR unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
    ...
    Else
        'queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'R' AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'DNINS' OR unidad_codigo_adm = 'DNREP') ) "
        queryinicial = "Select * from ao_compra_cabecera where (venta_tipo = 'Q' AND estado_codigo = 'REG' AND (unidad_codigo LIKE '%REP%' OR unidad_codigo LIKE '%INS%') AND (unidad_codigo_adm = '" & parametro & "' OR unidad_codigo_adm = 'COMEX') ) "
    End If
