   ...
   Begin VB.Frame FraDet3 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.CommandButton Command3 
            Height          =   525
            Left            =   1350
            Picture         =   "fw_compras_fondos.frx":6DA8
            Style           =   1  'Graphical
            TabIndex        =   69
         ...
         Begin VB.CommandButton BtnModDetalle 
            Height          =   525
            Left            =   1350
            Picture         =   "fw_compras_fondos.frx":75A0
            Style           =   1  'Graphical
            TabIndex        =   54
         ...
         Begin VB.CommandButton BtnAprobar2 
            Height          =   525
            Left            =   0
            Picture         =   "fw_compras_fondos.frx":7FB5
            Style           =   1  'Graphical
            TabIndex        =   58
            ToolTipText     =   "Aprueba Registro"
            Top             =   585
         ...
         Begin VB.CommandButton BtnAddDetalle 
            Height          =   525
            Left            =   0
            Picture         =   "fw_compras_fondos.frx":88CC
            Style           =   1  'Graphical
            TabIndex        =   55
      ...
      Begin MSDataGridLib.DataGrid dg_det3 
         Bindings        =   "fw_compras_fondos.frx":917C
         Height          =   1590
         Left            =   3000
         TabIndex        =   13
         Top             =   240
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.PictureBox FrmABMDet2 
         ...
         Begin VB.PictureBox BtnAprobar4 
            ...
            Height          =   615
            Left            =   4080
            Picture         =   "fw_compras_fondos.frx":9197
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   102
            Top             =   0
         ...
         Begin VB.PictureBox BtnAprobar1 
            ...
            Height          =   615
            Left            =   5400
            Picture         =   "fw_compras_fondos.frx":A38F
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   95
            Top             =   0
         ...
         Begin VB.PictureBox BtnAnlDetalle2 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "fw_compras_fondos.frx":ACA6
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   94
            Top             =   0
         ...
         Begin VB.PictureBox BtnModDetalle2 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "fw_compras_fondos.frx":B49E
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   93
            Top             =   0
         ...
         Begin VB.PictureBox BtnAddDetalle2 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "fw_compras_fondos.frx":BEB3
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   92
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "fw_compras_fondos.frx":C763
         Height          =   2880
         Left            =   120
         TabIndex        =   8
         Top             =   960
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin VB.PictureBox fraOpciones 
         ...
         Begin VB.CommandButton BtnVer 
            ...
            Height          =   600
            Left            =   10800
            Picture         =   "fw_compras_fondos.frx":C77E
            Style           =   1  'Graphical
            TabIndex        =   84
         ...
         Begin VB.CommandButton BtnDesAprobar 
            ...
            Height          =   600
            Left            =   11760
            Picture         =   "fw_compras_fondos.frx":CBC0
            Style           =   1  'Graphical
            TabIndex        =   83
            Top             =   0
            Visible         =   0   'False
         ...
         Begin VB.PictureBox BtnAñadir 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "fw_compras_fondos.frx":CDCA
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   82
            Top             =   0
         ...
         Begin VB.PictureBox BtnModificar 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "fw_compras_fondos.frx":D589
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   81
            Top             =   0
         ...
         Begin VB.PictureBox BtnEliminar 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "fw_compras_fondos.frx":DE9E
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   80
            Top             =   0
         ...
         Begin VB.PictureBox BtnAprobar 
            ...
            Height          =   615
            Left            =   6960
            Picture         =   "fw_compras_fondos.frx":E5EA
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   79
            Top             =   0
         ...
         Begin VB.PictureBox BtnBuscar 
            ...
            Height          =   615
            Left            =   4080
            Picture         =   "fw_compras_fondos.frx":EE1D
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   78
            Top             =   0
         ...
         Begin VB.PictureBox BtnImprimir 
            ...
            Height          =   615
            Left            =   5520
            Picture         =   "fw_compras_fondos.frx":F5D2
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   77
            Top             =   0
         ...
         Begin VB.PictureBox BtnSalirA 
            ...
            Height          =   615
            Left            =   8520
            Picture         =   "fw_compras_fondos.frx":FE9F
            ScaleHeight     =   615
            ScaleWidth      =   1245
            TabIndex        =   76
            ToolTipText     =   "Cierra la Ventana Activa"
...
If parametro <> "COMEX" Then
    ...
    If Ado_detalle1.Recordset.RecordCount > 0 Then
        If Ado_detalle1.Recordset!estado_codigo <> "REG" Then
            ...
            Exit Sub
        End If
        sino = MsgBox("Desea Envia como Ingreso a Almacen y además, será parte de la Factura Elegida... ? (Ya no podrá modificarlo)", vbYesNo + vbInformation, "Atención")
        If sino = vbYes Then
            DETALLE2 = Ado_detalle2.Recordset!adjudica_codigo
            VAR_COD2 = Ado_datos.Recordset!compra_codigo
            'If VAR_TIPO_ALM = "" Then
...
Private Sub BtnAprobar4_Click()
 If (Ado_datos.Recordset.RecordCount > 0) And (Ado_datos.Recordset!edif_codigo <> "20101-3") And (Ado_datos.Recordset!edif_codigo <> "70101-3") And (Ado_datos.Recordset!edif_codigo <> "30101-3") And (Ado_datos.Recordset!edif_codigo <> "10101-3") Then
    ...
    End If
  Else
    MsgBox "No se puede ACEPTAR, porque es SALDO INICIAL o no registró la Factura del Proveedor o Ya Fue Aceptado previamente ...", vbExclamation
