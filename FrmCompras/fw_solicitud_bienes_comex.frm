...
'        fw_compras_comex.Ado_detalle1.Recordset("venta_o_compra").Value = "C" 'C = PAGOS PERIODICOS ó CREDITO y E = EFECTIVO (Al Contado)
...
'dtc_cod_alm
  ...
  If (Txt_campo16.Text = "" Or Txt_campo16.Text = "0") Then
    MsgBox "Debe registrar ..." + lbl_campo16.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
    Exit Sub
  End If
  If Txt_tdc.Text = "" Then
    MsgBox "Debe registrar el " + Lbl_TDC.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
    Exit Sub
  End If
