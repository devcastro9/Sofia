...
Begin VB.Form Fw_ReportesCompras 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   345
   ClientWidth     =   15240
   Icon            =   "Fw_ReportesCompras.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   7710
   ScaleWidth      =   15240
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   960
         Picture         =   "Fw_ReportesCompras.frx":058A
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   102
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   13320
         Picture         =   "Fw_ReportesCompras.frx":0E57
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   101
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox cmb_gestion_rep 
         Height          =   315
         ItemData        =   "Fw_ReportesCompras.frx":1619
         Left            =   5400
         List            =   "Fw_ReportesCompras.frx":163E
         TabIndex        =   65
         Top             =   360
         Width           =   1335
      End
      Begin VB.ComboBox cbo_mes_rep 
         Height          =   315
         ItemData        =   "Fw_ReportesCompras.frx":1684
         Left            =   1320
         List            =   "Fw_ReportesCompras.frx":16AC
         TabIndex        =   63
         Top             =   360
         Width           =   2055
      End
   ...
   Begin VB.Frame fmrTipoReporte 
      ...
      Begin VB.OptionButton optRep014 
         BackColor       =   &H00C0C0C0&
         Caption         =   "CONTROL DIARIO DE COBRANZAS"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Elija las Fechas, luego una Opción y el Botón Imprimir"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "Fw_ReportesCompras"
...
Private Sub BtnImprimir_Click()
  ...
  ElseIf optRep0010.Value = True Then
      CryUnidad.ReportFileName = App.Path & "\Reportes\Compras\fr_libro_compras.rpt"
        CryUnidad.StoredProcParam(0) = cmb_gestion_rep.Text
