   ...
   Begin VB.Frame FraDet3 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.CommandButton Command3 
            Height          =   525
            Left            =   1350
            Picture         =   "fw_compras_gral.frx":75DB
            Style           =   1  'Graphical
            TabIndex        =   69
         ...
         Begin VB.CommandButton BtnModDetalle 
            Height          =   525
            Left            =   1350
            Picture         =   "fw_compras_gral.frx":7DD3
            Style           =   1  'Graphical
            TabIndex        =   54
         ...
         Begin VB.CommandButton BtnAprobar2 
            Height          =   525
            Left            =   0
            Picture         =   "fw_compras_gral.frx":87E8
            Style           =   1  'Graphical
            TabIndex        =   58
            ToolTipText     =   "Aprueba Registro"
            Top             =   585
         ...
         Begin VB.CommandButton BtnAddDetalle 
            Height          =   525
            Left            =   0
            Picture         =   "fw_compras_gral.frx":90FF
            Style           =   1  'Graphical
            TabIndex        =   55
      ...
      Begin MSDataGridLib.DataGrid dg_det3 
         Bindings        =   "fw_compras_gral.frx":99AF
         Height          =   1590
         Left            =   3000
         TabIndex        =   13
         Top             =   240
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.PictureBox FrmABMDet2 
         ...
         Begin VB.PictureBox BtnAprobar4 
            ...
            Height          =   615
            Left            =   4080
            Picture         =   "fw_compras_gral.frx":99CA
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   102
            Top             =   0
         ...
         Begin VB.PictureBox BtnAprobar1 
            ...
            Height          =   615
            Left            =   5400
            Picture         =   "fw_compras_gral.frx":ABC2
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   95
            Top             =   0
         ...
         Begin VB.PictureBox BtnAnlDetalle2 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "fw_compras_gral.frx":B4D9
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   94
            Top             =   0
         ...
         Begin VB.PictureBox BtnModDetalle2 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "fw_compras_gral.frx":BCD1
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   93
            Top             =   0
         ...
         Begin VB.PictureBox BtnAddDetalle2 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "fw_compras_gral.frx":C6E6
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   92
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "fw_compras_gral.frx":CF96
         Height          =   3240
         Left            =   120
         TabIndex        =   8
         Top             =   960
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin VB.PictureBox fraOpciones 
         ...
         Begin VB.CommandButton BtnVer 
            ...
            Height          =   600
            Left            =   10800
            Picture         =   "fw_compras_gral.frx":CFB1
            Style           =   1  'Graphical
            TabIndex        =   84
         ...
         Begin VB.CommandButton BtnDesAprobar 
            ...
            Height          =   600
            Left            =   11760
            Picture         =   "fw_compras_gral.frx":D3F3
            Style           =   1  'Graphical
            TabIndex        =   83
            Top             =   0
            Visible         =   0   'False
         ...
         Begin VB.PictureBox BtnAñadir 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "fw_compras_gral.frx":D5FD
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   82
            Top             =   0
         ...
         Begin VB.PictureBox BtnModificar 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "fw_compras_gral.frx":DDBC
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   81
            Top             =   0
         ...
         Begin VB.PictureBox BtnEliminar 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "fw_compras_gral.frx":E6D1
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   80
            Top             =   0
         ...
         Begin VB.PictureBox BtnAprobar 
            ...
            Height          =   615
            Left            =   6960
            Picture         =   "fw_compras_gral.frx":EE1D
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   79
            Top             =   0
         ...
         Begin VB.PictureBox BtnBuscar 
            ...
            Height          =   615
            Left            =   4080
            Picture         =   "fw_compras_gral.frx":F650
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   78
            Top             =   0
         ...
         Begin VB.PictureBox BtnImprimir 
            ...
            Height          =   615
            Left            =   5520
            Picture         =   "fw_compras_gral.frx":FE05
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   77
            Top             =   0
         ...
         Begin VB.PictureBox BtnSalirA 
            ...
            Height          =   615
            Left            =   8520
            Picture         =   "fw_compras_gral.frx":106D2
            ScaleHeight     =   615
            ScaleWidth      =   1245
            TabIndex        =   76
            ToolTipText     =   "Cierra la Ventana Activa"
...
Private Sub BtnAprobar4_Click()
 ...
 If (Ado_datos.Recordset.RecordCount > 0) And (Ado_datos.Recordset!edif_codigo <> "20101-3") And (Ado_datos.Recordset!edif_codigo <> "70101-3") And (Ado_datos.Recordset!edif_codigo <> "30101-3") And (Ado_datos.Recordset!edif_codigo <> "10101-3") Then
    ...
    If (Ado_detalle2.Recordset.RecordCount > 0) Or (Ado_detalle2.Recordset!estado_codigo = "REG") Then
        VAR_COD2 = Ado_datos.Recordset!compra_codigo
        CORRELARTIVO1 = "0"
        'VERIFICA si está en Stock (ao_almacen_ingresos)
