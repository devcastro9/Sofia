...
Begin VB.Form AlmFrmSalidaMaterialF11 
   Caption         =   "Almacen"
   ClientHeight    =   7770
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11400
   Icon            =   "AlmFrmSalidaMaterialF11.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7770
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Items"
      TabPicture(0)   =   "AlmFrmSalidaMaterialF11.frx":0ECA
      ...
      Begin TrueOleDBGrid60.TDBDropDown tdbdIngreso 
         Height          =   915
         Left            =   360
         OleObjectBlob   =   "AlmFrmSalidaMaterialF11.frx":0EE6
         TabIndex        =   37
         Top             =   720
         Width           =   2355
      End
      Begin TrueOleDBGrid60.TDBDropDown tdbdMat 
         Height          =   915
         Left            =   375
         OleObjectBlob   =   "AlmFrmSalidaMaterialF11.frx":4106
         TabIndex        =   18
         Top             =   735
         Width           =   2355
      End
      ...
      Begin TrueOleDBGrid60.TDBGrid TDBGDet 
         Bindings        =   "AlmFrmSalidaMaterialF11.frx":6702
         Height          =   3225
         Left            =   75
         OleObjectBlob   =   "AlmFrmSalidaMaterialF11.frx":671B
         TabIndex        =   17
         Top             =   75
         Width           =   8130
      End
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   990
      Left            =   0
      Picture         =   "AlmFrmSalidaMaterialF11.frx":BBFB
      ScaleHeight     =   930
      ScaleWidth      =   11340
      TabIndex        =   23
      Top             =   0
      ...
      Begin VB.CommandButton cmdVerificar 
         ...
         Height          =   855
         Left            =   10380
         Picture         =   "AlmFrmSalidaMaterialF11.frx":EE95
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   30
         Width           =   1425
      ...
      Begin VB.Label LblCabecera 
         ...
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "F11 SOLICITUD DE MATERIAL ALMACEN "
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   15.75
            Charset         =   0
      ...
      Begin VB.Image Image1 
         Height          =   960
         Left            =   0
         Picture         =   "AlmFrmSalidaMaterialF11.frx":F2D7
         Top             =   0
         Width           =   11640
      End
   End
   Begin TrueOleDBGrid60.TDBGrid TdbgEntrega 
      Height          =   5880
      Left            =   1125
      OleObjectBlob   =   "AlmFrmSalidaMaterialF11.frx":36347
      TabIndex        =   8
      Top             =   1050
      Width           =   2475
   End
   Begin VB.Frame FraDatos 
      ...
      Begin TrueOleDBList60.TDBCombo tdbcDestino 
         ...
         Height          =   300
         Left            =   2880
         OleObjectBlob   =   "AlmFrmSalidaMaterialF11.frx":39797
         TabIndex        =   12
         Top             =   0
         Visible         =   0   'False
         Width           =   2670
   ...
   Begin VB.Frame FraOpciones 
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   855
         Left            =   120
         Picture         =   "AlmFrmSalidaMaterialF11.frx":3B6B3
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   5310
         Width           =   855
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   855
         Left            =   120
         Picture         =   "AlmFrmSalidaMaterialF11.frx":3B8BD
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   4470
         Width           =   855
      ...
      Begin VB.CommandButton CmdEliminar 
         ...
         Height          =   855
         Left            =   120
         Picture         =   "AlmFrmSalidaMaterialF11.frx":3BAC7
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   3630
         Width           =   855
      ...
      Begin VB.CommandButton CmdCancelar 
         ...
         Height          =   855
         Left            =   120
         Picture         =   "AlmFrmSalidaMaterialF11.frx":3C1B1
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   2790
         Width           =   855
      ...
      Begin VB.CommandButton CmdGrabar 
         ...
         Height          =   855
         Left            =   120
         Picture         =   "AlmFrmSalidaMaterialF11.frx":3C3BB
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   1950
         Width           =   855
      ...
      Begin VB.CommandButton CmdEditar 
         ...
         Height          =   855
         Left            =   120
         Picture         =   "AlmFrmSalidaMaterialF11.frx":3C5C5
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   1110
         Width           =   855
      ...
      Begin VB.CommandButton CmdAnadir 
         ...
         Left            =   120
         MousePointer    =   4  'Icon
         Picture         =   "AlmFrmSalidaMaterialF11.frx":3C7CF
         Style           =   1  'Graphical
         TabIndex        =   0
         Top             =   270
         Width           =   855
   ...
   End
End
Attribute VB_Name = "AlmFrmSalidaMaterialF11"
...
'    TDBGDet.Columns("NroIngreso").BackColor = IIf(RsIngreso.RecordCount > 0, RGB(255, 255, 255), RGB(219, 219, 219))
    ...
    TexTFrenSer = FrmF11.frenteservicio
