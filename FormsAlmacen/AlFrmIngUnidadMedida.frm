...
Begin VB.Form AlFrmUnidadMedida 
   ...
   ClientTop       =   345
   ClientWidth     =   10395
   Icon            =   "AlFrmIngUnidadMedida.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   8115
   ScaleWidth      =   10395
   ...
   Begin VB.Frame frmabm 
      ...
      Begin VB.CommandButton CmdAddCabeza 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "AlFrmIngUnidadMedida.frx":6852
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton CmdImpCabeza 
         ...
         Height          =   720
         Left            =   7320
         Picture         =   "AlFrmIngUnidadMedida.frx":D340
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton CmdSalCabeza 
         ...
         Height          =   720
         Left            =   8880
         Picture         =   "AlFrmIngUnidadMedida.frx":DA2A
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton CmdDelCabeza 
         ...
         Height          =   720
         Left            =   5400
         Picture         =   "AlFrmIngUnidadMedida.frx":DC34
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton CmdBusCabeza 
         ...
         Height          =   720
         Left            =   6360
         Picture         =   "AlFrmIngUnidadMedida.frx":E31E
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton CmdModCabeza 
         ...
         Height          =   720
         Left            =   4440
         Picture         =   "AlFrmIngUnidadMedida.frx":E528
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   120
         Width           =   765
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   990
      Left            =   0
      Picture         =   "AlFrmIngUnidadMedida.frx":E732
      ScaleHeight     =   930
      ScaleWidth      =   10335
      TabIndex        =   0
      Top             =   0
   ...
   Begin MSDataGridLib.DataGrid DtgMain 
      Bindings        =   "AlFrmIngUnidadMedida.frx":135D6
      Height          =   5655
      Left            =   0
      TabIndex        =   19
      Top             =   1920
   ...
   Begin VB.Frame frmgrabcabeza 
      ...
      Begin VB.CommandButton CmdGraCabeza 
         ...
         Height          =   675
         Left            =   2400
         Picture         =   "AlFrmIngUnidadMedida.frx":135EF
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton CmdCanCabeza 
         ...
         Height          =   675
         Left            =   3600
         Picture         =   "AlFrmIngUnidadMedida.frx":137F9
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   120
         Width           =   765
...
Private Sub CmdDelCabeza_Click()
   ...
   If AdodcTabla.Recordset("Estatus") = "N" Then
      If sino = vbYes Then
        AdodcTabla.Recordset.Delete
      End If
   Else
        MsgBox "No se puede ELIMINAR un registro Aprobado o Errado ...", vbExclamation, "Validación de Registro"
   End If
End Sub
