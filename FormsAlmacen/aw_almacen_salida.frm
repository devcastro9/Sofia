...
Begin VB.Form aw_almacen_salida 
   ...
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ScaleHeight     =   2.16394e9
   ScaleMode       =   0  'User
   ScaleWidth      =   1.27074e10
...
If Ado_datos.Recordset("estado_almacen") = "REG" Then
  'If Ado_datos.Recordset!almacen_codigo <> "" Then
    If Ado_datos.Recordset!doc_numero_alm > 0 Then
        ...
        rs_datos15.Open "select * from av_ac_bienes_vs_ao_almacenes_totales where almacen_tipo = '" & VAR_ALMT & "' and stock_actual > 0 ORDER BY bien_descripcion", db, adOpenKeyset, adLockReadOnly
        'AND almacen_codigo = " & Ado_datos.Recordset!almacen_codigo & "
