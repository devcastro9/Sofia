...
Begin VB.Form aw_almacen_salida_rep 
   ...
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ScaleHeight     =   9.35357e9
   ScaleMode       =   0  'User
   ScaleWidth      =   7.59208e8
   ...
   Begin VB.Frame Fra_reporte 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.PictureBox BtnCancelar3 
            ...
            Height          =   615
            Left            =   3360
            Picture         =   "aw_almacen_salida_rep.frx":12CF
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   131
            Top             =   0
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Begin VB.CommandButton BtnImprimir1 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_rep.frx":1BBB
         Style           =   1  'Graphical
         TabIndex        =   88
      ...
      Begin VB.CommandButton BtnAnlDetalle 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_rep.frx":2488
         Style           =   1  'Graphical
         TabIndex        =   91
      ...
      Begin VB.CommandButton BtnModDetalle 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_rep.frx":2BD4
         Style           =   1  'Graphical
         TabIndex        =   90
      ...
      Begin VB.CommandButton BtnAddDetalle 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_rep.frx":34E9
         Style           =   1  'Graphical
         TabIndex        =   89
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   735
         Left            =   6360
         Picture         =   "aw_almacen_salida_rep.frx":3CA8
         ScaleHeight     =   735
         ScaleWidth      =   1395
         TabIndex        =   79
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   5040
         Picture         =   "aw_almacen_salida_rep.frx":4575
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   80
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2520
         Picture         =   "aw_almacen_salida_rep.frx":4D2A
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   82
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   735
         Left            =   3720
         Picture         =   "aw_almacen_salida_rep.frx":5476
         ScaleHeight     =   735
         ScaleWidth      =   1320
         TabIndex        =   81
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "aw_almacen_salida_rep.frx":5CA9
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   92
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   710
         Left            =   9000
         Picture         =   "aw_almacen_salida_rep.frx":6468
         Style           =   1  'Graphical
         TabIndex        =   85
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   855
         Left            =   3800
         Picture         =   "aw_almacen_salida_rep.frx":68AA
         Style           =   1  'Graphical
         TabIndex        =   84
         Top             =   -60
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1185
         Picture         =   "aw_almacen_salida_rep.frx":72A1
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   83
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17400
         Picture         =   "aw_almacen_salida_rep.frx":7BB6
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   78
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "aw_almacen_salida_rep.frx":8378
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   75
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "aw_almacen_salida_rep.frx":8B4E
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   74
         Top             =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "aw_almacen_salida_rep.frx":943A
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrmCabecera"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "DETALLE BIENES (Insumos)"
      TabPicture(1)   =   "aw_almacen_salida_rep.frx":9456
      ...
      Begin VB.Frame FrmEdita 
         ...
         Begin VB.PictureBox FraGrabarDet 
            ...
            Begin VB.CommandButton CmdGrabaDet 
               ...
               Height          =   650
               Left            =   4515
               Picture         =   "aw_almacen_salida_rep.frx":9472
               Style           =   1  'Graphical
               TabIndex        =   63
               Top             =   120
               Width           =   1365
            ...
            Begin VB.CommandButton CmdCancelaDet 
               ...
               Left            =   5850
               MaskColor       =   &H00000000&
               Picture         =   "aw_almacen_salida_rep.frx":9C48
               Style           =   1  'Graphical
               TabIndex        =   62
         ...
         Begin MSDataListLib.DataCombo dtc_preciocompra15 
            Bindings        =   "aw_almacen_salida_rep.frx":A534
         ...
         Begin MSDataListLib.DataCombo dtc_subgrupo15 
            Bindings        =   "aw_almacen_salida_rep.frx":A54E
         ...
         Begin MSDataListLib.DataCombo dtc_grupo15 
            Bindings        =   "aw_almacen_salida_rep.frx":A568
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   960
         ...
         Begin MSDataListLib.DataCombo dtc_precioventafinal15 
            Bindings        =   "aw_almacen_salida_rep.frx":A582
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   4485
         ...
         Begin MSDataListLib.DataCombo dtc_codigo15 
            Bindings        =   "aw_almacen_salida_rep.frx":A59C
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   6600
         ...
         Begin MSDataListLib.DataCombo dtc_desc15 
            Bindings        =   "aw_almacen_salida_rep.frx":A5B6
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_unimed15 
            Bindings        =   "aw_almacen_salida_rep.frx":A5D0
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   9840
         ...
         Begin MSDataListLib.DataCombo dtc_stocktotal15 
            Bindings        =   "aw_almacen_salida_rep.frx":A5EA
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   9840
         ...
         Begin MSDataListLib.DataCombo Dtc_Stock13 
            Bindings        =   "aw_almacen_salida_rep.frx":A604
            Height          =   315
            Left            =   9840
            TabIndex        =   39
            Top             =   3000
         ...
         Begin MSDataListLib.DataCombo Dtc_partida15 
            Bindings        =   "aw_almacen_salida_rep.frx":A61E
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   7320
         ...
         Begin MSDataListLib.DataCombo dtc_precioventabase15 
            Bindings        =   "aw_almacen_salida_rep.frx":A638
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   3120
      ...
      Begin VB.Frame FrmCabecera 
         ...
         Begin VB.Frame Frame1 
            ...
            Begin MSDataListLib.DataCombo dtc_desc5 
               Bindings        =   "aw_almacen_salida_rep.frx":A652
            ...
            Begin MSDataListLib.DataCombo dtc_codigo5 
               Bindings        =   "aw_almacen_salida_rep.frx":A66B
               DataField       =   "beneficiario_codigo_tecR"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4275
            ...
            Begin MSDataListLib.DataCombo dtc_desc20 
               Bindings        =   "aw_almacen_salida_rep.frx":A684
            ...
            Begin MSDataListLib.DataCombo dtc_desc22 
               Bindings        =   "aw_almacen_salida_rep.frx":A69E
            ...
            Begin MSDataListLib.DataCombo dtc_codigo20 
               Bindings        =   "aw_almacen_salida_rep.frx":A6B8
               DataField       =   "almacen_codigo_dR"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4755
            ...
            Begin MSDataListLib.DataCombo dtc_codigo22 
               Bindings        =   "aw_almacen_salida_rep.frx":A6D2
               DataField       =   "depto_codigo_dR"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4755
            ...
            Begin MSDataListLib.DataCombo dtc_Aux20 
               Bindings        =   "aw_almacen_salida_rep.frx":A6EC
               DataField       =   "almacen_codigo_dR"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   3600
         ...
         Begin VB.Frame Fra_datos 
            ...
            Begin MSDataListLib.DataCombo dtc_desc4 
               Bindings        =   "aw_almacen_salida_rep.frx":A706
            ...
            Begin MSDataListLib.DataCombo dtc_desc11 
               Bindings        =   "aw_almacen_salida_rep.frx":A71F
            ...
            Begin MSDataListLib.DataCombo dtc_codigo11 
               Bindings        =   "aw_almacen_salida_rep.frx":A739
               DataField       =   "almacen_codigoR"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_codigo4 
               Bindings        =   "aw_almacen_salida_rep.frx":A753
               DataField       =   "beneficiario_codigo_almR"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_desc21 
               Bindings        =   "aw_almacen_salida_rep.frx":A76C
            ...
            Begin MSDataListLib.DataCombo dtc_codigo21 
               Bindings        =   "aw_almacen_salida_rep.frx":A786
               DataField       =   "depto_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_Aux11 
               Bindings        =   "aw_almacen_salida_rep.frx":A7A0
               DataField       =   "almacen_codigoR"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   2880
         ...
         Begin MSDataListLib.DataCombo dtc_codigo3 
            Bindings        =   "aw_almacen_salida_rep.frx":A7BA
         ...
         Begin MSDataListLib.DataCombo dtc_desc3 
            Bindings        =   "aw_almacen_salida_rep.frx":A7D3
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   165
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "aw_almacen_salida_rep.frx":A7EC
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "aw_almacen_salida_rep.frx":A805
            DataField       =   "unidad_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   1860
         ...
         Begin MSDataListLib.DataCombo dtc_aux3 
            Bindings        =   "aw_almacen_salida_rep.frx":A81E
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   6960
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "aw_almacen_salida_rep.frx":A837
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "aw_almacen_salida_rep.frx":A850
            DataField       =   "unidad_destino"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   1800
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "aw_almacen_salida_rep.frx":A869
         Height          =   4290
         Left            =   75
         TabIndex        =   46
         Top             =   240
   ...
   Begin VB.Frame FrmDetalle 
      ...
      Begin MSDataGridLib.DataGrid DtGLista 
         Bindings        =   "aw_almacen_salida_rep.frx":A881
         Height          =   2340
         Left            =   120
         TabIndex        =   14
         Top             =   240
...
Dim Cant_Alm, VAR_CANT, VAR_CANT2 As Double
...
If Ado_datos.Recordset("estado_almacen") = "REG" Then
  If Ado_datos.Recordset!almacen_codigoR <> "" Then
    If Ado_datos.Recordset!doc_numero_almR > 0 Then
        Text9.Visible = False
...
'               VAR_ALMH = Ado_datos.Recordset!almacen_codigoR
...
'''                db.Execute "UPDATE ao_ventas_cabecera SET doc_numero_almR = " & VAR_NUM & " WHERE venta_codigo = " & correlv & " "
...
'''                db.Execute "UPDATE ao_ventas_detalle SET doc_numero_almR = " & VAR_NUM & " WHERE (par_codigo <> '43340') AND (bien_cantidad_por_empaque > 0) AND venta_codigo = " & correlv & " "
...
'''                 rsAuxDetalle.Open "select * from ao_ventas_detalle where venta_codigo= " & correlv & " and almacen_codigoR = " & VAR_ALMH & " and bien_cantidad_por_empaque > 0 ", db, adOpenKeyset, adLockBatchOptimistic
...
'''                     rs_almacen2.Open "select * from ao_almacen_totales where almacen_codigoR = '" & rsAuxDetalle!almacen_codigoR & "' and bien_codigo = '" & rsAuxDetalle!bien_codigo & "' ", db, adOpenKeyset, adLockOptimistic
'''                     If rs_almacen2.RecordCount > 0 Then
'''                         db.Execute "update ao_almacen_totales set ao_almacen_totales.stock_salida = " & rsAuxDetalle!bien_cantidad_por_empaque & "  from ao_almacen_totales, ao_ventas_detalle Where ao_almacen_totales.almacen_codigoR = '" & rsAuxDetalle!almacen_codigoR & "'   And ao_almacen_totales.bien_codigo = '" & rsAuxDetalle!bien_codigo & "'   "
'''                         'AdoAux.Recordset.MoveNext
'''                     Else
''''                        db.Execute "INSERT INTO ao_almacen_totales (almacen_codigoR, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_salida) SELECT " & Ado_datos.Recordset!almacen_codigoR & ", '" & rsAuxDetalle!bien_codigo & "', '" & rsAuxDetalle!grupo_codigo & "', '" & rsAuxDetalle!subgrupo_codigo & "', '" & rsAuxDetalle!par_codigo & "' , '" & rsAuxDetalle!bien_cantidad_por_empaque & "' FROM av_acumula_ventas_detalle WHERE almacen_codigoR = '" & Ado_datos.Recordset!almacen_codigoR & "'   And bien_codigo = '" & rsAuxDetalle!bien_codigo & "'    "
'''                        db.Execute "INSERT INTO ao_almacen_totales (almacen_codigoR, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_salida) SELECT av_acumula_ventas_detalle.almacen_codigoR , av_acumula_ventas_detalle.bien_codigo , av_acumula_ventas_detalle.grupo_codigo, av_acumula_ventas_detalle.subgrupo_codigo, av_acumula_ventas_detalle.par_codigo  ,av_acumula_ventas_detalle.bien_cantidad_por_empaque  FROM av_acumula_ventas_detalle WHERE almacen_codigoR = '" & Ado_datos.Recordset!almacen_codigoR & "'   And bien_codigo = '" & rsAuxDetalle!bien_codigo & "'    "
...
''''                        'rs_aux4.Open "Select * from ao_almacen_totales where almacen_codigoR = 0 and bien_codigo = '" & Ado_datos.Recordset!bien_codigo & "'   ", db, adOpenKeyset, adLockOptimistic
''''                        If rs_aux4.RecordCount > 0 Then
''''                            db.Execute "INSERT INTO ao_almacen_totales (almacen_codigoR, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_ingreso) SELECT " & rs_aux4!almacen_codigoR & ", '" & rs_aux4!bien_codigo & "', '" & rs_aux4!grupo_codigo & "', '" & rs_aux4!subgrupo_codigo & "', '" & rs_aux4!par_codigo & "' , '" & rs_aux4!bien_cantidad_adjudica & "' FROM av_acumula_compras_detalle WHERE almacen_codigoR = '" & rs_almacen2!almacen_codigoR & "'   And bien_codigo = '" & rs_almacen2!bien_codigo & "'    "
''''                        Else
''''                            'If Ado_datos.Recordset!venta_tipo = "V" Then
''''                            '    'db.Execute "INSERT INTO ao_almacen_totales (almacen_codigoR, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_ingreso) SELECT " & rs_aux4!almacen_codigoR & ", '" & rs_aux4!bien_codigo & "', '" & rs_aux4!grupo_codigo & "', '" & rs_aux4!subgrupo_codigo & "', '" & rs_aux4!par_codigo & "' , '" & rs_aux4!bien_cantidad_adjudica & "' FROM av_acumula_compras_detalle WHERE almacen_codigoR = '" & rs_almacen2!almacen_codigoR & "'   And bien_codigo = '" & rs_almacen2!bien_codigo & "'    "
''''                                db.Execute "INSERT INTO ao_almacen_totales (almacen_codigoR, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_ingreso) VALUES (" & rsAuxDetalle!almacen_codigoR & ", '" & rsAuxDetalle!bien_codigo & "', '" & rsAuxDetalle!grupo_codigo & "', '" & rsAuxDetalle!subgrupo_codigo & "', '" & rsAuxDetalle!par_codigo & "' , " & rsAuxDetalle!venta_det_cantidad & ")"
''''                            'Else
...
If Ado_datos.Recordset!estado_almacen = "REG" Then
    'CONTROL DE LOS ITEMS HABILITADOS
    If rs_datos14.State = 1 Then rs_datos14.Close
    rs_datos14.Open "select * from ao_ventas_detalle where venta_codigo = '" & Ado_datos.Recordset!venta_codigo & "'  and almacen_tipo = '" & VAR_ALMT & "'  order by  par_codigo, bien_codigo ", db, adOpenKeyset, adLockOptimistic
    ...
    While Not rs_datos14.EOF
        ...
        If dtc_codigo3.Text = "20101-2" Or dtc_codigo3.Text = "30101-2" Or dtc_codigo3.Text = "70101-2" Or dtc_codigo3.Text = "10101-2" Then
            ...
            Else
                 db.Execute "ap_almacen_totales 1," & Ado_datos.Recordset!almacen_codigo_dR & ", '" & ado_datos14.Recordset!bien_codigo & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0" & ", " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & precio_tot & ", 0, 0, " & precio_tot / GlTipoCambioOficial & ", 0, 0, 'REG','" & glusuario & "'"
            End If
        End If
        ...
        Set rs_almacen2 = New ADODB.Recordset
        If rs_almacen2.State = 1 Then rs_almacen2.Close
        rs_almacen2.Open "select * from ao_almacen_totales where almacen_codigo = " & Ado_datos.Recordset!almacen_codigoR & " and bien_codigo = '" & ado_datos14.Recordset!bien_codigo & "' ", db, adOpenKeyset, adLockOptimistic
        If rs_almacen2.RecordCount > 0 Then
             'db.Execute "update ao_almacen_totales set ao_almacen_totales.stock_salida = av_acumula_ventas_detalle.bien_cantidad_salida from ao_almacen_totales inner join av_acumula_ventas_detalle on ao_almacen_totales.almacen_codigo = av_acumula_ventas_detalle.almacen_codigo and ao_almacen_totales.bien_codigo = av_acumula_ventas_detalle.bien_codigo WHERE ao_almacen_totales.almacen_codigo = " & VAR_ALMH & " And ao_almacen_totales.bien_codigo = '" & VAR_BIEN2 & "'     "
             db.Execute "ap_almacen_totales 2," & Ado_datos.Recordset!almacen_codigoR & ", '" & ado_datos14.Recordset!bien_codigo & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0" & ", " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & precio_tot & ", 0, 0, " & precio_tot / GlTipoCambioOficial & ", 0, 0, 'REG','" & glusuario & "'"
        Else
             db.Execute "ap_almacen_totales 1," & Ado_datos.Recordset!almacen_codigoR & ", '" & ado_datos14.Recordset!bien_codigo & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0" & ", " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & precio_tot & ", 0, 0, " & precio_tot / GlTipoCambioOficial & ", 0, 0, 'REG','" & glusuario & "'"
        End If
...
'    End If
    ...
    VAR_COTIZA = ado_datos14.Recordset.RecordCount
    VAR_CANT2 = IIf(IsNull(ado_datos14.Recordset!venta_det_cantidad), 1, ado_datos14.Recordset!venta_det_cantidad)
    VAR_Bs3 = IIf(IsNull(ado_datos14.Recordset!venta_precio_unitario_bs), 0, ado_datos14.Recordset!venta_precio_unitario_bs)
    ...
    'If CDbl(Dtc_Stock13.Text) >= CDbl(TxtDescuento.Text) Then      'TxtPrecioU.Text
        If swnuevo = 1 Then
            ...
            rs_aux8.Open "select * from ao_ventas_detalle where venta_codigo= " & correlv & "  and bien_codigo = '" & VAR_BIEN2 & "'", db, adOpenKeyset, adLockBatchOptimistic
            ...
            End If
            '
            db.Execute "INSERT INTO AO_ventas_detalle (ges_gestion, venta_codigo, bien_codigo, cotiza_codigo, venta_codigo_new, venta_codigo_det, venta_det_cantidad, venta_precio_unitario_bs, " & _
                   ...
                   " modelo_elegido, modelo_elegido_h, modelo_elegido_x, almacen_tipo, pais_codigo, observaciones, doc_codigo_alm, doc_numero_alm, estado_almacen, " & _
                   " estado_codigo , estado_bien, fecha_ingreso_salida, bien_codigo_padre, estado_codigo_bien, usr_codigo, fecha_registro, hora_registro) " & _
            " values ('" & glGestion & "', " & correlv & ", '" & VAR_BIEN2 & "', " & VAR_COTIZA & ", '0', " & VAR_COTIZA & ", " & CDbl(VAR_CANT2) & ", " & CDbl(VAR_Bs3) & ",  " & _
            ...
            " '" & dtc_subgrupo15.Text & "', '" & Dtc_partida15.Text & "', " & CDbl(TxtDescuento.Text) & ", '0', " & VAR_ALMX & ", 'S/M', 'S/M', 'S/M',  'S/M',  " & _
            " 'N', 'N', 'N', '" & VAR_ALMT & "', 'BOL', '" & dtc_desc15.Text & "', '" & VAR_DOC & "', " & Ado_datos.Recordset!doc_numero_almR & ", 'REG', " & _
            " 'APR', 'REG', '" & Date & "', '', 'REG', '" & glusuario & "', '" & Date & "', ''  ) "
    ...
    '    '   ado_datos14.Recordset!tipo_descuento = IIf(dtc_codigo12.Text = "", "0", dtc_codigo12.Text)                      ' Tipo de Descuento
         '   ado_datos14.Recordset!concepto_venta = txt_descripcion_venta                  'Descripcion y Caracteristicas
            ...
            If swnuevo = 1 Then
                ...
                'db.Execute "UPDATE ao_ventas_detalle SET bien_codigo = '" & Trim(VAR_BIEN2) & "' WHERE venta_codigo = " & correlv & " AND bien_codigo = '' "
        ...
        If swnuevo = 2 Then
            db.Execute "UPDATE ao_ventas_detalle SET bien_codigo = '" & VAR_BIEN2 & "', bien_cantidad_por_empaque = " & CDbl(TxtDescuento.Text) & ", observaciones = '" & ado_datos14.Recordset!observaciones & "' WHERE venta_codigo = " & correlv & " AND bien_codigo = '" & VAR_BIEN2 & "' "
        End If
...
Private Sub dtc_desc15_Click(Area As Integer)
    ...
    Set rs_aux9 = New ADODB.Recordset
    If rs_aux9.State = 1 Then rs_aux9.Close
    rs_aux9.Open "SELECT * FROM ao_almacen_totales WHERE almacen_codigo = " & IIf(IsNull(Ado_datos.Recordset!almacen_codigoR), 0, Ado_datos.Recordset!almacen_codigoR) & " and bien_codigo ='" & dtc_codigo15.Text & "'", db, adOpenStatic
   ' Set AdoAux9.Recordset = rs_aux9
    If rs_aux9.RecordCount > 0 Then
     Dtc_Stock13.Text = IIf(IsNull(rs_aux9!stock_actual), 0, rs_aux9!stock_actual)
    Else
...
Private Sub ABRIR_TABLAS_AUX()
 ...
 'Beneficiario Personas Nat. y Juridicas
    ...
    rs_datos4.Open "Select * from av_almacen_responsable where unidad_codigo = '" & parametro & "' order by beneficiario_denominacion", db, adOpenStatic
...
'        Ado_datos.Recordset!doc_codigo = VAR_R
        ...
        Select Case VAR_ORIGEN
            Case "UALMI"
                ...
                VAR_DOCH = ""
                VAR_DOCA = ""
                VAR_BENI = dtc_codigo4.Text
                VAR_BENR = "0"
                VAR_BENH = "0"
                VAR_BENA = "0"
                VAR_BENDI = dtc_codigo5.Text
                VAR_BENDR = "0"
                VAR_BENDH = "0"
                VAR_BENDA = "0"
                VAR_NUMI = VAR_NUM
                ...
                VAR_ALMI = dtc_codigo11.Text
                VAR_ALMR = "0"
                VAR_ALMH = "0"
                VAR_ALMA = "0"
                
                VAR_ALMDI = dtc_codigo20.Text
                VAR_ALMDR = "0"
                VAR_ALMDH = "0"
                VAR_ALMDA = "0"
            Case "UALMR"
        ...
        db.Execute "INSERT INTO AO_ventas_cabecera (ges_gestion, venta_codigo, venta_codigo_new, depto_codigo, unidad_codigo, solicitud_codigo, edif_codigo, unidad_destino, unidad_codigo_ant, solicitud_codigo_ant, venta_fecha, venta_tipo, beneficiario_codigo, beneficiario_codigo_resp, beneficiario_codigo_cobr, beneficiario_codigo_alm, " & _
                   ...
                   " doc_codigo_alm, doc_numero_alm, poa_codigo_alm, almacen_codigo, almacen_codigo_d, depto_codigo_d,          doc_codigo_almR, doc_numero_almR, almacen_codigoR, almacen_codigo_dR, depto_codigo_dR, doc_codigo_almH, doc_numero_almH, almacen_codigoH, almacen_codigo_dH, depto_codigo_dH, archivo_respaldo, " & _
                   " archivo_respaldo_cargado, correl_detalle, correl_cobro_prog, estado_cancelado, estado_alcance, estado_codigo, estado_almacen, usr_codigo, fecha_registro, estado_codigo_verif, usr_codigo_verif, fecha_verif, literal_a, literal_i , literal_r, literal_h, nro_eqp, tipo_moneda) " & _
            " values ('" & glGestion & "', " & var_cod5 & ", '0', '" & VAR_DPTO & "', '" & parametro & "', " & var_cod & ", '" & dtc_codigo3.Text & "', '" & dtc_codigo2.Text & "', '" & VAR_CITE & "', '0', '" & FVenta & "', 'A', '" & VAR_BENA & "', '" & dtc_codigo4.Text & "', '0', '" & VAR_BENI & "', " & _
            ...
            " '" & VAR_DOCI & "', " & VAR_NUMI & ", '" & VAR_POA & "', " & VAR_ALMI & ", " & VAR_ALMDI & ", '" & VAR_DPTOD & "', '" & VAR_DOCR & "', " & VAR_NUMR & ", " & VAR_ALMR & ", " & VAR_ALMDR & ", '" & VAR_DPTOD & "', '" & VAR_DOCH & "', " & VAR_NUMH & ", " & VAR_ALMH & ", " & VAR_ALMDH & ", '" & VAR_DPTOD & "', '" & VAR_CITE & "', " & _
            " 'N',                              '0',            '1',                'N',            'N',            'APR',          'REG', '" & glusuario & "', '" & Date & "', 'REG',  '" & glusuario & "', '" & Date & "', '', '', '', '', '0', 'BOB' ) "
...
'        'Ado_datos.Recordset("fecha_aprueba") = ""
    ...
    If swgrabar = 2 Then
        ...
        If dtc_codigo3.Text = "20101-2" Or dtc_codigo3.Text = "30101-2" Or dtc_codigo3.Text = "70101-2" Or dtc_codigo3.Text = "10101-2" Then
            VAR_R = "R-119"
            db.Execute "UPDATE ao_ventas_cabecera SET almacen_codigo_dR = '" & dtc_codigo20.Text & "', depto_codigo_dR = '" & dtc_codigo22.Text & "'   WHERE venta_codigo = " & var_cod5 & " "
            ...
            VAR_NUM = Ado_datos.Recordset!doc_numero_almR
        Else
            VAR_R = "R-115"
            VAR_NUM = Ado_datos.Recordset!doc_numero_almR
...
'         rs_aux1!solicitud_codigo_ant = 0
        ...
        'db.Execute "UPDATE ao_ventas_cabecera SET doc_numero_almR = " & VAR_NUM & " WHERE venta_codigo = " & var_cod5 & " "
    End If
End Sub
...
'    'queryinicial = "select * From av_ventas_cabecera_sol_alm WHERE estado_codigo = 'APR' AND estado_almacen = 'REG' AND LEFT(doc_codigo_alm,5) = '" & Left(VAR_R, 5) & "' "
    ...
    rs_datos.Sort = " almacen_codigoR, doc_numero_almR"
...
Set rs_datos = New Recordset
    ...
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos.Sort = "doc_codigo_almR, doc_numero_almR"
    'rs_datos.Sort = "unidad_codigo, SOLICITUD_codigo"
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
...
Set rs_datos = New Recordset
    ...
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos.Sort = "doc_codigo_almR, almacen_codigoR, doc_numero_almR"
    'rs_datos.Sort = "unidad_codigo, SOLICITUD_codigo"
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
