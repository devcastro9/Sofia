...
Begin VB.Form aw_almacen_salida_herra 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   1725
   ClientWidth     =   15270
   Icon            =   "aw_almacen_salida_herra.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ScaleHeight     =   7.57988e8
   ScaleMode       =   0  'User
   ScaleWidth      =   7.01406e9
   ...
   Begin VB.Frame Fra_reporte 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.PictureBox BtnImprimir2 
            ...
            Height          =   615
            Left            =   1560
            Picture         =   "aw_almacen_salida_herra.frx":0A02
            ScaleHeight     =   615
            ScaleWidth      =   1455
            TabIndex        =   131
         ...
         Begin VB.PictureBox BtnCancelar3 
            ...
            Height          =   615
            Left            =   3360
            Picture         =   "aw_almacen_salida_herra.frx":12CF
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   130
            Top             =   0
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Begin VB.CommandButton BtnImprimir1 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_herra.frx":1BBB
         Style           =   1  'Graphical
         TabIndex        =   87
      ...
      Begin VB.CommandButton BtnAnlDetalle 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_herra.frx":2488
         Style           =   1  'Graphical
         TabIndex        =   90
      ...
      Begin VB.CommandButton BtnModDetalle 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_herra.frx":2BD4
         Style           =   1  'Graphical
         TabIndex        =   89
      ...
      Begin VB.CommandButton BtnAddDetalle 
         ...
         Height          =   525
         Left            =   120
         Picture         =   "aw_almacen_salida_herra.frx":34E9
         Style           =   1  'Graphical
         TabIndex        =   88
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Height          =   735
         Left            =   7920
         Picture         =   "aw_almacen_salida_herra.frx":3CA8
         ScaleHeight     =   735
         ScaleWidth      =   1395
         TabIndex        =   151
         ToolTipText     =   "Listado De herramientas del Tecnico"
         Top             =   0
         Width           =   1400
      End
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   735
         Left            =   6360
         Picture         =   "aw_almacen_salida_herra.frx":4575
         ScaleHeight     =   735
         ScaleWidth      =   1395
         TabIndex        =   78
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   5040
         Picture         =   "aw_almacen_salida_herra.frx":4E42
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   79
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2520
         Picture         =   "aw_almacen_salida_herra.frx":55F7
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   81
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   735
         Left            =   3720
         Picture         =   "aw_almacen_salida_herra.frx":5D43
         ScaleHeight     =   735
         ScaleWidth      =   1320
         TabIndex        =   80
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "aw_almacen_salida_herra.frx":6576
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   91
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   710
         Left            =   9840
         Picture         =   "aw_almacen_salida_herra.frx":6D35
         Style           =   1  'Graphical
         TabIndex        =   84
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   855
         Left            =   3800
         Picture         =   "aw_almacen_salida_herra.frx":7177
         Style           =   1  'Graphical
         TabIndex        =   83
         Top             =   -60
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1185
         Picture         =   "aw_almacen_salida_herra.frx":7B6E
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   82
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   18360
         Picture         =   "aw_almacen_salida_herra.frx":8483
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   77
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "aw_almacen_salida_herra.frx":8C45
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   74
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "aw_almacen_salida_herra.frx":941B
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   73
         Top             =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "aw_almacen_salida_herra.frx":9D07
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrmCabecera"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "DETALLE BIENES (Insumos)"
      TabPicture(1)   =   "aw_almacen_salida_herra.frx":9D23
      ...
      Begin VB.Frame FrmEdita 
         ...
         Begin VB.PictureBox FraGrabarDet 
            ...
            Begin VB.CommandButton CmdGrabaDet 
               ...
               Height          =   650
               Left            =   4515
               Picture         =   "aw_almacen_salida_herra.frx":9D3F
               Style           =   1  'Graphical
               TabIndex        =   62
               Top             =   120
               Width           =   1365
            ...
            Begin VB.CommandButton CmdCancelaDet 
               ...
               Left            =   5850
               MaskColor       =   &H00000000&
               Picture         =   "aw_almacen_salida_herra.frx":A515
               Style           =   1  'Graphical
               TabIndex        =   61
         ...
         Begin MSDataListLib.DataCombo dtc_preciocompra15 
            Bindings        =   "aw_almacen_salida_herra.frx":AE01
         ...
         Begin MSDataListLib.DataCombo dtc_subgrupo15 
            Bindings        =   "aw_almacen_salida_herra.frx":AE1B
         ...
         Begin MSDataListLib.DataCombo dtc_grupo15 
            Bindings        =   "aw_almacen_salida_herra.frx":AE35
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   960
         ...
         Begin MSDataListLib.DataCombo dtc_precioventafinal15 
            Bindings        =   "aw_almacen_salida_herra.frx":AE4F
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   4485
         ...
         Begin MSDataListLib.DataCombo dtc_codigo15 
            Bindings        =   "aw_almacen_salida_herra.frx":AE69
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   6600
         ...
         Begin MSDataListLib.DataCombo dtc_desc15 
            Bindings        =   "aw_almacen_salida_herra.frx":AE83
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_unimed15 
            Bindings        =   "aw_almacen_salida_herra.frx":AE9D
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   9840
         ...
         Begin MSDataListLib.DataCombo dtc_stocktotal15 
            Bindings        =   "aw_almacen_salida_herra.frx":AEB7
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   9840
         ...
         Begin MSDataListLib.DataCombo Dtc_Stock13 
            Bindings        =   "aw_almacen_salida_herra.frx":AED1
            Height          =   315
            Left            =   9840
            TabIndex        =   38
            Top             =   2880
         ...
         Begin MSDataListLib.DataCombo Dtc_partida15 
            Bindings        =   "aw_almacen_salida_herra.frx":AEEB
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   7320
         ...
         Begin MSDataListLib.DataCombo dtc_precioventabase15 
            Bindings        =   "aw_almacen_salida_herra.frx":AF05
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   3120
            ...
            Text            =   ""
         End
         Begin MSDataListLib.DataCombo dtc_desc_est 
            Bindings        =   "aw_almacen_salida_herra.frx":AF1F
            DataField       =   "estado_codigo_bien"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   240
            TabIndex        =   142
            ...
            BackColor       =   16777215
            ForeColor       =   0
            ListField       =   "estado_descripcion"
            BoundColumn     =   "estado_codigo"
            Text            =   ""
         End
         Begin MSDataListLib.DataCombo dtc_cod_est 
            Bindings        =   "aw_almacen_salida_herra.frx":AF39
            DataField       =   "estado_codigo_bien"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   6600
      ...
      Begin VB.Frame FrmCabecera 
         ...
         Begin VB.Frame Frame1 
            ...
            Begin MSDataListLib.DataCombo dtc_desc5 
               Bindings        =   "aw_almacen_salida_herra.frx":AF53
               DataField       =   "beneficiario_codigo_tecH"
            ...
            Begin MSDataListLib.DataCombo dtc_codigo5 
               Bindings        =   "aw_almacen_salida_herra.frx":AF6C
            ...
            Begin MSDataListLib.DataCombo dtc_desc20 
               Bindings        =   "aw_almacen_salida_herra.frx":AF85
            ...
            Begin MSDataListLib.DataCombo dtc_desc22 
               Bindings        =   "aw_almacen_salida_herra.frx":AF9F
            ...
            Begin MSDataListLib.DataCombo dtc_codigo20 
               Bindings        =   "aw_almacen_salida_herra.frx":AFB9
               DataField       =   "almacen_codigo_d"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4755
            ...
            Begin MSDataListLib.DataCombo dtc_codigo22 
               Bindings        =   "aw_almacen_salida_herra.frx":AFD3
               DataField       =   "depto_codigo_d"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4755
            ...
            Begin MSDataListLib.DataCombo dtc_Aux20 
               Bindings        =   "aw_almacen_salida_herra.frx":AFED
               DataField       =   "almacen_codigo_d"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   3600
         ...
         Begin VB.Frame Fra_datos 
            ...
            Begin MSDataListLib.DataCombo dtc_desc4 
               Bindings        =   "aw_almacen_salida_herra.frx":B007
            ...
            Begin MSDataListLib.DataCombo dtc_desc11 
               Bindings        =   "aw_almacen_salida_herra.frx":B020
               DataField       =   "almacen_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   1380
            ...
            Begin MSDataListLib.DataCombo dtc_codigo11 
               Bindings        =   "aw_almacen_salida_herra.frx":B03A
               DataField       =   "almacen_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_codigo4 
               Bindings        =   "aw_almacen_salida_herra.frx":B054
               DataField       =   "beneficiario_codigo_alm"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_desc21 
               Bindings        =   "aw_almacen_salida_herra.frx":B06D
            ...
            Begin MSDataListLib.DataCombo dtc_codigo21 
               Bindings        =   "aw_almacen_salida_herra.frx":B087
               DataField       =   "depto_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_Aux11 
               Bindings        =   "aw_almacen_salida_herra.frx":B0A1
               DataField       =   "almacen_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   2880
         ...
         Begin MSDataListLib.DataCombo dtc_codigo3 
            Bindings        =   "aw_almacen_salida_herra.frx":B0BB
         ...
         Begin MSDataListLib.DataCombo dtc_desc3 
            Bindings        =   "aw_almacen_salida_herra.frx":B0D4
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   165
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "aw_almacen_salida_herra.frx":B0ED
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "aw_almacen_salida_herra.frx":B106
            DataField       =   "unidad_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   1860
         ...
         Begin MSDataListLib.DataCombo dtc_aux3 
            Bindings        =   "aw_almacen_salida_herra.frx":B11F
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   6960
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "aw_almacen_salida_herra.frx":B138
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "aw_almacen_salida_herra.frx":B151
            DataField       =   "unidad_destino"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   1800
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "aw_almacen_salida_herra.frx":B16A
         Height          =   4290
         Left            =   120
         TabIndex        =   45
         Top             =   240
         ...
         BeginProperty Column03 
            DataField       =   "beneficiario_denominacionH"
            Caption         =   "Nombre"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
   ...
   Begin VB.Frame FrmDetalle 
      BackColor       =   &H00C0C0C0&
      Caption         =   "HERAMMIENTAS ENTREGADAS ________________________________________________________HERRAMIENTAS DEVUELTAS"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   645
         Left            =   7980
         Picture         =   "aw_almacen_salida_herra.frx":B182
         Style           =   1  'Graphical
         TabIndex        =   141
      ...
      Begin VB.CommandButton BtnAddDetalle3 
         ...
         Left            =   7980
         MaskColor       =   &H80000014&
         Picture         =   "aw_almacen_salida_herra.frx":B5C4
         Style           =   1  'Graphical
         TabIndex        =   140
         ...
         Width           =   885
      End
      Begin MSDataGridLib.DataGrid DtGListaD 
         Bindings        =   "aw_almacen_salida_herra.frx":BA06
         Height          =   2340
         Left            =   8880
         TabIndex        =   139
         Top             =   240
      ...
      Begin MSDataGridLib.DataGrid DtGLista 
         Bindings        =   "aw_almacen_salida_herra.frx":BA21
         Height          =   2340
         Left            =   120
         TabIndex        =   144
         Top             =   240
   ...
   Begin MSAdodcLib.Adodc AdoAux9 
      ...
      _Version        =   393216
   End
   Begin MSAdodcLib.Adodc ado_datos14d 
      Height          =   330
      Left            =   6720
      Top             =   9480
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "aw_almacen_salida_herra"
...
Dim rs_datos14d As New ADODB.Recordset
...
' If accion <> "NEW" Then
    Set rs_datos14 = New ADODB.Recordset
        ...
        '
        rs_datos14.Open "select * from av_venta_detalle_herramientas where venta_codigo = '" & Ado_datos.Recordset!venta_codigo & "'  and almacen_tipo = '" & VAR_ALMT & "'  order by  par_codigo, bien_codigo ", db, adOpenKeyset, adLockOptimistic
        ...
        Set rs_datos14d = New ADODB.Recordset
        If rs_datos14d.State = 1 Then rs_datos14d.Close
        '
        rs_datos14d.Open "select * from av_almacen_salida_herr where venta_codigo = '" & Ado_datos.Recordset!venta_codigo & "' and almacen_codigo = '5'", db, adOpenKeyset, adLockOptimistic
        'rs_datos14d.Open "select * from ao_ventas_detalle where venta_codigo = '" & Ado_datos.Recordset!venta_codigo & "'  and par_codigo <> '43340'  order by  par_codigo, bien_codigo ", db, adOpenKeyset, adLockOptimistic
        'rs_datos14d.Sort = "hora_registro"
        Set ado_datos14d.Recordset = rs_datos14d
        ado_datos14d.Recordset.Requery
        If ado_datos14d.Recordset.RecordCount > 0 Then
            deta2 = 1
            Call AbreAlmacen
        Else
            deta2 = 0
...
If Ado_datos.Recordset("estado_almacen") = "REG" Then
  If Ado_datos.Recordset!almacen_codigoH <> "" Then
    If Ado_datos.Recordset!doc_numero_almH > 0 Then
    ...
    '            VAR_DET = "39800"
            ...
            Case "UALMH"    'HERRAMIENTAS
                rs_datos15.Open "select * from av_ac_bienes_vs_ao_almacenes_totales where almacen_tipo = 'H' AND almacen_codigo = " & Ado_datos.Recordset!almacen_codigoH & " and stock_actual > 0 ORDER BY bien_descripcion", db, adOpenKeyset, adLockReadOnly
    '            VAR_DET = "34800"
                Set ado_datos15.Recordset = rs_datos15
                ado_datos15.Refresh
        End Select
...
Private Sub BtnAddDetalle3_Click()
    If Ado_datos.Recordset("estado_almacen") = "REG" Then
        ...
        rs_aux10.Open "select * from av_almacen_salida_herr where venta_codigo = '" & Ado_datos.Recordset!venta_codigo & "' and almacen_codigo = '5' AND bien_codigo = '" & Trim(dtc_codigo15.Text) & "'", db, adOpenKeyset, adLockOptimistic
        If rs_aux10.RecordCount = 0 Then
            'VAR_ALMH = Ado_datos.Recordset!almacen_codigoH
            'VAR_ALMD = Ado_datos.Recordset!almacen_codigo_dH
            VAR_ALMH = Ado_datos.Recordset!almacen_codigoH
            correlv = Ado_datos.Recordset!venta_codigo
            VAR_PROY2 = Ado_datos.Recordset!EDIF_CODIGO
            VAR_BEN3 = Ado_datos.Recordset!beneficiario_codigo_almH
            VAR_DOC = Ado_datos.Recordset!doc_codigo_almH
            VAR_ALMD = "0"                                          'Ado_datos.Recordset!almacen_codigo_DH
            VAR_BIEN2 = Trim(dtc_codigo15.Text)
            VAR_PROY2 = Ado_datos.Recordset!EDIF_CODIGO
            VAR_DOC = Ado_datos.Recordset!doc_codigo_almH
            VAR_COD2 = IIf(Ado_datos.Recordset!doc_numero_almH = "", "1", Ado_datos.Recordset!doc_numero_almH)
            
            db.Execute "ap_ventas_grla 2, '" & glGestion & "', " & VAR_ALMD & ", '" & VAR_DOC & "', " & VAR_COD2 & ", '" & VAR_BIEN2 & "', '" & VAR_PROY2 & "', " & correlv & ", '" & VAR_BEN3 & "', '" & Ado_datos.Recordset!fecha_verif & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & "0" & ", " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_dol), 0, ado_datos14.Recordset!venta_precio_total_dol) & ", 'REG', '" & glusuario & "','" & Ado_datos.Recordset!venta_descripcion & "'," & precio_uni & ""
            
            db.Execute "ap_compras_grla 2,'" & glGestion & "', " & VAR_ALMH & ", '" & VAR_DOC & "', " & VAR_COD2 & ", '" & VAR_BIEN2 & "', '" & VAR_PROY2 & "', " & correlv & ", '" & VAR_BEN3 & "', '" & Ado_datos.Recordset!fecha_verif & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & "0" & ", " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_dol), 0, ado_datos14.Recordset!venta_precio_total_dol) & ", 'REG', '" & glusuario & "','" & Ado_datos.Recordset!venta_descripcion & "'," & precio_uni & ""
            
            ' db.Execute "UPDATE ao_almacen_totales SET stock_salida = ISNULL((SELECT SUM(cantidad_salida) FROM ao_almacen_salidas WHERE bien_codigo = '" & VAR_BIEN2 & "' AND almacen_codigo = " & VAR_ALMD & "),0) where almacen_codigo = " & VAR_ALMD & " and bien_codigo = '" & VAR_BIEN2 & "' "
            ' db.Execute "UPDATE ao_almacen_totales SET stock_ingreso = ISNULL((SELECT SUM(cantidad_ingreso) FROM ao_almacen_ingresos WHERE bien_codigo = '" & VAR_BIEN2 & "' AND almacen_codigo = " & VAR_ALMH & "),0) where almacen_codigo = " & VAR_ALMH & " and bien_codigo = '" & VAR_BIEN2 & "' "
            ' db.Execute "update ao_almacen_totales set stock_actual = ISNULL(stock_ingreso,0)  - stock_salida"
            ...
            ' db.Execute "update ao_almacen_totales set stock_salida  = ISNULL(totales_almacen_salida.cantidad_salida,0) FROM totales_almacen_salida WHERE totales_almacen_salida.bien_codigo = ao_almacen_totales.bien_codigo and totales_almacen_salida.almacen_codigo = ao_almacen_totales.almacen_codigo"
            ' db.Execute "update ao_almacen_totales set stock_actual = stock_ingreso - ISNULL(stock_salida,0)"

            db.Execute "ap_almacen_totales 2," & Ado_datos.Recordset!almacen_codigo & ", '" & ado_datos14.Recordset!bien_codigo & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0" & ", " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0 , 0, 0, " & precio_tot / GlTipoCambioOficial & ", 0, 0, 'REG','" & glusuario & "'"
            
            ado_datos14.Recordset!fecha_ingreso_salida = Date
            ado_datos14.Recordset!estado_bien = "ING"
            ado_datos14.Recordset.Update
            Call AbrirDetalle
        Else
            sino = MsgBox("Esta Herramienta ya Fué Devuelta", vbInformation, "SOFIA")
        End If
    End If
End Sub
...
'    dtc_desc3.BoundText = VAR_DPTO + "0101-2"
'    dtc_codigo3.Text = VAR_DPTO + "0101-2"
    dtc_codigo20.BoundText = "5"
    dtc_desc22.BoundText = VAR_DPTO
    ...
    'If VAR_ALMH = "" Then  'VAR_ALMH <> ""
        ...
        If Ado_datos11.Recordset.RecordCount > 0 Then
           ...
           VAR_ALMH = rs_datos11!almacen_codigo
...
'                    rs_aux5.Update
'                End If
'                db.Execute "UPDATE ao_ventas_cabecera SET doc_codigo_almH = '" & VAR_R & "' WHERE venta_codigo = " & correlv & " "
'                db.Execute "UPDATE ao_ventas_cabecera SET doc_numero_almH = " & VAR_NUM & " WHERE venta_codigo = " & correlv & " "
'                db.Execute "UPDATE ao_ventas_detalle SET doc_codigo_almH = '" & VAR_R & "' WHERE (par_codigo <> '43340') AND (bien_cantidad_por_empaque > 0) AND venta_codigo = " & correlv & " "
'                db.Execute "UPDATE ao_ventas_detalle SET doc_numero_almH = " & VAR_NUM & " WHERE (par_codigo <> '43340') AND (bien_cantidad_por_empaque > 0) AND venta_codigo = " & correlv & " "
...
'                 rsAuxDetalle.Open "select * from ao_ventas_detalle where venta_codigo= " & correlv & " and almacen_codigo = " & VAR_ALMH & " and bien_cantidad_por_empaque > 0 ", db, adOpenKeyset, adLockBatchOptimistic
...
'                     Else
''                        db.Execute "INSERT INTO ao_almacen_totales (almacen_codigo, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_salida) SELECT " & Ado_datos.Recordset!almacen_codigoH & ", '" & rsAuxDetalle!bien_codigo & "', '" & rsAuxDetalle!grupo_codigo & "', '" & rsAuxDetalle!subgrupo_codigo & "', '" & rsAuxDetalle!par_codigo & "' , '" & rsAuxDetalle!bien_cantidad_por_empaque & "' FROM av_acumula_ventas_detalle WHERE almacen_codigo = '" & Ado_datos.Recordset!almacen_codigoH & "'   And bien_codigo = '" & rsAuxDetalle!bien_codigo & "'    "
'                        db.Execute "INSERT INTO ao_almacen_totales (almacen_codigo, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_salida) SELECT av_acumula_ventas_detalle.almacen_codigo , av_acumula_ventas_detalle.bien_codigo , av_acumula_ventas_detalle.grupo_codigo, av_acumula_ventas_detalle.subgrupo_codigo, av_acumula_ventas_detalle.par_codigo  ,av_acumula_ventas_detalle.bien_cantidad_por_empaque  FROM av_acumula_ventas_detalle WHERE almacen_codigo = '" & Ado_datos.Recordset!almacen_codigoH & "'   And bien_codigo = '" & rsAuxDetalle!bien_codigo & "'    "
...
'            CryV01.ReportFileName = App.Path & "\Reportes\Almacenes\ar_salida_almacenes.rpt"
'        End If
'        If Left(Ado_datos.Recordset!doc_codigo_almH, 5) = "R-115" Then
'            CryV01.ReportFileName = App.Path & "\Reportes\Almacenes\ar_salida_almacenes.rpt"
'        Else
...
On Error GoTo UpdateErr
  If dtc_codigo15 = "" Then
     MsgBox "Debe Elejir un Bien !! Vuelva a Intentar ...", vbExclamation, "Atención"
  ...
  If dtc_cod_est.Text = "" Then
    MsgBox "Debe Registrar Estado del Bien, !! Vuelva a Intentar ...", vbExclamation, "Atención"
     'ado_datos14.Recordset.CancelBatch
    'Call AbrirDetalle
    Exit Sub
  End If
...
'    End If
    ...
    '       ado_datos14.Recordset!tipo_descuento = IIf(dtc_codigo12.Text = "", "0", dtc_codigo12.Text)                      ' Tipo de Descuento
            ...
            ado_datos14.Recordset!almacen_codigo = IIf(Ado_datos.Recordset!almacen_codigo = "", "2", Ado_datos.Recordset!almacen_codigoH)
            ado_datos14.Recordset!doc_codigo_alm = IIf(Ado_datos.Recordset!doc_codigo_almH = "", "R-115", Ado_datos.Recordset!doc_codigo_almH)
            ado_datos14.Recordset!doc_numero_alm = IIf(Ado_datos.Recordset!doc_numero_almH = "", "1", Ado_datos.Recordset!doc_numero_almH)
            VAR_COD2 = IIf(Ado_datos.Recordset!doc_numero_almH = "", "1", Ado_datos.Recordset!doc_numero_almH)
            ...
            ado_datos14.Recordset!estado_almacen = "APR"
            ado_datos14.Recordset!estado_codigo_bien = dtc_cod_est.Text
            ado_datos14.Recordset!fecha_ingreso_salida = Date
            ado_datos14.Recordset!estado_bien = "SAL"
            ado_datos14.Recordset.Update
...
'            Set rs_aux4 = New ADODB.Recordset
'            If rs_aux4.State = 1 Then rs_aux4.Close
'            rs_aux4.Open "Select * from av_acumula_ventas_detalle where almacen_codigo = " & VAR_ALMH & " and bien_codigo = '" & VAR_BIEN2 & "'  and estado_almacen = 'APR' ", db, adOpenKeyset, adLockOptimistic
'            If rs_aux4.RecordCount > 0 Then
'                db.Execute "INSERT INTO ao_almacen_totales(almacen_codigo, bien_codigo, grupo_codigo, subgrupo_codigo, par_codigo, stock_ingreso) SELECT " & rs_aux4!almacen_codigo & ", '" & rs_aux4!bien_codigo & "', '" & rs_aux4!grupo_codigo & "', '" & rs_aux4!subgrupo_codigo & "', '" & rs_aux4!par_codigo & "' , '" & rs_aux4!bien_cantidad_adjudica & "' FROM av_acumula_compras_detalle WHERE almacen_codigo = '" & rs_almacen2!almacen_codigo & "'   And bien_codigo = '" & rs_almacen2!bien_codigo & "'    "
'            Else
'                'If Ado_datos.Recordset!venta_tipo = "V" Then
...
'            End If
            ...
            rs_precio.Open "SELECT TOP 1 * from ao_almacen_ingresos where ges_gestion = '" & glGestion & "' AND almacen_codigo = " & VAR_ALMH & " and bien_codigo = '" & VAR_BIEN2 & "' ORDER BY fecha_ingreso DESC", db, adOpenKeyset, adLockOptimistic
            ...
            Set rs_aux4 = New ADODB.Recordset
            If rs_aux4.State = 1 Then rs_aux4.Close
            rs_aux4.Open "Select * from ao_almacen_salidas where ges_gestion = '" & glGestion & "' AND almacen_codigo = " & VAR_ALMH & " AND doc_codigo = '" & VAR_DOC & "' AND doc_numero = " & ado_datos14.Recordset!doc_numero_alm & " and bien_codigo = '" & VAR_BIEN2 & "'   ", db, adOpenKeyset, adLockOptimistic
            If rs_aux4.RecordCount > 0 Then
                db.Execute "update ao_almacen_salidas set edif_codigo = '" & Ado_datos.Recordset!EDIF_CODIGO & "', beneficiario_codigo = '" & Ado_datos.Recordset!beneficiario_codigo_almH & "', fecha_salida = '" & Ado_datos.Recordset!fecha_verif & "', cantidad_salida = " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", fecha_registro = '" & Date & "', usr_codigo = '" & glusuario & "', concepto = '" & Ado_datos.Recordset!venta_descripcion & "', importe_venta_bs = " & precio_tot & " WHERE ges_gestion = '" & glGestion & "' AND almacen_codigo = " & VAR_ALMH & " AND doc_numero = " & Ado_datos.Recordset!doc_numero_almH & " and bien_codigo = '" & VAR_BIEN2 & "'"
            Else
                'db.Execute "INSERT INTO ao_almacen_salidas (ges_gestion,        almacen_codigo, doc_codigo,         doc_numero,         bien_codigo,         edif_codigo, venta_codigo,      beneficiario_codigo,         fecha_salida,                bien_nro_lote,                                cantidad_salida,     importe_venta_bs, importe_venta_dol, estado_codigo, fecha_registro, usr_codigo, concepto,precio_unitario_bs ) VALUES "
              db.Execute "ap_ventas_grla 2,'" & glGestion & "', " & VAR_ALMH & ", '" & VAR_DOC & "', " & VAR_COD2 & ", '" & VAR_BIEN2 & "', '" & VAR_PROY2 & "', " & correlv & ", '" & VAR_BEN3 & "', '" & Ado_datos.Recordset!fecha_verif & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & precio_tot & ", " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_dol), 0, ado_datos14.Recordset!venta_precio_total_dol) & ", 'REG','" & glusuario & "','" & Ado_datos.Recordset!venta_descripcion & "'," & precio_uni & ""
                
                'db.Execute "INSERT INTO ao_almacen_ingresos (ges_gestion ,   almacen_codigo,      doc_codigo,       doc_numero,      bien_codigo,           edif_codigo,        compra_codigo, beneficiario_codigo,     fecha_ingreso, bien_nro_lote,                                cantidad_ingreso,      importe_compra_bs,                                                                             importe_compra_dol,               estado_codigo, fecha_registro, usr_codigo,                                         concepto, precio_unitario_bs) VALUES "
              db.Execute "ap_compras_grla 2, '" & glGestion & "', " & VAR_ALMD & ", '" & VAR_DOC & "', " & VAR_COD2 & ", '" & VAR_BIEN2 & "', '" & VAR_PROY2 & "', " & correlv & ", '" & VAR_BEN3 & "', '" & Ado_datos.Recordset!fecha_verif & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & precio_tot & ", " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_dol), 0, ado_datos14.Recordset!venta_precio_total_dol) & ", 'REG','" & glusuario & "','" & Ado_datos.Recordset!venta_descripcion & "'," & precio_uni & ""
            ...
            'ACTUALIZA ao_almacen_totales   'Actualiza en el Almacen ORIGEN
                ...
                If rs_almacen2.RecordCount > 0 Then
                     db.Execute "ap_almacen_totales 2," & Ado_datos.Recordset!almacen_codigoH & ", '" & ado_datos14.Recordset!bien_codigo & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0" & ", " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & precio_tot & ", 0, 0, " & precio_tot / GlTipoCambioOficial & ", 0, 0, 'REG','" & glusuario & "'"
                 Else
                     db.Execute "ap_almacen_totales 1," & Ado_datos.Recordset!almacen_codigoH & ", '" & ado_datos14.Recordset!bien_codigo & "', " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0" & ", " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & precio_tot & ", 0, 0, " & precio_tot / GlTipoCambioOficial & ", 0, 0, 'REG','" & glusuario & "'"
                End If
                
                Set rs_almacen2 = New ADODB.Recordset
                 If rs_almacen2.State = 1 Then rs_almacen2.Close
                 rs_almacen2.Open "select * from ao_almacen_totales where almacen_codigo = " & VAR_ALMD & " and bien_codigo = '" & VAR_BIEN2 & "' ", db, adOpenKeyset, adLockOptimistic
                If rs_almacen2.RecordCount > 0 Then
...
'        Dim iResult As Integer
'        'Dim co As New ADODB.Command
'        CryR01.ReportFileName = App.Path & "\Reportes\Almacenes\ar_almacen_kardex_fisico.rpt"
...
'       ' CryR01.StoredProcParam(1) = DTPicker3.Value
'        CryR01.StoredProcParam(1) = Format(DTPicker3.Value, "dd/mm/yyyy")
'        CryR01.StoredProcParam(2) = ado_datos14.Recordset!almacen_codigo
'        DTPicker3.Value = Date
''        CryR01.StoredProcParam(1) = Ado_datos.Recordset!ges_gestion
''        VAR_TITULO = "MODULO ALMACENES"
''        CryR01.Formulas(0) = "titulo = '" & VAR_TITULO & "' "
'        CryR01.Formulas(1) = "subtitulo = '" & lbl_titulo.Caption & "' "
'        CryR01.Formulas(2) = "FechaAl = '" & DTPicker3.Value & "' "
'
...
Private Sub BtnAnlDetalle_Click()
 If ado_datos14.Recordset.RecordCount > 0 Then
    If ado_datos14.Recordset("estado_almacen") <> "ANL" Then
          ...
          If sino = vbYes Then
            ...
            db.Execute "delete ao_almacen_salidas Where almacen_codigo = '" & ado_datos14.Recordset!almacen_codigo & "' and ges_gestion = " & Ado_datos.Recordset!ges_gestion & " and bien_codigo = '" & ado_datos14.Recordset!bien_codigo & "' and doc_numero = " & ado_datos14.Recordset!doc_numero_almH & "  and doc_codigo = '" & ado_datos14.Recordset!doc_codigo_almH & "'"
            'WHERE     (ges_gestion = '2017') AND (bien_codigo = '4216') AND (almacen_codigo = 2) AND (doc_codigo = 'R-115') AND (doc_numero = 2762)
            ado_datos14.Recordset.Update
            rs_datos14.Update
            ...
            Set rs_almacen2 = New ADODB.Recordset
             ...
             If rs_almacen2.RecordCount > 0 Then
                 ...
                 db.Execute "UPDATE ao_almacen_totales SET stock_salida = ISNULL((SELECT SUM(cantidad_salida) FROM ao_almacen_salidas WHERE bien_codigo = '" & ado_datos14.Recordset!bien_codigo & "' AND almacen_codigo = " & ado_datos14.Recordset!almacen_codigo & "),0)where almacen_codigo = " & ado_datos14.Recordset!almacen_codigo & " and bien_codigo = '" & ado_datos14.Recordset!bien_codigo & "' "
                 db.Execute "update ao_almacen_totales set stock_actual = ISNULL(stock_ingreso,0) - stock_salida"
             Else
                ...
                " VALUES (" & VAR_ALMH & ", '" & VAR_BIEN2 & "', 0, " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", " & ado_datos14.Recordset!bien_cantidad_por_empaque & ", 0, " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_bs), 0, ado_datos14.Recordset!venta_precio_total_bs) & ", " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_bs), 0, ado_datos14.Recordset!venta_precio_total_bs) & ", 0, " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_dol), 0, ado_datos14.Recordset!venta_precio_total_dol) & ", " & IIf(IsNull(ado_datos14.Recordset!venta_precio_total_dol), 0, ado_datos14.Recordset!venta_precio_total_dol) & ", 'REG', '" & Date & "', '" & glusuario & "' ) "
             End If
...
'          If sino = vbYes Then
'            db.Execute "delete ao_solicitud_bienes Where unidad_codigo = '" & Ado_datos.Recordset!unidad_codigo & "' and solicitud_codigo = " & Ado_datos.Recordset!solicitud_codigo & " and bien_codigo = '" & Ado_datos14.Recordset!bien_codigo & "' "
'            db.Execute "delete ao_ventas_detalle Where venta_codigo = '" & Ado_datos.Recordset!venta_codigo & "' and solicitud_codigo = " & Ado_datos.Recordset!solicitud_codigo & " and bien_codigo = '" & ado_datos14.Recordset!bien_codigo & "' "
'            Call ABRIR_TABLA_DET
'          End If
'       Else
'            MsgBox "No se puede ANULAR, el registro ya está APROBADO o ANULADO, Verifique por favor ...", vbExclamation, "Validación de Registro"
...
Private Sub Command1_Click()
    If ado_datos14d.Recordset.RecordCount > 0 Then
        ...
        VAR_DOC = Ado_datos.Recordset!doc_codigo_almH
        VAR_COD2 = IIf(Ado_datos.Recordset!doc_numero_almH = "", "1", Ado_datos.Recordset!doc_numero_almH)
        sino = MsgBox("Esta seguro de QUITAR esta devolución?", vbYesNo, "Confirmando")
        If sino = vbYes Then
            'ado_datos14d.Recordset.Delete adAffectCurrent
            db.Execute "DELETE ao_almacen_salidas   WHERE venta_codigo = " & correlv & " AND almacen_codigo = '5' AND bien_codigo = '" & ado_datos14d.Recordset!bien_codigo & "'"
            db.Execute "DELETE ao_almacen_ingresos WHERE compra_codigo = " & correlv & " AND almacen_codigo = '4' AND bien_codigo = '" & ado_datos14d.Recordset!bien_codigo & "'"
            'ado_datos14.Recordset!fecha_ingreso_salida = Date
            ado_datos14.Recordset!estado_bien = "SAL"
            ado_datos14.Recordset.Update
            Call AbrirDetalle
        ...
        End If
    Else
        sino = MsgBox("No existe ninguna devolución", vbCritical, "SOFIA")
    End If
End Sub
...
Private Sub dtc_cod_est_Click(Area As Integer)
dtc_desc_est.BoundText = dtc_cod_est.BoundText
End Sub
...
Private Sub dtc_desc_est_Click(Area As Integer)
dtc_cod_est.BoundText = dtc_desc_est.BoundText
End Sub
...
If accion <> "NEW" Then
If Ado_datos.Recordset!almacen_codigoH <> "NULL" Then
Set rs_aux9 = New ADODB.Recordset
    If rs_aux9.State = 1 Then rs_aux9.Close
    rs_aux9.Open "SELECT * FROM ao_almacen_totales WHERE almacen_codigo = " & Ado_datos.Recordset!almacen_codigoH & " and bien_codigo ='" & dtc_codigo15.Text & "'", db, adOpenStatic
...
Private Sub pAlmacen(CodigoA As String)
   ...
   strConsultaF = "select * from ac_almacenes where beneficiario_codigo = '" & CodigoA & "' AND almacen_tipo = 'H' "
...
Private Sub ABRIR_TABLAS_AUX()
    ...
    Set rs_datos11 = New ADODB.Recordset
    If rs_datos11.State = 1 Then rs_datos11.Close
    rs_datos11.Open "select * from ac_almacenes ", db, adOpenStatic
    Set Ado_datos11.Recordset = rs_datos11
    dtc_desc11.BoundText = dtc_codigo11.BoundText
    ...
    rs_datos23.Open "select * from gc_estado_registro where almacenes = 'S' ", db, adOpenStatic
...
'       Ado_datos.Recordset("tipoben_codigo") = IIf(dtc_aux2.Text = "", "1", dtc_aux2.Text)      'Tipo de Beneficiario
       ...
       MControl = Ado_datos.Recordset!mes_inicio_crono
        ...
        Ado_datos.Recordset("almacen_codigoH") = dtc_codigo11.Text                '2=Almacen Insumos
        If dtc_codigo3.Text = "20101-2" Or dtc_codigo3.Text = "30101-2" Or dtc_codigo3.Text = "70101-2" Or dtc_codigo3.Text = "10101-2" Then
            VAR_R = "R-119"
            'Select Case parametro
...
'            End Select
        ...
        Ado_datos.Recordset!doc_codigo_almH = "R-148"
        ...
        Ado_datos.Recordset!doc_numero_almH = VAR_NUM
...
'            End Select
    ...
    End If
       ...
       Ado_datos.Recordset!doc_codigo_almH = VAR_R       '"R-115"
       Ado_datos.Recordset("beneficiario_codigo_almH") = dtc_codigo4.Text        'Responsable Almacen
       Ado_datos.Recordset("beneficiario_codigo_tecH") = dtc_codigo5.Text        'Entregado a:
       Ado_datos.Recordset("almacen_codigoH") = IIf(dtc_codigo11.Text = "", "0", dtc_codigo11.Text)
       'Ado_datos.Recordset("almacen_codigo_dH") = IIf(dtc_codigo20.Text = "", "0", dtc_codigo20.Text)
       Ado_datos.Recordset("depto_codigo") = IIf(dtc_codigo21.Text = "", Left(dtc_codigo3.Text, 1), dtc_codigo21.Text)
       Ado_datos.Recordset("depto_codigo_dH") = IIf(dtc_codigo22.Text = "", Left(dtc_codigo3.Text, 1), dtc_codigo22.Text)
...
'         rs_aux1!solicitud_codigo_ant = 0
        ...
        'db.Execute "UPDATE ao_ventas_cabecera SET doc_codigo_almH = '" & VAR_R & "' WHERE venta_codigo = " & var_cod5 & " "
        'db.Execute "UPDATE ao_ventas_cabecera SET doc_numero_almH = " & VAR_NUM & " WHERE venta_codigo = " & var_cod5 & " "
    End If
End Sub
...
'    End Select
    ...
    'queryinicial = "select * From av_ventas_cabecera_sol_alm WHERE estado_codigo = 'APR' AND estado_almacen = 'REG' AND LEFT(doc_codigo_almH,5) = '" & Left(VAR_R, 5) & "' "
...
Set rs_datos = New Recordset
    ...
    'queryinicial = "select * From av_ventas_cabecera_sol_alm WHERE estado_codigo = 'APR' AND LEFT(doc_codigo_almH,5) = '" & Left(VAR_R, 5) & "' "
    queryinicial = "select * From av_ventas_cabecera_sol_alm WHERE (estado_codigo = 'APR' AND estado_almacen <> 'ANL') AND ((almacen_tipo = '" & VAR_ALMT & "' AND unidad_codigo <> '" & parametro & "' AND depto_codigo = '" & VAR_DPTO & "') OR unidad_codigo = '" & parametro & "') and edif_descripcion LIKE 'TRASPASO%'"
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos.Sort = "unidad_codigo, SOLICITUD_codigo"
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
...
Set rs_datos = New Recordset
    ...
    'queryinicial = "select * From av_ventas_cabecera_sol_alm WHERE estado_codigo = 'APR' AND LEFT(doc_codigo_almH,5) = '" & Left(VAR_R, 5) & "' "
    queryinicial = "select * From av_ventas_cabecera_sol_alm WHERE (estado_codigo = 'APR' AND estado_almacen <> 'ANL') AND ((almacen_tipo = '" & VAR_ALMT & "' AND unidad_codigo <> '" & parametro & "' AND depto_codigo = '" & VAR_DPTO & "') OR unidad_codigo = '" & parametro & "') and  (NOT (edif_descripcion LIKE 'TRASPASO%')) "
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos.Sort = "unidad_codigo, SOLICITUD_codigo"
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
...
Private Sub Picture2_Click()
 CryR02.Reset
       CryR02.WindowState = crptMaximized
       CryR02.WindowShowSearchBtn = True
       CryR02.WindowShowRefreshBtn = True
       CryR02.WindowShowPrintSetupBtn = True
        
       Dim iResult As Integer
      
       
       CryR02.ReportFileName = App.Path & "\Reportes\Almacenes\ar_salida_de_herramientas.rpt"
        
       CryR02.WindowShowPrintSetupBtn = True
       CryR02.WindowShowRefreshBtn = True
       
       CryR02.StoredProcParam(0) = Ado_datos.Recordset!beneficiario_codigo_tecH
