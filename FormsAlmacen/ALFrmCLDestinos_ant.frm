...
Begin VB.Form ALFrmClDestinos 
   ...
   Begin VB.Frame FrmDatos 
      ...
      Begin MSDataListLib.DataCombo DtcGrupoD 
         Bindings        =   "ALFrmCLDestinos.frx":13C96
      ...
      Begin MSDataListLib.DataCombo DtcGrupo 
         Bindings        =   "ALFrmCLDestinos.frx":13CAF
         DataField       =   "codigo_beneficiario"
         DataSource      =   "AdodcTabla"
         Height          =   315
         Left            =   2400
      ...
      Begin MSDataListLib.DataCombo DtcParD 
         Bindings        =   "ALFrmCLDestinos.frx":13CC8
      ...
      Begin MSDataListLib.DataCombo DtcPar 
         Bindings        =   "ALFrmCLDestinos.frx":13CE1
         DataField       =   "munic_codigo"
         DataSource      =   "AdodcTabla"
         Height          =   315
         Left            =   2400
   ...
   Begin MSDataGridLib.DataGrid DtgMain 
      Bindings        =   "ALFrmCLDestinos.frx":13CFA
      Height          =   5895
      Left            =   120
      TabIndex        =   25
      Top             =   1920
   ...
   Begin VB.Frame frmgrabcabeza 
      ...
      Begin VB.CommandButton CmdGraCabeza 
         ...
         Height          =   675
         Left            =   4920
         Picture         =   "ALFrmCLDestinos.frx":13D13
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   240
         Width           =   765
      ...
      Begin VB.CommandButton CmdCanCabeza 
         ...
         Height          =   675
         Left            =   6360
         Picture         =   "ALFrmCLDestinos.frx":13F1D
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   240
         Width           =   765
...
'    TextCOD_MONTADOR = cod_MONTADOR + 1
    ...
    'If rsAuxTabla.RecordCount > 0 Then
        TextCOD = "ALM" + rsAuxTabla.RecordCount + 1
    'End If
    ...
    If rstbeneaux.RecordCount > 0 Then
        TextCOD = TextCOD + "A"
'        SW = True
        'MsgBox " El CODIGO ya existe por lo que se adicionará la letra A "
'        Exit Sub
    End If
    db.Execute "INSERT INTO ALCLDestinos (CodDestino, DescDestino, Direccion, Ubicacion, codigo_beneficiario, munic_codigo, estado_registro, usr_usuario, fecha_registro, hora_registro) VALUES ('" & TextCOD & "', '" & Textdescri & "', '" & TxtDescripAnt & "', '" & Trim(TxtUbica) & "',  '" & DtcGrupo & "', '" & DtcPar & "', 'S', '" & GlUsuario & "',  '01/11/2011', '12:00')  "
...
If swgraba = 2 Then
    ...
    db.Execute "UPDATE ALCLDestinos SET DescDestino='" & Textdescri & "', Direccion='" & Trim(TxtDescripAnt) & "', Ubicacion='" & Trim(TxtUbica) & "', codigo_beneficiario='" & DtcGrupo & "', estado_registro='" & estatus2 & "' WHERE CodDestino='" & TextCOD & "'"
