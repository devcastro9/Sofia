...
Begin VB.Form GrFrmBuscaEnGridExterno 
   ...
   Begin VB.PictureBox PicCampos 
      ...
      Height          =   855
      Left            =   0
      Picture         =   "GrFrmBuscaEnGridExterno.frx":27A2
      ScaleHeight     =   795
      ScaleWidth      =   5610
      TabIndex        =   6
      Top             =   0
      ...
      Begin VB.CommandButton CmdListo 
         ...
         Height          =   720
         Left            =   4680
         Picture         =   "GrFrmBuscaEnGridExterno.frx":5A3C
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   60
         Width           =   765
      ...
      Begin MSComctlLib.ImageList ImlImagenesAv 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":5C46
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":5DA0
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":5EFA
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":6054
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":61AE
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":6308
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":6462
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin VB.ComboBox CmbCompara 
         Height          =   315
         ItemData        =   "GrFrmBuscaEnGridExterno.frx":65BC
         Left            =   1800
         List            =   "GrFrmBuscaEnGridExterno.frx":65D2
      ...
      Begin VB.ComboBox CmbCampo 
         Height          =   315
         ItemData        =   "GrFrmBuscaEnGridExterno.frx":65ED
         Left            =   120
         List            =   "GrFrmBuscaEnGridExterno.frx":65EF
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   360
         Width           =   1575
      ...
      Begin VB.Image Image3 
         Height          =   960
         Left            =   0
         Picture         =   "GrFrmBuscaEnGridExterno.frx":65F1
         Top             =   0
         Width           =   12600
      End
   End
