...
Begin VB.Form frm_ReportesRRH 
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   1800
         Picture         =   "frm_ReportesRRH.frx":04EA
         ScaleHeight     =   615
         ScaleWidth      =   1365
         TabIndex        =   66
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frm_ReportesRRH.frx":0CAC
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   64
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.ComboBox Combo1 
         Height          =   315
         ItemData        =   "frm_ReportesRRH.frx":1579
         Left            =   3600
         List            =   "frm_ReportesRRH.frx":15A1
         TabIndex        =   114
         Top             =   480
         Width           =   2055
      End
