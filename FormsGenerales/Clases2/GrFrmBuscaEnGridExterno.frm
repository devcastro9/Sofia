...
Begin VB.Form GrFrmBuscaEnGridExterno 
   ...
   Begin VB.PictureBox PicCampos 
      ...
      Left            =   0
      Negotiate       =   -1  'True
      Picture         =   "GrFrmBuscaEnGridExterno.frx":CA44
      ScaleHeight     =   11520
      ScaleWidth      =   4650
      TabIndex        =   6
      Top             =   0
      ...
      Begin MSComctlLib.ImageList ImlImagenesAv 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":78A76
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":78BD0
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":78D2A
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":78E84
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":78FDE
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":79138
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":79292
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "GrFrmBuscaEnGridExterno.frx":793EC
               Key             =   ""
            EndProperty
         EndProperty
      End
      Begin VB.ComboBox CmbCompara 
         Height          =   315
         ItemData        =   "GrFrmBuscaEnGridExterno.frx":79586
         Left            =   1800
         List            =   "GrFrmBuscaEnGridExterno.frx":7959C
      ...
      Begin VB.ComboBox CmbCampo 
         Height          =   315
         ItemData        =   "GrFrmBuscaEnGridExterno.frx":795B7
         Left            =   120
         List            =   "GrFrmBuscaEnGridExterno.frx":795B9
         Style           =   2  'Dropdown List
         TabIndex        =   3
         Top             =   360
         Width           =   1575
...
Que_Error:
  If Err.Number = "3704" Then
    ...
    rsTablaAux.Requery
    Screen.MousePointer = vbDefault
    MsgBox "No Existen Coincidencias, Elija <Refrescar> y Vuelva a Intentar... ", vbInformation + vbOKOnly, "Atención"
    Exit Sub
  End If
  Screen.MousePointer = vbDefault
