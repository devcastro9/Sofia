...
Begin VB.MDIForm frmMain 
   ...
   BackColor       =   &H00C0C0C0&
   Caption         =   "Sistema de Organizaci�n Financiera y Administrativa (SOFIA)"
   ClientHeight    =   7680
   ClientLeft      =   885
   ClientTop       =   1065
   ClientWidth     =   11280
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton CmdTesoreria 
         ...
         Style           =   1  'Graphical
         TabIndex        =   17
         ToolTipText     =   "Reportes de Tesorer�a"
         Top             =   15
         Width           =   1470
      End
      ...
      Begin VB.CommandButton CmdPedido 
         ...
         Style           =   1  'Graphical
         TabIndex        =   4
         ToolTipText     =   "Subir Facturas Electr�nicas"
         Top             =   20
         Visible         =   0   'False
         Width           =   630
      End
...
Private Sub Mnu_AsignacionTareasM_Click()
    If glusuario = "ADMIN" Or glusuario = "CSALINAS" Or glusuario = "JSAAVEDRA" Or glusuario = "ACASTRO" Or glusuario = "ASANTIVA�EZ" Or glusuario = "OCOLODRO" Or glusuario = "JORAQUENI" Or glusuario = "LNAVA" Or glusuario = "KGARCIA" Or glusuario = "VMEJIA" Or glusuario = "FFLORES" Or glusuario = "PRODAS" Or glusuario = "CESCALANTE" Or glusuario = "TCRUZ" Or glusuario = "NPAREDES" Or glusuario = "ARODRIGUEZ" Or glusuario = "MARTEAGA" Or glusuario = "LVEDIA" Then
        Aux = "DNMAN"
...
'    tw_cronograma_zonas.Show
    If glusuario = "ADMIN" Or glusuario = "JMAMANI" Or glusuario = "VMEJIA" Or glusuario = "ACASTRO" Or glusuario = "ASANTIVA�EZ" Or glusuario = "OCOLODRO" Or glusuario = "JORAQUENI" Or glusuario = "LNAVA" Or glusuario = "KGARCIA" Or glusuario = "FFLORES" Or glusuario = "PRODAS" Or glusuario = "CESCALANTE" Or glusuario = "CSALINAS" Or glusuario = "NPAREDES" Or glusuario = "ARODRIGUEZ" Or glusuario = "MARTEAGA" Or glusuario = "LVEDIA" Then
        Aux = "DNMAN"
...
'  End If
''  sino = MsgBox("�La impresi�n concluy� con EXITO?", vbQuestion + vbYesNo, "Confirmando Impresi�n... ")
''  If sino = vbYes Then
...
Private Sub MDIForm_Load()
    ' Esta funci�n no elimina el bot�n "X" de un MDI, pero s� lo deja inactivo
...
'      Case "Guardar"
'         'TareasPendientes: Agregar c�digo de bot�n 'Guardar'.
'         MsgBox "Agregar c�digo de bot�n 'Guardar'."
'      Case "Imprimir"
'         'TareasPendientes: Agregar c�digo de bot�n 'Imprimir'.
'         MsgBox "Agregar c�digo de bot�n 'Imprimir'."
'      Case "Cortar"
'         'TareasPendientes: Agregar c�digo de bot�n 'Cortar'.
'         MsgBox "Agregar c�digo de bot�n 'Cortar'."
'      Case "Copiar"
'         'TareasPendientes: Agregar c�digo de bot�n 'Copiar'.
'         MsgBox "Agregar c�digo de bot�n 'Copiar'."
'      Case "Pegar"
'         'TareasPendientes: Agregar c�digo de bot�n 'Pegar'.
'         MsgBox "Agregar c�digo de bot�n 'Pegar'."
'      Case "Negrita"
...
'                If vNombOpcMenu = "econ�micosrecursos" Then Econ�micosRecursos.Enabled = IIf(rsNivelAcceso!habilitado = "Si", True, False)
...
''            If vNombOpcMenu = "ejecuci�ndevengado" Then Ejecuci�nDevengado.Enabled = IIf(rsNivelAcceso!HABILITADO = "Si", True, False)
''            If vNombOpcMenu = "ejecuci�npagado" Then Ejecuci�nPagado.Enabled = IIf(rsNivelAcceso!HABILITADO = "Si", True, False)
...
'''''                If vNombOpcMenu = "comprasdirectas" Then Ejecuci�nPagado.Enabled = IIf(rsNivelAcceso!HABILITADO = "Si", True, False)
'''''                If vNombOpcMenu = "licitacionesnacionales" Then Ejecuci�nPagado.Enabled = IIf(rsNivelAcceso!HABILITADO = "Si", True, False)
...
'        If vNombOpcMenu = "evaluaciondesempe�o" Then EvaluacionDesempe�o.Enabled = IIf(rsNivelAcceso!habilitado = "Si", True, False)
'
...
'        If vNombOpcMenu = "mnuprivacceso" Then mnuPrivAcceso.Enabled = IIf(rsNivelAcceso!habilitado = "Si", True, False) 'Privilegios de Operaci�n
'    rsNivelAcceso.MoveNext
'    Wend
'    rsNivelAcceso.MoveFirst
'End If
...
Private Sub Option2_Click()
        ...
        If iResult <> 0 Then MsgBox CR07.LastErrorNumber & " : " & CR07.LastErrorString, vbCritical, "Error de impresi�n"
