...
Begin VB.Form frm_ao_comex_pagos 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   1680
         Picture         =   "frm_ao_comex_pagos.frx":0000
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   39
         Top             =   120
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frm_ao_comex_pagos.frx":08EC
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   38
         Top             =   120
   ...
   Begin VB.Frame FrmCobros 
      ...
      Begin VB.TextBox TxtConcepto 
         ...
         DataSource      =   "frm_ao_compra_servicio.Ado_detalle3"
         Height          =   345
         Left            =   1815
         MaxLength       =   250
         MultiLine       =   -1  'True
      ...
      Begin VB.TextBox txt_respaldos 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   5
         Text            =   "frm_ao_comex_pagos.frx":10C2
         Top             =   3960
         Width           =   7275
      End
      ...
      Begin MSDataListLib.DataCombo txt_campo1 
         Bindings        =   "frm_ao_comex_pagos.frx":10D5
      ...
      Begin MSDataListLib.DataCombo Txt_descripcion 
         Bindings        =   "frm_ao_comex_pagos.frx":10EF
         DataField       =   "beneficiario_codigo"
         DataSource      =   "frm_ao_compra_servicio.Ado_detalle3"
         Height          =   315
         Left            =   1560
      ...
      Begin MSDataListLib.DataCombo dtc_desc4A 
         Bindings        =   "frm_ao_comex_pagos.frx":1109
   ...
   End
End
Attribute VB_Name = "frm_ao_comex_pagos"
...
If Valida Then
   ...
   If swnuevo = 1 Then
      ...
      frm_ao_compra_servicio.Ado_detalle3.Recordset("ges_gestion") = glGestion
      frm_ao_compra_servicio.Ado_detalle3.Recordset("compra_codigo").Value = txt_codigo.Caption         'frm_ao_compra_servicio.Ado_datos.Recordset!compra_codigo
      frm_ao_compra_servicio.Ado_detalle3.Recordset("adjudica_codigo") = lbl_adjudica.Caption           ' frm_ao_compra_servicio.Ado_detalle2.Recordset!adjudica_codigo
      frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_codigo") = txtCodigo1.Caption
      frm_ao_compra_servicio.Ado_detalle3.Recordset("beneficiario_codigo") = Txt_campo1.Text
   Else
   ...
   End If
    If Chk_fac.Value = 1 Then
        frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_emite_factura").Value = "S"
    Else
        frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_emite_factura").Value = "N"
    End If
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_descripcion") = TxtConcepto.Text
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_fecha_prog") = DTPFechaProg.Value
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_fecha_efectiva").Value = DTPFechaPago.Value

    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_monto_bs").Value = TxtMontoBs.Text
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_monto_dol").Value = TxtMontoDol.Text
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_descuento_bs").Value = 0
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_total_bs").Value = TxtMontoBs.Text
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_total_dol").Value = TxtMontoDol.Text
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_nro_cmpbte_factura").Value = txt_factura.Text         'Factura
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_nro_autorizacion").Value = txtDoc.Text                'Autorizacion
    
    frm_ao_compra_servicio.Ado_detalle3.Recordset("pago_respaldos") = txt_respaldos.Text
    'Ado_datos.Recordset!Literal = Literal(CStr(Ado_datos.Recordset!cobranza_total_bs)) + " BOLIVIANOS"
    frm_ao_compra_servicio.Ado_detalle3.Recordset("literal").Value = Literal(CStr(frm_ao_compra_servicio.Ado_detalle3.Recordset!pago_total_dol)) + " DOLARES AMERICANOS"
    frm_ao_compra_servicio.Ado_detalle3.Recordset("poa_codigo").Value = "4.1.1"
    
    frm_ao_compra_servicio.Ado_detalle3.Recordset("estado_codigo") = "REG"
    frm_ao_compra_servicio.Ado_detalle3.Recordset("usr_codigo") = glusuario
    frm_ao_compra_servicio.Ado_detalle3.Recordset("fecha_registro") = Format(Date, "dd/mm/yyyy")
    frm_ao_compra_servicio.Ado_detalle3.Recordset("hora_registro") = Format(Time, "HH:mm:ss")
...
'    End If
    ...
    frm_ao_compra_servicio.Ado_detalle3.Recordset.Update
   Para_Aceptado = "S"
