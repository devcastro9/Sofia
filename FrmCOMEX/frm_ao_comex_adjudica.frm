...
Begin VB.Form frm_ao_comex_adjudica 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frm_ao_comex_adjudica.frx":0000
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   42
         Top             =   120
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   1680
         Picture         =   "frm_ao_comex_adjudica.frx":07D6
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   41
         Top             =   120
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cmd_unimed2 
         ...
         Height          =   315
         ItemData        =   "frm_ao_comex_adjudica.frx":10C2
         Left            =   6480
         List            =   "frm_ao_comex_adjudica.frx":10D8
         TabIndex        =   35
         Text            =   "ANUAL"
         Top             =   5300
         Width           =   1875
      ...
      Begin VB.ComboBox cmb_mes_ini 
         ...
         DataSource      =   "frm_ao_compra_servicio.ado_detalle2"
         Height          =   315
         ItemData        =   "frm_ao_comex_adjudica.frx":1100
         Left            =   480
         List            =   "frm_ao_comex_adjudica.frx":1128
         TabIndex        =   33
         Text            =   "SEPTIEMBRE"
         Top             =   5300
         Width           =   1620
      ...
      Begin VB.Frame Frame2 
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "frm_ao_comex_adjudica.frx":1191
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "frm_ao_comex_adjudica.frx":11AB
            DataField       =   "beneficiario_codigo"
            DataSource      =   "frm_ao_compra_servicio.ado_detalle2"
            Height          =   315
            Left            =   120
         ...
         Begin MSDataListLib.DataCombo dtc_aux4 
            Bindings        =   "frm_ao_comex_adjudica.frx":11C5
            DataField       =   "beneficiario_codigo"
            DataSource      =   "frm_ao_compra_servicio.ado_detalle2"
            Height          =   315
            Left            =   3240
         ...
         Begin MSDataListLib.DataCombo dtc_aux5 
            Bindings        =   "frm_ao_comex_adjudica.frx":11DF
            DataField       =   "beneficiario_codigo"
            DataSource      =   "frm_ao_compra_servicio.ado_detalle2"
            Height          =   315
            Left            =   160
      ...
      Begin VB.Label lbl_campo3 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Total del Contrato USD"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_ao_comex_adjudica"
...
If Valida Then
   ...
   If swnuevo = 1 Then
      ...
      fw_compras_gral.Ado_detalle2.Recordset("adjudica_codigo") = fw_compras_gral.Ado_detalle2.Recordset.RecordCount
   ...
   End If
    ...
    fw_compras_gral.Ado_detalle2.Recordset("adjudica_descripcion").Value = dtc_desc5.Text         'fw_compras_gral.Ado_datos.Recordset!compra_descripcion
    ...
    fw_compras_gral.Ado_detalle2.Recordset("adjudica_monto_dol").Value = txt_total_dol.Text
...
Private Sub CRONO_PAGO()
    ...
    rs_aux5.Open "select * from ao_compra_adjudica where compra_codigo = " & VAR_COMPRA & "  ", db, adOpenKeyset, adLockBatchOptimistic
    'Set AdoAux.Recordset = rsAuxDetalle
    If rs_aux5.RecordCount > 0 Then
      CONT2 = 1
      FInicio = rs_aux5!fecha_inicio_contrato
      VAR_MED2 = fw_compras_gral.Ado_detalle2.Recordset!unimed_codigo_pag
      VAR_COBR2 = fw_compras_gral.Ado_detalle2.Recordset!cantidad_cuotas_pag
      MControl = fw_compras_gral.Ado_detalle2.Recordset!mes_inicio_crono
      ...
      While (CONT2 <= VAR_COBR2)
        ...
        rs_aux2.Open "select * from ao_compra_planilla_pagos where compra_codigo = " & VAR_COMPRA & "  ", db, adOpenKeyset, adLockOptimistic
...
'                pago_nro_cmpbte_factura, pago_nro_autorizacion
            ...
            rs_aux2!adjudica_codigo = fw_compras_gral.Ado_detalle2.Recordset!adjudica_codigo
