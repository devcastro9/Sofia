...
Private Sub ABRIR_TABLA()
    ...
    Select Case VAR_PAISC
        Case "AMERICA"
            ...
            'queryinicial = "Select * from ao_solicitud_cotiza_venta where unidad_codigo = '" & Txt_campo1.Text & "' and solicitud_codigo = " & GlSolicitud & " and pais_continente = 'AMERICA'  "
        ...
        Case "ASIA"
            ...
            rs_datosA.Open "Select * from ao_solicitud_cotiza_venta where unidad_codigo = '" & parametro & "' and solicitud_codigo = " & GlSolicitud & " and pais_continente = 'ASIA' and cotiza_codigo = " & txt_codigo1.Caption & "  ", db, adOpenKeyset, adLockOptimistic
            'rs_datosA.Open "Select * from ao_solicitud_cotiza_venta where unidad_codigo = '" & Txt_campo1.Text & "' and solicitud_codigo = " & GlSolicitud & " and pais_continente = 'ASIA'  ", db, adOpenKeyset, adLockOptimistic
        ...
        Case "EUROPA"
            ...
            'rs_datosE.Open "Select * from ao_solicitud_cotiza_venta where unidad_codigo = '" & Txt_campo1.Text & "' and solicitud_codigo = " & GlSolicitud & " and pais_continente = 'EUROPA' and cotiza_codigo = " & txt_codigo1.Caption & " ", db, adOpenKeyset, adLockOptimistic
