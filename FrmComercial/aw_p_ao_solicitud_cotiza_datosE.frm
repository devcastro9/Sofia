...
Begin VB.Form aw_p_ao_solicitud_cotiza_datosE 
   BackColor       =   &H00000000&
   ...
   ClientWidth     =   11025
   ControlBox      =   0   'False
   Icon            =   "aw_p_ao_solicitud_cotiza_datosE.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5970
   ...
   Begin VB.PictureBox Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_desc7 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0A02
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0A1B
         DataField       =   "tipo_eqp"
         DataSource      =   "aw_p_ao_solicitud_cotiza_venta.Ado_datos"
         Height          =   315
         Left            =   600
      ...
      Begin MSDataListLib.DataCombo dtc_codigo21 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0A35
      ...
      Begin MSDataListLib.DataCombo dtc_desc21 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0A50
         DataField       =   "bien_codigo"
         DataSource      =   "aw_p_ao_solicitud_cotiza_venta.Ado_datos"
         Height          =   315
         Left            =   0
      ...
      Begin MSDataListLib.DataCombo dtc_codigo7 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0A6A
         DataField       =   "pais_codigo"
         DataSource      =   "aw_p_ao_solicitud_cotiza_venta.Ado_datos"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_desc24 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0A83
         DataField       =   "bien_codigo"
         DataSource      =   "aw_p_ao_solicitud_cotiza_venta.Ado_datos"
         Height          =   315
         Left            =   0
      ...
      Begin MSDataListLib.DataCombo dtc_desc61 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0A9D
      ...
      Begin MSDataListLib.DataCombo dtc_codigo61 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0AB7
         DataField       =   "cuadro_ctrl_codigo"
         DataSource      =   "aw_p_ao_solicitud_cotiza_venta.Ado_datos"
         Height          =   315
         Left            =   8640
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "aw_p_ao_solicitud_cotiza_datosE.frx":0AD2
         DataField       =   "tipo_eqp"
         DataSource      =   "aw_p_ao_solicitud_cotiza_venta.Ado_datos"
         Height          =   315
         Left            =   3480
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "aw_p_ao_solicitud_cotiza_datosE.frx":0AEB
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   24
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   720
         Picture         =   "aw_p_ao_solicitud_cotiza_datosE.frx":6CB1D
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   2160
         MaskColor       =   &H00000000&
         Picture         =   "aw_p_ao_solicitud_cotiza_datosE.frx":6CD27
         Style           =   1  'Graphical
         TabIndex        =   13
   ...
   End
End
Attribute VB_Name = "aw_p_ao_solicitud_cotiza_datosE"
...
Private Sub BtnCancelar_Click()
  On Error Resume Next
   ...
   If sino = vbYes Then
        aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset.CancelUpdate
        Unload Me
    End If
End Sub
  ...
  If VAR_VAL = "OK" Then
    ...
    If rs_datos10.RecordCount > 0 Then
      If Txt_Correl.Caption = 1 Then
        ...
        If sino = vbYes Then
           'TODOS LOS REGISTROS
           aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset.MoveFirst
           While Not aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset.EOF
             '-
             Set aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset = rs_datos10
             aw_p_ao_solicitud_cotiza_venta.txt_codigo1.Caption = aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cotiza_codigo
             MsgBox Str(aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cotiza_codigo)
             'aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!pais_continente = "AMERICA"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!pais_codigo = dtc_codigo7.Text
    '         aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!bien_codigo = IIf(IsNull(dtc_codigo21.Text) Or dtc_codigo21.Text = "", "NA1", dtc_codigo21.Text)
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cotiza_fecha = Date     'DTPfecha1.Value
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!modelo_codigo = Txt_campo4.Text     '      'MODELO PROVISIONAL AUTOMATICO JQA 02-2015
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!modelo_codigo_h = "S/M"  'Txt_campo5.Text    'dtc_codigo41.Text
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!modelo_codigo_x = "S/M"   'Txt_campo6.Text    'dtc_codigo51.Text
        
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cotiza_energia = Txt_campo2.Text
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cotiza_luz = Txt_campo3.Text
    
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!bien_cotiza_num_accesos = Txt_campo7.Text
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!dimension_fosa_m = Txt_campo8.Text        '
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!dimension_fosa_fondo = Txt_campo9.Text
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!dimension_fosa_frente = Txt_campo10.Text  '
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cuadro_ctrl_codigo = IIf((dtc_codigo61.Text = ""), 1, dtc_codigo61.Text)
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cotiza_nro_montador = IIf((Txt_campo5.Text = ""), "2", Txt_campo5.Text)
             'aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!Foto = Date
             'aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!ARCHIVO_Foto = var_cod + ".JPG"
             'aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!archivo_foto_cargado = "N"
             'hora_registro
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!proceso_codigo = "COM"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!subproceso_codigo = "COM-01"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!etapa_codigo = "COM-01-04"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!clasif_codigo = "COM"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!doc_codigo = "R-222"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!doc_numero = "0"  'txt_campo1.Text
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!clasif_codigo2 = "COM"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!doc_codigo2 = "R-224"
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!doc_numero2 = "0"  'txt_campo1.Text
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!poa_codigo = "3.1.1"
             'WWWWWWWWWWWWWW JQA 02-2015
                If VAR_COD2 < 10 Then
                   aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!unidad_codigo_ant = parametro + "-00000" + Trim(txt_codigo)
                End If
                If VAR_COD2 > 9 And VAR_COD2 < 100 Then
                   aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!unidad_codigo_ant = parametro + "-0000" + Trim(txt_codigo)
                End If
                If VAR_COD2 > 99 And VAR_COD2 < 1000 Then
                   aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!unidad_codigo_ant = parametro + "-000" + Trim(txt_codigo)
                End If
                If VAR_COD2 > 999 And VAR_COD2 < 10000 Then
                   aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!unidad_codigo_ant = parametro + "-00" + Trim(txt_codigo)
                End If
                If VAR_COD2 > 9999 And VAR_COD2 < 100000 Then
                   aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!unidad_codigo_ant = parametro + "-0" + Trim(txt_codigo)
                End If
                If VAR_COD2 > 99999 Then
                   aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!unidad_codigo_ant = parametro + "-" + Trim(txt_codigo)
                End If
             'aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!unidad_codigo_ant = var_cod2     'txt_codigo1.Text
             'WWWWWWWWWWWWWW JQA 02-2015
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!tipo_eqp = dtc_codigo2.Text
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!fecha_registro = Date     'no cambia
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!usr_codigo = IIf(glusuario = "", "ADMIN", glusuario) 'no cambia
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset.Update 'adAffectAll    'Batch
             'costos
           aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset.MoveNext
           Wend
        Else
             ...
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!fecha_registro = Date     'no cambia
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!usr_codigo = IIf(glusuario = "", "ADMIN", glusuario) 'no cambia
             aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset.Update    'Batch 'adAffectAll
        End If
      Else
        'SOLO EL REGISTRO ACTIVO
        MsgBox Str(aw_p_ao_solicitud_cotiza_venta.Ado_datosE.Recordset!cotiza_codigo)
