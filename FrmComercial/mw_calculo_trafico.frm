...
Begin VB.Form mw_calculo_trafico 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Comercial Calculo de Cotizacion"
   ClientHeight    =   10950
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   11280
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.TextBox DtpFecha 
         ...
         Width           =   1215
      End
      Begin VB.TextBox txt_solicitud 
         Alignment       =   2  'Center
         Appearance      =   0  'Flat
         BackColor       =   &H00C0C0C0&
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "mw_calculo_trafico.frx":0000
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5160
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "mw_calculo_trafico.frx":0019
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "mw_calculo_trafico.frx":0032
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "mw_calculo_trafico.frx":004B
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5160
      ...
      Begin VB.Label Label7 
         ...
         Caption         =   "Proyecto de Edificaciones"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.PictureBox fra_opciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   710
         Left            =   10800
         Picture         =   "mw_calculo_trafico.frx":0064
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   710
         Left            =   9720
         Picture         =   "mw_calculo_trafico.frx":04A6
         Style           =   1  'Graphical
         TabIndex        =   56
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command1 
         Appearance      =   0  'Flat
         DownPicture     =   "mw_calculo_trafico.frx":06B0
         Height          =   700
         Left            =   8520
         MaskColor       =   &H8000000F&
         Picture         =   "mw_calculo_trafico.frx":0E6F
         Style           =   1  'Graphical
         TabIndex        =   55
         ToolTipText     =   "Nuevo"
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "mw_calculo_trafico.frx":171F
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   54
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "mw_calculo_trafico.frx":1EDE
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   53
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "mw_calculo_trafico.frx":27F3
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   52
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   3960
         Picture         =   "mw_calculo_trafico.frx":2F3F
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   51
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   5400
         Picture         =   "mw_calculo_trafico.frx":3772
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   50
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   6840
         Picture         =   "mw_calculo_trafico.frx":3F27
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   49
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "mw_calculo_trafico.frx":47F4
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   48
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "mw_calculo_trafico.frx":4FB6
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   30
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "mw_calculo_trafico.frx":58A2
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   29
         Top             =   0
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin VB.PictureBox fra_opciones_det 
         ...
         Begin VB.PictureBox BtnAnlDetalle 
            ...
            Height          =   615
            Left            =   3120
            Picture         =   "mw_calculo_trafico.frx":6078
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   37
            Top             =   0
         ...
         Begin VB.PictureBox BtnModDetalle 
            ...
            Height          =   615
            Left            =   1545
            Picture         =   "mw_calculo_trafico.frx":67C4
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   36
            Top             =   0
         ...
         Begin VB.PictureBox BtnAddDetalle 
            ...
            Height          =   615
            Left            =   120
            Picture         =   "mw_calculo_trafico.frx":70D9
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   35
            Top             =   0
         ...
         Begin VB.PictureBox BtnGrabarDet 
            ...
            Height          =   615
            Left            =   4440
            Picture         =   "mw_calculo_trafico.frx":7898
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   34
            Top             =   0
         ...
         Begin VB.PictureBox BtnCancelarDet 
            ...
            Height          =   615
            Left            =   5880
            Picture         =   "mw_calculo_trafico.frx":806E
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   33
            Top             =   0
   ...
   End
End
Attribute VB_Name = "mw_calculo_trafico"
...
Private Sub ABRIR_DET()
    ...
    rs_datos5.Open "Select * from ao_comercial_cotizacion where estado_codigo = 'APR' AND trafico_codigo = '" & Ado_datos.Recordset!trafico_codigo & "' and tomado = 'N' order by cotiza_codigo", db, adOpenStatic
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
     ...
     rs_datos!edif_codigo = dtc_codigo1.Text
     rs_datos!unidad_codigo = dtc_codigo2.Text
     
     rs_datos!solicitud_codigo = dtc_codigo3.Text
...
Private Sub ABRIR_TABLAS_AUX()
    ...
    rs_datos1.Open "Select * from gc_edificaciones order by edif_codigo ", db, adOpenStatic
   ...
   'gc_unidad_ejecutora
    ...
    rs_datos2.Open "Select * from gc_unidad_ejecutora order by unidad_codigo", db, adOpenStatic
...
'    dtc_desc4.BoundText = dtc_codigo4.BoundText
'
'    'ao_comercial_cotizacion
'    Set rs_datos5 = New ADODB.Recordset
'    If rs_datos5.State = 1 Then rs_datos5.Close
'    rs_datos5.Open "Select * from ao_comercial_cotizacion where estado_codigo = 'APR' order by cotiza_codigo", db, adOpenStatic
'    Set Ado_datos5.Recordset = rs_datos5
'    dtc_desc5.BoundText = dtc_codigo5.BoundText
'
...
Private Sub pnivel1(codigo1 As String)
   Dim strConsultaF As String
   strConsultaF = "select * from gc_unidad_ejecutora"
    ' where edif_codigo = '" & codigo1 & "'"
'
'   Set dtc_codigo2.RowSource = Nothing
'   Set dtc_codigo2.RowSource = db.Execute(strConsultaF, , adCmdText)
...
Private Sub OptFilGral2_Click()
    ...
    queryinicial = "Select * from ao_comercial_calculo_trafico  "
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
...
Private Sub ABRIR_TABLA_DET()
    ...
    rs_det1.Open "select * from ao_comercial_calculo_trafico where trafico_codigo = '" & Ado_datos.Recordset!solicitud_codigo & "' order by solicitud_codigo ", db, adOpenKeyset, adLockOptimistic, adCmdText
...
Private Function ExisteReg(Codigo As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM ao_comercial_calculo_trafico WHERE trafico_codigo = '" & Codigo & "'"
