...
Begin VB.Form mw_ventas_seguimiento 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   " Procesos Administrativos - Ventas Nuevas - Seguimiento"
   ClientHeight    =   10740
   ClientLeft      =   1560
   ClientTop       =   1725
   ClientWidth     =   16845
   Icon            =   "mw_ventas_seguimiento.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "mw_ventas_seguimiento.frx":058A
      ...
      Begin VB.Frame FrmCabecera 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "mw_ventas_seguimiento.frx":05A6
            DataField       =   "beneficiario_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   9660
         ...
         Begin VB.Frame Fra_Total 
            ...
            Begin MSDataListLib.DataCombo dtc_desc11 
               Bindings        =   "mw_ventas_seguimiento.frx":05BF
            ...
            Begin MSDataListLib.DataCombo dtc_codigo11 
               Bindings        =   "mw_ventas_seguimiento.frx":05D9
               DataField       =   "venta_tipo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   3720
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "mw_ventas_seguimiento.frx":05F3
            DataField       =   "beneficiario_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   6480
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "mw_ventas_seguimiento.frx":060C
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "mw_ventas_seguimiento.frx":0625
            DataField       =   "unidad_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   1755
         ...
         Begin MSDataListLib.DataCombo dtc_aux3 
            Bindings        =   "mw_ventas_seguimiento.frx":063E
         ...
         Begin MSDataListLib.DataCombo dtc_codigo3 
            Bindings        =   "mw_ventas_seguimiento.frx":0657
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4980
         ...
         Begin MSDataListLib.DataCombo dtc_desc3 
            Bindings        =   "mw_ventas_seguimiento.frx":0670
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   180
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   18000
         Picture         =   "mw_ventas_seguimiento.frx":0689
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   69
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   3960
         Picture         =   "mw_ventas_seguimiento.frx":0E4B
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   68
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "mw_ventas_seguimiento.frx":1600
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   67
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   1440
         Picture         =   "mw_ventas_seguimiento.frx":1E33
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   66
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   -15
         Picture         =   "mw_ventas_seguimiento.frx":257F
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   65
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5280
         Picture         =   "mw_ventas_seguimiento.frx":2E94
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   64
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "mw_ventas_seguimiento.frx":3761
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   61
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "mw_ventas_seguimiento.frx":404D
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   60
         Top             =   0
   ...
   Begin VB.Frame FrmDetalle 
      ...
      Begin MSDataGridLib.DataGrid DtGLista 
         Bindings        =   "mw_ventas_seguimiento.frx":4823
         Height          =   1305
         Left            =   240
         TabIndex        =   8
         Top             =   225
   ...
   End
End
Attribute VB_Name = "mw_ventas_seguimiento"
...
'                    BtnAñadir.Visible = False   'Cerrar Tramite
                ...
                Case Else
                    If glusuario = "MVALDIVIA" Or glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "CSALINAS" Then
...
Private Sub OptFilGral1_Click()
  '===== Proceso para filtrado general de datos(registros no aprobados)
    ...
    Select Case glusuario      'VAR_DA      'av_ventas_cabecera
        Case "ADMIN", "CSALINAS"
            queryinicial = "select * From av_ventas_cabecera WHERE (venta_tipo <> 'C' AND venta_tipo <> 'A' AND estado_codigo='APR' AND estado_cancelado = 'N' ) "
