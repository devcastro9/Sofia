...
Begin VB.Form aw_p_ao_solicitud 
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "aw_p_ao_solicitud.frx":12CF
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   92
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "aw_p_ao_solicitud.frx":1A84
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   91
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2880
         Picture         =   "aw_p_ao_solicitud.frx":22B7
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   90
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1425
         Picture         =   "aw_p_ao_solicitud.frx":2A03
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   89
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "aw_p_ao_solicitud.frx":3318
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   88
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   9120
         Picture         =   "aw_p_ao_solicitud.frx":3AD7
         Style           =   1  'Graphical
         TabIndex        =   87
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   9960
         Picture         =   "aw_p_ao_solicitud.frx":3F19
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "aw_p_ao_solicitud.frx":4123
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   85
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   4275
         Picture         =   "aw_p_ao_solicitud.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   82
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   2880
         Picture         =   "aw_p_ao_solicitud.frx":51D1
         ScaleHeight     =   615
         ScaleWidth      =   1305
         TabIndex        =   81
         Top             =   0
   ...
   Begin VB.CommandButton BtnImprimir1 
      ...
      Height          =   620
      Left            =   1530
      Picture         =   "aw_p_ao_solicitud.frx":59A7
      Style           =   1  'Graphical
      TabIndex        =   63
   ...
   Begin VB.CommandButton BtnImprimir2 
      ...
      Height          =   620
      Left            =   1530
      Picture         =   "aw_p_ao_solicitud.frx":642A
      Style           =   1  'Graphical
      TabIndex        =   62
   ...
   Begin VB.PictureBox FrmABMDet2 
      ...
      Begin VB.CommandButton BtnAnlDetalle2 
         ...
         Height          =   620
         Left            =   40
         Picture         =   "aw_p_ao_solicitud.frx":6D62
         Style           =   1  'Graphical
         TabIndex        =   97
      ...
      Begin VB.CommandButton BtnAddDetalle2 
         ...
         Height          =   620
         Left            =   40
         Picture         =   "aw_p_ao_solicitud.frx":74AE
         Style           =   1  'Graphical
         TabIndex        =   95
      ...
      Begin VB.CommandButton BtnModDetalle2 
         ...
         Height          =   620
         Left            =   1380
         Picture         =   "aw_p_ao_solicitud.frx":7C6D
         Style           =   1  'Graphical
         TabIndex        =   96
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Begin VB.CommandButton BtnAddDetalle 
         ...
         Height          =   620
         Left            =   40
         Picture         =   "aw_p_ao_solicitud.frx":8582
         Style           =   1  'Graphical
         TabIndex        =   59
         ToolTipText     =   "Adiciona Detalle"
         Top             =   100
      ...
      Begin VB.CommandButton BtnModDetalle 
         ...
         Height          =   620
         Left            =   1380
         Picture         =   "aw_p_ao_solicitud.frx":8D41
         Style           =   1  'Graphical
         TabIndex        =   58
         ToolTipText     =   "Modifica Detalle Elegido"
         Top             =   100
      ...
      Begin VB.CommandButton BtnAnlDetalle 
         ...
         Height          =   620
         Left            =   40
         Picture         =   "aw_p_ao_solicitud.frx":9656
         Style           =   1  'Graphical
         TabIndex        =   57
         ToolTipText     =   "Elimina Detalle Elegido"
         Top             =   800
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "aw_p_ao_solicitud.frx":9DA2
         Height          =   1695
         Left            =   75
         TabIndex        =   61
         Top             =   240
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "aw_p_ao_solicitud.frx":9DBD
         Height          =   1335
         Left            =   75
         TabIndex        =   33
         Top             =   225
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "aw_p_ao_solicitud.frx":9DD8
         Height          =   4170
         Left            =   120
         TabIndex        =   34
         Top             =   240
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.CommandButton BtnAux3 
         ...
         Left            =   6165
         MaskColor       =   &H00FFFFFF&
         Picture         =   "aw_p_ao_solicitud.frx":9DF0
         Style           =   1  'Graphical
         TabIndex        =   64
      ...
      Begin MSDataListLib.DataCombo dtc_desc7 
         Bindings        =   "aw_p_ao_solicitud.frx":AAD1
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "aw_p_ao_solicitud.frx":AAEA
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "aw_p_ao_solicitud.frx":AB04
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "aw_p_ao_solicitud.frx":AB1E
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "aw_p_ao_solicitud.frx":AB37
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1695
      ...
      Begin VB.Frame fra_cliente 
         ...
         Begin VB.CommandButton BtnAux2 
            ...
            Left            =   7690
            MaskColor       =   &H00FFFFFF&
            Picture         =   "aw_p_ao_solicitud.frx":AB50
            Style           =   1  'Graphical
            TabIndex        =   71
         ...
         Begin MSDataListLib.DataCombo dtc_desc4 
            Bindings        =   "aw_p_ao_solicitud.frx":B927
         ...
         Begin MSDataListLib.DataCombo dtc_codigo4 
            Bindings        =   "aw_p_ao_solicitud.frx":B940
            DataField       =   "beneficiario_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   6000
      ...
      Begin MSDataListLib.DataCombo dtc_aux11 
         Bindings        =   "aw_p_ao_solicitud.frx":B959
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6480
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "aw_p_ao_solicitud.frx":B974
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7800
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "aw_p_ao_solicitud.frx":B98E
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2520
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "aw_p_ao_solicitud.frx":B9A8
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "aw_p_ao_solicitud.frx":B9C1
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3720
      ...
      Begin MSDataListLib.DataCombo dtc_codigo8 
         Bindings        =   "aw_p_ao_solicitud.frx":B9DA
      ...
      Begin MSDataListLib.DataCombo dtc_codigo7 
         Bindings        =   "aw_p_ao_solicitud.frx":B9F3
         DataField       =   "etapa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5160
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "aw_p_ao_solicitud.frx":BA0C
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "aw_p_ao_solicitud.frx":BA25
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "aw_p_ao_solicitud.frx":BA3E
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6120
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "aw_p_ao_solicitud.frx":BA57
         DataField       =   "proceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2820
      ...
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "aw_p_ao_solicitud.frx":BA70
         DataField       =   "subproceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2820
      ...
      Begin MSDataListLib.DataCombo dtc_desc8 
         Bindings        =   "aw_p_ao_solicitud.frx":BA89
         DataField       =   "clasif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3660
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "aw_p_ao_solicitud.frx":BAA2
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3480
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "aw_p_ao_solicitud.frx":BABC
         DataField       =   "solicitud_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6480
      ...
      Begin MSDataListLib.DataCombo dtc_codigo9 
         Bindings        =   "aw_p_ao_solicitud.frx":BAD5
      ...
      Begin MSDataListLib.DataCombo dtc_desc9 
         Bindings        =   "aw_p_ao_solicitud.frx":BAEE
         DataField       =   "doc_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   8100
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "aw_p_ao_solicitud.frx":BB07
         DataField       =   "poa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2160
   ...
   If rs_datos!estado_codigo = "REG" Then
     ...
     If rs_aux2.RecordCount > 0 Then
        ...
        If rs_aux4.RecordCount > 0 Then
              ...
              Select Case dtc_codigo2.Text
                  ...
                  Case "3", "9"
                      ...
                      'Else
                          ...
                          rs_aux1!beneficiario_codigo_resp = Ado_datos.Recordset!beneficiario_codigo_resp2
            ...
            End If
        Else
          MsgBox "No se puede APROBAR, registre la " + FraDet1.Caption + ", luego, vuelva a intentar...", vbExclamation, "Validación de Registro"
        End If
     Else
          MsgBox "No se puede APROBAR, registre el " + FraDet2.Caption + ", luego,  vuelva a intentar...", vbExclamation, "Validación de Registro"
     End If
...
'            rs_datos!archivo_respaldo_cargado = "N"
            ...
            " Values ('" & Year(Date) & "', '" & VAR_UNI & "', " & var_cod & ", '" & DTPfecha1.Value & "', '" & DTPfecha1.Value & "', " & dtc_codigo2.Text & ", '" & dtc_codigo3.Text & "', '" & VAR_BENEF & "', '" & dtc_codigo11.Text & "', '" & usuario2 & "', '', " & _
            " '" & Trim(Txt_descripcion.Text) & "', '" & txt_obs.Text & "', 'COM', 'COM-01', 'COM-01-02', 'COM', 'R-220', '0', '3.1.1', '" & Year(Date) & "', '" & VAR_CITE & "', '0', '0', '0', '0', '0', '0', " & _
...
'    Set dg_datos.DataSource = Ado_datos.Recordset
    ...
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    If glusuario = "ADMIN" Or glusuario = "CPLATA" Or glusuario = "DTERCEROS" Or glusuario = "BINFANTE" Or glusuario = "AURBINA" Then
        queryinicial = "select * From ao_solicitud WHERE estado_codigo = 'REG' AND unidad_codigo = '" & parametro & "' "
    Else
    ...
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    'rs_datos.Sort = "cobranza_fecha_prog"
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
    'wwwwwwwwwwwwwwwwwwwwwwwwww
End Sub
...
'    Set dg_datos.DataSource = Ado_datos.Recordset
    ...
    'If glusuario = "ADMIN" Or glusuario = "CPLATA" Or glusuario = "DTERCEROS" Or glusuario = "BINFANTE" Or glusuario = "AURBINA" Then
        queryinicial = "select * From ao_solicitud WHERE unidad_codigo = '" & parametro & "' "
    'Else
    '    queryinicial = "select * From ao_solicitud WHERE unidad_codigo = '" & parametro & "'  AND beneficiario_codigo_resp2 = '" & usuario2 & "' "
    'End If
    'queryinicial = "Select * from ao_solicitud where " + parametro
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    'rs_datos.Sort = "cobranza_fecha_prog"
