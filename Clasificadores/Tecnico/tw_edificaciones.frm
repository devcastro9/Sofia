...
Begin VB.Form tw_edificaciones 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   15960
         Picture         =   "tw_edificaciones.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   80
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "tw_edificaciones.frx":020A
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   79
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "tw_edificaciones.frx":09CC
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   78
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "tw_edificaciones.frx":1299
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   77
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "tw_edificaciones.frx":1A4E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   76
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "tw_edificaciones.frx":2281
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   75
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1320
         Picture         =   "tw_edificaciones.frx":29CD
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   74
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "tw_edificaciones.frx":32E2
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   73
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   15600
         Picture         =   "tw_edificaciones.frx":3AA1
         Style           =   1  'Graphical
         TabIndex        =   72
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "tw_edificaciones.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   69
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6480
         Picture         =   "tw_edificaciones.frx":46B9
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   68
         Top             =   0
   ...
   Begin VB.PictureBox Fra_aux1 
      ...
      Begin VB.ComboBox dtc_codigo11 
         Height          =   315
         ItemData        =   "tw_edificaciones.frx":4FA5
         Left            =   120
         List            =   "tw_edificaciones.frx":4FB8
         TabIndex        =   15
         Text            =   "CALLE"
         Top             =   360
         Width           =   1815
      ...
      Begin VB.CommandButton CmdCancelaDet 
         ...
         Left            =   6585
         MaskColor       =   &H00000000&
         Picture         =   "tw_edificaciones.frx":4FDC
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton CmdGrabaDet 
         ...
         Height          =   675
         Left            =   8040
         Picture         =   "tw_edificaciones.frx":58C8
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   315
         Width           =   1365
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.CommandButton BtnAux1 
         ...
         Left            =   7700
         MaskColor       =   &H00FF0000&
         Picture         =   "tw_edificaciones.frx":609E
         Style           =   1  'Graphical
         TabIndex        =   60
         Top             =   5025
         Width           =   660
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_desc7 
            Bindings        =   "tw_edificaciones.frx":6B76
         ...
         Begin MSDataListLib.DataCombo dtc_campo2 
            Bindings        =   "tw_edificaciones.frx":6B8F
         ...
         Begin MSDataListLib.DataCombo dtc_aux2 
            Bindings        =   "tw_edificaciones.frx":6BA8
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "tw_edificaciones.frx":6BC1
            DataField       =   "munic_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   5160
         ...
         Begin MSDataListLib.DataCombo dtc_codigo7 
            Bindings        =   "tw_edificaciones.frx":6BDA
            DataField       =   "pais_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   2880
         ...
         Begin MSDataListLib.DataCombo dtc_codigo9 
            Bindings        =   "tw_edificaciones.frx":6BF3
         ...
         Begin MSDataListLib.DataCombo dtc_desc9 
            Bindings        =   "tw_edificaciones.frx":6C0C
            DataField       =   "prov_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   120
         ...
         Begin MSDataListLib.DataCombo dtc_codigo8 
            Bindings        =   "tw_edificaciones.frx":6C25
            DataField       =   "depto_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   7080
         ...
         Begin MSDataListLib.DataCombo dtc_desc8 
            Bindings        =   "tw_edificaciones.frx":6C3E
            DataField       =   "depto_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4080
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "tw_edificaciones.frx":6C57
            DataField       =   "munic_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4080
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "tw_edificaciones.frx":6C70
         DataField       =   "codigo6"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7080
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "tw_edificaciones.frx":6C89
         DataField       =   "codigo5"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7080
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "tw_edificaciones.frx":6CA2
         DataField       =   "codigo4"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6840
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "tw_edificaciones.frx":6CBB
         DataField       =   "codigo3"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2880
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "tw_edificaciones.frx":6CD4
         DataField       =   "codigo1"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5280
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "tw_edificaciones.frx":6CED
         DataField       =   "codigo1"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1300
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "tw_edificaciones.frx":6D06
         DataField       =   "codigo4"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4200
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "tw_edificaciones.frx":6D1F
         DataField       =   "codigo3"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "tw_edificaciones.frx":6D38
         DataField       =   "codigo5"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2475
      ...
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "tw_edificaciones.frx":6D51
         DataField       =   "codigo6"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2115
   ...
   End
End
Attribute VB_Name = "tw_edificaciones"
...
Private Sub BtnCancelar_Click()
  On Error GoTo AddErr
   ...
   If sino = vbYes Then
      var_cod = Ado_datos.Recordset!edif_codigo
        Call ABRIR_TABLA
...
On Error GoTo AddErr
   If ExisteReg(Ado_datos.Recordset!edif_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado en otro proceso ...", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  Call valida_campos
    ...
    If VAR_SW = "ADD" Then
     ...
     End If
     If VAR_SW = "MOD" Then
       var_cod = Ado_datos.Recordset!edif_codigo   'Codigo Llave de la Tabla
     End If
     ...
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
     MsgBox "Se guardó con éxito, EL REGISTRO : " + (var_cod)
     Call ABRIR_TABLA
     If (dg_datos.SelBookmarks.Count <> 0) Then
        dg_datos.SelBookmarks.Remove 0
     End If
...
Private Function ExisteReg(codigoe As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM ao_solicitud WHERE edif_codigo = '" & codigoe & "'"
