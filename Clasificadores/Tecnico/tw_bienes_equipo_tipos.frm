...
Begin VB.Form tw_bienes_equipo_tipos 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   15960
         Picture         =   "tw_bienes_equipo_tipos.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "tw_bienes_equipo_tipos.frx":020A
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   28
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "tw_bienes_equipo_tipos.frx":09CC
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "tw_bienes_equipo_tipos.frx":1299
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "tw_bienes_equipo_tipos.frx":1A4E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "tw_bienes_equipo_tipos.frx":2281
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "tw_bienes_equipo_tipos.frx":29CD
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "tw_bienes_equipo_tipos.frx":32E2
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   22
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   15600
         Picture         =   "tw_bienes_equipo_tipos.frx":3AA1
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "tw_bienes_equipo_tipos.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   18
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6480
         Picture         =   "tw_bienes_equipo_tipos.frx":46B9
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   17
         Top             =   0
   ...
   End
End
Attribute VB_Name = "tw_bienes_equipo_tipos"
...
Private Sub BtnCancelar_Click()
  On Error Resume Next
      VAR_COD2 = Ado_datos.Recordset!tipo_eqp
   ...
   If sino = vbYes Then
     ...
     If Ado_datos.Recordset.RecordCount > 0 Then
        rs_datos.Find "tipo_eqp = '" & VAR_COD2 & "' ", , , 1
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        rs_datos!estado_codigo = "REG"
'        rs_datos!Correl = 0
        MsgBox "Se guardó con éxito, EL REGISTRO : " + (Ado_datos.Recordset!tipo_eqp)
     End If
     ...
     If VAR_SW = "MOD" Then
       VAR_COD2 = Ado_datos.Recordset!tipo_eqp   'Codigo Llave de la Tabla
     End If
     Call ABRIR_TABLA
     If (dg_datos.SelBookmarks.Count <> 0) Then
        dg_datos.SelBookmarks.Remove 0
