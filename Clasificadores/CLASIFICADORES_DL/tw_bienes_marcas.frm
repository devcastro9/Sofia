...
Begin VB.Form tw_bienes_marcas 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Clasificadores - Marcas de Bienes"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   11280
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   15960
         Picture         =   "tw_bienes_marcas.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   28
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "tw_bienes_marcas.frx":020A
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   27
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "tw_bienes_marcas.frx":09CC
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "tw_bienes_marcas.frx":1299
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "tw_bienes_marcas.frx":1A4E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "tw_bienes_marcas.frx":2281
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "tw_bienes_marcas.frx":29CD
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   22
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "tw_bienes_marcas.frx":32E2
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   21
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   15600
         Picture         =   "tw_bienes_marcas.frx":3AA1
         Style           =   1  'Graphical
         TabIndex        =   20
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "tw_bienes_marcas.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   17
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "tw_bienes_marcas.frx":46B9
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   16
         Top             =   0
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00C0C0C0&
         Caption         =   "Denominación Marcas de Bienes"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00C0C0C0&
         Caption         =   "Código Marcas de Bienes"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "tw_bienes_marcas"
...
Private Sub BtnCancelar_Click()
  ...
  VAR_COD2 = Ado_datos.Recordset!marca_codigo
   ...
   If sino = vbYes Then
     ...
     If Ado_datos.Recordset.RecordCount > 0 Then
        rs_datos.Find "marca_codigo = '" & VAR_COD2 & "' ", , , 1
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!marca_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from ac_bienes_marcas where marca_codigo = '" & txt_codigo.Text & "'  "
        ...
        End If
        rs_datos!marca_codigo = var_cod
        rs_datos!estado_codigo = "REG"
'        rs_datos!Correl = 0
     MsgBox "Se guardó con éxito, EL REGISTRO : " + (Ado_datos.Recordset!marca_codigo)
     End If
     rs_datos!marca_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
 If VAR_SW = "MOD" Then
       VAR_COD2 = Ado_datos.Recordset!marca_codigo   'Codigo Llave de la Tabla
     End If
     'Call ABRIR_TABLA
     If (dg_datos.SelBookmarks.Count <> 0) Then
        dg_datos.SelBookmarks.Remove 0
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_bienes_marcas.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from ac_bienes_marcas  "
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM ac_bienes WHERE estado_codigo = 'APR' and marca_codigo = '" & Unidad & "'"
