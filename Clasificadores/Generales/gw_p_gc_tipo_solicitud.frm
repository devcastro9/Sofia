...
Begin VB.Form gw_p_gc_tipo_solicitud 
   BackColor       =   &H00000000&
   ...
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "gw_p_gc_tipo_solicitud.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6060
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "gw_p_gc_tipo_solicitud.frx":0A02
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "gw_p_gc_tipo_solicitud.frx":0C0C
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "gw_p_gc_tipo_solicitud.frx":104E
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "gw_p_gc_tipo_solicitud.frx":180D
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "gw_p_gc_tipo_solicitud.frx":2122
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "gw_p_gc_tipo_solicitud.frx":286E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "gw_p_gc_tipo_solicitud.frx":30A1
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "gw_p_gc_tipo_solicitud.frx":3856
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   22
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "gw_p_gc_tipo_solicitud.frx":4123
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   21
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "gw_p_gc_tipo_solicitud.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   18
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "gw_p_gc_tipo_solicitud.frx":50BB
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   17
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "gw_p_gc_tipo_solicitud.frx":59A7
         Height          =   4335
         Left            =   120
         TabIndex        =   13
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Identificacion Tipo Tramite "
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación  Tipos de Tramites"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Tipos de Tramites"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "gw_p_gc_tipo_solicitud"
...
On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!solicitud_tipo) Then
   ...
   Else
      ...
      If sino = vbYes Then
         db.Execute "DELETE gc_tipo_solicitud where solicitud_tipo = '" & Ado_datos.Recordset!solicitud_tipo & "'  "
      End If
   End If
   Call ABRIR_TABLA
   Exit Sub
...
'        rs_datos!Correl = 0
     End If
     rs_datos!solicitud_tipo_descripcion = Txt_descripcion.Text
     rs_datos!solicitud_num = txt_num.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub valida_campos()
  If txt_num.Text = "" Then
    MsgBox "Debe registrar el Identificacion Tipo ", "Validación de datos"
    VAR_VAL = "ERR"
    Exit Sub
  End If
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\gr_tipo_solicitud.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  solicitud_tipo, solicitud_tipo_descripcion, solicitud_num,estado_codigo, fecha_registro, usr_codigo from gc_tipo_solicitud  "
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM ao_solicitud WHERE solicitud_tipo = '" & Unidad & "'"
