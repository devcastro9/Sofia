...
Begin VB.Form gw_p_gc_beneficiario_persona 
   ...
   Begin VB.PictureBox fraDatos 
      ...
      Begin VB.Label Label24 
         ...
         BackColor       =   &H00000000&
         BackStyle       =   0  'Transparent
         Caption         =   "Teléfono Fijo Personal"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
'  End If
  ...
  If dtc_codigo3.Text = "" Then         'Expedido en
    ...
    Exit Sub
  End If
  If txt_campo7.Text = "" Then         'Teléfono Celular Personal
    MsgBox "Debe registrar la " + Label26.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
    Exit Sub
  End If
  If Txt_campo8.Text = "" Then         'Correo Electrónico Personal
    MsgBox "Debe registrar la " + LblCorreo.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
    Exit Sub
  End If
End Sub
...
Private Sub BtnModificar_Click()
  ...
  If glusuario = "SQUISPE" Or glusuario = "RGIL" Or glusuario = "FDELGADILLO" Or glusuario = "ADMIN" Or glusuario = "MARTEAGA" Or glusuario = "APALACIOS" Or glusuario = "CSALINAS" Or glusuario = "GSOLIZ" Or glusuario = "EVILLALOBOS" Or glusuario = "EHALKYER" Or glusuario = "LVEDIA" Or glusuario = "JCASTRO" Then
    fraDatos.Enabled = True
    fraOpciones.Visible = False
    FraGrabarCancelar.Visible = True
    dg_datos.Enabled = False
