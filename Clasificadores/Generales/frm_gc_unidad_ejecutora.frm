...
Begin VB.Form frm_gc_unidad_ejecutora 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Unidad Ejecutora"
   ClientHeight    =   7695
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   11400
   Icon            =   "frm_gc_unidad_ejecutora.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7695
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "frm_gc_unidad_ejecutora.frx":0A02
         Style           =   1  'Graphical
         TabIndex        =   41
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "frm_gc_unidad_ejecutora.frx":0E44
         Style           =   1  'Graphical
         TabIndex        =   39
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_gc_unidad_ejecutora.frx":104E
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   38
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_gc_unidad_ejecutora.frx":180D
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   37
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_gc_unidad_ejecutora.frx":2122
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   36
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frm_gc_unidad_ejecutora.frx":286E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   35
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "frm_gc_unidad_ejecutora.frx":30A1
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   34
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "frm_gc_unidad_ejecutora.frx":3856
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   33
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_gc_unidad_ejecutora.frx":4123
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   32
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_gc_unidad_ejecutora.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   29
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_gc_unidad_ejecutora.frx":50BB
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   28
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":59A7
         Height          =   5175
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":59BF
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":59D8
         DataField       =   "dgral_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":59F1
         DataField       =   "subproceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4200
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":5A0A
         DataField       =   "subproceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":5A23
         DataField       =   "da_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4200
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":5A3C
         DataField       =   "da_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "frm_gc_unidad_ejecutora.frx":5A55
         DataField       =   "da_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2760
      ...
      Begin VB.Label Label3 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Sigla Unidad Ejecutora"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label Label2 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Procedimiento Administrativo Relacionado"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Unidad Ejecutora"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_gc_unidad_ejecutora"
...
Private Sub BtnEliminar_Click()
    On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!unidad_codigo) Then
   ...
   Else
      ...
      If sino = vbYes Then
         db.Execute "DELETE gc_unidad_ejecutora where unidad_codigo = '" & Ado_datos.Recordset!unidad_codigo & "'  "
      End If
   End If
   Call ABRIR_TABLA
   Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from gc_unidad_ejecutora where unidad_codigo = '" & txt_codigo.Text & "'  "
        ...
        Set rs_aux1 = New ADODB.Recordset
        If rs_aux1.State = 1 Then rs_aux1.Close
        SQL_FOR = "select * from gc_unidad_ejecutora where da_codigo = '" & dtc_codigo3.Text & "'  "
        rs_aux1.Open SQL_FOR, db, adOpenKeyset, adLockOptimistic
        If rs_aux1.RecordCount > 0 Then
...
Private Sub pnivel2(codigo3 As String)
   ...
   strConsultaF = "select * from gc_direccion_administrativa where dgral_codigo = '" & codigo3 & "'"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from gc_unidad_ejecutora  "
