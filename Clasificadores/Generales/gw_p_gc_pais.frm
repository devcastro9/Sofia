...
Begin VB.Form gw_p_gc_pais 
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "gw_p_gc_pais.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "gw_p_gc_pais.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "gw_p_gc_pais.frx":6CE48
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "gw_p_gc_pais.frx":6D400
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "gw_p_gc_pais.frx":6D9BD
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "gw_p_gc_pais.frx":6DBC7
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "gw_p_gc_pais.frx":6E891
         Style           =   1  'Graphical
         TabIndex        =   14
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "gw_p_gc_pais.frx":6EE71
         Style           =   1  'Graphical
         TabIndex        =   12
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "gw_p_gc_pais.frx":6F495
         Height          =   4335
         Left            =   120
         TabIndex        =   33
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Top             =   1200
      Width           =   5775
      Begin VB.TextBox Txt_continente 
         BackColor       =   &H00FFFFFF&
         ...
         Width           =   1335
      End
      Begin VB.TextBox Txt_cod_horario 
         BackColor       =   &H00FFFFFF&
         DataField       =   "pais_cod_horario"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   360
         TabIndex        =   7
         ...
         Width           =   1335
      End
      Begin VB.TextBox Txt_cod_aeropuerto 
         BackColor       =   &H00FFFFFF&
         DataField       =   "pais_cod_aeropuerto"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   3840
         TabIndex        =   6
         ...
         Width           =   1335
      End
      Begin VB.TextBox Txt_descripcion_ingles 
         BackColor       =   &H00FFFFFF&
         DataField       =   "pais_descripcion_ingles"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   360
         TabIndex        =   5
         ...
         Width           =   3015
      End
      Begin VB.TextBox Txt_cod_iso_num 
         BackColor       =   &H00FFFFFF&
         DataField       =   "pais_cod_iso_num"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   3840
         TabIndex        =   4
         ...
         Width           =   1335
      End
      Begin VB.TextBox Txt_cod_telefonico 
         BackColor       =   &H00FFFFFF&
         DataField       =   "pais_cod_telefonico"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   2040
         TabIndex        =   3
      ...
      Begin VB.Label lbl_continente 
         ...
         Width           =   945
      End
      Begin VB.Label lbl_cod_horario 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Horario"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
         ...
         Width           =   1380
      End
      Begin VB.Label lbl_cod_aeropuerto 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Aeropuerto"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
         ...
         Width           =   1710
      End
      Begin VB.Label lbl_descripcion_ingles 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Ingles"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
         ...
         Width           =   1890
      End
      Begin VB.Label lbl_cod_iso_num 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Iso"
         BeginProperty Font 
         ...
         Width           =   975
      End
      Begin VB.Label lbl_cod_telefonico 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Telefónico"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "gw_p_gc_pais.frx":6F4AD
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   28
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "gw_p_gc_pais.frx":DB4DF
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "gw_p_gc_pais.frx":DB6E9
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   765
   ...
   End
End
Attribute VB_Name = "gw_p_gc_pais"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!pais_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from gc_pais where pais_codigo = '" & txt_codigo.Text & "'  "
'        Set rs_aux1.DataSource = db.Execute(" EXEC gp_listar_mediante_codigo_gc_direccion_general '" & txt_codigo.Text & "' ")
        ...
        End If
        rs_datos!pais_codigo = var_cod
        rs_datos!estado_codigo = "REG"
'        rs_datos!Correl = 0
     End If
     rs_datos!pais_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\gr_paises.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select * from gc_pais  "
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM gc_beneficiario WHERE WHERE estado_codigo = 'APR' "
...
Private Sub Txt_cod_aeropuerto_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub Txt_cod_horario_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub Txt_cod_iso_num_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub Txt_cod_telefonico_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub
...
Private Sub Txt_continente_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub

Private Sub Txt_descripcion_ingles_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub
