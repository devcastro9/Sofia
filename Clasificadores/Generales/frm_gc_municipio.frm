...
Begin VB.Form frm_gc_municipio 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Municipio"
   ClientHeight    =   7410
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12945
   Icon            =   "frm_gc_municipio.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7410
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_municipio.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12600
      TabIndex        =   20
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_municipio.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_municipio.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_gc_municipio.frx":6CE48
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_gc_municipio.frx":6D400
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_gc_municipio.frx":6D9BD
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_gc_municipio.frx":6DBC7
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_gc_municipio.frx":6E891
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_gc_municipio.frx":6EE71
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_gc_municipio.frx":6F495
         Height          =   4935
         Left            =   120
         TabIndex        =   8
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo4 
            Bindings        =   "frm_gc_municipio.frx":6F4AD
            DataField       =   "pais_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4440
         ...
         Begin MSDataListLib.DataCombo dtc_codigo6 
            Bindings        =   "frm_gc_municipio.frx":6F4C6
            DataField       =   "prov_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4440
         ...
         Begin MSDataListLib.DataCombo dtc_desc6 
            Bindings        =   "frm_gc_municipio.frx":6F4DF
            DataField       =   "prov_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   360
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "frm_gc_municipio.frx":6F4F8
            DataField       =   "depto_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4440
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "frm_gc_municipio.frx":6F511
            DataField       =   "depto_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   360
         ...
         Begin MSDataListLib.DataCombo dtc_desc4 
            Bindings        =   "frm_gc_municipio.frx":6F52A
            DataField       =   "pais_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   360
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación del Municipio"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_municipio.frx":6F543
      ScaleHeight     =   960
      ScaleWidth      =   12600
      TabIndex        =   21
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_gc_municipio.frx":DB575
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_gc_municipio.frx":DB77F
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   765
   ...
   End
End
Attribute VB_Name = "frm_gc_municipio"
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        rs_aux2.Open "Select max(val(munic_codigo)) as Codigo from gc_municipio where prov_codigo = " & dtc_codigo6.Text & "    ", db, adOpenStatic
        If rs_aux2.RecordCount > 1 Then
            var_cod = IIf(IsNull(rs_aux2!Codigo), 1, rs_aux2!Codigo + 1)
        Else
            var_cod = Val(Ado_datos.Recordset!prov_codigo) * 100 + 1
        End If
        
        rs_datos!munic_codigo = var_cod
        txt_codigo = var_cod            ' Esto para codigos correlativos
        rs_datos!estado_codigo = "REG"  ' no cambia
        rs_datos!correl_edif = 0
     ...
     End If
     rs_datos!munic_descripcion = Txt_descripcion.Text
     rs_datos!munic_poblacion = Txt_campo2.Text
     rs_datos!munic_anio_creacion = txt_campo3.Text
     rs_datos!munic_sigla = txt_campo1.Text
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\gr_municipios.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from gv_municipio  "
