...
Begin VB.Form gw_p_gc_departamento 
   BackColor       =   &H00000000&
   ...
   ClientTop       =   345
   ClientWidth     =   11280
   Icon            =   "gw_p_gc_departamento.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6570
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "gw_p_gc_departamento.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   20
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "gw_p_gc_departamento.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "gw_p_gc_departamento.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "gw_p_gc_departamento.frx":6CE48
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "gw_p_gc_departamento.frx":6D400
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "gw_p_gc_departamento.frx":6D9BD
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "gw_p_gc_departamento.frx":6DBC7
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "gw_p_gc_departamento.frx":6E891
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "gw_p_gc_departamento.frx":6EE71
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "gw_p_gc_departamento.frx":6F495
         Height          =   4335
         Left            =   120
         TabIndex        =   26
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "gw_p_gc_departamento.frx":6F4AD
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "gw_p_gc_departamento.frx":6F4C6
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Departamento"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "gw_p_gc_departamento.frx":6F4DF
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   21
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "gw_p_gc_departamento.frx":DB511
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "gw_p_gc_departamento.frx":DB71B
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   765
   ...
   End
End
Attribute VB_Name = "gw_p_gc_departamento"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!depto_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
''        rs_datos!doc_codigo = RTrim(RTrim(dtc_codigo1.Text) + ".") + LTrim(Str(Val(var_cod)))
        ...
        rs_datos!depto_codigo = txt_codigo.Text ' Esto para codigos transcritos
...
'        db.Execute "Update gc_direccion_general Set correl_da = CAST('" & var_cod & "' AS INT) + 1 Where dgral_codigo= '" & dtc_codigo1.Text & "' "
     End If
     rs_datos!depto_descripcion = Txt_descripcion.Text
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\gr_departamento.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from gc_departamento  "
