...
Begin VB.Form frm_gc_calles 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Vias de Acceso"
   ClientHeight    =   6540
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "frm_gc_calles.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6540
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_calles.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   22
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_calles.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_calles.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_gc_calles.frx":6CE48
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_gc_calles.frx":6D400
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_gc_calles.frx":6D9BD
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_gc_calles.frx":6DBC7
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_gc_calles.frx":6E891
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_gc_calles.frx":6EE71
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_gc_calles.frx":6F495
         Height          =   4335
         Left            =   120
         TabIndex        =   10
         Top             =   240
      ...
      Begin MSAdodcLib.Adodc Ado_datos 
         ...
         Password        =   ""
         RecordSource    =   ""
         Caption         =   " <-- Inicio                        Vias de Accesol                          Fin -->"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_gc_calles.frx":6F4AD
         DataField       =   "zona_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_gc_calles.frx":6F4C6
         DataField       =   "zona_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_gc_calles.frx":6F4DF
         DataField       =   "calle_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
         ...
         _Version        =   393216
         Style           =   2
         ListField       =   "calle_tipo_nombre"
         BoundColumn     =   "calle_tipo"
         Text            =   "Todos"
      End
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_gc_calles.frx":6F4F8
         DataField       =   "calle_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4200
      ...
      Begin VB.Label lbl_enlace1 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Zona a la que Corresponde"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_calles.frx":6F511
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   23
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_gc_calles.frx":DB543
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_gc_calles.frx":DB74D
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   120
         Width           =   765
   ...
   End
End
Attribute VB_Name = "frm_gc_calles"
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        rs_aux2.Open "Select max(calle_codigo) as Codigo from gc_calles where zona_codigo = " & dtc_codigo1.Text & "    ", db, adOpenStatic
        If Not rs_aux2.EOF Then
            VAR_SW2 = (rs_datos!zona_codigo * 100) + 1
            var_cod = IIf(IsNull(rs_aux2!Codigo), VAR_SW2, rs_aux2!Codigo + 1)
        End If
        rs_datos!calle_codigo = var_cod
        txt_codigo = var_cod            ' Esto para codigos correlativos
        rs_datos!estado_codigo = "REG"  ' no cambia
        rs_datos!CORREL = 0
        rs_datos!calle_tipo = dtc_codigo2.Text   'Codigo del padre 2
        rs_datos!zona_codigo = dtc_codigo1.Text   'Codigo del padre 1
     ...
     End If
     rs_datos!calle_denominacion = Txt_descripcion.Text
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\gr_calles.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from gc_calles  "
