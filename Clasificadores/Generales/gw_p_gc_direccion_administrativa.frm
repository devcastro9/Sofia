...
Begin VB.Form gw_p_gc_direccion_administrativa 
   BackColor       =   &H00000000&
   ...
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "gw_p_gc_direccion_administrativa.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6945
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "gw_p_gc_direccion_administrativa.frx":0A02
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   34
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "gw_p_gc_direccion_administrativa.frx":11C4
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   33
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "gw_p_gc_direccion_administrativa.frx":1A91
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   32
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "gw_p_gc_direccion_administrativa.frx":2246
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   31
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "gw_p_gc_direccion_administrativa.frx":2A79
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   30
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "gw_p_gc_direccion_administrativa.frx":31C5
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   29
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "gw_p_gc_direccion_administrativa.frx":3ADA
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   28
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "gw_p_gc_direccion_administrativa.frx":4299
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "gw_p_gc_direccion_administrativa.frx":46DB
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "gw_p_gc_direccion_administrativa.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "gw_p_gc_direccion_administrativa.frx":51D1
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   22
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "gw_p_gc_direccion_administrativa.frx":59A7
         Height          =   4335
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "gw_p_gc_direccion_administrativa.frx":59BF
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "gw_p_gc_direccion_administrativa.frx":59D8
         DataField       =   "dgral_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "gw_p_gc_direccion_administrativa.frx":59F1
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "gw_p_gc_direccion_administrativa.frx":5A0A
         DataField       =   "proceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label Label1 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Procedimiento Administrativo"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Gerencia Operativa"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Gerencia Operativa"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "gw_p_gc_direccion_administrativa"
...
Private Sub BtnEliminar_Click()
      On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!da_codigo) Then
   ...
   Else
      ...
      If sino = vbYes Then
         db.Execute "DELETE gc_direccion_administrativa where da_codigo = '" & Ado_datos.Recordset!da_codigo & "'  "
      End If
   End If
   Call ABRIR_TABLA
   Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from gc_direccion_administrativa where dgral_codigo = '" & dtc_codigo1.Text & "'  "
...
'            Exit Sub
        ...
        Else
            var_cod = 1
        End If
        rs_datos!da_codigo = RTrim(RTrim(dtc_codigo1.Text) + ".") + LTrim(Str(Val(var_cod)))
        rs_datos!estado_codigo = "REG"  ' no cambia
        rs_datos!correl_unidad = 0
     ...
     End If
     rs_datos!da_descripcion = Txt_descripcion.Text
     rs_datos!proceso_codigo = dtc_codigo2.Text
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\gr_gerencias_operativas.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from gc_direccion_administrativa  "
...
Private Sub ABRIR_TABLAS_AUX()
    ...
    rs_datos2.Open "Select * from gc_proceso_nivel1 where estado_codigo = 'APR' order by proceso_descripcion", db, adOpenStatic
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM gc_unidad_ejecutora WHERE da_codigo = '" & Unidad & "'"
