...
Begin VB.Form gw_p_gc_beneficiario_aux2 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Registro Auxiliar de Empresas"
   ClientHeight    =   6510
   ClientLeft      =   420
   ClientTop       =   1830
   ClientWidth     =   9075
   Icon            =   "gw_p_gc_beneficiario_aux2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.PictureBox Fra_aux1 
      ...
      Height          =   1320
      Left            =   240
      Picture         =   "gw_p_gc_beneficiario_aux2.frx":0A02
      ScaleHeight     =   1260
      ScaleWidth      =   8580
      TabIndex        =   76
      Top             =   5040
      ...
      Begin VB.ComboBox dtc_codigo11 
         Height          =   315
         ItemData        =   "gw_p_gc_beneficiario_aux2.frx":6CA34
         Left            =   120
         List            =   "gw_p_gc_beneficiario_aux2.frx":6CA47
         TabIndex        =   18
         Text            =   "CALLE"
         Top             =   360
         Width           =   1815
      ...
      Begin VB.CommandButton CmdCancelaDet 
         ...
         Left            =   6585
         MaskColor       =   &H00000000&
         Picture         =   "gw_p_gc_beneficiario_aux2.frx":6CA68
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton CmdGrabaDet 
         ...
         Height          =   675
         Left            =   7560
         Picture         =   "gw_p_gc_beneficiario_aux2.frx":6CC72
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   315
         Width           =   1005
   ...
   Begin VB.PictureBox fraDatos 
      ...
      Begin VB.PictureBox FraGrabarCancelar 
         ...
         Height          =   975
         Left            =   60
         Picture         =   "gw_p_gc_beneficiario_aux2.frx":6CE7C
         ScaleHeight     =   915
         ScaleWidth      =   8580
         TabIndex        =   74
         Top             =   5040
         ...
         Begin VB.CommandButton BtnGrabar 
            ...
            Height          =   675
            Left            =   2640
            Picture         =   "gw_p_gc_beneficiario_aux2.frx":D8EAE
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   120
            Width           =   1365
         ...
         Begin VB.CommandButton BtnCancelar 
            ...
            Left            =   4200
            MaskColor       =   &H00000000&
            Picture         =   "gw_p_gc_beneficiario_aux2.frx":D9684
            Style           =   1  'Graphical
            TabIndex        =   16
            ToolTipText     =   "Cancelar"
            Top             =   120
      ...
      Begin VB.Frame Frame2 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":D9F70
         ...
         Begin MSDataListLib.DataCombo dtc_codigo3 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":D9F89
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":D9FA2
            DataField       =   "tipodoc_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   6600
         ...
         Begin MSDataListLib.DataCombo dtc_desc3 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":D9FBB
            DataField       =   "depto_sigla"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   7680
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":D9FD4
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":D9FED
            DataField       =   "tipoben_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   3120
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton BtnAux1 
            ...
            Height          =   600
            Left            =   5520
            Picture         =   "gw_p_gc_beneficiario_aux2.frx":DA006
            Style           =   1  'Graphical
            TabIndex        =   17
         ...
         Begin MSDataListLib.DataCombo dtc_codigo4 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAADE
         ...
         Begin MSDataListLib.DataCombo dtc_codigo7 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAAF7
         ...
         Begin MSDataListLib.DataCombo dtc_desc7 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAB10
            DataField       =   "munic_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   120
         ...
         Begin MSDataListLib.DataCombo dtc_codigo6 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAB29
         ...
         Begin MSDataListLib.DataCombo dtc_desc6 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAB42
            DataField       =   "prov_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4320
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAB5B
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAB74
            DataField       =   "depto_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   120
         ...
         Begin MSDataListLib.DataCombo dtc_desc4 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAB8D
            DataField       =   "pais_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   5280
         ...
         Begin MSDataListLib.DataCombo dtc_desc8 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DABA6
         ...
         Begin MSDataListLib.DataCombo dtc_desc9 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DABBF
         ...
         Begin MSDataListLib.DataCombo dtc_codigo8 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DABD8
            DataField       =   "zona_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   7560
         ...
         Begin MSDataListLib.DataCombo dtc_codigo9 
            Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DABF1
            DataField       =   "calle_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   3960
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAC0A
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAC24
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_aux4 
         Bindings        =   "gw_p_gc_beneficiario_aux2.frx":DAC3E
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
   ...
   End
End
Attribute VB_Name = "gw_p_gc_beneficiario_aux2"
...
'     dg_datos.Enabled = True
     ...
     If glPersNew = "NEWC" Then
        ...
        mw_solicitud.txt_obs = txt_codigo.Text + " - " + rs_aux1!beneficiario_denominacion + " - Telef. " + rs_aux1!beneficiario_telefono_fijo
     End If
