...
Begin VB.Form gw_p_gc_direccion_general 
   BackColor       =   &H00000000&
   ...
   ClientWidth     =   11970
   ForeColor       =   &H00000000&
   Icon            =   "gw_p_gc_direccion_general.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6510
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "gw_p_gc_direccion_general.frx":0A02
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   27
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "gw_p_gc_direccion_general.frx":11C4
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "gw_p_gc_direccion_general.frx":1A91
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "gw_p_gc_direccion_general.frx":2246
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "gw_p_gc_direccion_general.frx":2A79
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "gw_p_gc_direccion_general.frx":31C5
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   22
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "gw_p_gc_direccion_general.frx":3ADA
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   21
         Top             =   0
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "gw_p_gc_direccion_general.frx":4299
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "gw_p_gc_direccion_general.frx":44A3
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   17
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "gw_p_gc_direccion_general.frx":4D8F
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   16
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "gw_p_gc_direccion_general.frx":5565
         Height          =   4335
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Gerencia General"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Gerencia General"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "gw_p_gc_direccion_general"
...
Private Sub BtnEliminar_Click()
      On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!dgral_codigo) Then
   ...
   Else
      ...
      If sino = vbYes Then
         db.Execute "DELETE gc_direccion_general where dgral_codigo = '" & Ado_datos.Recordset!dgral_codigo & "'  "
      End If
   End If
   Call ABRIR_TABLA
   Exit Sub
...
Private Function ExisteReg(Unidad As String) As Boolean
 '    INICIO
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM gc_direccion_administrativa WHERE dgral_codigo = '" & Unidad & "'"
