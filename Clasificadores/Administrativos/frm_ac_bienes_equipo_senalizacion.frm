...
Begin VB.Form frm_ac_bienes_equipo_senalizacion 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   32
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":020A
         Style           =   1  'Graphical
         TabIndex        =   31
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":064C
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   30
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":0E0B
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   29
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":1720
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   28
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":1E6C
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":269F
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":2E54
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":3721
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   24
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   21
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_ac_bienes_equipo_senalizacion.frx":46B9
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   20
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_ac_bienes_equipo_senalizacion.frx":4FA5
         Height          =   4335
         Left            =   120
         TabIndex        =   37
         Top             =   240
         ...
         BeginProperty Column01 
            DataField       =   "senal_descripcion_cabina"
            Caption         =   "Denominación cabina"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
               HaveTrueFalseNull=   0
         ...
         BeginProperty Column02 
            DataField       =   "senal_descripcion_pasillo"
            Caption         =   "denominacion pasillo"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
               HaveTrueFalseNull=   0
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Top             =   840
      Width           =   5775
      Begin VB.TextBox txt_descripcion_pas 
         DataField       =   "senal_descripcion_pasillo"
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_ac_bienes_equipo_senalizacion.frx":4FBD
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_ac_bienes_equipo_senalizacion.frx":4FD6
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_ac_bienes_equipo_senalizacion.frx":4FEF
         DataField       =   "tipo_eqp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_ac_bienes_equipo_senalizacion.frx":5008
         DataField       =   "tipo_eqp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label lbl_enlace2 
         ...
         Width           =   1110
      End
      Begin VB.Label lbl_descripcion_pas 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Descripcion Pasillo"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_ac_bienes_equipo_senalizacion"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!boton_codigo) Then
   ...
   Else
      ...
      If sino = vbYes Then
         db.Execute "DELETE ac_bienes_equipo_senalizacion where senal_codigo = '" & Ado_datos.Recordset!boton_codigo & "'  "
      End If
   End If
   Call ABRIR_TABLA
   Exit Sub
...
''        rs_datos!doc_codigo = RTrim(RTrim(dtc_codigo1.Text) + ".") + LTrim(Str(Val(var_cod)))
        ...
        rs_datos!senal_codigo = txt_codigo.Text ' Esto para codigos trascritos
...
'        db.Execute "Update gc_direccion_general Set correl_da = CAST('" & var_cod & "' AS INT) + 1 Where dgral_codigo= '" & dtc_codigo1.Text & "' "
     End If
     rs_datos!senal_descripcion_cabina = Txt_descripcion.Text
     rs_datos!senal_descripcion_pasillo = txt_descripcion_pas.Text
...
'habilitar codigo cuando se transcribe
  ...
  If Txt_descripcion.Text = "" Then
    ...
    Exit Sub
  End If
    If txt_descripcion_pas.Text = "" Then
    MsgBox "Debe registrar la " + lbl_descripcion_pas.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
    Exit Sub
  End If
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_bienes_equipo_senalizacion.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from ac_bienes_equipo_senalizacion  "
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM ao_solicitud_cotiza_modelo WHERE senal_codigo = '" & Unidad & "'"
