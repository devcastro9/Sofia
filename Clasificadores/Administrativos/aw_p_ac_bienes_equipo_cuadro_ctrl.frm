...
Begin VB.Form aw_p_ac_bienes_equipo_cuadro_ctrl 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Cuarto de Control"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6495
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":058A
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   21
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6C5BC
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6C7C6
         Style           =   1  'Graphical
         TabIndex        =   25
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6C9D0
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6CF88
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6D545
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6D74F
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6E419
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6E9F9
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.Label lbl_titulo 
         ...
         Caption         =   "EQUIPO (CUARTO DE CONTROL)"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   15.75
            Charset         =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6F01D
         Height          =   4335
         Left            =   120
         TabIndex        =   27
         Top             =   240
         ...
         BeginProperty Column01 
            DataField       =   "cuadro_ctrl_descripcion"
         ...
         BeginProperty Column05 
            DataField       =   "tiene_sala_maq"
            Caption         =   "Sala Maquinas"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
               HaveTrueFalseNull=   0
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Top             =   1200
      Width           =   5775
      Begin VB.TextBox txt_tiene_sala_maq 
         DataField       =   "tiene_sala_maq"
         ...
         Width           =   1815
      End
      Begin VB.ComboBox txt_tipo_eqp 
         DataField       =   "tipo_eqp"
         DataSource      =   "Ado_datos"
         Height          =   315
         ItemData        =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6F035
         Left            =   360
         List            =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6F042
         TabIndex        =   1
         Top             =   1800
         Width           =   1815
      End
      ...
      Begin VB.TextBox txt_codigo 
         ...
         Width           =   1815
      End
      Begin VB.Label lbl_tiene_sala_maq 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Sala de Máquinas"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Cuarto de Control"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Cuarto de Control "
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":6F04F
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   22
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":DB081
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "aw_p_ac_bienes_equipo_cuadro_ctrl.frx":DB28B
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   120
         Width           =   765
   ...
   End
End
Attribute VB_Name = "aw_p_ac_bienes_equipo_cuadro_ctrl"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!cuadro_ctrl_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
'        rs_datos!Correl = 0
     End If
     rs_datos!cuadro_ctrl_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_equipo_cuarto_control.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select * from ac_bienes_equipo_cuadro_ctrl  "
...
Private Sub txt_tiene_sala_maq_KeyPress(KeyAscii As Integer)
    KeyAscii = Asc(UCase(Chr(KeyAscii)))
End Sub
