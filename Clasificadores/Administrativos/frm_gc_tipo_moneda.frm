...
Begin VB.Form frm_gc_tipo_moneda 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores -Tipo de Moneda"
   ClientHeight    =   6945
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_tipo_moneda.frx":0000
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   22
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_tipo_moneda.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_tipo_moneda.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_gc_tipo_moneda.frx":6C446
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_gc_tipo_moneda.frx":6C9FE
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_gc_tipo_moneda.frx":6CFBB
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_gc_tipo_moneda.frx":6D1C5
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_gc_tipo_moneda.frx":6DE8F
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_gc_tipo_moneda.frx":6E46F
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_tipo_moneda.frx":6EA93
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   18
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_gc_tipo_moneda.frx":DAAC5
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_gc_tipo_moneda.frx":DACCF
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_gc_tipo_moneda.frx":DAED9
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_gc_tipo_moneda.frx":DAEF2
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
   ...
   End
End
Attribute VB_Name = "frm_gc_tipo_moneda"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!tipo_moneda) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
''        rs_datos!doc_codigo = RTrim(RTrim(dtc_codigo1.Text) + ".") + LTrim(Str(Val(var_cod)))
        ...
        rs_datos!tipo_moneda = txt_codigo.Text ' Esto para codigos trascritos
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\gr_tipo_moneda.rpt"
