...
Begin VB.Form frm_ac_bienes_tecnologia_linea 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Línea (Tecnología)"
   ClientHeight    =   6945
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   11280
   Icon            =   "frm_ac_bienes_tecnologia_linea.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6945
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ac_bienes_tecnologia_linea.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   26
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6D262
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6D842
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6E50C
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6E716
         Style           =   1  'Graphical
         TabIndex        =   9
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6ECD3
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6F28B
         Style           =   1  'Graphical
         TabIndex        =   27
         Top             =   120
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ac_bienes_tecnologia_linea.frx":6F495
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   29
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":DB4C7
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_ac_bienes_tecnologia_linea.frx":DB6D1
         Style           =   1  'Graphical
         TabIndex        =   30
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_ac_bienes_tecnologia_linea.frx":DB8DB
         Height          =   4335
         Left            =   120
         TabIndex        =   21
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_ac_bienes_tecnologia_linea.frx":DB8F3
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_ac_bienes_tecnologia_linea.frx":DB90C
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_ac_bienes_tecnologia_linea.frx":DB925
         DataField       =   "tipo_eqp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_ac_bienes_tecnologia_linea.frx":DB93E
         DataField       =   "tipo_eqp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Descripcion de la Línea de Modelo"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Linea de Modelo"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_ac_bienes_tecnologia_linea"
...
''        rs_datos!doc_codigo = RTrim(RTrim(dtc_codigo1.Text) + ".") + LTrim(Str(Val(var_cod)))
        ...
        rs_datos!tecnologia_codigo = txt_codigo.Text ' Esto para codigos trascritos
...
'        db.Execute "Update gc_direccion_general Set correl_da = CAST('" & var_cod & "' AS INT) + 1 Where dgral_codigo= '" & dtc_codigo1.Text & "' "
     ...
     rs_datos!tecnologia_descripcion = Txt_descripcion.Text
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_equipo_linea_tecnologia.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from ac_bienes_equipo_tecnologia  "
