...
Begin VB.Form frm_ac_negociacion_forma 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Formas de Negociacion"
   ClientHeight    =   6480
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12435
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ac_negociacion_forma.frx":0000
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   20
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_negociacion_forma.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   28
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_negociacion_forma.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   27
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_ac_negociacion_forma.frx":6C446
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_ac_negociacion_forma.frx":6C9FE
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_ac_negociacion_forma.frx":6CFBB
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_ac_negociacion_forma.frx":6D1C5
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_ac_negociacion_forma.frx":6DE8F
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_ac_negociacion_forma.frx":6E46F
         Style           =   1  'Graphical
         TabIndex        =   21
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ac_negociacion_forma.frx":6EA93
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   16
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_ac_negociacion_forma.frx":DAAC5
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_ac_negociacion_forma.frx":DACCF
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         ...
         BeginProperty Column01 
            DataField       =   "negocia_forma_descripcion"
   ...
   End
End
Attribute VB_Name = "frm_ac_negociacion_forma"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!negocia_forma) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from ac_negociacion_forma where negocia_forma = '" & txt_codigo.Text & "'  "
'        Set rs_aux1.DataSource = db.Execute(" EXEC gp_listar_mediante_codigo_gc_direccion_general '" & txt_codigo.Text & "' ")
        ...
        End If
'        rs_datos!negocia_forma = var_cod
        rs_datos!estado_codigo = "REG"
'        rs_datos!Correl = 0
     End If
     ...
     rs_datos!negocia_forma_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_negociacion_forma.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from ac_negociacion_forma"
