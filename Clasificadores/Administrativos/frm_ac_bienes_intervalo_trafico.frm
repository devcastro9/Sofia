...
Begin VB.Form frm_ac_bienes_intervalo_trafico 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":0000
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   31
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":07C2
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   30
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":108F
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   29
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":1844
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   28
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":2077
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":27C3
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":30D8
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":3897
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":3CD9
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   20
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_ac_bienes_intervalo_trafico.frx":47CF
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   19
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_ac_bienes_intervalo_trafico.frx":4FA5
         Height          =   4335
         Left            =   120
         TabIndex        =   13
         Top             =   240
         ...
         BeginProperty Column01 
            DataField       =   "intervalo_trafico_parametro"
            Caption         =   "Parametro Intervalo"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
               HaveTrueFalseNull=   0
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_ac_bienes_intervalo_trafico.frx":4FBD
         DataField       =   "edif_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
         ...
         Style           =   2
         ListField       =   "edif_tipo"
         BoundColumn     =   "edif_tipo"
         Text            =   "Todos"
      End
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_ac_bienes_intervalo_trafico.frx":4FD6
         DataField       =   "edif_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Parametro Intervalo Trafico"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_ac_bienes_intervalo_trafico"
...
Private Sub BtnEliminar_Click()
   ...
   If ExisteReg(Ado_datos.Recordset!nro_total_equipos) Then
   ...
   Else
      ...
      If sino = vbYes Then
         db.Execute "DELETE ac_bienes_equipo_intervalos_trafico where nro_total_equipos = '" & Ado_datos.Recordset!nro_total_equipos & "'  "
      End If
   End If
   Call ABRIR_TABLA
   Exit Sub
...
''        rs_datos!doc_codigo = RTrim(RTrim(dtc_codigo1.Text) + ".") + LTrim(Str(Val(var_cod)))
        ...
        rs_datos!nro_total_equipos = txt_codigo.Text ' Esto para codigos trascritos
        rs_datos!estado_codigo = "REG"  ' no cambia
        'rs_datos!correl_doc = 0
        rs_datos!edif_tipo = dtc_codigo1.Text   'Codigo del padre
...
'        db.Execute "Update gc_direccion_general Set correl_da = CAST('" & var_cod & "' AS INT) + 1 Where dgral_codigo= '" & dtc_codigo1.Text & "' "
     End If
     rs_datos!intervalo_trafico_parametro = Txt_descripcion.Text
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_bienes_intervalo_trafico.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from ac_bienes_equipo_intervalos_trafico  "
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM ao_solicitud_calculo_trafico WHERE h_nro_total_equipos = '" & Unidad & "'"
...
Private Sub txt_codigo_KeyPress(KeyAscii As Integer)
    Validar txt_codigo.Text, KeyAscii
End Sub

Private Sub Txt_descripcion_KeyPress(KeyAscii As Integer)
        Validar Txt_descripcion.Text, KeyAscii
End Sub
