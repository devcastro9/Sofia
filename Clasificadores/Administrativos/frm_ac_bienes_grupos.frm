...
Begin VB.Form frm_ac_bienes_grupos 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Grupos de Bienes y Servicios"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   15960
         Picture         =   "frm_ac_bienes_grupos.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_ac_bienes_grupos.frx":020A
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   30
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "frm_ac_bienes_grupos.frx":09CC
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   29
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "frm_ac_bienes_grupos.frx":1299
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   28
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frm_ac_bienes_grupos.frx":1A4E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_ac_bienes_grupos.frx":2281
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_ac_bienes_grupos.frx":29CD
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_ac_bienes_grupos.frx":32E2
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   15600
         Picture         =   "frm_ac_bienes_grupos.frx":3AA1
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_ac_bienes_grupos.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   20
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_ac_bienes_grupos.frx":46B9
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   19
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_ac_bienes_grupos.frx":4FA5
         Height          =   4335
         Left            =   120
         TabIndex        =   12
         Top             =   240
         ...
         BeginProperty Column05 
            DataField       =   "correlativo_subgrupo"
            Caption         =   "correl"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.ComboBox txt_bbss 
         Height          =   315
         ItemData        =   "frm_ac_bienes_grupos.frx":4FBD
         Left            =   360
         List            =   "frm_ac_bienes_grupos.frx":4FC7
         TabIndex        =   17
         Text            =   "BIENES"
         Top             =   3360
         Width           =   1575
   ...
   End
End
Attribute VB_Name = "frm_ac_bienes_grupos"
...
Private Sub BtnCancelar_Click()
  On Error Resume Next
   ...
   If sino = vbYes Then
      If VAR_SW = "ADD" Then
        db.Execute "delete ac_bienes_grupo where grupo_codigo='" & txt_codigo.Text & "'"
      Else
...
'        SQL_FOR = "select * from ac_bienes_grupo where grupo_codigo = '" & txt_codigo.Text & "'  "
        SQL_FOR = "select max(grupo_codigo) as var_mayor from ac_bienes_grupo"
...
'            Exit Sub
           var_cod = rs_aux1!var_mayor + 10000
        Else
'            var_cod = txt_codigo.Text
           var_cod = "10000"
        End If
        rs_datos!grupo_codigo = var_cod
        rs_datos!estado_codigo = "REG"
        rs_datos!correlativo_subgrupo = "0"
'        rs_datos!Correl = 0
     End If
     'rs_datos!dgral_descripcion = Txt_descripcion.Text
     If txt_bbss = "BIENES" Then
        rs_datos!grupo_bien_servicio = "B"
     Else
        rs_datos!grupo_bien_servicio = "S"
     End If
     
     rs_datos!grupo_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
'    txt_codigo.Enabled = False
     Else
       MsgBox "No se puede MODIFICAR un registro Anulado (ERR) o Aprobado (APR) anteriormente ...", vbExclamation, "Validación de Registro"
   End If
  Exit Sub
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from ac_bienes_grupo"
