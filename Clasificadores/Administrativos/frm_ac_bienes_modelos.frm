...
Begin VB.Form frm_ac_bienes_modelos 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ac_bienes_modelos.frx":0000
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   18
      Top             =   120
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_ac_bienes_modelos.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_ac_bienes_modelos.frx":6C656
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_ac_bienes_modelos.frx":6CC36
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_ac_bienes_modelos.frx":6D900
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_ac_bienes_modelos.frx":6DB0A
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_ac_bienes_modelos.frx":6E0C7
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_bienes_modelos.frx":6E67F
         Style           =   1  'Graphical
         TabIndex        =   20
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_bienes_modelos.frx":6E889
         Style           =   1  'Graphical
         TabIndex        =   19
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ac_bienes_modelos.frx":6EA93
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   28
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_ac_bienes_modelos.frx":DAAC5
         Style           =   1  'Graphical
         TabIndex        =   30
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_ac_bienes_modelos.frx":DACCF
         Style           =   1  'Graphical
         TabIndex        =   29
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_ac_bienes_modelos.frx":DAED9
         Height          =   4335
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_ac_bienes_modelos.frx":DAEF1
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_ac_bienes_modelos.frx":DAF0A
         DataField       =   "marca_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
   ...
   End
End
Attribute VB_Name = "frm_ac_bienes_modelos"
