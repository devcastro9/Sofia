...
Begin VB.Form frm_ac_tipo_compra_venta 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Tipo Compra_Venta"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ac_tipo_compra_venta.frx":0000
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   19
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_tipo_compra_venta.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_ac_tipo_compra_venta.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_ac_tipo_compra_venta.frx":6C860
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_ac_tipo_compra_venta.frx":6CE40
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_ac_tipo_compra_venta.frx":6DB0A
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_ac_tipo_compra_venta.frx":6DD14
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_ac_tipo_compra_venta.frx":6E2D1
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ac_tipo_compra_venta.frx":6E889
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   120
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_ac_tipo_compra_venta.frx":6EA93
      ScaleHeight     =   915
      ScaleWidth      =   12075
      TabIndex        =   15
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_ac_tipo_compra_venta.frx":DAAC5
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_ac_tipo_compra_venta.frx":DACCF
         Style           =   1  'Graphical
         TabIndex        =   16
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_ac_tipo_compra_venta.frx":DAED9
         Height          =   4335
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   End
End
Attribute VB_Name = "frm_ac_tipo_compra_venta"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!venta_tipo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from ac_tipo_compra_venta where venta_tipo = '" & txt_codigo.Text & "'  "
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_tipo_compra_venta.rpt"
