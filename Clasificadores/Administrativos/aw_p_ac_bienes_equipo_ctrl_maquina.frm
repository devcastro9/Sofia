...
Begin VB.Form aw_p_ac_bienes_equipo_ctrl_maquina 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Control de Máquinas"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6495
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":058A
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   20
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6C5BC
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6C7C6
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6C9D0
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6CF88
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6D545
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6D74F
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6E419
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6E9F9
         Style           =   1  'Graphical
         TabIndex        =   3
      ...
      Begin VB.Label lbl_titulo 
         ...
         Caption         =   "EQUIPO (CONTROL MÁQUINAS)"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   15.75
            Charset         =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6F01D
         Height          =   4335
         Left            =   120
         TabIndex        =   26
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6F035
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6F04E
         DataField       =   "pais_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6F067
         DataField       =   "tipo_eqp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6F080
         DataField       =   "tipo_eqp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Control Máquinas"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Control Máquinas"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":6F099
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   21
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":DB0CB
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "aw_p_ac_bienes_equipo_ctrl_maquina.frx":DB2D5
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   765
   ...
   End
End
Attribute VB_Name = "aw_p_ac_bienes_equipo_ctrl_maquina"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!ctrlmaq_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from ac_bienes_equipo_ctrl_maquina where ctrlmaq_codigo = '" & txt_codigo.Text & "'  "
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\ar_equipo_control_maquina.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select * from ac_bienes_equipo_ctrl_maquina  "
