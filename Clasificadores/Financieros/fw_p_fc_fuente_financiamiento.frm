...
Begin VB.Form fw_p_fc_fuente_financiamiento 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Fuentes de Financiamiento"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "fw_p_fc_fuente_financiamiento.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6495
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "fw_p_fc_fuente_financiamiento.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   20
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   6
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6CE48
         Style           =   1  'Graphical
         TabIndex        =   7
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6D400
         Style           =   1  'Graphical
         TabIndex        =   8
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6D9BD
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6DBC7
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6E891
         Style           =   1  'Graphical
         TabIndex        =   4
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":6EE71
         Style           =   1  'Graphical
         TabIndex        =   3
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "fw_p_fc_fuente_financiamiento.frx":6F495
         Height          =   4335
         Left            =   120
         TabIndex        =   26
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Fuentes de Financiamiento"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_codigo 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Código Fuentes de Financiamiento"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "fw_p_fc_fuente_financiamiento.frx":6F4AD
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   21
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":DB4DF
         Style           =   1  'Graphical
         TabIndex        =   11
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "fw_p_fc_fuente_financiamiento.frx":DB6E9
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   120
         Width           =   765
   ...
   End
End
Attribute VB_Name = "fw_p_fc_fuente_financiamiento"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!fte_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
'        Set rs_aux1.DataSource = db.Execute(" EXEC gp_listar_mediante_codigo_gc_direccion_general '" & txt_codigo.Text & "' ")
        ...
        End If
        rs_datos!fte_codigo = var_cod
        rs_datos!ESTADO_codigo = "REG"
'        rs_datos!Correl = 0
     End If
     rs_datos!fte_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub BtnImprimir_Click()
  ...
  cr01.ReportFileName = App.Path & "\REPORTES\clasificadores\fr_fuente_financiamiento.rpt"
  IResult = cr01.PrintReport
  If IResult <> 0 Then
      MsgBox cr01.LastErrorNumber & " : " & cr01.LastErrorString, vbExclamation + vbOKOnly, "Error"
  End If
  cr01.WindowState = crptMaximized
'    MsgBox "No se encuentra habilitado, consulte co el Administrador...", vbExclamation + vbOKOnly, "Error"
End Sub
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from fc_fuente_financiamiento  "
