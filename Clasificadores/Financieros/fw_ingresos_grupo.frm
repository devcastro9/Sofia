...
Begin VB.Form fw_ingresos_grupo 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Grupo Ingresos"
   ClientHeight    =   6510
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   11970
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "fw_ingresos_grupo.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_ingresos_grupo.frx":020A
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   28
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "fw_ingresos_grupo.frx":09C9
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "fw_ingresos_grupo.frx":12DE
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_ingresos_grupo.frx":1A2A
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "fw_ingresos_grupo.frx":225D
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "fw_ingresos_grupo.frx":2A12
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "fw_ingresos_grupo.frx":32DF
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   22
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5040
         Picture         =   "fw_ingresos_grupo.frx":3AA1
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   19
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "fw_ingresos_grupo.frx":4277
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   18
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         ...
         BeginProperty Column02 
            DataField       =   "grupoi_bien_servicio"
            Caption         =   "BB - SS"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.ComboBox txt_bbss 
         ...
         Height          =   315
         ItemData        =   "fw_ingresos_grupo.frx":4B63
         Left            =   360
         List            =   "fw_ingresos_grupo.frx":4B6D
         TabIndex        =   15
         Top             =   3000
         Width           =   2055
      End
   ...
   End
End
Attribute VB_Name = "fw_ingresos_grupo"
...
'        rs_datos.CancelUpdate
      If VAR_SW = "ADD" Then
        db.Execute "delete fc_ingresos_grupo where grupoi_codigo='" & txt_codigo.Text & "'"
      Else
        rs_datos.CancelUpdate
      End If
...
Private Sub BtnEliminar_Click()
      On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!grupoi_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
'        SQL_FOR = "select * from ac_bienes_grupo where grupo_codigo = '" & txt_codigo.Text & "'  "
        SQL_FOR = "select max(grupoi_codigo) as var_mayor from fc_ingresos_grupo"
...
'            var_cod = txt_codigo.Text
           var_cod = "1000"
        End If
        rs_datos!grupoi_codigo = var_cod
        rs_datos!estado_codigo = "REG"
        rs_datos!correlativo_subgrupoi = "0"
'        rs_datos!Correl = 0
     End If
     'rs_datos!dgral_descripcion = Txt_descripcion.Text
     If txt_bbss = "BIENES" Then
        rs_datos!grupoi_bien_servicio = "B"
     Else
        rs_datos!grupoi_bien_servicio = "S"
     End If
     
     rs_datos!grupoi_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!unidad_codigo = " "
     rs_datos!usr_codigo = glusuario
     rs_datos!hora_registro = " "
     rs_datos.UpdateBatch adAffectAll
...
'  End If
  If Txt_descripcion.Text = "" Then
    ...
    Exit Sub
  End If
   If txt_bbss.Text = "" Then
    MsgBox "Debe Seleccionar el " + Label2.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
    Exit Sub
  End If
End Sub
...
Private Sub BtnImprimir_Click()
 Dim iResult As Integer
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\CLASIFICADORES\fr_ingresos_grupo.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select * from fc_ingresos_grupo"
...
Private Function ExisteReg(Unidad As String) As Boolean
 '    INICIO
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM fc_ingresos_rubro WHERE estado_codigo = 'APR' and grupoi_codigo = '" & Unidad & "'"
