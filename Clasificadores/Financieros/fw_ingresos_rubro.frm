...
Begin VB.Form fw_ingresos_rubro 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Clasificadores - Financieros - Rubros de Ingresos"
   ClientHeight    =   6945
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "fw_ingresos_rubro.frx":0000
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   31
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "fw_ingresos_rubro.frx":07C2
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   30
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "fw_ingresos_rubro.frx":108F
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   29
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_ingresos_rubro.frx":1844
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   28
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "fw_ingresos_rubro.frx":2077
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "fw_ingresos_rubro.frx":27C3
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_ingresos_rubro.frx":30D8
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "fw_ingresos_rubro.frx":3897
         Style           =   1  'Graphical
         TabIndex        =   24
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "fw_ingresos_rubro.frx":3CD9
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Index           =   0
         Left            =   5160
         Picture         =   "fw_ingresos_rubro.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   20
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "fw_ingresos_rubro.frx":46B9
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   19
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         ...
         BeginProperty Column05 
            DataField       =   "correlativo_ingresos"
            Caption         =   "correl"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
      ...
      Begin MSAdodcLib.Adodc Ado_datos 
         ...
         Password        =   ""
         RecordSource    =   ""
         Caption         =   " <-- Inicio                        Rubros de Ingresos                          Fin -->"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "fw_ingresos_rubro.frx":4FA5
         ...
         _Version        =   393216
         Style           =   2
         ListField       =   "grupoi_codigo"
         BoundColumn     =   "grupoi_codigo"
         Text            =   "Todos"
      End
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "fw_ingresos_rubro.frx":4FBE
         DataField       =   "grupoi_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
   ...
   End
End
Attribute VB_Name = "fw_ingresos_rubro"
...
Private Sub BtnEliminar_Click()
   On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!rubro_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
''        rs_datos!doc_codigo = RTrim(RTrim(dtc_codigo1.Text) + ".") + LTrim(Str(Val(var_cod)))
        ...
        rs_datos!rubro_codigo = txt_codigo.Text ' Esto para codigos trascritos
        rs_datos!estado_codigo = "REG"  ' no cambia
       ' rs_datos!correl_etapa = 0
       rs_datos!grupoi_codigo = dtc_codigo1.Text   'Codigo del padre
...
'        db.Execute "Update gc_direccion_general Set correl_da = CAST('" & var_cod & "' AS INT) + 1 Where dgral_codigo= '" & dtc_codigo1.Text & "' "
     End If
     rs_datos!rubro_descripcion = Txt_descripcion.Text
    ' rs_datos!grupoi_codigo = dtc_desc1.Text
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\fr_ingreso_rubro.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from fc_ingresos_rubro  "
...
Private Sub ABRIR_TABLAS_AUX()
    ...
    rs_datos1.Open "Select * from fc_ingresos_grupo ", db, adOpenStatic     'order by clasif_descripcion
