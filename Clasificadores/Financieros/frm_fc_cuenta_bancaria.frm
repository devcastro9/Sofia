...
Begin VB.Form frm_fc_cuenta_bancaria 
   BackColor       =   &H00000000&
   ...
   ClientTop       =   345
   ClientWidth     =   14835
   Icon            =   "frm_fc_cuenta_bancaria.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7335
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_fc_cuenta_bancaria.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   14520
      TabIndex        =   36
      Top             =   120
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_fc_cuenta_bancaria.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   44
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_fc_cuenta_bancaria.frx":6D058
         Style           =   1  'Graphical
         TabIndex        =   43
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_fc_cuenta_bancaria.frx":6D638
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_fc_cuenta_bancaria.frx":6E302
         Style           =   1  'Graphical
         TabIndex        =   41
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_fc_cuenta_bancaria.frx":6E50C
         Style           =   1  'Graphical
         TabIndex        =   40
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_fc_cuenta_bancaria.frx":6EAC9
         Style           =   1  'Graphical
         TabIndex        =   39
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_fc_cuenta_bancaria.frx":6F081
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_fc_cuenta_bancaria.frx":6F28B
         Style           =   1  'Graphical
         TabIndex        =   37
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_fc_cuenta_bancaria.frx":6F495
      ScaleHeight     =   915
      ScaleWidth      =   14475
      TabIndex        =   32
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_fc_cuenta_bancaria.frx":DB4C7
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_fc_cuenta_bancaria.frx":DB6D1
         Style           =   1  'Graphical
         TabIndex        =   33
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_fc_cuenta_bancaria.frx":DB8DB
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_fc_cuenta_bancaria.frx":DB8F4
         DataField       =   "bco_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
   ...
   End
End
Attribute VB_Name = "frm_fc_cuenta_bancaria"
