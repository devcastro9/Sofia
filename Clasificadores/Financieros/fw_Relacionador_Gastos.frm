...
Begin VB.Form fw_Relacionador_Gastos 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Clasificadores - Financieros - Relacionador Gastos"
   ClientHeight    =   8040
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   13080
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "fw_Relacionador_Gastos.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   36
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "fw_Relacionador_Gastos.frx":020A
         Style           =   1  'Graphical
         TabIndex        =   35
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_Relacionador_Gastos.frx":064C
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   34
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "fw_Relacionador_Gastos.frx":0E0B
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   33
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "fw_Relacionador_Gastos.frx":1720
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   32
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_Relacionador_Gastos.frx":1E6C
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   31
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "fw_Relacionador_Gastos.frx":269F
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   30
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "fw_Relacionador_Gastos.frx":2E54
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   29
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "fw_Relacionador_Gastos.frx":3721
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   28
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "fw_Relacionador_Gastos.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "fw_Relacionador_Gastos.frx":46B9
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   24
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "fw_Relacionador_Gastos.frx":4FA5
         Height          =   5175
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_Correl5 
         Bindings        =   "fw_Relacionador_Gastos.frx":4FBD
      ...
      Begin MSDataListLib.DataCombo dtc_Correl4 
         Bindings        =   "fw_Relacionador_Gastos.frx":4FD6
      ...
      Begin MSDataListLib.DataCombo dtc_SubCta2_4 
         Bindings        =   "fw_Relacionador_Gastos.frx":4FEF
         DataField       =   "Correl_Deb"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1800
      ...
      Begin MSDataListLib.DataCombo dtc_SubCta2_5 
         Bindings        =   "fw_Relacionador_Gastos.frx":5008
         DataField       =   "Correl_Cred"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1800
      ...
      Begin MSDataListLib.DataCombo dtc_SubCta1_5 
         Bindings        =   "fw_Relacionador_Gastos.frx":5021
         DataField       =   "Correl_Cred"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   960
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "fw_Relacionador_Gastos.frx":503A
         DataField       =   "Codigo_Tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4920
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "fw_Relacionador_Gastos.frx":5053
         DataField       =   "Codigo_Tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "fw_Relacionador_Gastos.frx":506C
         DataField       =   "Correl_Deb"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "fw_Relacionador_Gastos.frx":5085
         DataField       =   "par_codigo_I"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4920
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "fw_Relacionador_Gastos.frx":509E
         DataField       =   "par_codigo_I"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "fw_Relacionador_Gastos.frx":50B7
         DataField       =   "par_codigo_F"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_SubCta1_4 
         Bindings        =   "fw_Relacionador_Gastos.frx":50D0
         DataField       =   "Correl_Deb"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   960
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "fw_Relacionador_Gastos.frx":50E9
         DataField       =   "par_codigo_F"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4920
      ...
      Begin MSDataListLib.DataCombo dtc_Cta_Deb 
         Bindings        =   "fw_Relacionador_Gastos.frx":5102
         DataField       =   "Correl_Deb"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_Cta_Cred 
         Bindings        =   "fw_Relacionador_Gastos.frx":511B
         DataField       =   "Correl_Cred"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "fw_Relacionador_Gastos.frx":5134
         DataField       =   "Correl_Cred"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   120
      ...
      Begin VB.Label lbl_enlace2 
         AutoSize        =   -1  'True
         BackColor       =   &H00C0C0C0&
         Caption         =   "Partida Gastos  Inicial"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00C0C0C0&
         Caption         =   "Denominación Relacionador"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "fw_Relacionador_Gastos"
...
'       rs_datos!org_sigla = Txt_sigla.Text
        ...
        rs_datos!par_codigo_I = dtc_codigo2.Text
        rs_datos!par_codigo_F = dtc_codigo3.Text
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\fr_Relacionador_Gastos.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from fc_relacionador_gastos  "
...
Private Sub ABRIR_TABLAS_AUX()
    ...
    rs_datos2.Open "Select * from fc_partida_gasto order by par_descripcion", db, adOpenStatic
    Set Ado_datos2.Recordset = rs_datos2
    dtc_desc2.BoundText = dtc_codigo2.BoundText
    
    Set rs_datos3 = New ADODB.Recordset
    If rs_datos3.State = 1 Then rs_datos3.Close
    rs_datos3.Open "Select * from fc_partida_gasto order by par_descripcion", db, adOpenStatic
