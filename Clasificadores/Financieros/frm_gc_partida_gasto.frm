...
Begin VB.Form frm_gc_partida_gasto 
   BackColor       =   &H00000000&
   ...
   ClientTop       =   345
   ClientWidth     =   11400
   Icon            =   "frm_gc_partida_gasto.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7695
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_partida_gasto.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   26
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_partida_gasto.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_gc_partida_gasto.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   34
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_gc_partida_gasto.frx":6D262
         Style           =   1  'Graphical
         TabIndex        =   33
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_gc_partida_gasto.frx":6D842
         Style           =   1  'Graphical
         TabIndex        =   32
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_gc_partida_gasto.frx":6E50C
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_gc_partida_gasto.frx":6E716
         Style           =   1  'Graphical
         TabIndex        =   30
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_gc_partida_gasto.frx":6ECD3
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_gc_partida_gasto.frx":6F28B
         Style           =   1  'Graphical
         TabIndex        =   28
         Top             =   120
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_gc_partida_gasto.frx":6F495
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   22
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_gc_partida_gasto.frx":DB4C7
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_gc_partida_gasto.frx":DB6D1
         Style           =   1  'Graphical
         TabIndex        =   23
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_gc_partida_gasto.frx":DB8DB
         DataField       =   "grupo_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4200
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_gc_partida_gasto.frx":DB8F4
         DataField       =   "grupo_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_gc_partida_gasto.frx":DB90D
         DataField       =   "subgrupo_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4200
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_gc_partida_gasto.frx":DB926
         DataField       =   "subgrupo_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
   ...
   End
End
Attribute VB_Name = "frm_gc_partida_gasto"
