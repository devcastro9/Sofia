...
Begin VB.Form frm_rc_motivos_procesos 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Motivos por Procesos"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "frm_rc_motivos_procesos.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6495
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "frm_rc_motivos_procesos.frx":0A02
         Style           =   1  'Graphical
         TabIndex        =   28
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "frm_rc_motivos_procesos.frx":0C0C
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_rc_motivos_procesos.frx":104E
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_rc_motivos_procesos.frx":180D
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_rc_motivos_procesos.frx":2122
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frm_rc_motivos_procesos.frx":286E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "frm_rc_motivos_procesos.frx":30A1
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   22
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "frm_rc_motivos_procesos.frx":3856
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   21
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_rc_motivos_procesos.frx":4123
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   20
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_rc_motivos_procesos.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   17
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_rc_motivos_procesos.frx":50BB
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   16
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_rc_motivos_procesos.frx":59A7
         Height          =   4335
         Left            =   120
         TabIndex        =   12
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Motivo por Proceso"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_rc_motivos_procesos"
...
On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!motivo_codigo) Then
   ...
   Else
      ...
      If sino = vbYes Then
         db.Execute "DELETE rc_motivo_proceso where motivo_codigo = '" & Ado_datos.Recordset!motivo_codigo & "'  "
      End If
   End If
   Call ABRIR_TABLA
   Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from rc_motivo_proceso where motivo_codigo = '" & txt_codigo.Text & "'  "
        ...
        End If
        rs_datos!motivo_codigo = var_cod
        rs_datos!estado_codigo = "REG"
        'rs_datos!CORREL = 0
     End If
     'rs_datos!dgral_descripcion = Txt_descripcion.Text
     rs_datos!motivo_denominacion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\rr_motivo_proceso.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from rc_motivo_proceso"
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM pc_poa_estrategico WHERE motivo_codigo = '" & Unidad & "'"
