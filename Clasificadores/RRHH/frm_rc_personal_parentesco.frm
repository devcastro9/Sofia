...
Begin VB.Form frm_rc_personal_parentesco 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Parentesco"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12390
   Icon            =   "frm_rc_personal_parentesco.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6495
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_rc_personal_parentesco.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   19
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_rc_personal_parentesco.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_rc_personal_parentesco.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_rc_personal_parentesco.frx":6D262
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_rc_personal_parentesco.frx":6D842
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_rc_personal_parentesco.frx":6E50C
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_rc_personal_parentesco.frx":6E716
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_rc_personal_parentesco.frx":6ECD3
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_rc_personal_parentesco.frx":6F28B
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   120
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_rc_personal_parentesco.frx":6F495
      ScaleHeight     =   960
      ScaleWidth      =   12120
      TabIndex        =   15
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_rc_personal_parentesco.frx":DB4C7
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_rc_personal_parentesco.frx":DB6D1
         Style           =   1  'Graphical
         TabIndex        =   16
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         ...
         BeginProperty Column01 
            DataField       =   "parentesco_descripcion"
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación de Parentesco"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_rc_personal_parentesco"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!solicitud_tipo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
'        rs_datos!Correl = 0
     End If
     rs_datos!parentesco_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\clasificadores\rr_personal_parentesco.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select * from rc_personal_parentesco "
