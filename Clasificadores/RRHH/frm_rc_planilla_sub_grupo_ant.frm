...
Begin VB.Form frm_rc_planilla_sub_grupo 
   BackColor       =   &H00000000&
   Caption         =   "Clasificadores - Sub Grupo Planilla"
   ClientHeight    =   9255
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   11280
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   7080
         Picture         =   "frm_rc_planilla_sub_grupo.frx":0000
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   29
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   9720
         Picture         =   "frm_rc_planilla_sub_grupo.frx":08CD
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frm_rc_planilla_sub_grupo.frx":0AD7
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   22
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1545
         Picture         =   "frm_rc_planilla_sub_grupo.frx":1296
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   21
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   3000
         Picture         =   "frm_rc_planilla_sub_grupo.frx":1BAB
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   20
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   4320
         Picture         =   "frm_rc_planilla_sub_grupo.frx":22F7
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   19
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   5760
         Picture         =   "frm_rc_planilla_sub_grupo.frx":2B2A
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   18
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17760
         Picture         =   "frm_rc_planilla_sub_grupo.frx":32DF
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   17
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_descripcion 
         Bindings        =   "frm_rc_planilla_sub_grupo.frx":3AA1
         Height          =   315
         Left            =   1320
         TabIndex        =   32
         Top             =   720
      ...
      Begin MSDataListLib.DataCombo dtc_codigo 
         Bindings        =   "frm_rc_planilla_sub_grupo.frx":3ABA
         DataField       =   "planilla_codigo"
         Height          =   315
         Left            =   360
         TabIndex        =   31
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   4275
         Picture         =   "frm_rc_planilla_sub_grupo.frx":3AD3
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   2880
         Picture         =   "frm_rc_planilla_sub_grupo.frx":43BF
         ScaleHeight     =   615
         ScaleWidth      =   1305
         TabIndex        =   26
         Top             =   0
   ...
   End
End
Attribute VB_Name = "frm_rc_planilla_sub_grupo"
