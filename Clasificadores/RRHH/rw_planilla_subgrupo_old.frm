...
Begin VB.Form rw_planilla_subgrupo 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   15600
         Picture         =   "rw_planilla_subgrupo.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "rw_planilla_subgrupo.frx":0442
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   28
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "rw_planilla_subgrupo.frx":0C01
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "rw_planilla_subgrupo.frx":1516
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   26
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "rw_planilla_subgrupo.frx":1C62
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "rw_planilla_subgrupo.frx":2495
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   24
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "rw_planilla_subgrupo.frx":2C4A
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   23
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "rw_planilla_subgrupo.frx":3517
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   22
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   15960
         Picture         =   "rw_planilla_subgrupo.frx":3CD9
         Style           =   1  'Graphical
         TabIndex        =   30
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "rw_planilla_subgrupo.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   19
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "rw_planilla_subgrupo.frx":47CF
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   18
         Top             =   0
   ...
   End
End
Attribute VB_Name = "rw_planilla_subgrupo"
