...
Begin VB.Form rw_planilla_grupo 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Clasificadores - RRHH - Grupo Planilla"
   ClientHeight    =   9255
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   11280
   Icon            =   "rw_planilla_grupo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10935
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   7080
         Picture         =   "rw_planilla_grupo.frx":0A02
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   29
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   9840
         Picture         =   "rw_planilla_grupo.frx":12CF
         Style           =   1  'Graphical
         TabIndex        =   23
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "rw_planilla_grupo.frx":14D9
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   22
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1545
         Picture         =   "rw_planilla_grupo.frx":1C98
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   21
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   3000
         Picture         =   "rw_planilla_grupo.frx":25AD
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   20
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   4320
         Picture         =   "rw_planilla_grupo.frx":2CF9
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   19
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   5760
         Picture         =   "rw_planilla_grupo.frx":352C
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   18
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17760
         Picture         =   "rw_planilla_grupo.frx":3CE1
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   17
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_descripcion 
         Bindings        =   "rw_planilla_grupo.frx":44A3
         DataField       =   "depto_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1080
      ...
      Begin MSDataListLib.DataCombo dtc_codigo 
         Bindings        =   "rw_planilla_grupo.frx":44BC
         DataField       =   "depto_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label Label1 
         ...
         BackColor       =   &H00000000&
         BackStyle       =   0  'Transparent
         Caption         =   "Departamento de Bolivia"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   4275
         Picture         =   "rw_planilla_grupo.frx":44D5
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   27
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   2880
         Picture         =   "rw_planilla_grupo.frx":4DC1
         ScaleHeight     =   615
         ScaleWidth      =   1305
         TabIndex        =   26
         Top             =   0
   ...
   End
End
Attribute VB_Name = "rw_planilla_grupo"
