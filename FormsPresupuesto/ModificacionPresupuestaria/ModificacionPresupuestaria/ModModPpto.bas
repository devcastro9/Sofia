...
'   Load fMainForm
  ...
  db.Open "Provider=SQLOLEDB.1;Persist Security Info=False;User ID=sa;Initial Catalog=SAF2001;Data Source=sersis;" '
  
  'safpruebas
'  db.Open "Provider=SQLOLEDB.1;Persist Security Info=False;User ID=sa;Initial Catalog=SAFPrueba;Data Source=sersis;"
   SwOrden = True
