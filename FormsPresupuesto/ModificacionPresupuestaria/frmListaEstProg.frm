...
Begin VB.Form frmListaEstProg 
   ...
   Begin VB.CommandButton BtnSalir 
      ...
      Height          =   720
      Left            =   5640
      Picture         =   "frmListaEstProg.frx":0A02
      Style           =   1  'Graphical
      TabIndex        =   2
      Top             =   2880
      Width           =   765
   ...
   Begin VB.CommandButton BtnGrabar 
      ...
      Height          =   720
      Left            =   4875
      Picture         =   "frmListaEstProg.frx":0C0C
      Style           =   1  'Graphical
      TabIndex        =   1
      Top             =   2880
      Width           =   750
   ...
   Begin MSDataGridLib.DataGrid dGrEstProg 
      Bindings        =   "frmListaEstProg.frx":0F16
      Height          =   2610
      Left            =   135
      TabIndex        =   0
      Top             =   165
   ...
   Begin MSAdodcLib.Adodc adoEstrProg 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"frmListaEstProg.frx":0F30
      OLEDBString     =   $"frmListaEstProg.frx":0FBA
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
      Password        =   ""
      RecordSource    =   "fc_estructura_programatica"
      Caption         =   " <-- Inicio                                           Fin -->"
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "MS Sans Serif"
         Size            =   8.25
