...
Begin VB.Form FrmRegularizacion 
   Caption         =   "Registro de Comprobantes - Gestión 2000"
   ClientHeight    =   8310
   ClientLeft      =   135
   ClientTop       =   285
   ClientWidth     =   11880
   ...
   Begin VB.Frame FraBeneficiario 
      ...
      Begin VB.ComboBox CmbTipoBeneficiario 
         Height          =   315
         ItemData        =   "FrmRegularizacion.frx":038A
         Left            =   465
         List            =   "FrmRegularizacion.frx":0394
         TabIndex        =   100
         Top             =   1425
         Width           =   2655
      End
   ...
   Begin VB.Frame FraCopiaRegistro 
      ...
      Begin VB.Frame FraCopiar 
         ...
         Begin VB.TextBox TxtJ 
            ...
            TabIndex        =   138
            Text            =   "FrmRegularizacion.frx":03AD
            Top             =   4935
            Width           =   6660
         End
         ...
         Begin MSDataListLib.DataCombo DtCDRD 
            Bindings        =   "FrmRegularizacion.frx":03B3
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   915
            TabIndex        =   146
         ...
         Begin MSDataListLib.DataCombo DtCDR 
            Bindings        =   "FrmRegularizacion.frx":03CE
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   165
            TabIndex        =   147
         ...
         Begin MSDataListLib.DataCombo DtCOF 
            Bindings        =   "FrmRegularizacion.frx":03E9
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   180
            TabIndex        =   148
         ...
         Begin MSDataListLib.DataCombo DtcC 
            Bindings        =   "FrmRegularizacion.frx":0404
            DataSource      =   "AdoRegularizacion"
            Height          =   288
            Left            =   180
            TabIndex        =   149
         ...
         Begin MSDataListLib.DataCombo DtCFF 
            Bindings        =   "FrmRegularizacion.frx":041F
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   195
            TabIndex        =   150
         ...
         Begin MSDataListLib.DataCombo DtcOFD 
            Bindings        =   "FrmRegularizacion.frx":0437
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   1755
            TabIndex        =   151
         ...
         Begin MSDataListLib.DataCombo DtcCD 
            Bindings        =   "FrmRegularizacion.frx":0452
            DataSource      =   "AdoRegularizacion"
            Height          =   312
            Left            =   1632
            TabIndex        =   152
         ...
         Begin MSDataListLib.DataCombo DtcFFD 
            Bindings        =   "FrmRegularizacion.frx":046E
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   1740
            TabIndex        =   153
         ...
         Begin MSDataListLib.DataCombo DtCUT 
            Bindings        =   "FrmRegularizacion.frx":0486
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   195
            TabIndex        =   154
         ...
         Begin MSDataListLib.DataCombo DtCUTD 
            Bindings        =   "FrmRegularizacion.frx":049E
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   1740
            TabIndex        =   155
         ...
         Begin MSDataListLib.DataCombo DtcConv2 
            Bindings        =   "FrmRegularizacion.frx":04B6
            DataSource      =   "AdoRegularizacion"
            Height          =   312
            Left            =   5520
            TabIndex        =   169
   ...
   Begin VB.Frame FraDetalle 
      ...
      Begin MSDataGridLib.DataGrid DtGDetalle 
         Bindings        =   "FrmRegularizacion.frx":04D1
         Height          =   1248
         Left            =   156
         TabIndex        =   82
         Top             =   240
   ...
   Begin MSDataGridLib.DataGrid DtcRegularizacion 
      Bindings        =   "FrmRegularizacion.frx":04EA
      Height          =   4830
      Left            =   1200
      TabIndex        =   118
      Top             =   1530
   ...
   Begin VB.Frame FraMaestro 
      ...
      Begin MSDataListLib.DataCombo DtcTipoCod 
         Bindings        =   "FrmRegularizacion.frx":050A
         DataField       =   "tipo_formulario"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   2400
      ...
      Begin MSDataListLib.DataCombo DtcDcuDes 
         Bindings        =   "FrmRegularizacion.frx":0520
      ...
      Begin MSDataListLib.DataCombo DtcDcu 
         Bindings        =   "FrmRegularizacion.frx":053B
         DataField       =   "codigo_documento"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   180
      ...
      Begin VB.TextBox TxtJustificacion 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   8
         Text            =   "FrmRegularizacion.frx":0556
         Top             =   4950
         Width           =   6750
      End
      Begin MSDataListLib.DataCombo DtcOrg 
         Bindings        =   "FrmRegularizacion.frx":055C
         DataField       =   "Org_codigo"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo DtcCat 
         Bindings        =   "FrmRegularizacion.frx":0577
      ...
      Begin MSDataListLib.DataCombo DTcFte 
         Bindings        =   "FrmRegularizacion.frx":0592
      ...
      Begin MSDataListLib.DataCombo DtcDesOrg 
         Bindings        =   "FrmRegularizacion.frx":05AA
         DataField       =   "Org_codigo"
         DataSource      =   "AdoRegularizacion"
         Height          =   288
         Left            =   1716
      ...
      Begin MSDataListLib.DataCombo DtcCatDes 
         Bindings        =   "FrmRegularizacion.frx":05C5
         DataField       =   "codigo_categoria"
         DataSource      =   "AdoRegularizacion"
         Height          =   312
         Left            =   1776
      ...
      Begin MSDataListLib.DataCombo DtcFteDes 
         Bindings        =   "FrmRegularizacion.frx":05E1
         DataField       =   "fte_codigo"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   1710
      ...
      Begin MSDataListLib.DataCombo DtCUnidad 
         Bindings        =   "FrmRegularizacion.frx":05F9
      ...
      Begin MSDataListLib.DataCombo DtCDesUnidad 
         Bindings        =   "FrmRegularizacion.frx":0611
         DataField       =   "codigo_unidad"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   1680
      ...
      Begin MSDataListLib.DataCombo DtcTipoDes 
         Bindings        =   "FrmRegularizacion.frx":0629
         DataField       =   "tipo_formulario"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   1380
      ...
      Begin MSDataListLib.DataCombo DtcConv 
         Bindings        =   "FrmRegularizacion.frx":063F
         DataField       =   "codigo_categoria"
         DataSource      =   "AdoRegularizacion"
         Height          =   312
         Left            =   5460
   ...
   Begin VB.Frame FraOpciones 
      ...
      Begin VB.CommandButton CmdAprueba 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":065A
         Style           =   1  'Graphical
         TabIndex        =   122
         Top             =   4245
         Width           =   945
      ...
      Begin VB.CommandButton CmdCopiar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":0A9C
         Style           =   1  'Graphical
         TabIndex        =   108
         Top             =   1590
         Width           =   945
      ...
      Begin VB.CommandButton CmdAdicionar 
         ...
         Left            =   120
         MousePointer    =   4  'Icon
         Picture         =   "FrmRegularizacion.frx":0DA6
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   270
         Width           =   945
      ...
      Begin VB.CommandButton CmdModificar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":11E8
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   930
         Width           =   945
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":162A
         Style           =   1  'Graphical
         TabIndex        =   33
         Top             =   2910
         Width           =   945
      ...
      Begin VB.CommandButton CmdBorrar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":1A6C
         Style           =   1  'Graphical
         TabIndex        =   32
         Top             =   2250
         Width           =   945
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":20D6
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   6330
         Width           =   945
      ...
      Begin VB.CommandButton CmdImprimir 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":2518
         Style           =   1  'Graphical
         TabIndex        =   30
         Top             =   3570
         Width           =   945
      ...
      Begin VB.CommandButton CmdDet 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":2B82
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   4905
         Width           =   945
   ...
   Begin VB.Frame FraOpcionesDetalle 
      ...
      Begin VB.CommandButton CmdBorrarDetalle 
         ...
         Height          =   735
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":2FC4
         Style           =   1  'Graphical
         TabIndex        =   117
         Top             =   2850
         Width           =   945
      ...
      Begin VB.CommandButton CmdModificarDetalle 
         ...
         Height          =   780
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":362E
         Style           =   1  'Graphical
         TabIndex        =   114
         Top             =   1200
         Width           =   960
      ...
      Begin VB.CommandButton CmdGrabaDetalle 
         ...
         Height          =   780
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":3A70
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   2040
         Width           =   960
      ...
      Begin VB.CommandButton CmdAgregarDetalle 
         ...
         Height          =   780
         Left            =   90
         Picture         =   "FrmRegularizacion.frx":3D7A
         Style           =   1  'Graphical
         TabIndex        =   88
         Top             =   375
         Width           =   960
      ...
      Begin VB.CommandButton CmdSalirDetalle 
         ...
         Height          =   780
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":41BC
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   3630
         Width           =   945
   ...
   Begin VB.Frame FraGrabarCancelar 
      ...
      Begin VB.CommandButton CmdCancelar 
         ...
         Height          =   780
         Left            =   60
         Picture         =   "FrmRegularizacion.frx":45FE
         Style           =   1  'Graphical
         TabIndex        =   64
         Top             =   2265
         Width           =   1005
      ...
      Begin VB.CommandButton CmdGrabar 
         ...
         Height          =   810
         Left            =   60
         Picture         =   "FrmRegularizacion.frx":4908
         Style           =   1  'Graphical
         TabIndex        =   63
         Top             =   1380
         Width           =   1005
   ...
   Begin VB.Frame FraDetalleG 
      ...
      Begin VB.Frame FraProyecto 
         ...
         Begin MSDataGridLib.DataGrid DtGProyecto 
            Bindings        =   "FrmRegularizacion.frx":4C12
            Height          =   1620
            Left            =   255
            TabIndex        =   124
            Top             =   240
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo DtcDesCta 
            Bindings        =   "FrmRegularizacion.frx":4C2C
            DataField       =   "cta_codigo"
            DataSource      =   "AdoDetalle"
            Height          =   315
            Left            =   120
         ...
         Begin MSDataListLib.DataCombo DtcCodCta 
            Bindings        =   "FrmRegularizacion.frx":4C44
            DataField       =   "cta_codigo"
            DataSource      =   "AdoDetalle"
            Height          =   315
            Left            =   1200
      ...
      Begin MSDataListLib.DataCombo dtcNombreRuc 
         Bindings        =   "FrmRegularizacion.frx":4C5C
         DataField       =   "codigo_beneficiario"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   2430
      ...
      Begin MSDataListLib.DataCombo dtcRuc 
         Bindings        =   "FrmRegularizacion.frx":4C71
         DataField       =   "codigo_beneficiario"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   660
      ...
      Begin MSDataListLib.DataCombo DtCPartida 
         Bindings        =   "FrmRegularizacion.frx":4C86
         DataField       =   "par_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   1605
      ...
      Begin MSDataListLib.DataCombo DtCPartidaDes 
         Bindings        =   "FrmRegularizacion.frx":4CBE
         DataField       =   "par_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   2955
      ...
      Begin MSDataListLib.DataCombo DtCCuentaOrigen 
         Bindings        =   "FrmRegularizacion.frx":4CD7
         DataField       =   "cta_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   3015
      ...
      Begin MSDataListLib.DataCombo DtCCuentaOrigenDes 
         Bindings        =   "FrmRegularizacion.frx":4CEF
         DataField       =   "cta_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   3945
      ...
      Begin MSDataListLib.DataCombo DtcCtaTGN 
         Bindings        =   "FrmRegularizacion.frx":4D07
         DataField       =   "cta_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   3570
   ...
   If Not AdoRegularizacion.Recordset.EOF And Not AdoRegularizacion.Recordset.BOF And AdoRegularizacion.Recordset.RecordCount > 0 Then
      ...
      With AdoRegularizacion
        ...
        Else
            ...
            mnuAccion(3).Enabled = False
        End If
        'greco no molestes aquí ... que hondas
...
'While Not (recSetAuxcomp1.EOF)
        ...
        " pago_detalle.Ges_Gestion = pagos.Ges_Gestion and pago_detalle.estado_aprobacion ='A'  and pago_detalle.codigo_pago_detalle='" & P_codigo_pago_detalle & "' ", db, adOpenDynamic, adLockOptimistic, adCmdText
...
' Actualizar los Datos en el GRID
    Set rsRegularizacion = New ADODB.Recordset
'    If GlUsuario = "FFL001" Or GlUsuario = "F_FLORES" Or GlUsuario = "F_Flores" Or GlUsuario = "J_CAMACHO" Or GlUsuario = "J_Camacho" Or GlUsuario = "M_YAÑEZ" Then
  ...
  ' VER NOW
   ...
   Else
      ...
      If rsDet.RecordCount > 0 Then
          ...
          'Datos de aprueba
          '      ****************** del detalle
            AdoRegularizacion.Recordset("monto_bolivianos") = Total_MontoBolivianos
            AdoRegularizacion.Recordset("monto_dolares") = Total_MontoDolares
            AdoRegularizacion.Recordset("Deducciones") = Total_Deduccion
            AdoRegularizacion.Recordset("liquido_pagar") = Total_SaldoBolivianos
          '      ****************** del detalle
...
' GABY revisar desde aquí
            ...
            If VARCONTA = "G" Then 'Regularizacion
                Cmd_ContaConf AdoRegularizacion.Recordset!codigo_pago, AdoRegularizacion.Recordset!org_codigo, AdoRegularizacion.Recordset!ges_gestion
                Cmd_Pagado AdoDetalle.Recordset!codigo_pago, AdoDetalle.Recordset!codigo_pago_detalle, AdoDetalle.Recordset!org_codigo, AdoDetalle.Recordset!ges_gestion
            End If
...
Screen.MousePointer = vbHourglass
        ...
        rsRepCab("monto_bolivianos") = IIf(IsNull(AdoRegularizacion.Recordset("monto_bolivianos")), 0, AdoRegularizacion.Recordset("monto_bolivianos"))
        rsRepCab("monto_dolares") = IIf(IsNull(AdoRegularizacion.Recordset("monto_dolares")), 0, AdoRegularizacion.Recordset("monto_dolares"))
        rsRepCab("Deducciones") = IIf(IsNull(AdoRegularizacion.Recordset("Deducciones")), 0, AdoRegularizacion.Recordset("Deducciones"))
        rsRepCab("liquido_pagar") = AdoRegularizacion.Recordset("liquido_pagar")
        LiteralCry = Str(rsRepCab("monto_bolivianos"))
...
'       Wend
      ...
      '-----------
          ...
          While Not rsDetalle.EOF
            ...
            End If
            rsRepDet("monto_total") = rsDetalle("monto_total")
            If AdoRegularizacion.Recordset("monto_bolivianos") = 0 Then
              LiteralCry = Str(rsDetalle("monto_total"))
            End If
            rsRepDet("monto_dolares") = rsDetalle("monto_dolares")
...
'        Cry.Reset
        Cry.ReportFileName = "c:\Saf-2000\FormsPresupuesto\Diseñadores\CrtComprobantePpto.rpt"
...
Private Sub Form_Load()
   ...
   'Ojo por utilización del ado da el error de irowset.
    ...
    Set rsRegularizacion = New ADODB.Recordset
    If rsRegularizacion.State = 1 Then rsRegularizacion.Close
    'If GlUsuario = "FFL001" Or GlUsuario = "F_FLORES" Or GlUsuario = "F_Flores" Or GlUsuario = "J_CAMACHO" Or GlUsuario = "J_Camacho" Or GlUsuario = "M_YAÑEZ" Or GlUsuario = "SAF" Then
        QueryInicial = "select * from pagos where (tipo_comp = 'DAC') and (estado_compromiso='N' or estado_devengado='N' or estado_pagado='N' or estado_reversion_total='N' or estado_devolucion='N' or estado_anulado='N') "
        rsRegularizacion.Open QueryInicial, db, adOpenKeyset, adLockOptimistic
        rsRegularizacion.Sort = "codigo_pago"
        CmdAprueba.Enabled = True
...
Dim RsAux As ADODB.Recordset
  Select Case Index
    ...
    Case 3 ' Anulación
      ...
      RsAux.Close
      'Realiza
      MsgBox "Realizando la Anulación.", vbInformation + vbOKOnly, "Atención"
      swDevolucion = "A"
      TxtTR.Text = "ANL"
      CmdCopiar_Click
  End Select
