...
Begin VB.Form FrmRegularizacion 
   ...
   Begin VB.Frame FraCopiaRegistro 
      ...
      Begin VB.Frame FraCopiar 
         ...
         Begin VB.TextBox TxtJ 
            ...
            TabIndex        =   126
            Text            =   "FrmRegularizacion.frx":038A
            Top             =   4935
            Width           =   6660
         End
         ...
         Begin MSDataListLib.DataCombo DtCDRD 
            Bindings        =   "FrmRegularizacion.frx":0390
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   915
            TabIndex        =   134
         ...
         Begin MSDataListLib.DataCombo DtCDR 
            Bindings        =   "FrmRegularizacion.frx":03AB
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   165
            TabIndex        =   135
         ...
         Begin MSDataListLib.DataCombo DtCOF 
            Bindings        =   "FrmRegularizacion.frx":03C6
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   180
            TabIndex        =   136
         ...
         Begin MSDataListLib.DataCombo DtcC 
            Bindings        =   "FrmRegularizacion.frx":03E1
            DataSource      =   "AdoRegularizacion"
            Height          =   288
            Left            =   180
            TabIndex        =   137
         ...
         Begin MSDataListLib.DataCombo DtCFF 
            Bindings        =   "FrmRegularizacion.frx":03FC
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   195
            TabIndex        =   138
         ...
         Begin MSDataListLib.DataCombo DtcOFD 
            Bindings        =   "FrmRegularizacion.frx":0414
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   1755
            TabIndex        =   139
         ...
         Begin MSDataListLib.DataCombo DtcCD 
            Bindings        =   "FrmRegularizacion.frx":042F
            DataSource      =   "AdoRegularizacion"
            Height          =   312
            Left            =   1632
            TabIndex        =   140
         ...
         Begin MSDataListLib.DataCombo DtcFFD 
            Bindings        =   "FrmRegularizacion.frx":044B
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   1740
            TabIndex        =   141
         ...
         Begin MSDataListLib.DataCombo DtCUT 
            Bindings        =   "FrmRegularizacion.frx":0463
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   195
            TabIndex        =   142
         ...
         Begin MSDataListLib.DataCombo DtCUTD 
            Bindings        =   "FrmRegularizacion.frx":047B
            DataSource      =   "AdoRegularizacion"
            Height          =   315
            Left            =   1740
            TabIndex        =   143
         ...
         Begin MSDataListLib.DataCombo DtcConv2 
            Bindings        =   "FrmRegularizacion.frx":0493
            DataSource      =   "AdoRegularizacion"
            Height          =   312
            Left            =   5520
            TabIndex        =   157
   ...
   Begin VB.Frame FraDetalle 
      ...
      Begin MSDataGridLib.DataGrid DtGDetalle 
         Bindings        =   "FrmRegularizacion.frx":04AE
         Height          =   1245
         Left            =   180
         TabIndex        =   82
         Top             =   240
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   900
         Left            =   -15
         Picture         =   "FrmRegularizacion.frx":04C7
         Stretch         =   -1  'True
         Top             =   0
         Width           =   11900
      End
   ...
   Begin MSDataGridLib.DataGrid DtcRegularizacion 
      Bindings        =   "FrmRegularizacion.frx":137B
      Height          =   4830
      Left            =   1200
      TabIndex        =   107
      Top             =   1530
   ...
   Begin VB.Frame FraMaestro 
      ...
      Begin MSDataListLib.DataCombo DtcTipoCod 
         Bindings        =   "FrmRegularizacion.frx":139B
         DataField       =   "tipo_formulario"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   2400
      ...
      Begin MSDataListLib.DataCombo DtcDcuDes 
         Bindings        =   "FrmRegularizacion.frx":13B1
      ...
      Begin MSDataListLib.DataCombo DtcDcu 
         Bindings        =   "FrmRegularizacion.frx":13CC
         DataField       =   "codigo_documento"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   180
      ...
      Begin VB.TextBox TxtJustificacion 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   8
         Text            =   "FrmRegularizacion.frx":13E7
         Top             =   4950
         Width           =   6750
      End
      Begin MSDataListLib.DataCombo DtcOrg 
         Bindings        =   "FrmRegularizacion.frx":13ED
         DataField       =   "Org_codigo"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo DtcCat 
         Bindings        =   "FrmRegularizacion.frx":1408
      ...
      Begin MSDataListLib.DataCombo DTcFte 
         Bindings        =   "FrmRegularizacion.frx":1423
      ...
      Begin MSDataListLib.DataCombo DtcDesOrg 
         Bindings        =   "FrmRegularizacion.frx":143B
         DataField       =   "Org_codigo"
         DataSource      =   "AdoRegularizacion"
         Height          =   288
         Left            =   1716
      ...
      Begin MSDataListLib.DataCombo DtcCatDes 
         Bindings        =   "FrmRegularizacion.frx":1456
         DataField       =   "codigo_categoria"
         DataSource      =   "AdoRegularizacion"
         Height          =   312
         Left            =   1776
      ...
      Begin MSDataListLib.DataCombo DtcFteDes 
         Bindings        =   "FrmRegularizacion.frx":1472
         DataField       =   "fte_codigo"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   1710
      ...
      Begin MSDataListLib.DataCombo DtCUnidad 
         Bindings        =   "FrmRegularizacion.frx":148A
      ...
      Begin MSDataListLib.DataCombo DtCDesUnidad 
         Bindings        =   "FrmRegularizacion.frx":14A2
         DataField       =   "codigo_unidad"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   1680
      ...
      Begin MSDataListLib.DataCombo DtcTipoDes 
         Bindings        =   "FrmRegularizacion.frx":14BA
         DataField       =   "tipo_formulario"
         DataSource      =   "AdoRegularizacion"
         Height          =   315
         Left            =   1380
      ...
      Begin MSDataListLib.DataCombo DtcConv 
         Bindings        =   "FrmRegularizacion.frx":14D0
         DataField       =   "codigo_categoria"
         DataSource      =   "AdoRegularizacion"
         Height          =   312
         Left            =   5460
   ...
   Begin VB.Frame FraDetalleG 
      ...
      Begin VB.Frame FraProyecto 
         ...
         Begin MSDataGridLib.DataGrid DtGProyecto 
            Bindings        =   "FrmRegularizacion.frx":14EB
            Height          =   1620
            Left            =   255
            TabIndex        =   112
            Top             =   240
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo DtcDesCta 
            Bindings        =   "FrmRegularizacion.frx":1505
            DataField       =   "cta_codigo"
            DataSource      =   "AdoDetalle"
            Height          =   315
            Left            =   120
         ...
         Begin MSDataListLib.DataCombo DtcCodCta 
            Bindings        =   "FrmRegularizacion.frx":151D
            DataField       =   "cta_codigo"
            DataSource      =   "AdoDetalle"
            Height          =   315
            Left            =   1200
      ...
      Begin VB.CommandButton CmdCalculo 
         ...
         Height          =   855
         Left            =   8745
         Picture         =   "FrmRegularizacion.frx":1535
         Style           =   1  'Graphical
         TabIndex        =   86
         Top             =   3525
         Width           =   990
      ...
      Begin MSDataListLib.DataCombo dtcNombreRuc 
         Bindings        =   "FrmRegularizacion.frx":173F
         DataField       =   "codigo_beneficiario"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   2430
      ...
      Begin MSDataListLib.DataCombo dtcRuc 
         Bindings        =   "FrmRegularizacion.frx":1754
         DataField       =   "codigo_beneficiario"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   660
      ...
      Begin MSDataListLib.DataCombo DtCPartida 
         Bindings        =   "FrmRegularizacion.frx":1769
         DataField       =   "par_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   1605
      ...
      Begin MSDataListLib.DataCombo DtCPartidaDes 
         Bindings        =   "FrmRegularizacion.frx":17A1
         DataField       =   "par_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   2955
      ...
      Begin MSDataListLib.DataCombo DtCCuentaOrigen 
         Bindings        =   "FrmRegularizacion.frx":17BA
         DataField       =   "cta_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   3015
      ...
      Begin MSDataListLib.DataCombo DtCCuentaOrigenDes 
         Bindings        =   "FrmRegularizacion.frx":17D2
         DataField       =   "cta_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   3945
      ...
      Begin MSDataListLib.DataCombo DtcCtaTGN 
         Bindings        =   "FrmRegularizacion.frx":17EA
         DataField       =   "cta_codigo"
         DataSource      =   "AdoDetalle"
         Height          =   315
         Left            =   3570
   ...
   Begin VB.Frame FraOpciones 
      ...
      Begin VB.CommandButton CmdAprueba 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":1802
         Style           =   1  'Graphical
         TabIndex        =   111
         Top             =   4260
         Width           =   945
      ...
      Begin VB.CommandButton CmdCopiar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":1A0C
         Style           =   1  'Graphical
         TabIndex        =   98
         Top             =   1590
         Width           =   945
      ...
      Begin VB.CommandButton CmdAdicionar 
         ...
         Left            =   120
         MousePointer    =   4  'Icon
         Picture         =   "FrmRegularizacion.frx":1C16
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   270
         Width           =   945
      ...
      Begin VB.CommandButton CmdModificar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":1F20
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   930
         Width           =   945
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":212A
         Style           =   1  'Graphical
         TabIndex        =   33
         Top             =   2910
         Width           =   945
      ...
      Begin VB.CommandButton CmdBorrar 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":2334
         Style           =   1  'Graphical
         TabIndex        =   32
         Top             =   2250
         Width           =   945
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":2A1E
         Style           =   1  'Graphical
         TabIndex        =   31
         Top             =   6330
         Width           =   945
      ...
      Begin VB.CommandButton CmdImprimir 
         ...
         Height          =   660
         Left            =   120
         Picture         =   "FrmRegularizacion.frx":2C28
         Style           =   1  'Graphical
         TabIndex        =   30
         Top             =   3570
         Width           =   945
      ...
      Begin VB.CommandButton CmdDet 
         ...
         Height          =   660
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":3312
         Style           =   1  'Graphical
         TabIndex        =   29
         Top             =   4905
         Width           =   945
      ...
      Begin VB.Image Image2 
         Height          =   7425
         Left            =   30
         Picture         =   "FrmRegularizacion.frx":3754
         Stretch         =   -1  'True
         Top             =   135
         Width           =   1065
      End
   ...
   Begin VB.Frame FraGrabarCancelar 
      ...
      Begin VB.CommandButton CmdCancelar 
         ...
         Height          =   780
         Left            =   60
         Picture         =   "FrmRegularizacion.frx":4608
         Style           =   1  'Graphical
         TabIndex        =   64
         Top             =   2265
         Width           =   1005
      ...
      Begin VB.CommandButton CmdGrabar 
         ...
         Height          =   810
         Left            =   60
         Picture         =   "FrmRegularizacion.frx":4812
         Style           =   1  'Graphical
         TabIndex        =   63
         Top             =   1380
         Width           =   1005
      ...
      Begin VB.Image Image4 
         Height          =   7365
         Left            =   30
         Picture         =   "FrmRegularizacion.frx":4A1C
         Stretch         =   -1  'True
         Top             =   150
         Width           =   1065
      End
   ...
   Begin VB.Frame FraOpcionesDetalle 
      ...
      Begin VB.CommandButton CmdBorrarDetalle 
         ...
         Height          =   735
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":58D0
         Style           =   1  'Graphical
         TabIndex        =   106
         Top             =   2850
         Width           =   945
      ...
      Begin VB.CommandButton CmdModificarDetalle 
         ...
         Height          =   780
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":5FBA
         Style           =   1  'Graphical
         TabIndex        =   104
         Top             =   1200
         Width           =   960
      ...
      Begin VB.CommandButton CmdGrabaDetalle 
         ...
         Height          =   780
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":61C4
         Style           =   1  'Graphical
         TabIndex        =   89
         Top             =   2040
         Width           =   960
      ...
      Begin VB.CommandButton CmdAgregarDetalle 
         ...
         Height          =   780
         Left            =   90
         Picture         =   "FrmRegularizacion.frx":63CE
         Style           =   1  'Graphical
         TabIndex        =   88
         Top             =   375
         Width           =   960
      ...
      Begin VB.CommandButton CmdSalirDetalle 
         ...
         Height          =   780
         Left            =   105
         Picture         =   "FrmRegularizacion.frx":66D8
         Style           =   1  'Graphical
         TabIndex        =   87
         Top             =   3630
         Width           =   945
      ...
      Begin VB.Image Image3 
         Height          =   7455
         Left            =   30
         Picture         =   "FrmRegularizacion.frx":68E2
         Stretch         =   -1  'True
         Top             =   165
         Width           =   1065
      End
...
If RsDet.RecordCount > 0 Then
  ...
  If rsPpto.RecordCount > 0 Then
     ...
     If AdoRegularizacion.Recordset("estado_compromiso") = "N" Then
      If ((rsPpto("FGS_vigente") - rsPpto("FGS_compromiso") + rsPpto("FGS_acum_rev") + rsPpto("FGS_acum_dev")) < RsDet("monto_total")) Then
        ...
        ' GABY revisar desde aquí
            ...
            If VARCONTA = "V" Then 'Devolucion
              ...
              If rsFGasto.RecordCount > 0 Then
                      ...
                      rsFGasto.Update
              End If
                DevolucionPresup AdoRegularizacion.Recordset!Nro_Comprobante_Anterior, AdoRegularizacion.Recordset!ges_gestion, AdoRegularizacion.Recordset!Org_codigo
...
'        Cry.Reset
        Cry.ReportFileName = App.path & "\FormsPresupuesto\Diseñadores\CrtComprobantePpto.rpt"
    ...
    Case 1 ' Reversión
      ...
      If AdoRegularizacion.Recordset!estado_compromiso = "S" And IsNull(AdoRegularizacion.Recordset!estado_devengado) Then
        ...
        If rsAux!SumaMonto > 0 Then
          ...
          rsAux.Close
          Exit Sub
' porque eres tan gil jorge gvi no j...
        Else
...
db.BeginTrans
   ...
   'End If
    ...
    If Not IsNull(vgMontoTotal) Then RsDet("monto_dolares") = CDbl(vgMontoTotal) / GlTipoCambioOficial Else RsDet("monto_dolares") = CDbl(vgMontoDolares)
