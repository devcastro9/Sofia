...
Begin VB.Form FrmAnulacion 
   Caption         =   "Anulaciones y Devoluciones de Comprobantes - Gestión 2000"
   ClientHeight    =   8310
   ClientLeft      =   135
   ClientTop       =   285
   ClientWidth     =   11880
...
Dim RsAux As ADODB.Recordset
  Select Case Index
    ...
    Case 2 ' Devolución
      If AdoRegularizacion.Recordset!org_codigo = "999" Then
          Dim opt As Integer
          opt = MsgBox("Está seguro de la Devolución del comprobante  " & AdoRegularizacion.Recordset!codigo_pago & "  " & AdoRegularizacion.Recordset!org_codigo & "  ??", vbQuestion + vbYesNo, "ANULACION")
          If opt = vbYes Then
