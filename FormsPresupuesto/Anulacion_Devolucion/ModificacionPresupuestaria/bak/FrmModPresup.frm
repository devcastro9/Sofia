...
Begin VB.Form FrmModPresup 
   ...
   Begin VB.Frame FraModpptoNav 
      ...
      Begin MSDataGridLib.DataGrid DtGIngresos 
         Bindings        =   "FrmModPresup.frx":56F6
         Height          =   5925
         Left            =   60
         TabIndex        =   48
         Top             =   465
   ...
   Begin VB.Frame FraModPresNav 
      ...
      Begin MSDataGridLib.DataGrid Dgrfo_formulacion_gasto 
         Bindings        =   "FrmModPresup.frx":5719
         Height          =   6555
         Left            =   60
         TabIndex        =   130
         Top             =   600
   ...
   Begin VB.Frame FraDatTrans 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin MSDataListLib.DataCombo DtCpar_codigo 
            Bindings        =   "FrmModPresup.frx":10265
            DataField       =   "par_codigo"
         ...
         Begin MSDataListLib.DataCombo DtCPar_descripcion_larga 
            Bindings        =   "FrmModPresup.frx":1029D
         ...
         Begin MSDataListLib.DataCombo DtCFte_codigo 
            Bindings        =   "FrmModPresup.frx":102B6
            DataField       =   "fte_codigo"
            Height          =   315
            Left            =   1590
            TabIndex        =   173
         ...
         Begin MSDataListLib.DataCombo DtCOrg_descripcion 
            Bindings        =   "FrmModPresup.frx":102D4
         ...
         Begin MSDataListLib.DataCombo DtCOrg_codigo 
            Bindings        =   "FrmModPresup.frx":102F6
            DataField       =   "Org_codigo"
            Height          =   315
            Left            =   1590
            TabIndex        =   175
         ...
         Begin MSDataListLib.DataCombo DtCFte_descripcion_larga 
            Bindings        =   "FrmModPresup.frx":10327
      ...
      Begin VB.Frame Framontos 
         ...
         Begin TDBNumberCtrl.TDBNumber Txtfgs_modificacionesT 
            ...
            BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
               ...
               Strikethrough   =   0   'False
            EndProperty
            MouseIcon       =   "FrmModPresup.frx":10346
            MousePointer    =   0
         End
   ...
   Begin VB.Frame FraModpptoDat 
      ...
      Begin VB.ComboBox CmbTipo_modificacion 
         Height          =   315
         ItemData        =   "FrmModPresup.frx":10362
         Left            =   6705
         List            =   "FrmModPresup.frx":10369
         TabIndex        =   13
         Top             =   570
         Width           =   1710
      End
      ...
      Begin VB.Frame FraORI 
         ...
         Begin VB.CommandButton CmdProyecto 
            ...
            Height          =   585
            Left            =   7560
            Picture         =   "FrmModPresup.frx":10376
            Style           =   1  'Graphical
            TabIndex        =   26
         ...
         Begin MSDataListLib.DataCombo DtCpar_codigo_ori 
            Bindings        =   "FrmModPresup.frx":104C0
            Height          =   315
            Left            =   1605
            TabIndex        =   20
            Top             =   1440
         ...
         Begin MSDataListLib.DataCombo DtCPar_descripcion_larga_ori 
            Bindings        =   "FrmModPresup.frx":10505
            Height          =   315
            Left            =   2685
            TabIndex        =   21
            Top             =   1440
         ...
         Begin MSDataListLib.DataCombo DtCFte_codigo_ori 
            Bindings        =   "FrmModPresup.frx":1052B
            Height          =   315
            Left            =   1605
            TabIndex        =   16
            Top             =   630
         ...
         Begin MSDataListLib.DataCombo DtCOrg_descripcion_ori 
            Bindings        =   "FrmModPresup.frx":1054D
            Height          =   315
            Left            =   2685
            TabIndex        =   19
            Top             =   1035
         ...
         Begin MSDataListLib.DataCombo DtCOrg_codigo_ori 
            Bindings        =   "FrmModPresup.frx":10573
            Height          =   315
            Left            =   1605
            TabIndex        =   18
            Top             =   1035
         ...
         Begin MSDataListLib.DataCombo DtCFte_descripcion_larga_ori 
            Bindings        =   "FrmModPresup.frx":105A8
            Height          =   315
            Left            =   2685
            TabIndex        =   17
            Top             =   630
         ...
         Begin MSDataListLib.DataCombo dcbuni_codigo_ori 
            Bindings        =   "FrmModPresup.frx":105CB
            Height          =   315
            Left            =   1590
            TabIndex        =   191
            Top             =   165
      ...
      Begin VB.Frame FraDES 
         ...
         Begin VB.CommandButton Command1 
            ...
            Height          =   585
            Left            =   7560
            Picture         =   "FrmModPresup.frx":105ED
            Style           =   1  'Graphical
            TabIndex        =   73
            ToolTipText     =   "Despliega lista de Proyectos"
            Top             =   1965
         ...
         Begin MSDataListLib.DataCombo DtCpar_codigo_des 
            Bindings        =   "FrmModPresup.frx":10737
            Height          =   315
            Left            =   1605
            TabIndex        =   81
            Top             =   1440
         ...
         Begin MSDataListLib.DataCombo DtCPar_descripcion_larga_des 
            Bindings        =   "FrmModPresup.frx":1077C
            Height          =   315
            Left            =   2685
            TabIndex        =   82
            Top             =   1440
         ...
         Begin MSDataListLib.DataCombo DtCFte_codigo_des 
            Bindings        =   "FrmModPresup.frx":107A2
            DataField       =   "fte_codigo"
            Height          =   315
            Left            =   1605
            TabIndex        =   83
         ...
         Begin MSDataListLib.DataCombo DtCOrg_descripcion_des 
            Bindings        =   "FrmModPresup.frx":107C4
            DataField       =   "Org_descripcion"
            Height          =   315
            Left            =   2685
            TabIndex        =   84
         ...
         Begin MSDataListLib.DataCombo DtCOrg_codigo_des 
            Bindings        =   "FrmModPresup.frx":107EA
            DataField       =   "Org_codigo"
            Height          =   315
            Left            =   1605
            TabIndex        =   85
         ...
         Begin MSDataListLib.DataCombo DtCFte_descripcion_larga_des 
            Bindings        =   "FrmModPresup.frx":1081F
            DataField       =   "Fte_descripcion_larga"
            Height          =   315
            Left            =   2685
            TabIndex        =   86
      ...
      Begin VB.Image Image1 
         Height          =   3405
         Left            =   60
         Picture         =   "FrmModPresup.frx":10842
         Stretch         =   -1  'True
         Top             =   4440
         Width           =   8430
      End
