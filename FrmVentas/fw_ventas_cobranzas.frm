...
Begin VB.Form fw_ventas_cobranzas 
   ...
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ScaleHeight     =   6.5323e6
   ScaleMode       =   0  'User
   ScaleWidth      =   6.57642e7
   WindowState     =   2  'Maximized
   Begin VB.PictureBox FraExtracto 
      BackColor       =   &H00808080&
      FillColor       =   &H00FFFFFF&
      Height          =   2145
      Left            =   3480
      ...
      Begin MSDataListLib.DataCombo DctOrigina18 
         Bindings        =   "fw_ventas_cobranzas.frx":0A02
      ...
      Begin MSDataListLib.DataCombo DctCliente18 
         Bindings        =   "fw_ventas_cobranzas.frx":0A36
         DataField       =   "cmpbte_deposito"
         DataSource      =   "Ado_datos02"
         Height          =   315
         Left            =   5040
      ...
      Begin MSDataListLib.DataCombo DctMonto18 
         Bindings        =   "fw_ventas_cobranzas.frx":0A50
         DataField       =   "cmpbte_deposito"
         DataSource      =   "Ado_datos02"
         Height          =   315
         Left            =   3720
      ...
      Begin VB.PictureBox BtnGrabar2 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "fw_ventas_cobranzas.frx":0A6A
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   90
         Top             =   1200
      ...
      Begin VB.PictureBox BtnCancelar2 
         ...
         Height          =   615
         Left            =   6720
         Picture         =   "fw_ventas_cobranzas.frx":1258
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   89
         Top             =   1200
      ...
      Begin MSDataListLib.DataCombo DctCod18 
         Bindings        =   "fw_ventas_cobranzas.frx":1B44
         DataField       =   "cmpbte_deposito"
         DataSource      =   "Ado_datos02"
         Height          =   315
         Left            =   120
      ...
      Begin MSDataListLib.DataCombo DctFecha18 
         Bindings        =   "fw_ventas_cobranzas.frx":1B5E
         DataField       =   "cmpbte_deposito"
         DataSource      =   "Ado_datos02"
         Height          =   315
         Left            =   2160
   ...
   Begin VB.PictureBox Fra_aux1 
      ...
      Begin VB.PictureBox CmdCancelaDet 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_ventas_cobranzas.frx":1B78
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   78
         Top             =   600
      ...
      Begin VB.PictureBox CmdGrabaDet 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_ventas_cobranzas.frx":2464
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   77
         Top             =   0
      ...
      Begin MSDataListLib.DataCombo DataCombo4 
         Bindings        =   "fw_ventas_cobranzas.frx":2C52
         Height          =   315
         Left            =   1560
         TabIndex        =   76
         Top             =   480
      ...
      Begin MSDataListLib.DataCombo DataCombo3 
         Bindings        =   "fw_ventas_cobranzas.frx":2C6C
         Height          =   315
         Left            =   120
         TabIndex        =   75
         Top             =   480
   ...
   Begin VB.Frame FrmCobros 
      ...
      Begin VB.Frame FrmCobrosDet 
         Appearance      =   0  'Flat
         BackColor       =   &H00C0C0C0&
         Caption         =   $"fw_ventas_cobranzas.frx":2C86
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
         ...
         Begin MSDataListLib.DataCombo dtc_cta2 
            Bindings        =   "fw_ventas_cobranzas.frx":2D17
         ...
         Begin MSDataListLib.DataCombo dtc_ctaDes 
            Bindings        =   "fw_ventas_cobranzas.frx":2D30
            DataField       =   "cta_codigo"
            DataSource      =   "Ado_datos02"
            Height          =   315
            Left            =   2445
         ...
         Begin VB.Label LblCmpbteFecha 
            ...
            BackColor       =   &H80000010&
            BackStyle       =   0  'Transparent
            Caption         =   "Fecha de Cmpbte./Cheque/Transf."
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.PictureBox FraGrabarCancelar 
         ...
         Begin VB.PictureBox BtnCancelar1 
            ...
            Height          =   615
            Left            =   5520
            Picture         =   "fw_ventas_cobranzas.frx":2D49
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   64
            Top             =   0
         ...
         Begin VB.PictureBox BtnGrabar1 
            ...
            Height          =   615
            Left            =   3840
            Picture         =   "fw_ventas_cobranzas.frx":3635
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   67
            Top             =   0
      ...
      Begin VB.ComboBox cmd_moneda 
         ...
         DataSource      =   "Ado_datos02"
         Height          =   315
         ItemData        =   "fw_ventas_cobranzas.frx":3E0B
         Left            =   240
         List            =   "fw_ventas_cobranzas.frx":3E18
         TabIndex        =   1
         Text            =   "BOB"
         Top             =   3400
         Width           =   855
      ...
      Begin MSDataListLib.DataCombo DataCombo8 
         Bindings        =   "fw_ventas_cobranzas.frx":3E2B
      ...
      Begin MSDataListLib.DataCombo DataCombo14 
         Bindings        =   "fw_ventas_cobranzas.frx":3E44
      ...
      Begin MSDataListLib.DataCombo DataCombo1 
         Bindings        =   "fw_ventas_cobranzas.frx":3E5D
      ...
      Begin MSDataListLib.DataCombo DataCombo9 
         Bindings        =   "fw_ventas_cobranzas.frx":3E76
         DataField       =   "trans_codigo"
         DataSource      =   "Ado_datos02"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo DataCombo2 
         Bindings        =   "fw_ventas_cobranzas.frx":3E8F
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos02"
         Height          =   315
         Left            =   1800
      ...
      Begin MSDataListLib.DataCombo DataCombo13 
         Bindings        =   "fw_ventas_cobranzas.frx":3EA8
         DataField       =   "beneficiario_codigo_fac"
         DataSource      =   "Ado_datos02"
         Height          =   315
         Left            =   600
   ...
   Begin VB.Frame FraNavega2 
      ...
      Begin VB.PictureBox fraOpciones1 
         ...
         Begin VB.PictureBox BtnImprimir2 
            ...
            Height          =   615
            Left            =   8160
            Picture         =   "fw_ventas_cobranzas.frx":3EC1
            ScaleHeight     =   615
            ScaleWidth      =   1305
            TabIndex        =   87
         ...
         Begin VB.PictureBox BtnAprobar 
            ...
            Height          =   615
            Left            =   4440
            Picture         =   "fw_ventas_cobranzas.frx":478E
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   79
            ...
            Width           =   1320
         End
         Begin VB.PictureBox BtnAñadir1 
            Appearance      =   0  'Flat
            BackColor       =   &H80000006&
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   615
            Left            =   120
            Picture         =   "fw_ventas_cobranzas.frx":4FC4
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   66
         ...
         Begin VB.PictureBox BtnAprobar1 
            ...
            Height          =   615
            Left            =   3000
            Picture         =   "fw_ventas_cobranzas.frx":5783
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   65
         ...
         Begin VB.PictureBox BtnModificar1 
            ...
            Height          =   615
            Left            =   1440
            Picture         =   "fw_ventas_cobranzas.frx":5FBB
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   63
      ...
      Begin MSDataGridLib.DataGrid dg_datos2 
         Bindings        =   "fw_ventas_cobranzas.frx":68D0
         Height          =   1380
         Left            =   75
         TabIndex        =   24
         Top             =   960
   ...
   Begin VB.Frame FraNavega1 
      ...
      Begin VB.PictureBox fraOpciones0 
         ...
         Begin VB.PictureBox BtnModificar 
            ...
            Height          =   615
            Left            =   11400
            Picture         =   "fw_ventas_cobranzas.frx":68EA
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   71
         ...
         Begin VB.PictureBox BtnSalir1 
            ...
            Height          =   615
            Left            =   17160
            Picture         =   "fw_ventas_cobranzas.frx":71FF
            ScaleHeight     =   615
            ScaleWidth      =   1245
            TabIndex        =   62
         ...
         Begin VB.PictureBox BtnBuscar1 
            ...
            Height          =   615
            Left            =   12840
            Picture         =   "fw_ventas_cobranzas.frx":79C1
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   61
      ...
      Begin MSDataGridLib.DataGrid dg_datos1 
         Bindings        =   "fw_ventas_cobranzas.frx":8176
         Height          =   3780
         Left            =   75
         TabIndex        =   22
         Top             =   840
   ...
   Begin VB.Frame FrmDetalle 
      ...
      Begin MSDataGridLib.DataGrid dg_datos16 
         Bindings        =   "fw_ventas_cobranzas.frx":8190
         Height          =   810
         Left            =   120
         TabIndex        =   14
         Top             =   240
   ...
   Begin VB.Frame FrmCobranza 
      ...
      Begin MSDataGridLib.DataGrid DtGLista 
         Bindings        =   "fw_ventas_cobranzas.frx":81AA
         Height          =   1260
         Left            =   120
         TabIndex        =   15
         Top             =   240
...
Dim swgrabar, swnuevo, deta2, SWCOBRO As Integer
...
Dim VAR_SOL, VAR_TIPOS, VAR_TIPOT As Integer
Dim i As Integer
...
Dim VAR_PROY2, VAR_CTA, VAR_PROY3 As String
...
Dim VAR_DOCC, VAR_CORRELC As String
Dim var_literal, VAR_LITERALDol As String
Dim SW_MODIF As String

Dim codigo_doc As String
Dim Numero As String
Dim Autorizacion As String
Dim AutorizacionRbo As String
...
Private Sub Ado_datos01_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
  If (Not Ado_datos01.Recordset.BOF) And (Not Ado_datos01.Recordset.EOF) Then   'EOF
     'If Not IsNull(Ado_datos01.Recordset("venta_codigo")) Then            'venta_codigo
        Ado_datos01.Caption = Ado_datos01.Recordset.RecordCount
...
'            DTPFechaProg1.backColor = &H404040       '&H80000013      'Fondo Oscuro
        ...
        If (Ado_datos01.Recordset("estado_codigo") = "REG") Then          'REG
            If glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "SQUISPE" Or glusuario = "ASANTIVAÑEZ" Or glusuario = "FCABRERA" Or glusuario = "TCASTILLO" Or glusuario = "FDELGADILLO" Or glusuario = "HMARIN" Or glusuario = "RCUELA" Or glusuario = "GSOLIZ" Or glusuario = "MARTEAGA" Or glusuario = "ULEDESMA" Or glusuario = "EVILLALOBOS" Or glusuario = "LVEDIA" Or glusuario = "JCASTRO" Or glusuario = "CPAREDES" Or glusuario = "APALACIOS" Or glusuario = "RGIL" Or glusuario = "KGARCIA" Or glusuario = "GMORA" Or glusuario = "CSALINAS" Then
                BtnAprobar.Visible = True
            Else
                BtnAprobar.Visible = False
            End If
...
'            If (glusuario = "RVALDIVIEZO" Or glusuario = "ADMIN" Or glusuario = "HBUSTILLOS" Or glusuario = "MVALDIVIA" Or glusuario = "SPAREDES") Or glusuario = "VPAREDES" Or glusuario = "ASANTIVAÑEZ" Then
...
'                If (glusuario = "RVALDIVIEZO" Or glusuario = "ADMIN" Or glusuario = "HBUSTILLOS" Or glusuario = "ASANTIVAÑEZ" Or glusuario = "VPAREDES") Or glusuario = "ASANTIVAÑEZ" Then
'                    BtnAprobar.Visible = True
...
Private Sub BtnAñadir1_Click()
  ...
  'If glusuario = "APALACIOS" Or glusuario = "EMACHICADO" Or glusuario = "IRAMOS" Or glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "TCASTILLO" Or glusuario = "RBUSTILLOS" Or glusuario = "FCABRERA" Or glusuario = "GSOLIZ" Or glusuario = "VPEÑA" Or glusuario = "SQUISPE" Or glusuario = "FDELGADILLO" Or glusuario = "BMONTAÑO" Or glusuario = "CSALINAS" Or glusuario = "SPAREDES" Or glusuario = "GPALLY" Or glusuario = "MMENACHO" Or glusuario = "RCUELA" Or glusuario = "JSOLIZ" Or glusuario = "CESCALANTE" Or glusuario = "EVILLALOBOS" Or glusuario = "FFLORES" Or glusuario = "PRODAS" Or glusuario = "DPANIAGUA" Or glusuario = "MARTEAGA" Or glusuario = "RROMERO" Or glusuario = "CORTEGA" Or glusuario = "DTERCEROS" Or glusuario = "CPLATA" Or glusuario = "AACOSTA" Or glusuario = "CURDININEA" Or glusuario = "CPAREDES" Or glusuario = "ULEDESMA" Or glusuario = "HMARIN" Or glusuario = "RGIL" Or glusuario = "GMORA" Or glusuario = "KGARCIA" Or glusuario = "ASANTIVAÑEZ" Or glusuario = "GFLORES" Then
 
    If (Ado_datos01.Recordset!saldo_bs > 0) Or (glusuario = "ADMIN" Or glusuario = "MVALDIVIA" Or glusuario = "CSALINAS" Or glusuario = "RCUELA" Or glusuario = "RVALDIVIEZO" Or glusuario = "GSOLIZ" Or glusuario = "KGARCIA" Or glusuario = "RPRIETO") Then
        swnuevo = 1
        FrmCobros.Visible = True
    ...
    '    FrmABMDet2.Visible = False
        ...
        NRO_COBR = Ado_datos01.Recordset!cobranza_codigo
        Call AbrirDet
        Ado_datos02.Recordset.AddNew            '.Recordset.AddNew
         ...
         Else
            If Ado_datos02.Recordset("estado_codigo") = "REG" And Ado_datos02.Recordset!estado_codigo_bco = "APR" Then
               ...
               If sino = vbYes Then
                   ...
                   db.Execute "update ao_ventas_cobranza_det set estado_codigo = 'APR',  usr_codigo_apr = '" & glusuario & "', fecha_aprueba = '" & Format(Date, "dd/mm/yyyy") & "', hora_registro = '" & Format(Time, "hh:mm:ss") & "' Where cobranza_codigo = " & NRO_COBR & " and cobranza_detalle = " & VAR_DET & " "
               ...
               End If
            Else
                MsgBox "No se puede APROBAR, verifique los datos y luego, vuelva a intentar !! ", vbExclamation, "Atención!"
            End If
         End If
     Else
        MsgBox "NO existen registros Cobrados para procesar !! ", vbExclamation, "Atención!"
     End If
 Else
    MsgBox "El Usuario NO tiene Acceso, consulte con el Administrador del Sistema ...", , "Atención"
 End If
...
'TRF_DIRECTA_SCZ
         ...
         Else
            ...
            If Ado_datos02.Recordset("estado_codigo_bco") = "REG" Then
               ...
               End If
            Else
                MsgBox "El registro ya fue VERIFICADO... !! ", vbExclamation, "Atención!"
            End If
         End If
     Else
...
Private Sub valida_campos()
    If IsNull(DTPicker1.Value) Or CDate(DTPicker1.Value) = "01/01/1900" Then
        MsgBox "Debe Registrar la Fecha de Recibo de Cobranza, Vuelva a Intentar ...", vbExclamation, "Atención"
        VAR_VAL = "ERR"
        Exit Sub
    End If
    ...
    If (TxtMonto02.Text = "" Or TxtMonto02 = "0" Or TxtMonto02 = "0.00") Then
      'MsgBox "Debe Registrar el " + lbl_monto1.Caption + ", !! Vuelva a Intentar ...", vbExclamation, "Atención"
        MsgBox "Debe Registrar el Monto Cobrado Bs. o Cobrado Dol. !! Vuelva a Intentar ...", vbExclamation, "Atención"
        VAR_VAL = "ERR"
        Exit Sub
    End If
    ...
    If (dtc_cta2.Text = "") Or (dtc_cta2.Text = "NN") Then
        MsgBox "Debe Elegir una Cuenta Bancaria !! Vuelva a Intentar ...", vbExclamation, "Atención"
        VAR_VAL = "ERR"
        Exit Sub
    End If
    If Txt_deposito.Text = "" Then
      MsgBox "Debe Registrar el Comprobante Deposito, Vuelva a Intentar ...", vbExclamation, "Atención"
      VAR_VAL = "ERR"
      Exit Sub
    End If
    If Txt_docnro.Text = "" Then
      MsgBox "Debe Registrar el Nro. de Recibo, Vuelva a Intentar ...", vbExclamation, "Atención"
      VAR_VAL = "ERR"
      Exit Sub
    End If
    If DataCombo1.Text = "" Then
      MsgBox "Debe Registrar el Cobrador CGI, Vuelva a Intentar ...", vbExclamation, "Atención"
      VAR_VAL = "ERR"
      Exit Sub
    End If
    'RONALD     DataCombo1
...
Private Sub BtnGrabar1_Click()
 ...
 If VAR_VAL = "OK" Then
    ...
    Else
        ...
        Else
            VAR_SW2 = "ERR"
            MsgBox "NO se puede registrar un importe Cobrado Mayor al Saldo X Cobrar ...", , "Atención"
        End If
    End If
    If VAR_SW2 = "OK" Then
        db.BeginTrans
        ...
        If cmd_moneda.Text = "BOB" Then
            var_literal = Literal(CStr(COBR_BS)) + " BOLIVIANOS"
        Else
            var_literal = Literal(CStr(VAR_DOL2)) + " DOLARES AMERICANOS"
            'var_literal = "CERO 00/100 BOLIVIANOS"
        End If
        'WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW
        'BORRAR
'        VAR_FECHA2 = Format("04/06/2021", "dd/mm/yyyy")
'        If (Ado_datos01.Recordset!doc_codigo_fac = "R-103" Or Ado_datos01.Recordset!doc_codigo_fac = "R-393") And CDate(DTPicker1.Value) >= CDate(VAR_FECHA2) Then
...
'                        MsgBox "No se puede EMITIR mas RECIBOS, la fecha límite de emisión EXPIRÓ, debe realizar una nueva Dosificación ... ", , "Atención"
'                        Exit Sub
'                    End If
'                    Autorizacion = rs_aux1!dosifica_autorizacion
'                    VAR_COD1 = CDbl(rs_aux1!CORREL) + 1
'                    rs_aux1!CORREL = VAR_COD1
'                    rs_aux1.Update
'                End If
...
'        End If
'        'WWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWWW
'        'Para CONTROL de Recibos pendiente hasta que se habilite dosificacion
...
Private Sub BtnGrabar2_Click()
    Txt_deposito.Text = DctCod18.Text
    DTPFechaCmpbte.Value = Format(CDate(DctFecha18.Text), "DD/MM/YYYY")
    FraExtracto.Visible = False
End Sub
...
Private Sub BtnImprimir2_Click()
    ...
    VAR_CORRELC = Ado_datos02.Recordset!correl_cobro
    VAR_DOCC = Ado_datos01.Recordset!doc_codigo_fac
    ' Genera reporte de recibo
    If Ado_datos02.Recordset.RecordCount > 0 Then
'        If Ado_datos02.Recordset!tipo_moneda = "BOB" Then
'            montoLiteral = Str(TxtMonto02.Text)    'Ado_datos02.Recordset!cobranza_bs          'Monto Bs
'            'VAR_Bs = Ado_datos02.Recordset!cobranza_bs         'Monto Bs
'            montoLiteral = Literal(montoLiteral)
'            var_literal = "BOB. " + TxtMonto02.Text + " (" + montoLiteral + " BOLIVIANOS)"
'        Else
'            'VAR_Dol = Ado_datos02.Recordset!cobranza_bs         'Monto Dolares
'            montoLiteral = Str(TxtMonto02D.Text)       'Ado_datos02.Recordset!cobranza_bs          'Monto Dolares
'            montoLiteral = Literal(montoLiteral)
'            var_literal = "USD. " + TxtMonto02D.Text + " (" + montoLiteral + " DOLARES AMERICANOS)"
'        End If
        'BOB
        montoLiteral = Str(TxtMonto02.Text)    'Ado_datos02.Recordset!cobranza_bs          'Monto Bs
        montoLiteral = Literal(montoLiteral)
        var_literal = "Bs." + TxtMonto02.Text + " (" + montoLiteral + " BOLIVIANOS)"
        'USD
        montoLiteralDol = Str(TxtMonto02D.Text)       'Ado_datos02.Recordset!cobranza_bs          'Monto Dolares
        montoLiteralDol = Literal(montoLiteralDol)
        VAR_LITERALDol = "$US." + TxtMonto02D.Text + " (" + montoLiteralDol + " DOLARES AMERICANOS)"
        ...
        crRecibo.StoredProcParam(0) = VAR_DOCC          '"R-103"                               'lbl_fac.Caption    ' codigo R-103
        crRecibo.StoredProcParam(1) = VAR_CORRELC           'Ado_datos02.Recordset!doc_numero      ' Numero Cobranza Detalle
        crRecibo.StoredProcParam(2) = var_literal                           '"Bs. " + TxtMonto + "(" + montoLiteral + " BOLIVIANOS)" ' monto
        crRecibo.StoredProcParam(3) = VAR_LITERALDol
...
'  If Ado_datos02.Recordset.RecordCount > 0 Then
'    If Ado_datos02.Recordset!estado_codigo_fac = "APR" And Ado_datos02.Recordset!estado_codigo_bco = "REG" And (glusuario = "ASANTIVAÑEZ" Or glusuario = "ADMIN") Then
'        DataCombo2.Locked = False
'    End If
...
'      TxtMonto02.SetFocus
'    Else
'      If Ado_datos02.Recordset!estado_codigo_bco = "APR" And Ado_datos02.Recordset!estado_codigo = "REG" And (glusuario = "ASANTIVAÑEZ" Or glusuario = "ADMIN") Then
'
'          'wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww
'          FraNavega2.Enabled = False
'    '      fraOpciones1.Visible = False
...
'    Call graba_proyecto
    ...
    'If VAR_SW = 1 Then
        ...
        If rstdestino.RecordCount > 0 Then
            ...
            End If
        Else
            MsgBox "NO se puede Procesar, previamente debe Contabilizar el Contrato de este trámite, verifique y vuelva a intentar ...", , "Atención"
            VAR_SW = 0
            Exit Sub
        End If
    'End If
...
Private Sub BtnSalir1_Click()
    ...
    If sino = vbYes Then
        Ado_datos01.Recordset.Close
        Set dg_datos1.DataSource = rsNada
        If rs_datos01.State = 1 Then rs_datos01.Close
        Unload Me
    End If
...
Private Sub CmdGrabaDet_Click()
    ...
    Set dg_datos1.DataSource = Ado_datos01.Recordset
     ...
     'VAR_SW = ""
        rs_datos01.MoveLast
     End If
     MsgBox "Se habilitó el Cobrador exitosamente ...", , "Atención"
     Fra_aux1.Visible = False
End Sub
...
Private Sub DataCombo8_LostFocus()
    ...
    Select Case DataCombo9.Text
        ...
        Case "O"
            LblCmpbte.Caption = "Nro.Cmpbte.Depósito"
            LblCmpbteFecha.Caption = "Fecha Cmpbte.Depósito"
            Call Extracto
        Case "I"
            LblCmpbte.Caption = "Nro.Cmpbte.Respaldo"
            LblCmpbteFecha.Caption = "Fecha Cmpbte.Respaldo"
        Case "E"
...
Private Sub AbrirDet()
    ...
    Set rs_datos02 = New Recordset
        ...
        If rs_datos02.RecordCount > 0 Then
        ...
        Else
            If swnuevo = 1 Then
                ...
                Set dg_datos2.DataSource = Ado_datos02.Recordset
            Else
                'Set rsNada = New Recordset
                'If rsNada.State = 1 Then rsNada.Close
                'Set Ado_datos02.Recordset = rsNada      '.DataSource
                'Set dg_datos2.DataSource = Ado_datos02.Recordset
...
Private Sub Form_Load()
    ...
    'Set rs_datos01 = New Recordset
    'If rs_datos01.State = 1 Then rs_datos01.Close
    'rs_datos01.Open "select * From av_venta_cobranza_REG where (doc_codigo_fac = 'X') ", db, adOpenKeyset, adLockOptimistic
    Set Ado_datos01.Recordset = rsNada  '.DataSource
    Set dg_datos1.DataSource = Ado_datos01.Recordset
    'Call OptFilGral01_Click
    OptFilGral05.Visible = False
    '"JSOLIZ", "EMACHICADO" Or glusuario = "IRAMOS" Or glusuario = "VPAREDES" Or glusuario = "KGARCIA" Or glusuario = "FCABRERA" Or glusuario = "GSOLIZ" Or glusuario = "VPEÑA" Or glusuario = "SQUISPE" Or glusuario = "FDELGADILLO" Or glusuario = "ASANTIVAÑEZ" Or glusuario = "BMONTAÑO" Or glusuario = "MVALDIVIA" Or glusuario = "SPAREDES" Or glusuario = "GPALLY" Or glusuario = "MMENACHO" Or glusuario = "RCUELA" Or glusuario = "BCASTRO" Or glusuario = "CESCALANTE" Or glusuario = "EVILLALOBOS" Or glusuario = "FFLORES" Or glusuario = "PRODAS" Or glusuario = "DPANIAGUA" Or glusuario = "MARTEAGA" Or glusuario = "RROMERO" Or glusuario = "CORTEGA" Or glusuario = "JHERESI" Or glusuario = "DTERCEROS" Or glusuario = "CPLATA" Or glusuario = "MARTEAGA" Or glusuario = "EVILLALOBOS" Or glusuario = "TCASTILLO" Or glusuario = "HMARIN" Or glusuario = "CURDININEA"  Or glusuario = "AACOSTA" Then
    Select Case glusuario
        Case "JSOLIZ", "EMACHICADO", "IRAMOS", "VPAREDES", "VPEÑA", "SQUISPE", "BMONTAÑO", "MVALDIVIA", "SPAREDES", "GPALLY", "MMENACHO", "BCASTRO", "CESCALANTE", "EVILLALOBOS", "FFLORES", "PRODAS", "DPANIAGUA", "RROMERO", "CORTEGA", "JHERESI", "DTERCEROS", "CPLATA", "EVILLALOBOS", "CURDININEA", "AACOSTA", "GFLORES"
            SW_MODIF = "MOD"
            OptFilGral03.Visible = True
            OptFilGral05.Visible = True
        Case "FCABRERA", "FDELGADILLO", "KGARCIA", "ASANTIVAÑEZ", "OPLAZA", "RLAVAYEN", "DGOMEZ"
            SW_MODIF = "MOD"
            OptFilGral03.Visible = True
            OptFilGral05.Visible = True
        Case "TCASTILLO", "HMARIN", "RPRIETO"
            ...
            OptFilGral03.Visible = True
            OptFilGral05.Visible = True
        Case "ULEDESMA", "GMORA", "SQUISPE", "RCUELA", "GSOLIZ", "MARTEAGA", "ADMIN", "APALACIOS", "RGIL", "CPAREDES", "CSALINAS", "LVEDIA", "JCASTRO"
            SW_MODIF = "MOD"
            OptFilGral03.Visible = True
            OptFilGral05.Visible = True
        Case Else
...
'    dtc_desc4A1.BoundText = dtc_codigo4A1.BoundText
    ...
    'rs_datos6.Open "Select * from gc_tipo_transaccion where solicitud_tipo = '14' order by trans_descripcion", db, adOpenStatic
    rs_datos6.Open "Select * from gc_tipo_transaccion where solicitud_tipo = '14' order by trans_descripcion", db, adOpenStatic
...
Private Sub OptFilGral01_Click()
  '===== Proceso para filtrado de registros Facturados
    db.Execute "UPDATE ao_ventas_cabecera SET depto_codigo = LEFT(edif_codigo,1) WHERE LEFT(edif_codigo,1) <> RTRIM(depto_codigo) "
    
    db.Execute "UPDATE ao_ventas_cobranza SET ao_ventas_cobranza.depto_codigo = ao_ventas_cabecera.depto_codigo FROM ao_ventas_cobranza INNER JOIN ao_ventas_cabecera ON ao_ventas_cobranza.venta_codigo = ao_ventas_cabecera.venta_codigo where ao_ventas_cobranza.depto_codigo <> ao_ventas_cabecera.depto_codigo"
    
    db.Execute "UPDATE ao_ventas_cobranza_det SET ao_ventas_cobranza_det.depto_codigo = ao_ventas_cobranza.depto_codigo FROM ao_ventas_cobranza_det INNER JOIN ao_ventas_cobranza ON ao_ventas_cobranza_det.cobranza_codigo = ao_ventas_cobranza.cobranza_codigo where ao_ventas_cobranza.depto_codigo <> ao_ventas_cobranza_det.depto_codigo"
    ...
    If rs_datos01.State = 1 Then rs_datos01.Close
    Select Case glusuario
        Case "ADMIN", "VPAREDES", "APALACIOS", "GSOLIZ", "SQUISPE", "ASANTIVAÑEZ", "RCUELA", "RVALDIVIEZO", "CSALINAS", "JCASTRO"
            BtnAprobar.Visible = True
            BtnModificar.Visible = True
...
'===== Proceso para filtrado general de datos (todos los registros RECIBOS)
    ...
    If rs_datos01.State = 1 Then rs_datos01.Close
    Select Case glusuario
        Case "ADMIN", "VPAREDES", "APALACIOS", "GSOLIZ", "SQUISPE", "ASANTIVAÑEZ", "GSOLIZ", "CPLATA", "DTERCEROS", "RROMERO", "BINFANTE", "RVALDIVIEZO", "CORTEGA", "CSALINAS", "JCASTRO", "DGOMEZ"
            BtnAprobar.Visible = True
            BtnModificar.Visible = True
        ...
        Case Else
            BtnAprobar.Visible = False
            BtnModificar.Visible = False
            queryinicial = "select * From av_venta_cobranza_fac WHERE ((doc_codigo_fac = 'R-103' or doc_codigo_fac = 'R-393') AND beneficiario_codigo_resp = '" & rs_datos9!beneficiario_codigo & "' ) "
    End Select
    rs_datos01.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos01.Sort = "cobranza_fecha_fac desc"
    Set Ado_datos01.Recordset = rs_datos01.DataSource
...
'        If glusuario = "RVALDIVIEZO" Or glusuario = "VPAREDES" Or glusuario = "ASANTIVAÑEZ" Then
