...
Begin VB.Form aw_seguimiento_cobranzas 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   " Procesos Financieros - Tesorería - Seguimiento de Cobranzas"
   ClientHeight    =   10410
   ClientLeft      =   1560
   ClientTop       =   1725
   ClientWidth     =   17115
   Icon            =   "aw_seguimiento_cobranzas.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ScaleHeight     =   1.11659e7
   ScaleMode       =   0  'User
   ScaleWidth      =   2.00425e8
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataGridLib.DataGrid dg_datos06 
         Bindings        =   "aw_seguimiento_cobranzas.frx":0A02
         Height          =   1380
         Left            =   75
         TabIndex        =   18
         Top             =   240
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnImprimir1 
         ...
         Height          =   615
         Left            =   7680
         Picture         =   "aw_seguimiento_cobranzas.frx":0A1C
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   14
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5640
         Picture         =   "aw_seguimiento_cobranzas.frx":12E9
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   13
         ToolTipText     =   "Kardex por Cliente Seleccionado"
         Top             =   0
         Width           =   1400
      End
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "aw_seguimiento_cobranzas.frx":1BB6
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   11
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   3720
         Picture         =   "aw_seguimiento_cobranzas.frx":2378
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   10
         Top             =   0
   ...
   Begin VB.Frame FrmDetalle 
      ...
      Begin MSDataGridLib.DataGrid dg_datos16 
         Bindings        =   "aw_seguimiento_cobranzas.frx":2B2D
         Height          =   930
         Left            =   120
         TabIndex        =   2
         Top             =   240
   ...
   Begin VB.Frame FrmCobranza 
      ...
      Begin MSDataGridLib.DataGrid DtGLista 
         Bindings        =   "aw_seguimiento_cobranzas.frx":2B47
         Height          =   1260
         Left            =   120
         TabIndex        =   3
         Top             =   240
   ...
   End
End
Attribute VB_Name = "aw_seguimiento_cobranzas"
...
Private Sub Ado_datos02_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
  ...
  If (Not Ado_datos02.Recordset.BOF) And (Not Ado_datos02.Recordset.EOF) Then   'EOF
     If Not IsNull(Ado_datos02.Recordset("venta_codigo")) Then            'venta_codigo
        NRO_COBR = Ado_datos02.Recordset!cobranza_codigo
        ...
        Else
           ' TxtDsctoTot2.backColor = &H404040        '&H80000013      'Fondo Oscuro
            ...
            Else
                If (glusuario = "ASANTIVAÑEZ" Or glusuario = "ADMIN" Or glusuario = "CSALINAS" Or glusuario = "RCUELA") Then
...
'  FrmABMDet.Visible = True
'  FrmABMDet2.Visible = True
'    If glusuario = "ASANTIVAÑEZ" Or glusuario = "ADMIN" Then
'        SSTab1.Tab = 0
'        SSTab1.TabEnabled(0) = True
'        SSTab1.TabEnabled(1) = True
'        SSTab1.TabEnabled(2) = True
...
'    fw_seg_cobranza_parametro.lblTipoReporte = ""
...
'            Dim iResult As Variant  ', i%, y%
      'CryF01.ReportFileName = App.Path & "\reportes\ventas\fr_seguimiento_cobranza_kardex.rpt"
      CryF01.ReportFileName = App.Path & "\reportes\ventas\fr_seguimiento_cobranza_kardex_det.rpt"
      CryF01.WindowShowRefreshBtn = True
        If Ado_datos02.Recordset!edif_codigo = "" Then
              CryF01.StoredProcParam(0) = "%"
        Else
              'CryF01.StoredProcParam(0) = cmb_codigoedificio.Text ' para REPORTE POR OPCIONES (PENDIENTE)
              CryF01.StoredProcParam(0) = Ado_datos02.Recordset!edif_codigo
        End If
'      CryF01.StoredProcParam(0) = cmb_codigoedificio.Text
'      CryF01.StoredProcParam(1) = Ado_datos02.Recordset!cobranza_codigo
'      CryF01.Formulas(1) = "literalcobro = '" & montoLiteral & "' "
'      CryF01.Formulas(2) = "correlcobro = '" & Ado_datos02.Recordset!cobranza_codigo & "' "
...
'            Dim iResult As Variant  ', i%, y%
      ...
      CryR01.WindowShowRefreshBtn = True
      CryR01.StoredProcParam(0) = Ado_datos02.Recordset!venta_codigo
      CryR01.StoredProcParam(1) = Ado_datos02.Recordset!cobranza_codigo
...
Private Sub generarRepRecibo()
    ...
    If Label38.Caption <> "" And TxtCmpbte2.Text <> "" And Label38.Caption <> "R-101" Then
        ...
        crRecibo.StoredProcParam(2) = "Bs. " + TxtMonto02.Text + "(" + montoLiteral + " BOLIVIAM)" ' monto
...
Private Sub Form_Load()
    ...
    VAR_SW = 0
    parametro = Aux
    db.Execute "UPDATE  ao_ventas_cabecera SET ao_ventas_cabecera.edif_codigo_corto = gc_edificaciones.edif_codigo_corto FROM ao_ventas_cabecera INNER JOIN gc_edificaciones ON ao_ventas_cabecera.edif_codigo = gc_edificaciones.edif_codigo where (gc_edificaciones.estado_codigo='APR' AND ao_ventas_cabecera.edif_codigo_corto Is Null)"
    mbDataChanged = False
    ...
    If glusuario = "RCUELA" Or glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "CSALINAS" Then
        OptFilGral00.Visible = True
        'SSTab1.Tab = 0
        'SSTab1.TabEnabled(0) = True
        'SSTab1.TabEnabled(1) = True
...
Private Sub OptFilGral05_Click()
  '===== Proceso para filtrado de Potosi
    ...
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '5' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
...
Private Sub OptFilGral06_Click()
  '===== Proceso para filtrado de Tarija
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '6' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
Private Sub OptFilGral01_Click()
  '===== Proceso para filtrado de Chuquisaca
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '1' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
'===== Proceso para filtrado de La Paz
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '2' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
Private Sub OptFilGral03_Click()
    ...
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '3' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
Private Sub OptFilGral04_Click()
    ...
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '4')  "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
'===== Proceso para filtrado de Todos los registros en Cobranzas
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
'                    queryinicial1 = " select cobranza_fecha_sol,edif_codigo, cobranza_codigo, beneficiario_codigo_resp, cobranza_fecha_fac, cobranza_total_bs, cobranza_total_dol, doc_numero, cobranza_nro_factura, estado_codigo_fac, beneficiario_codigo From av_ventas_cobranza WHERE estado_codigo_sol = 'APR' AND estado_codigo_fac = 'REG' "      'ORDER BY cobranza_fecha_prog
...
Private Sub OptFilGral2_Click()
  '===== Proceso para filtrado general de datos (todos los registros )
    ...
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    If glusuario = "ASANTIVAÑEZ" Or glusuario = "CSALINAS" Or glusuario = "RCUELA" Then
...
Private Sub OptFilGral07_Click()
  '===== Proceso para filtrado de Santa Cruz
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '7' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
Private Sub OptFilGral08_Click()
  '===== Proceso para filtrado de Beni
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '8' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
...
Private Sub OptFilGral09_Click()
  '===== Proceso para filtrado de Pando
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    queryinicial2 = " SELECT * FROM av_seguimiento_cobranza WHERE (left(edif_codigo,1) = '9' ) "
    rs_datos02.Open queryinicial2, db, adOpenKeyset, adLockOptimistic
    rs_datos02.Sort = "depto_codigo, cobranza_fecha_fac"
    Set Ado_datos02.Recordset = rs_datos02.DataSource
    Set dg_datos2.DataSource = Ado_datos02.Recordset
