...
Begin VB.Form frm_solicitud_bienes7A 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_solicitud_bienes7A.frx":0000
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   69
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   600
         Picture         =   "frm_solicitud_bienes7A.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   71
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   2040
         MaskColor       =   &H00000000&
         Picture         =   "frm_solicitud_bienes7A.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   70
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox Txt_campo10 
            ...
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   285
            Left            =   240
            TabIndex        =   48
            Text            =   "1"
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C446
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C45F
            DataField       =   "unimed_codigo"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   315
            Left            =   2520
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C478
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C491
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C4AA
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C4C3
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C4DC
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C4F5
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C50E
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle7"
            Height          =   315
            Left            =   6720
            TabIndex        =   65
            Top             =   2160
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "frm_solicitud_bienes7A.frx":6C527
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
            Height          =   315
            Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "frm_solicitud_bienes7A.frx":6C540
         DataField       =   "bien_codigo"
         DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
         Height          =   315
         Left            =   8400
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "frm_solicitud_bienes7A.frx":6C559
         DataField       =   "bien_codigo"
         DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_solicitud_bienes7A.frx":6C572
         DataField       =   "bien_codigo"
         DataSource      =   "fw_solicitud_servicio_basico.ado_detalle2"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "frm_solicitud_bienes7A"
...
Private Sub BtnCancelar_Click()
  On Error Resume Next
   ...
   If sino = vbYes Then
        fw_solicitud_servicio_basico.Ado_detalle2.Recordset.CancelUpdate
