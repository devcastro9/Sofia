...
Begin VB.Form frm_ao_solicitud_servicio_basico 
   ...
   Begin VB.PictureBox FrmABMDet2 
      ...
      Begin VB.CommandButton Command4 
         ...
         Height          =   640
         Left            =   980
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton BtnAnlDetalle2 
         ...
         Height          =   640
         Left            =   120
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":6E1B6
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton BtnModDetalle2 
         ...
         Height          =   640
         Left            =   980
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":6E5F8
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton BtnAddDetalle2 
         ...
         Height          =   640
         Left            =   120
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":6EA3A
         Style           =   1  'Graphical
         TabIndex        =   70
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Height          =   1490
      Left            =   120
      Picture         =   "frm_ao_solicitud_servicio_basico.frx":6EE7C
      ScaleHeight     =   1425
      ScaleWidth      =   1875
      TabIndex        =   64
      Top             =   7080
      ...
      Begin VB.CommandButton BtnImprimir1 
         ...
         Height          =   640
         Left            =   980
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":DAEAE
         Style           =   1  'Graphical
         TabIndex        =   68
         ToolTipText     =   "Imprime Nota de Venta"
         Top             =   740
      ...
      Begin VB.CommandButton BtnAddDetalle 
         ...
         Height          =   640
         Left            =   120
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":DC630
         Style           =   1  'Graphical
         TabIndex        =   67
         ToolTipText     =   "Adiciona Detalle"
         Top             =   60
      ...
      Begin VB.CommandButton BtnModDetalle 
         ...
         Height          =   640
         Left            =   980
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":DCA72
         Style           =   1  'Graphical
         TabIndex        =   66
         ToolTipText     =   "Modifica Detalle Elegido"
         Top             =   60
      ...
      Begin VB.CommandButton BtnAnlDetalle 
         ...
         Height          =   640
         Left            =   120
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":DCEB4
         Style           =   1  'Graphical
         TabIndex        =   65
         ToolTipText     =   "Elimina Detalle Elegido"
         Top             =   740
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_ao_solicitud_servicio_basico.frx":DD2F6
      ScaleHeight     =   960
      ScaleWidth      =   14835
      TabIndex        =   49
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":149328
         Style           =   1  'Graphical
         TabIndex        =   50
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":149532
         Style           =   1  'Graphical
         TabIndex        =   58
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":149974
         Style           =   1  'Graphical
         TabIndex        =   57
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":149B7E
         Style           =   1  'Graphical
         TabIndex        =   56
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":14A136
         Style           =   1  'Graphical
         TabIndex        =   55
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   6000
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":14A6F3
         Style           =   1  'Graphical
         TabIndex        =   54
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":14A8FD
         Style           =   1  'Graphical
         TabIndex        =   53
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":14B5C7
         Style           =   1  'Graphical
         TabIndex        =   52
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":14BBA7
         Style           =   1  'Graphical
         TabIndex        =   51
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_ao_solicitud_servicio_basico.frx":14C1CB
      ScaleHeight     =   915
      ScaleWidth      =   14835
      TabIndex        =   60
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":1B81FD
         Style           =   1  'Graphical
         TabIndex        =   62
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_ao_solicitud_servicio_basico.frx":1B8407
         Style           =   1  'Graphical
         TabIndex        =   61
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B8611
         Height          =   1215
         Left            =   195
         TabIndex        =   45
         Top             =   240
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B862C
         Height          =   1215
         Left            =   195
         TabIndex        =   24
         Top             =   240
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B8647
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B8661
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3600
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B867A
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B8693
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B86AD
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6960
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B86C6
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4560
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B86DF
         DataField       =   "solicitud_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4395
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B86F8
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1665
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B8711
         DataField       =   "poa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1920
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B872B
         DataField       =   "beneficiario_codigo_resp2"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_ao_solicitud_servicio_basico.frx":1B8745
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1440
