...
Begin VB.Form ao_solicitud_fondos 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "ao_solicitud_fondos.frx":0000
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   69
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   600
         Picture         =   "ao_solicitud_fondos.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   71
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   2040
         MaskColor       =   &H00000000&
         Picture         =   "ao_solicitud_fondos.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   70
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox Txt_campo10 
            ...
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   285
            Left            =   240
            TabIndex        =   48
            Text            =   "1"
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "ao_solicitud_fondos.frx":6C446
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "ao_solicitud_fondos.frx":6C45F
            DataField       =   "unimed_codigo"
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   315
            Left            =   2520
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "ao_solicitud_fondos.frx":6C478
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "ao_solicitud_fondos.frx":6C491
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "ao_solicitud_fondos.frx":6C4AA
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "ao_solicitud_fondos.frx":6C4C3
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "ao_solicitud_fondos.frx":6C4DC
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "ao_solicitud_fondos.frx":6C4F5
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "ao_solicitud_fondos.frx":6C50E
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "fw_solicitud_fondos.ado_detalle7"
            Height          =   315
            Left            =   6720
            TabIndex        =   65
            Top             =   2160
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "ao_solicitud_fondos.frx":6C527
            DataField       =   "bien_codigo"
            DataSource      =   "fw_solicitud_fondos.ado_detalle2"
            Height          =   315
            Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "ao_solicitud_fondos.frx":6C540
         DataField       =   "bien_codigo"
         DataSource      =   "fw_solicitud_fondos.ado_detalle2"
         Height          =   315
         Left            =   8400
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "ao_solicitud_fondos.frx":6C559
         DataField       =   "bien_codigo"
         DataSource      =   "fw_solicitud_fondos.ado_detalle2"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "ao_solicitud_fondos.frx":6C572
         DataField       =   "bien_codigo"
         DataSource      =   "fw_solicitud_fondos.ado_detalle2"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "ao_solicitud_fondos"
...
Private Sub BtnCancelar_Click()
  On Error Resume Next
   ...
   If sino = vbYes Then
        fw_solicitud_fondos.Ado_detalle2.Recordset.CancelUpdate
...
Private Sub BtnGrabar_Click()
  ...
  Call valida_campos
 If VAR_VAL = "OK" Then
     If lbl_det.Caption = "30000" Or lbl_det.Caption = "20000" Or lbl_det.Caption = "22000" Then
         If swnuevo = 1 Then
            fw_solicitud_fondos.Ado_detalle2.Recordset("ges_gestion").Value = glGestion
            fw_solicitud_fondos.Ado_detalle2.Recordset("unidad_codigo").Value = txt_campo1.Caption
            fw_solicitud_fondos.Ado_detalle2.Recordset("solicitud_codigo").Value = txt_codigo.Caption
            fw_solicitud_fondos.Ado_detalle2.Recordset("estado_codigo").Value = "REG"
            fw_solicitud_fondos.Ado_detalle2.Recordset("venta_o_compra").Value = "V"
    '        frm_to_identificacion_cliente.Ado_detalle3.Recordset("archivo_foto_cargado").Value = "N"
    '        frm_to_identificacion_cliente.Ado_detalle3.Recordset("archivo_plano_cargado").Value = "N"
         End If
            If var_val2 = "1" Then
                frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_codigo").Value = IIf(Txt_campo5.Text = "", "NA1", Txt_campo5.Text)
                frm_to_identificacion_cliente.Ado_detalle3.Recordset("marca_codigo").Value = IIf(Txt_campo8.Text = "", "S/M", Txt_campo8.Text)
                frm_to_identificacion_cliente.Ado_detalle3.Recordset("modelo_codigo").Value = IIf(Txt_campo9.Text = "", "S/M", Txt_campo9.Text)
            Else
                'OJO FALTA GRABAR EN ac_bienes
                fw_solicitud_fondos.Ado_detalle2.Recordset("bien_codigo").Value = IIf(dtc_codigo1.Text = "", "NA1", dtc_codigo1.Text)
                fw_solicitud_fondos.Ado_detalle2.Recordset("marca_codigo").Value = IIf(Txt_campo2.Text = "", "S/M", Txt_campo2.Text)
                fw_solicitud_fondos.Ado_detalle2.Recordset("modelo_codigo").Value = IIf(Txt_campo3.Text = "", "S/M", Txt_campo3.Text)
            End If
            fw_solicitud_fondos.Ado_detalle2.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "20000", dtc_aux1.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "24000", dtc_aux2.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "24300", dtc_aux3.Text)
            ...
            Else
                ...
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            End If
            fw_solicitud_fondos.Ado_detalle2.Recordset("bien_precio_venta_base").Value = IIf(Txt_campo10 = "", 0, Txt_campo10)
            fw_solicitud_fondos.Ado_detalle2.Recordset("unimed_codigo").Value = IIf(dtc_codigo2 = "", "MES", dtc_codigo2)
            fw_solicitud_fondos.Ado_detalle2.Recordset("bien_cantidad").Value = IIf(Txt_campo16 = "", 1, Txt_campo16)
            fw_solicitud_fondos.Ado_detalle2.Recordset("bien_total_venta").Value = IIf(Txt_campo11 = "", 0, Txt_campo11)
            fw_solicitud_fondos.Ado_detalle2.Recordset("bien_precio_compra").Value = 0
            fw_solicitud_fondos.Ado_detalle2.Recordset("bien_total_compra").Value = 0
            
            fw_solicitud_fondos.Ado_detalle2.Recordset("fosa_dimension_frente").Value = IIf(dtc_codigo5.Text = "", 7, dtc_codigo5.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset("fosa_dimension_fondo").Value = 0  'Txt_campo15.Text
            ...
            fw_solicitud_fondos.Ado_detalle2.Recordset("fecha_registro").Value = Date
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("hora_registro").Value = Date
            fw_solicitud_fondos.Ado_detalle2.Recordset("usr_codigo").Value = glusuario
            fw_solicitud_fondos.Ado_detalle2.Recordset.UpdateBatch adAffectAll
     End If
     If lbl_det.Caption = "39800" Then
         If swnuevo = 1 Then
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("ges_gestion").Value = glGestion
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("unidad_codigo").Value = txt_campo1.Caption
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("solicitud_codigo").Value = txt_codigo.Caption
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("estado_codigo").Value = "REG"
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("venta_o_compra").Value = "V"
    '        frm_to_identificacion_cliente.Ado_detalle3.Recordset("archivo_foto_cargado").Value = "N"
    '        frm_to_identificacion_cliente.Ado_detalle3.Recordset("archivo_plano_cargado").Value = "N"
         End If
            If var_val2 = "1" Then
                frm_to_identificacion_cliente.Ado_detalle5.Recordset("bien_codigo").Value = IIf(Txt_campo5.Text = "", "NA1", Txt_campo5.Text)
                frm_to_identificacion_cliente.Ado_detalle5.Recordset("marca_codigo").Value = IIf(Txt_campo8.Text = "", "S/M", Txt_campo8.Text)
                frm_to_identificacion_cliente.Ado_detalle5.Recordset("modelo_codigo").Value = IIf(Txt_campo9.Text = "", "S/M", Txt_campo9.Text)
            Else
                'OJO FALTA GRABAR EN ac_bienes
                frm_to_identificacion_cliente.Ado_detalle5.Recordset("bien_codigo").Value = IIf(dtc_codigo1.Text = "", "NA1", dtc_codigo1.Text)
                frm_to_identificacion_cliente.Ado_detalle5.Recordset("marca_codigo").Value = IIf(Txt_campo2.Text = "", "S/M", Txt_campo2.Text)
                frm_to_identificacion_cliente.Ado_detalle5.Recordset("modelo_codigo").Value = IIf(Txt_campo3.Text = "", "S/M", Txt_campo3.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "30000", dtc_aux1.Text)
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "39000", dtc_aux2.Text)
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "39810", dtc_aux3.Text)
            If Txt_campo16.Text <> "" Then
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            Else
                Txt_campo16.Text = 1
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("bien_precio_venta_base").Value = IIf(Txt_campo10 = "", 0, Txt_campo10)
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("unimed_codigo").Value = IIf(dtc_codigo2 = "", "MES", dtc_codigo2)
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("bien_cantidad").Value = IIf(Txt_campo16 = "", 1, Txt_campo16)
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("bien_total_venta").Value = IIf(Txt_campo11 = "", 0, Txt_campo11)
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("bien_precio_compra").Value = 0
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("bien_total_compra").Value = 0
            
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("fosa_dimension_frente").Value = IIf(dtc_codigo5.Text = "", 7, dtc_codigo5.Text)
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("fosa_dimension_fondo").Value = 0  'Txt_campo15.Text
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("archivo_foto").Value = Trim(dtc_codigo1.Text) + "-A.JPG"
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("archivo_plano").Value = Trim(dtc_codigo1.Text) + "-B.JPG"
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("fecha_registro").Value = Date
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("hora_registro").Value = Date
            frm_to_identificacion_cliente.Ado_detalle5.Recordset("usr_codigo").Value = glusuario
            frm_to_identificacion_cliente.Ado_detalle5.Recordset.UpdateBatch adAffectAll
    End If
    If lbl_det.Caption = "34800" Then
         If swnuevo = 1 Then
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("ges_gestion").Value = glGestion
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("unidad_codigo").Value = txt_campo1.Caption
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("solicitud_codigo").Value = txt_codigo.Caption
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("estado_codigo").Value = "REG"
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("venta_o_compra").Value = "V"
    '        frm_to_identificacion_cliente.Ado_detalle6.Recordset("archivo_foto_cargado").Value = "N"
    '        frm_to_identificacion_cliente.Ado_detalle6.Recordset("archivo_plano_cargado").Value = "N"
         End If
            If var_val2 = "1" Then
                frm_to_identificacion_cliente.Ado_detalle6.Recordset("bien_codigo").Value = IIf(Txt_campo5.Text = "", "NA1", Txt_campo5.Text)
                frm_to_identificacion_cliente.Ado_detalle6.Recordset("marca_codigo").Value = IIf(Txt_campo8.Text = "", "S/M", Txt_campo8.Text)
                frm_to_identificacion_cliente.Ado_detalle6.Recordset("modelo_codigo").Value = IIf(Txt_campo9.Text = "", "S/M", Txt_campo9.Text)
            Else
                'OJO FALTA GRABAR EN ac_bienes
                frm_to_identificacion_cliente.Ado_detalle6.Recordset("bien_codigo").Value = IIf(dtc_codigo1.Text = "", "NA1", dtc_codigo1.Text)
                frm_to_identificacion_cliente.Ado_detalle6.Recordset("marca_codigo").Value = IIf(Txt_campo2.Text = "", "S/M", Txt_campo2.Text)
                frm_to_identificacion_cliente.Ado_detalle6.Recordset("modelo_codigo").Value = IIf(Txt_campo3.Text = "", "S/M", Txt_campo3.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "90000", dtc_aux1.Text)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "99900", dtc_aux2.Text)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "99990", dtc_aux3.Text)
            If Txt_campo16.Text <> "" Then
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            Else
                Txt_campo16.Text = 1
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("bien_precio_venta_base").Value = IIf(Txt_campo10 = "", 0, Txt_campo10)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("unimed_codigo").Value = IIf(dtc_codigo2 = "", "MES", dtc_codigo2)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("bien_cantidad").Value = IIf(Txt_campo16 = "", 1, Txt_campo16)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("bien_total_venta").Value = IIf(Txt_campo11 = "", 0, Txt_campo11)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("bien_precio_compra").Value = 0
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("bien_total_compra").Value = 0
            
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("fosa_dimension_frente").Value = IIf(dtc_codigo5.Text = "", 7, dtc_codigo5.Text)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("fosa_dimension_fondo").Value = 0  'Txt_campo15.Text
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("archivo_foto").Value = Trim(dtc_codigo1.Text) + "-A.JPG"
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("archivo_plano").Value = Trim(dtc_codigo1.Text) + "-B.JPG"
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("fecha_registro").Value = Date
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("hora_registro").Value = Date
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("usr_codigo").Value = glusuario
            frm_to_identificacion_cliente.Ado_detalle6.Recordset.UpdateBatch adAffectAll
    End If
    If lbl_det.Caption = "24300" Then
         If swnuevo = 1 Then
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("ges_gestion").Value = glGestion
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("unidad_codigo").Value = txt_campo1.Caption
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("solicitud_codigo").Value = txt_codigo.Caption
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("estado_codigo").Value = "REG"
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("venta_o_compra").Value = "V"
    '        frm_to_identificacion_cliente.Ado_detalle6.Recordset("archivo_foto_cargado").Value = "N"
    '        frm_to_identificacion_cliente.Ado_detalle6.Recordset("archivo_plano_cargado").Value = "N"
         End If
            If var_val2 = "1" Then
                frm_to_identificacion_cliente.Ado_detalle7.Recordset("bien_codigo").Value = IIf(Txt_campo5.Text = "", "NA1", Txt_campo5.Text)
                frm_to_identificacion_cliente.Ado_detalle7.Recordset("marca_codigo").Value = IIf(Txt_campo8.Text = "", "S/M", Txt_campo8.Text)
                frm_to_identificacion_cliente.Ado_detalle7.Recordset("modelo_codigo").Value = IIf(Txt_campo9.Text = "", "S/M", Txt_campo9.Text)
            Else
                'OJO FALTA GRABAR EN ac_bienes
                frm_to_identificacion_cliente.Ado_detalle7.Recordset("bien_codigo").Value = IIf(dtc_codigo1.Text = "", "NA1", dtc_codigo1.Text)
                frm_to_identificacion_cliente.Ado_detalle7.Recordset("marca_codigo").Value = IIf(Txt_campo2.Text = "", "S/M", Txt_campo2.Text)
                frm_to_identificacion_cliente.Ado_detalle7.Recordset("modelo_codigo").Value = IIf(Txt_campo3.Text = "", "S/M", Txt_campo3.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "20000", dtc_aux1.Text)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "24000", dtc_aux2.Text)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "24300", dtc_aux3.Text)
            If Txt_campo16.Text <> "" Then
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            Else
                Txt_campo16.Text = 1
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("bien_precio_venta_base").Value = IIf(Txt_campo10 = "", 0, Txt_campo10)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("unimed_codigo").Value = IIf(dtc_codigo2 = "", "MES", dtc_codigo2)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("bien_cantidad").Value = IIf(Txt_campo16 = "", 1, Txt_campo16)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("bien_total_venta").Value = IIf(Txt_campo11 = "", 0, Txt_campo11)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("bien_precio_compra").Value = 0
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("bien_total_compra").Value = 0
            
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("fosa_dimension_frente").Value = IIf(dtc_codigo5.Text = "", 7, dtc_codigo5.Text)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("fosa_dimension_fondo").Value = 0  'Txt_campo15.Text
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("archivo_foto").Value = Trim(dtc_codigo1.Text) + "-A.JPG"
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("archivo_plano").Value = Trim(dtc_codigo1.Text) + "-B.JPG"
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("fecha_registro").Value = Date
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("hora_registro").Value = Date
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("usr_codigo").Value = glusuario
            frm_to_identificacion_cliente.Ado_detalle7.Recordset.UpdateBatch adAffectAll
    End If
    If lbl_det.Caption = "21000" Then
         If swnuevo = 1 Then
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("ges_gestion").Value = glGestion
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("unidad_codigo").Value = txt_campo1.Caption
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("solicitud_codigo").Value = txt_codigo.Caption
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("estado_codigo").Value = "REG"
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("venta_o_compra").Value = "C"
    ...
    '        frm_ao_solicitud_servicio_basico.Ado_detalle6.Recordset("archivo_plano_cargado").Value = "N"
         End If
            If var_val2 = "1" Then
                fw_solicitud_servicio_basico.Ado_detalle2.Recordset("bien_codigo").Value = IIf(Txt_campo5.Text = "", "NA1", Txt_campo5.Text)
                fw_solicitud_servicio_basico.Ado_detalle2.Recordset("marca_codigo").Value = IIf(Txt_campo8.Text = "", "S/M", Txt_campo8.Text)
                fw_solicitud_servicio_basico.Ado_detalle2.Recordset("modelo_codigo").Value = IIf(Txt_campo9.Text = "", "S/M", Txt_campo9.Text)
            Else
                'OJO FALTA GRABAR EN ac_bienes
                fw_solicitud_servicio_basico.Ado_detalle2.Recordset("bien_codigo").Value = IIf(dtc_codigo1.Text = "", "NA1", dtc_codigo1.Text)
                fw_solicitud_servicio_basico.Ado_detalle2.Recordset("marca_codigo").Value = IIf(Txt_campo2.Text = "", "S/M", Txt_campo2.Text)
                fw_solicitud_servicio_basico.Ado_detalle2.Recordset("modelo_codigo").Value = IIf(Txt_campo3.Text = "", "S/M", Txt_campo3.Text)
            End If
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "20000", dtc_aux1.Text)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "24000", dtc_aux2.Text)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "24300", dtc_aux3.Text)
            If Txt_campo16.Text <> "" Then
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            Else
                Txt_campo16.Text = 1
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            End If
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("bien_precio_compra").Value = IIf(Txt_campo10 = "", 0, Txt_campo10)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("unimed_codigo").Value = IIf(dtc_codigo2 = "", "MES", dtc_codigo2)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("bien_cantidad").Value = IIf(Txt_campo16 = "", 1, Txt_campo16)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("bien_total_compra").Value = IIf(Txt_campo11 = "", 0, Txt_campo11)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("bien_precio_venta_base").Value = 0
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("bien_total_venta").Value = 0
            
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("fosa_dimension_frente").Value = IIf(dtc_codigo5.Text = "", 1, dtc_codigo5.Text)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("fosa_dimension_fondo").Value = 0  'Txt_campo15.Text
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("archivo_foto").Value = Trim(dtc_codigo1.Text) + "-A.JPG"
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("observacion").Value = IIf(dtc_desc1.Text = "", 1, dtc_desc1.Text)
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("fecha_registro").Value = Date
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("hora_registro").Value = Date
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset("usr_codigo").Value = glusuario
            fw_solicitud_servicio_basico.Ado_detalle2.Recordset.UpdateBatch adAffectAll
    End If
    ...
    If lbl_det = "43340" Then
     ...
     'Graba en Cotiza    1
        ...
        rs_aux4.Open SQL_FOR, db, adOpenKeyset, adLockOptimistic
            ...
            End If
            If lbl_det.Caption = "21000" Then
                rs_aux4!edif_codigo = fw_solicitud_servicio_basico.dtc_codigo3.Text
                rs_aux4!proceso_codigo = "TEC"
...
Private Sub ABRIR_TABLA()
    ...
    If lbl_det = "20000" Then ' CAJA CHICA
         rs_datos1.Open "select * from ac_bienes where  (par_codigo = '22100' OR par_codigo = '22200') OR (par_codigo = '22300') OR (par_codigo = '21100') OR (par_codigo = '31110') OR ((grupo_codigo = '30000') AND (par_codigo <> '39810') AND (par_codigo <> '39820')  AND (par_codigo <> '34800') ) OR (par_codigo ='22600') OR (par_codigo = '24110' OR par_codigo = '24120' or par_codigo = '24130') ORDER BY bien_descripcion ", db, adOpenStatic   'order by descripcion
    End If
    
    If lbl_det = "30000" Then 'CARGOS DE CUENTA
            rs_datos1.Open "select * from ac_bienes where (par_codigo = '22100' OR par_codigo = '22200') OR (par_codigo = '22300') OR (par_codigo = '21100') OR (par_codigo = '31110') OR ((grupo_codigo = '30000') AND (par_codigo <> '39810') AND (par_codigo <> '39820')  AND (par_codigo <> '34800') ) OR (par_codigo ='22600') OR (par_codigo = '24110' OR par_codigo = '24120' or par_codigo = '24130') ORDER BY bien_descripcion ", db, adOpenStatic   'order by descripcion
    End If
   
    If lbl_det = "22000" Then 'PASAJES Y/O VIATICOS
        rs_datos1.Open "select * from ac_bienes where  (par_codigo = '22100' OR par_codigo = '22200')  ORDER BY bien_descripcion ", db, adOpenStatic   'order by descripcion
    End If
    ...
    End If
    'select * from av_solicitud_bienes2 where unidad_codigo = '" & parametro & "' and solicitud_codigo = " & Ado_datos.Recordset!solicitud_codigo & " and (par_codigo = '22110' AND par_codigo = '22120') and (par_codigo = '22210' AND par_codigo = '22220') and (par_codigo = '22300') and (par_codigo = '21100') and (par_codigo = '31110') and ((grupo_codigo = '30000') AND (par_codigo <> '39810') AND (par_codigo <> '39820')  AND (par_codigo <> '34800') ) and (par_codigo ='22600') and (par_codigo = '24110' AND par_codigo = '24120' or par_codigo = '24130')  ", db, adOpenKeyset, adLockOptimistic, adCmdText
    'End If
    ...
    If lbl_det = "24300" Then
        rs_datos3.Open "Select * from gc_tipo_solicitud WHERE solicitud_tipo = 1 order by solicitud_tipo_descripcion ", db, adOpenStatic
    Else
...
Private Sub Txt_campo16_LostFocus()
    If Txt_campo16.Text = "" Then
        Txt_campo16.Text = "1"
    End If
    Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
