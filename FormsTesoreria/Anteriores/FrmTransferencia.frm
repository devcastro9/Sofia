...
Begin VB.Form FrmTransferencia 
   ...
   Begin VB.Frame FraOpciones 
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   735
         Left            =   105
         Picture         =   "FrmTransferencia.frx":1440
         Style           =   1  'Graphical
         TabIndex        =   19
         Top             =   6150
         Width           =   930
     ...
     rsTransferencia.Open "SELECT * FROM to_transferencia", db, adOpenKeyset, adLockOptimistic
          For i = 0 To LstComprobante.ListCount - 1
             ...
             ' End If
              ...
              If LstDesCuenta.Text <> "" Then
                y = LstDesCuenta.Text
                rsTransferencia("Cta_origen_descripcion") = y 'LstDesCuenta.Text
              End If
              ...
              If LstBancoDestino.Text <> "" Then rsTransferencia("banco_destino") = LstBancoDestino.Text
                 ...
                 'Buscando Nro. de correlativo de Transferencia
                  ...
                  Else
                     ...
                     rsCorrel.Update
                  End If
                  a = rsCorrel("numero_correlativo")
                  rsTransferencia("Nro_Transferencia") = a 'rsCorrel("numero_correlativo")
                  LstGes.ListIndex = i
     ...
     While Not rsIT.EOF
            ...
            If rsComprobante.RecordCount > 0 Then
                 ...
                 If rsCmpteI.RecordCount > 0 Then
                        ...
                        x = rsComprobante("Fecha_pago")
                        rsCmpteI("Fecha_Pago") = x '
