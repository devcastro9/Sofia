...
Begin VB.Form FrmImprimirComprobante 
   ...
   ClientTop       =   1620
   ClientWidth     =   11880
   Icon            =   "FrmImprimirComprobantes.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   ScaleHeight     =   8595
   ScaleWidth      =   11880
   WindowState     =   2  'Maximized
   Begin Crystal.CrystalReport CryCmpte1 
      Left            =   1620
      Top             =   9900
      _ExtentX        =   741
      _ExtentY        =   741
   ...
   Begin VB.Frame FraOpciones 
      ...
      Begin VB.CommandButton CmdBusqueda 
         ...
         Height          =   795
         Left            =   105
         Picture         =   "FrmImprimirComprobantes.frx":0ECA
         Style           =   1  'Graphical
         TabIndex        =   45
         Top             =   3555
         Width           =   930
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   795
         Left            =   105
         Picture         =   "FrmImprimirComprobantes.frx":0FCC
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   4350
         Width           =   930
      ...
      Begin VB.CommandButton CmdImprimir 
         ...
         Height          =   795
         Left            =   105
         Picture         =   "FrmImprimirComprobantes.frx":140E
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   375
         Width           =   930
      ...
      Begin VB.CommandButton CmdImpresionRangos 
         ...
         Height          =   795
         Left            =   120
         Picture         =   "FrmImprimirComprobantes.frx":1A78
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   1170
         Visible         =   0   'False
...
'                                    CryCmpte.printout
    ...
    CryCmpte1.ReportFileName = App.Path & "\FormsTesoreria\Impresion Comprobantes de Pago\Rpt_Comprobantes.rpt"
    iResult = CryCmpte1.PrintReport
    If iResult <> 0 Then
       MsgBox CryCmpte1.LastErrorNumber & " : " & CryCmpte1.LastErrorString, vbCritical + vbOKOnly, "Error..."
     End If
