...
Begin VB.Form FrmCorrelativos 
   ...
   Begin VB.Frame FraOpciones 
      ...
      Begin VB.CommandButton CmdImpresion 
         ...
         Height          =   885
         Left            =   150
         Picture         =   "FrmCorrelativos.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   360
         Width           =   945
...
Private Sub CmdImpresion_Click()
            CryCorrel.ReportFileName = App.path & "\FormsTesoreria\Operacion de Cheques\Rpt_Correlativos.rpt" ' gvi "C:\SAF-2000\FormsTesoreria\Operacion de Cheques\Rpt_Correlativos.rpt"
