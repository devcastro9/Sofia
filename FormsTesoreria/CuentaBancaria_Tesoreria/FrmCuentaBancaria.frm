...
If OptFechaImpresion.Value = False And OptFechaPago.Value = False Then
        MsgBox "Elija si el reporte sera por fecha de pago o de impresion", vbInformation + vbCritical, "Validación de datos"
        Exit Sub
End If
...
If OptMes.Value = True Then
                ...
                If OptFechaPago.Value = falso And OptFechaImpresion.Value = falso And OptMes.Value = False Then
                    MsgBox "Elija una opción por fecha o mes", vbInformation + vbCritical, "Vaidación de datos"
                    Exit Sub
                End If
