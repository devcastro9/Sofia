...
Begin VB.Form FrmSaldosReales 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.Image Image1 
         Height          =   960
         Left            =   0
         Picture         =   "FrmSaldosReales.frx":0ECA
         Top             =   0
         Width           =   11640
      End
   End
   Begin VB.Frame FraOpciones 
      ...
      Begin VB.CommandButton CmdImprimir 
         ...
         Height          =   705
         Left            =   165
         Picture         =   "FrmSaldosReales.frx":27F3A
         Style           =   1  'Graphical
         TabIndex        =   11
         Top             =   960
         Width           =   930
      ...
      Begin VB.CommandButton CmdSalir 
         ...
         Height          =   795
         Left            =   165
         Picture         =   "FrmSaldosReales.frx":285A4
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   1665
         Width           =   930
...
Private Sub cmdImprimir_Click()
            ...
            If iResult <> 0 Then
                MsgBox CrySaldoActual.LastErrorNumber & " : " & CrySaldoActual.LastErrorString, vbCritical + vbOKOnly, "Error..."
            End If
End Sub
