...
Begin VB.Form FrmConciliacion 
   Caption         =   "Comparación de datos con Banco y QUEIROZ GALVAO"
   ClientHeight    =   4800
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6000
   ...
   Begin VB.Frame Frame5 
      ...
      Begin VB.CommandButton CmdSeleccion 
         Caption         =   "Selección de registros de GTZ"
         Height          =   750
         Left            =   1050
         MousePointer    =   4  'Icon
...
'                                            End If
                                            If SW <> 1 Then
                                                    'Colocando el status de 'S' al estado de conciliación de pago_detalle
                                                    Set rsPAgoDetalle = New ADODB.Recordset
                                                    If rsPAgoDetalle.State = 1 Then rsPAgoDetalle.Close
...
If DtCCuentaOrigen.Text = "" Then
   MsgBox "Elija alguna cuenta", vbInformation + vbCritical, "Validación de datos"
   Exit Sub
End If
...
Resp = MsgBox("Esta seguro de realizar la conciliación?", vbInformation + vbYesNo)
If Resp = vbYes Then
         Set rsJoinDatos = New ADODB.Recordset
          ...
          End If
        MsgBox "Termina conciliación de pagos", vbInformation + vbCritical, "Validación de datos"
        ...
        rsJoinDatos.Open sql, db, adOpenKeyset, adLockOptimistic
          If rsJoinDatos.RecordCount > 0 Then
            ...
            Wend
          End If
          MsgBox "Termina conciliacion ingresos ", vbInformation + vbCritical, "Validación de datos"
          Set rsJoinDatos = New ADODB.Recordset
          If rsJoinDatos.State = 1 Then rsJoinDatos.Close
          sql = "SELECT fc_DatosBanco.Nro_Doc, " & _
                "fc_DatosBanco.Organismo, fc_DatosGTZ.Organismo, " & _
           ...
           If rsJoinDatos.RecordCount > 0 Then
            ...
            Wend
           End If
           MsgBox "Termina conciliacion pco's", vbInformation + vbCritical, "Validación de datos"
End If
...
'    FrmComparacion.CmbCompAño.Text = CmbAño.Text
