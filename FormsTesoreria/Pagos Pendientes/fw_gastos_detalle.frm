...
Begin VB.Form fw_gastos_detalle 
   BackColor       =   &H00000000&
   Caption         =   "Procesos Financieros - Tesorería - Resgistro de Pagos"
   ClientHeight    =   10260
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   14475
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   15600
         Picture         =   "fw_gastos_detalle.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   62
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "fw_gastos_detalle.frx":0442
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   61
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1440
         Picture         =   "fw_gastos_detalle.frx":0C01
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   60
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "fw_gastos_detalle.frx":1516
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   59
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_gastos_detalle.frx":1C62
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   58
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "fw_gastos_detalle.frx":2495
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   57
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "fw_gastos_detalle.frx":2C4A
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   56
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "fw_gastos_detalle.frx":3517
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   55
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   15960
         Picture         =   "fw_gastos_detalle.frx":3CD9
         Style           =   1  'Graphical
         TabIndex        =   54
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "fw_gastos_detalle.frx":3EE3
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   51
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "fw_gastos_detalle.frx":47CF
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   50
         Top             =   0
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin TabDlg.SSTab TbPago 
         ...
         TabPicture(0)   =   "fw_gastos_detalle.frx":4FA5
         Tab(0).ControlEnabled=   -1  'True
         Tab(0).Control(0)=   "FraPagoDetalle"
         Tab(0).Control(0).Enabled=   0   'False
         Tab(0).ControlCount=   1
         TabCaption(1)   =   "Datos de Carta"
         TabPicture(1)   =   "fw_gastos_detalle.frx":4FC1
         ...
         Begin VB.Frame FraPagoDetalle 
            ...
            Begin MSDataListLib.DataCombo dtc_cuentabancaria 
               Bindings        =   "fw_gastos_detalle.frx":4FDD
            ...
            Begin MSDataListLib.DataCombo dtc_tipotransacion 
               Bindings        =   "fw_gastos_detalle.frx":4FF6
   ...
   End
End
Attribute VB_Name = "fw_gastos_detalle"
...
'  correlDocCta = "0"
  If Ado_datos.Recordset.RecordCount > 0 Then
    ...
    If Ado_datos.Recordset!estado_codigo = "REG" Then
        ...
        VAR_SW = "MOD"
'        dtp_fechapago.Value = Ado_datos.Recordset!fecha_pago
'        BtnVer.Visible = True
    Else
...
Private Sub OptFilGral1_Click()
   ...
   ' rs_datos.Sort = "solicitud_codigo"unidad_codigounidad_codigo
...
Private Sub Validar()
   ...
   If dtc_tipotransacion.BoundText = "T" Then
    ...
    If Trim(txt_swit.Text) = "" Then
            MsgBox "SWFIT es requerido."
            esValido = False
          Exit Sub
     End If
                   
    If Trim(txt_personaprovee.Text) = "" Then
            MsgBox "Persona provee es requerido."
            esValido = False
          Exit Sub
     End If
