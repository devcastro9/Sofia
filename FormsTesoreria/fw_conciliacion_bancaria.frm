...
Begin VB.Form fw_conciliacion_bancaria 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Financiero - Tesorer韆 - Conciliaci髇 Bancaria"
   ClientHeight    =   8790
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   14835
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin VB.PictureBox FrmABMDet 
         ...
         Begin VB.PictureBox BtnImprimir1 
            ...
            ScaleWidth      =   1395
            TabIndex        =   51
            ToolTipText     =   "Imprime Reporte de Conciliaci贸n"
            Top             =   2160
            Width           =   1400
         End
      ...
      Begin VB.Frame Frame1 
         BackColor       =   &H00C0C0C0&
         Caption         =   "Borrar registro de Facturaci贸n Electr贸nica"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
'    Call ABRIR_DETALLE
  ...
  Else
    MsgBox "NO se puede Procesar !!. Verifique si existe el registro. ", vbExclamation, "Atenci贸n!"
...
Private Sub BtnGrabar_Click()
    sino = MsgBox("驴Est谩 Seguro de Eliminar el Registro de Facturas Electr贸nicas ?", vbYesNo + vbQuestion, "Atenci贸n")
    If sino = vbYes Then
        ...
        MsgBox "Se anularon los registros de Facturas Electr贸nicas ..."
        Frame1.Visible = False
    End If
End Sub
...
'            Label6.Caption = Ado_datos11.Recordset!trans_descripcion
        ...
        Else
            MsgBox "Debe elegir un registro cobrado para modificar, verifique y vuelva a intentar ...", , "Atenci贸n"
        End If
End Sub
...
Private Sub BtnA帽adir_Click()
'    Call limpiar
'    LblMensaje.Visible = False
'    Fra_ABM.Enabled = True
'    BtnA帽adir.Visible = True
...
Private Sub btnCargarArchivo_Click()
  ...
  If existeRuta = Falso Then
     ...
     sino = MsgBox("No existe ruta destino 'EXTRACTOS' 驴 Desea crearla ? ", vbYesNo + vbQuestion, "Atenci贸n")
     If sino = vbYes Then
  ...
  If existeRuta Then
     ...
     If esValio Then
        If rbtMes.Value = True Then
            'sino = MsgBox("驴Esta seguro de subir la asistencia del MES con los siguientes datos?" & vbCrLf & "Gestion: " & cmb_gestion_rep.Text & vbCrLf & "Mes:" & cmb_mes_ini.Text & vbCrLf & "Equipo Biom茅trico: " & cmb_equipo.Text & vbCrLf & "Departamento: " & cmb_departamento.Text, vbYesNo + vbQuestion, "Atenci贸n")
...
Private Sub btnImportarDato_Click()
        ...
        If SiEstaImportado Then
            sino = MsgBox("驴Existen datos para '" & NombreArchivo & "',desea reemplazarlos?", vbQuestion + vbYesNo, "Confirmando ... ")
            If sino = vbYes Then
...
Private Sub ImportarDato()
  On Error GoTo ErrorHandler
        ...
        MsgBox " Se inicia el proceso de importaci贸n de datos..."
