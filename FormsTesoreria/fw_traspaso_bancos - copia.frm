...
Begin VB.Form fw_traspaso_bancos 
   ...
   Caption         =   "Tesoreria - Traspasos entre Cuentas Bancarias"
   ClientHeight    =   10410
   ClientLeft      =   1560
   ClientTop       =   1725
   ClientWidth     =   10815
   ...
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ScaleHeight     =   1.15949e5
   ScaleMode       =   0  'User
   ScaleWidth      =   4.13881e7
   WindowState     =   2  'Maximized
   Begin VB.Frame FraDet3 
      BackColor       =   &H00E0E0E0&
      Caption         =   "Elija una de las Opciones para Filtrar..."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   9.75
         Charset         =   0
      ...
      Begin VB.CommandButton BtnRefrescar 
         ...
         Width           =   1245
      End
      Begin VB.CommandButton BtnFiltro4 
         BackColor       =   &H00E0E0E0&
         Caption         =   "4.Edificio"
         Height          =   495
         Left            =   7320
         Picture         =   "fw_traspaso_bancos.frx":0F8C
         Style           =   1  'Graphical
         TabIndex        =   117
         ToolTipText     =   "Acepta todos los Registro del Recibo de Tesorería ""RboTes"""
         Top             =   720
         Width           =   1245
      End
      Begin VB.CommandButton BtnFiltro3 
         BackColor       =   &H00E0E0E0&
         Caption         =   "3.Recibo.Cobr."
         Height          =   495
         Left            =   4320
         Picture         =   "fw_traspaso_bancos.frx":1516
         Style           =   1  'Graphical
         TabIndex        =   116
         ToolTipText     =   "Acepta todos los Registro del Recibo de Tesorería ""RboTes"""
         Top             =   720
         Width           =   1245
      End
      Begin VB.CommandButton BtnFiltro2 
         BackColor       =   &H00E0E0E0&
         Caption         =   "2.Fecha.Recibo"
         Height          =   495
         Left            =   2400
         Picture         =   "fw_traspaso_bancos.frx":1AA0
         Style           =   1  'Graphical
         TabIndex        =   115
         ToolTipText     =   "Acepta todos los Registro del Recibo de Tesorería ""RboTes"""
         Top             =   720
      ...
      Begin VB.PictureBox BtnCancelar1 
         ...
         Height          =   615
         Left            =   15480
         Picture         =   "fw_traspaso_bancos.frx":202A
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   114
         ToolTipText     =   "Cancela la Busqueda"
         Top             =   360
         Width           =   1335
      End
      Begin VB.TextBox txtRecTes 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   100
         Text            =   "fw_traspaso_bancos.frx":29E9
         Top             =   840
         Visible         =   0   'False
         Width           =   645
      End
      Begin VB.CommandButton BtnFiltro1 
         BackColor       =   &H00E0E0E0&
         Caption         =   "1.Rbo.Tes."
         Height          =   495
         Left            =   360
         Picture         =   "fw_traspaso_bancos.frx":29EB
         Style           =   1  'Graphical
         TabIndex        =   99
         ToolTipText     =   "Acepta todos los Registro del Recibo de Tesorería ""RboTes"""
         Top             =   720
      ...
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "fw_traspaso_bancos.frx":2F75
         DataField       =   "IdRecibo"
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "fw_traspaso_bancos.frx":2F8E
         DataField       =   "IdRecibo"
         DataSource      =   "ado_datos14"
         Height          =   315
         Left            =   5640
      ...
      Begin MSDataListLib.DataCombo dtc_recibo6 
         Bindings        =   "fw_traspaso_bancos.frx":2FA7
         DataField       =   "IdRecibo"
         DataSource      =   "ado_datos14"
         Height          =   315
         Left            =   360
         ...
         Text            =   "0"
      End
      Begin MSDataListLib.DataCombo dtc_reciboCobr6 
         Bindings        =   "fw_traspaso_bancos.frx":2FC0
         DataField       =   "IdRecibo"
         DataSource      =   "ado_datos14"
         Height          =   315
         Left            =   4320
         ...
         Text            =   "0"
      End
      Begin MSDataListLib.DataCombo dtc_fecha6 
         Bindings        =   "fw_traspaso_bancos.frx":2FD9
         DataField       =   "IdRecibo"
         DataSource      =   "ado_datos14"
         Height          =   315
         Left            =   2160
         ...
         Text            =   "0"
      End
      Begin MSDataListLib.DataCombo dtc_edificio6 
         Bindings        =   "fw_traspaso_bancos.frx":2FF2
         DataField       =   "IdRecibo"
         DataSource      =   "ado_datos14"
         Height          =   315
         Left            =   6360
   ...
   Begin VB.Frame Fra_reporte 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.PictureBox Picture2 
            ...
            Height          =   615
            Left            =   3120
            Picture         =   "fw_traspaso_bancos.frx":300B
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   93
            Top             =   0
         ...
         Begin VB.PictureBox BtnCancelar3 
            ...
            Height          =   615
            Left            =   4920
            Picture         =   "fw_traspaso_bancos.frx":37E1
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   75
            Top             =   0
   ...
   Begin VB.Frame FrmDetalle2 
      ...
      Begin MSDataGridLib.DataGrid DtGLista11 
         Bindings        =   "fw_traspaso_bancos.frx":40CD
         Height          =   1740
         Left            =   120
         TabIndex        =   96
         Top             =   240
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Begin VB.PictureBox BtnAnlDetalle 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_traspaso_bancos.frx":40E7
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   110
      ...
      Begin VB.PictureBox BtnModDetalle 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_traspaso_bancos.frx":4833
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   109
      ...
      Begin VB.PictureBox BtnAddDetalle 
         ...
         Height          =   735
         Left            =   0
         Picture         =   "fw_traspaso_bancos.frx":5148
         ScaleHeight     =   735
         ScaleWidth      =   1320
         TabIndex        =   107
      ...
      Begin VB.PictureBox BtnBuscar1 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_traspaso_bancos.frx":5936
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   106
      ...
      Begin VB.CommandButton BtnImprimir1 
         ...
         Height          =   525
         Left            =   0
         Picture         =   "fw_traspaso_bancos.frx":60EB
         Style           =   1  'Graphical
         TabIndex        =   92
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnAprobar1 
         ...
         Height          =   735
         Left            =   3720
         Picture         =   "fw_traspaso_bancos.frx":69B8
         ScaleHeight     =   735
         ScaleWidth      =   1320
         TabIndex        =   105
      ...
      Begin VB.PictureBox BtnDesAprobar 
         ...
         Height          =   735
         Left            =   3720
         Picture         =   "fw_traspaso_bancos.frx":71F0
         ScaleHeight     =   735
         ScaleWidth      =   1320
         TabIndex        =   108
         ToolTipText     =   "Aprueba Comprobante de Traspaso"
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   6360
         Picture         =   "fw_traspaso_bancos.frx":7BE7
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   83
         ToolTipText     =   "Busca Registros "
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   735
         Left            =   5040
         Picture         =   "fw_traspaso_bancos.frx":839C
         ScaleHeight     =   735
         ScaleWidth      =   1320
         TabIndex        =   84
         ToolTipText     =   "Aprueba Comprobante de Traspaso"
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2520
         Picture         =   "fw_traspaso_bancos.frx":8BCF
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   85
         ToolTipText     =   "Anula Registro"
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   735
         Left            =   7680
         Picture         =   "fw_traspaso_bancos.frx":931B
         ScaleHeight     =   735
         ScaleWidth      =   1395
         TabIndex        =   89
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_traspaso_bancos.frx":9BE8
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   88
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1185
         Picture         =   "fw_traspaso_bancos.frx":A3A7
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   87
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17400
         Picture         =   "fw_traspaso_bancos.frx":ACBC
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   86
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "fw_traspaso_bancos.frx":B47E
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   80
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "fw_traspaso_bancos.frx":BD6A
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   79
         Top             =   0
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      TabCaption(0)   =   "TRASPASOS ENTRE CUENTAS"
      TabPicture(0)   =   "fw_traspaso_bancos.frx":C540
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "FrmCabecera"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "DETALLE DE TRASPASOS"
      TabPicture(1)   =   "fw_traspaso_bancos.frx":C55C
      ...
      Begin VB.Frame FrmCabecera 
         ...
         Begin VB.Frame Frame1 
            ...
            Begin MSDataListLib.DataCombo dtc_desc5 
               Bindings        =   "fw_traspaso_bancos.frx":C578
            ...
            Begin MSDataListLib.DataCombo dtc_codigo5 
               Bindings        =   "fw_traspaso_bancos.frx":C591
               DataField       =   "beneficiario_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   195
            ...
            Begin MSDataListLib.DataCombo dtc_desc22 
               Bindings        =   "fw_traspaso_bancos.frx":C5AA
            ...
            Begin MSDataListLib.DataCombo dtc_codigo22 
               Bindings        =   "fw_traspaso_bancos.frx":C5C4
               DataField       =   "cta_codigo_destino"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   195
            ...
            Begin MSDataListLib.DataCombo dtc_moneda22 
               Bindings        =   "fw_traspaso_bancos.frx":C5DE
               DataField       =   "cta_codigo_destino"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   3360
         ...
         Begin VB.Frame Fra_datos 
            ...
            Begin MSDataListLib.DataCombo dtc_desc4 
               Bindings        =   "fw_traspaso_bancos.frx":C5F8
            ...
            Begin MSDataListLib.DataCombo dtc_codigo4 
               Bindings        =   "fw_traspaso_bancos.frx":C611
               DataField       =   "beneficiario_codigo_resp"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   120
            ...
            Begin MSDataListLib.DataCombo dtc_desc21 
               Bindings        =   "fw_traspaso_bancos.frx":C62A
               DataField       =   "cta_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   120
            ...
            Begin MSDataListLib.DataCombo dtc_codigo21 
               Bindings        =   "fw_traspaso_bancos.frx":C644
               DataField       =   "cta_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   120
         ...
         Begin MSDataListLib.DataCombo dtc_codigo3 
            Bindings        =   "fw_traspaso_bancos.frx":C65E
         ...
         Begin MSDataListLib.DataCombo dtc_desc3 
            Bindings        =   "fw_traspaso_bancos.frx":C677
            DataField       =   "doc_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   1725
         ...
         Begin MSDataListLib.DataCombo dtc_aux3 
            Bindings        =   "fw_traspaso_bancos.frx":C690
            DataField       =   "doc_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   6960
   ...
   Begin VB.Frame FrmDetalle 
      ...
      Begin MSDataGridLib.DataGrid DtGLista 
         Bindings        =   "fw_traspaso_bancos.frx":C6A9
         Height          =   1860
         Left            =   120
         TabIndex        =   77
         Top             =   240
...
'        BtnAnlDetalle.Visible = True
    ...
    If Not IsNull(Ado_datos.Recordset!IdTraspasoBancos) Then
        ...
        End If
'        If (Ado_datos.Recordset!estado_verificado = "APR") And (Ado_datos.Recordset!estado_codigo = "APR") And (Ado_datos.Recordset!estado_conciliado = "REG") Then
'            If glusuario = "TCASTILLO" Or glusuario = "ADMIN" Or glusuario = "MPEÑARANDA" Or glusuario = "VPAREDES" Or glusuario = "MWILDE" Or glusuario = "MVALDIVIA" Or glusuario = "EVILLALOBOS" Then
'                BtnAprobar1.Visible = False
'                BtnAprobar.Visible = False
'                BtnModificar.Visible = False
'                BtnDesAprobar.Visible = True
...
'                End Select
            ...
            Case "4828818", "6094423", "4908774"      ', "6962804"    ' SPAREDES - MWILDE - "MVALDIVIA"
...
'                End Select
            ...
            Case "12341952"     ' FCABRERA
                queryinicial2 = "select * from fv_ventas_cobranza_det_traspasos WHERE estado_codigo_tes = 'APR' AND (IdTraspasoBancos is NULL or IdTraspasoBancos ='0') and estado_codigo_cont = 'REG' AND  (depto_codigo = '3' OR depto_codigo = '4')  "
...
Private Sub BtnAddDetalle_Click()
  If glusuario = "TCASTILLO" Or glusuario = "FCABRERA" Or glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "MWILDE" Or glusuario = "MVALDIVIA" Or glusuario = "EVILLALOBOS" Then
...
Private Sub BtnAprobar_Click()
 On Error GoTo UpdateErr
  If (Ado_datos.Recordset!estado_codigo = "REG") And (Ado_datos.Recordset!estado_verificado = "APR") And (glusuario = "RCUELA" Or glusuario = "ADMIN") Then
...
Private Sub BtnAprobar1_Click()
 On Error GoTo UpdateErr
  If (Ado_datos.Recordset!estado_verificado = "REG") And (glusuario = "ADMIN" Or glusuario = "TCASTILLO" Or glusuario = "FCABRERA" Or glusuario = "VPAREDES" Or glusuario = "MWILDE" Or glusuario = "MVALDIVIA" Or glusuario = "EVILLALOBOS") Then
    VAR_RECIBO = Ado_datos.Recordset!IdTraspasoBancos
    'Actualiza Totales
    db.Execute "UPDATE fo_traspaso_bancos set fo_traspaso_bancos.total_bs  = fv_recibos_detalle_sum.cobranza_bs, fo_traspaso_bancos.total_dol   = fv_recibos_detalle_sum.cobranza_dol from fo_traspaso_bancos inner join fv_recibos_detalle_sum " & _
        " on fo_traspaso_bancos.IdTraspasoBancos  = fv_recibos_detalle_sum.IdTraspasoBancos where fo_traspaso_bancos.IdTraspasoBancos = " & VAR_RECIBO & "  "
...
'On Error GoTo UpdateErr
'If glusuario = "MPEÑARANDA" Or glusuario = "TCASTILLO" Or glusuario = "FCABRERA" Or glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "MWILDE" Or glusuario = "MVALDIVIA" Or glusuario = "EVILLALOBOS" Then
' If Ado_datos.Recordset.RecordCount > 0 Then
...
On Error GoTo UpdateErr
If glusuario = "MPEÑARANDA" Or glusuario = "TCASTILLO" Or glusuario = "FCABRERA" Or glusuario = "ADMIN" Or glusuario = "SPAREDES" Or glusuario = "VPAREDES" Or glusuario = "MWILDE" Or glusuario = "MVALDIVIA" Or glusuario = "EVILLALOBOS" Then
 If Ado_datos.Recordset.RecordCount > 0 Then
    If Ado_datos.Recordset!estado_codigo = "REG" Then
        If ado_datos14.Recordset.RecordCount > 0 Then         '<> "" Then
...
Private Sub pCta1(CodigoA As String)
   ...
   strConsultaF = "select * from fc_cuenta_bancaria where (cta_es_CUT = 'E') or (cta_cod_sigma = '" & CodigoA & "') or (hora_registro = '" & CodigoA & "') "
...
Private Sub OptFilGral1_Click()
   '===== Proceso para filtrado general de datos(registros NO aprobados)
    ...
    Select Case glusuario
        Case "ADMIN", "NPAREDES", "RCUELA"              '"SQUISPE", "CNUÑEZ",
