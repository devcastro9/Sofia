...
Begin VB.Form Fw_ReportesTesoreria 
   BackColor       =   &H00C0C0C0&
   Caption         =   "REPORTES DE TESORERIA"
   ClientHeight    =   8880
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   16530
   Icon            =   "Fw_ReportesTesoreria.frx":0000
   LinkTopic       =   "Form1"
   ScaleHeight     =   8880
   ScaleWidth      =   16530
   ...
   Begin VB.Frame Frame4 
      BackColor       =   &H00C0C0C0&
      Caption         =   "------ TESORERIA ACUMULADO -------------------------------------------------------------- TESORERIA DETALLLE"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   9.75
         Charset         =   0
      ...
      Begin VB.OptionButton optRep004 
         BackColor       =   &H00C0C0C0&
         Caption         =   "por: COBRADOR y REGIONAL"
         ForeColor       =   &H00000000&
         Height          =   325
         Left            =   360
         TabIndex        =   111
      ...
      Begin VB.OptionButton optRep008 
         BackColor       =   &H00C0C0C0&
         Caption         =   "por CTA.BANCARIA y REGIONAL, para CONCILIACION"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   8.25
            Charset         =   0
      ...
      Begin VB.OptionButton optRep007 
         BackColor       =   &H00C0C0C0&
         Caption         =   "por REGIONAL y CUENTA BANCARIA"
         ForeColor       =   &H00000000&
         Height          =   325
         Left            =   8040
         TabIndex        =   104
      ...
      Begin VB.OptionButton optRep001 
         BackColor       =   &H00C0C0C0&
         Caption         =   "por REGIONAL y TIPO DE TRANSACCION"
         ForeColor       =   &H00000000&
         Height          =   325
         Left            =   8040
         TabIndex        =   103
      ...
      Begin VB.OptionButton optRep017 
         BackColor       =   &H00C0C0C0&
         Caption         =   "por: REGIONAL, TESORERO(A) - COBRADOR"
         ForeColor       =   &H00000000&
         Height          =   325
         Left            =   8040
         TabIndex        =   102
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   735
         Left            =   13440
         Picture         =   "Fw_ReportesTesoreria.frx":0A02
         ScaleHeight     =   735
         ScaleWidth      =   1365
         TabIndex        =   100
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   735
         Left            =   360
         Picture         =   "Fw_ReportesTesoreria.frx":11C4
         ScaleHeight     =   735
         ScaleWidth      =   1395
         TabIndex        =   99
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.OptionButton Option3 
         BackColor       =   &H00C0C0C0&
         Caption         =   "Facturación Acumulada por REGIONAL y MES"
         ForeColor       =   &H00000000&
         Height          =   325
         Left            =   5760
         TabIndex        =   83
   ...
   End
End
Attribute VB_Name = "Fw_ReportesTesoreria"
...
Private Sub BtnImprimir_Click()
  ...
  If optRep001.Value = True Then        'And Opt_1.Value = True
    'Call RepUnidad("CONSALDO", "\Reportes\Ventas\ar_lista_de_ventas_unidad.rpt", "VENTAS EN GENERAL")
        CryUnidad.ReportFileName = App.Path & "\Reportes\Tesoreria\fr_tesoreria_regional_detalle_tipo.rpt"
...
'        End If
    ...
    'TESORERIA: POR COBRADOR y REGIONAL (TOTALES)
  ElseIf optRep004.Value = True Then        'And Opt_1.Value = True
     CryUnidad.ReportFileName = App.Path & "\Reportes\Tesoreria\fr_tesoreria_cobrador_regional.rpt"
        titulo2 = "MODULO TESORERIA"
        subtitulo2 = "SEGUIMIENTO POR SERVICIO"
        CryUnidad.Formulas(2) = "Titulo = '" & titulo2 & "'"
        CryUnidad.Formulas(3) = "SubTitulo = '" & subtitulo2 & "'"
        iResult = CryUnidad.PrintReport
        If iResult <> 0 Then
    ...
    ' TESORERIA: POR SERVICIO Y REGIONAL (DETALLE)
  ElseIf optrep005.Value = True Then        'And Opt_1.Value = True     'optrep005
        CryUnidad.ReportFileName = App.Path & "\Reportes\Tesoreria\fr_tesoreria_servicio_regional_detalle.rpt"
        titulo2 = "MODULO TESORERIA"
        subtitulo2 = "SEGUIMIENTO POR SERVICIO"
        CryUnidad.Formulas(2) = "Titulo = '" & titulo2 & "'"
        CryUnidad.Formulas(3) = "SubTitulo = '" & subtitulo2 & "'"
    ...
    ' TESORERIA: POR COBRADOR Y REGIONAL (DETALLE)
  ElseIf optrep006.Value = True Then        'And Opt_1.Value = True     'optrep005
        CryUnidad.ReportFileName = App.Path & "\Reportes\Tesoreria\fr_tesoreria_cobrador_regional_detalle.rpt"
        titulo2 = "MODULO TESORERIA"
        subtitulo2 = "SEGUIMIENTO POR REGIONAL"
        CryUnidad.Formulas(2) = "Titulo = '" & titulo2 & "'"
        CryUnidad.Formulas(3) = "SubTitulo = '" & subtitulo2 & "'"
...
'    Call RepUnidad("MONTOCERO", "\Reportes\Ventas\ar_lista_cobranzas_solo_recibo.rpt", "VENTAS FACTURADAS Y COBRADAS")
    ...
    ElseIf optRep009.Value = True And opt_4.Value = True Then
        ...
        'TESORERIA: POR REGIONAL, TESORERO, COBRADOR
...
'----- REPORTES GERENCIALES
  ...
  ElseIf optRep033.Value = True And optNo.Value = True Then
    ...
    ElseIf optRep002.Value = True Then
        CryUnidad.ReportFileName = App.Path & "\Reportes\Tesoreria\fr_tesoreria_servicio_regional.rpt"
        titulo2 = "MODULO TESORERIA"
        subtitulo2 = "SEGUIMIENTO POR SERVICIO"
        CryUnidad.Formulas(2) = "Titulo = '" & titulo2 & "'"
        CryUnidad.Formulas(3) = "SubTitulo = '" & subtitulo2 & "'"
