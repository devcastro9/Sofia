   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.PictureBox fra_opciones_det_2 
         ...
         Begin VB.PictureBox Picture19 
            ...
            Height          =   615
            Left            =   17760
            Picture         =   "frm_ro_pagos_grupos_principal.frx":1092B
            ScaleHeight     =   615
            ScaleWidth      =   1245
            TabIndex        =   26
         ...
         Begin VB.PictureBox Picture17 
            ...
            Height          =   615
            Left            =   4440
            Picture         =   "frm_ro_pagos_grupos_principal.frx":110ED
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   25
            ToolTipText     =   "Aprueba Cronograma"
         ...
         Begin VB.PictureBox Picture16 
            ...
            Height          =   615
            Left            =   3120
            Picture         =   "frm_ro_pagos_grupos_principal.frx":11920
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   24
         ...
         Begin VB.PictureBox Picture15 
            ...
            Height          =   615
            Left            =   1560
            Picture         =   "frm_ro_pagos_grupos_principal.frx":1206C
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   23
         ...
         Begin VB.PictureBox Picture14 
            ...
            Height          =   615
            Left            =   120
            Picture         =   "frm_ro_pagos_grupos_principal.frx":12981
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   22
            Top             =   0
         ...
         Begin VB.CommandButton Command1 
            ...
            Height          =   600
            Left            =   6360
            Picture         =   "frm_ro_pagos_grupos_principal.frx":13140
            Style           =   1  'Graphical
            TabIndex        =   33
            Top             =   0
            Visible         =   0   'False
...
If retroactivos.State = 1 Then retroactivos.Close
      ...
      retroactivos.Open "select * from ro_pagos_cronograma_detalle where ges_gestion = '" & "2017" & "' AND mes_grupo = " & meses & " AND unidad_codigo <> 'P010' AND unidad_codigo <> 'P020' AND unidad_codigo <> 'P030' AND unidad_codigo <> 'P040' AND unidad_codigo <> 'P050' AND unidad_codigo <> 'P060' AND unidad_codigo <> 'P070' AND unidad_codigo <> 'P080' AND unidad_codigo <> 'P090' ORDER BY planilla_codigo, unidad_codigo, total_ganado DESC, beneficiario_codigo", db, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockOptimistic, ADODB.CommandTypeEnum.adCmdText 'adOpenKeyset ', adLockReadOnly   ', adOpenKeyset, adOpenStatic, adCmdText" 'adOpenKeyset, adLockReadOnly   ', adOpenKeyset, adOpenStatic, adCmdText
      ...
      rs_aux_retro.Open "SELECT * FROM ro_retroactivo_aux WHERE beneficiario_codigo ='" & retroactivos!beneficiario_codigo & "'", db, adOpenKeyset, adLockOptimistic
      ...
      Case "1"
        ...
        If retroactivos!beneficiario_haber_mensual < 2000 Then
            rs_aux_retro!ENERO = 2000 - retroactivos!beneficiario_haber_mensual
            rs_aux_retro!haber_basico_incre = "2000"
            rs_aux_retro!haber_basico_incre_enero = "2000"
            rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
        Else
            rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
            rs_aux_retro!ENERO = retroactivos!beneficiario_haber_mensual * 0.07
            rs_aux_retro!haber_basico_incre = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
            rs_aux_retro!haber_basico_incre_enero = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
       ...
       rs_aux6.Open "SELECT * FROM ro_personal_contratado WHERE beneficiario_codigo ='" & retroactivos!beneficiario_codigo & "'", db, adOpenKeyset, adLockOptimistic
            ...
            fecha_pla = DateSerial("2017", meses + 1, 1 - 1)
        ...
        Select Case rs_aux6!beneficiario_codigo_afp
                Case "1006803"      'AFP1
                    ...
                    rs_aux_retro!afp2 = "0"       'falta 987654
                     ...
                     rs_aux_retro!afp1_enero = rs_aux_retro!total_ganado_enero * 0.1271
                ...
                Case "987654"       'AFP2
                    ...
                    rs_aux_retro!afp2_enero = rs_aux_retro!total_ganado_enero * 0.1271
      ...
      Case "2"
        ...
        If retroactivos!beneficiario_haber_mensual < 2000 Then
        rs_aux_retro!febrero = 2000 - retroactivos!beneficiario_haber_mensual
         rs_aux_retro!haber_basico_incre = "2000"
         rs_aux_retro!haber_basico_incre_febrero = "2000"
         rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
        Else
        rs_aux_retro!febrero = retroactivos!beneficiario_haber_mensual * 0.07
        rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
        rs_aux_retro!haber_basico_incre = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
        rs_aux_retro!haber_basico_incre_febrero = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
        End If
       ...
       rs_aux6.Open "SELECT * FROM ro_personal_contratado WHERE beneficiario_codigo ='" & retroactivos!beneficiario_codigo & "'", db, adOpenKeyset, adLockOptimistic
        ...
        Select Case rs_aux6!beneficiario_codigo_afp
                Case "1006803"      'AFP1
                    ...
                    rs_aux_retro!afp1_febrero = rs_aux_retro!total_ganado_febrero * 0.1271
                ...
                Case "987654"       'AFP2
                   ...
                   ' rs_aux_retro!total_dsctos = rs_aux_retro!afp2
                    ...
                    rs_aux_retro!afp2_febrero = rs_aux_retro!total_ganado_febrero * 0.1271
                    'VAR_NETO = rs_aux_retro!total_ganado - rs_aux_retro!afp2
                Case Else
                    rs_aux_retro!afp1 = "0"
                    rs_aux_retro!afp2 = "0"
      ...
      If retroactivos!beneficiario_haber_mensual < 2000 Then
      rs_aux_retro!marzo = 2000 - retroactivos!beneficiario_haber_mensual
      rs_aux_retro!haber_basico_incre = "2000"
      rs_aux_retro!haber_basico_incre_marzo = "2000"
      rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
      Else
      rs_aux_retro!marzo = retroactivos!beneficiario_haber_mensual * 0.07
      rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
      rs_aux_retro!haber_basico_incre = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
      rs_aux_retro!haber_basico_incre_marzo = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
      End If
       ...
       rs_aux6.Open "SELECT * FROM ro_personal_contratado WHERE beneficiario_codigo ='" & retroactivos!beneficiario_codigo & "'", db, adOpenKeyset, adLockOptimistic
        ...
        Select Case rs_aux6!beneficiario_codigo_afp
                Case "1006803"      'AFP1
                    ...
                    rs_aux_retro!afp1_marzo = rs_aux_retro!total_ganado_marzo * 0.1271
                ...
                Case "987654"       'AFP2
                    ...
                    rs_aux_retro!afp2_marzo = rs_aux_retro!total_ganado_marzo * 0.1271
     ...
     ' rs_aux_retro!haber_basico_incre = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.7)
      ...
      If retroactivos!beneficiario_haber_mensual < 2000 Then
      rs_aux_retro!abril = 2000 - retroactivos!beneficiario_haber_mensual
      rs_aux_retro!haber_basico_incre = "2000"
      rs_aux_retro!haber_basico_incre_abril = "2000"
      rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
      Else
      rs_aux_retro!abril = retroactivos!beneficiario_haber_mensual * 0.07
      rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
      rs_aux_retro!haber_basico_incre = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
      rs_aux_retro!haber_basico_incre_abril = rs_aux_retro!haber_basico_ant + (rs_aux_retro!haber_basico_ant * 0.07)
      End If
      rs_aux_retro!haber_basico_ant = retroactivos!beneficiario_haber_mensual
...
'        End If
        ...
        persona.Open "select * from gc_beneficiario where beneficiario_codigo = '" & rs_aux6!beneficiario_codigo & "'", db, adOpenKeyset, adLockOptimistic, adCmdText
            ...
            rs_datos2.AddNew
             ...
             rs_datos2!cargo_codigo = rs_aux6!fecha_ingreso
             rs_datos2!cargo_codigo = rs_aux6!fecha_expiracion
...
'            End If
            ...
            rs_datos2!r_prevision_indemnizacion = "0"
              ...
              rs_aux15.Open "select SUM(monto) AS totalmonto, SUM(dias) AS Totaldias from ro_memorandas where ges_gestion = '" & Ado_datos1.Recordset!ges_gestion & "' AND mes_descuento = " & Ado_datos1.Recordset!mes_grupo & " AND beneficiario_codigo = '" & rs_aux6!beneficiario_codigo & "' AND descuento_pla = 'SI' AND estado_codigo = 'APR' AND tipo_memo <> 'ANT'", db, adOpenKeyset, adLockOptimistic, adCmdText
         ...
         If rs_aux30.State = 1 Then rs_aux30.Close
              rs_aux30.Open "select SUM(monto) AS totalmonto, SUM(dias) AS Totaldias from ro_memorandas where ges_gestion = '" & Ado_datos1.Recordset!ges_gestion & "' AND mes_descuento = " & Ado_datos1.Recordset!mes_grupo & " AND beneficiario_codigo = '" & rs_aux6!beneficiario_codigo & "' AND descuento_pla = 'SI' AND estado_codigo = 'APR' AND tipo_memo = 'ANT'", db, adOpenKeyset, adLockOptimistic, adCmdText
...
'        rs_aux5.Open "select * from ro_pagos_cronograma_detalle where ges_gestion = '" & Ado_datos1.Recordset!ges_gestion & "' AND planilla_codigo = '" & Ado_datos1.Recordset!planilla_codigo & "' AND mes_grupo = " & Ado_datos1.Recordset!mes_grupo & " AND numero_pago = " & Ado_datos1.Recordset!NUMERO_PAGO & " AND beneficiario_codigo = '" & rs_aux6!beneficiario_codigo & "' AND unidad_codigo = '" & Ado_datos1.Recordset!unidad_codigo_pla & "'", db, adOpenKeyset, adLockOptimistic, adCmdText
        ...
        If rs_aux5.RecordCount = 0 Then
         ...
         Wend
          ...
          rs_datos2!mes_grupo = rs_datos1!mes_grupo
          rs_datos2!NUMERO_PAGO = rs_datos1!NUMERO_PAGO
          rs_datos2!unidad_codigo_pla = rs_aux6!unidad_codigo_pla
          rs_datos2!tipo_moneda = "BOB"
          rs_datos2!tipo_cambio = GlTipoCambioOficial
            'Adicionar  beneficiario_haber_mensual_ant
'
...
'       rs_datos1.Updat
     ...
     sino = MsgBox("Se genero correctamente las planillas", vbInformation, "Atención")
     Else
     sino = MsgBox("No se agrego ninguna persona a la planilla", vbCritical, "Atención")
     End If
   Call ABRIR_TABLAS_AUX(5)
