...
Begin VB.Form Ac_Estructura_Org 
   ...
   ClientTop       =   330
   ClientWidth     =   12510
   Icon            =   "Ac_Estructura_Org.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraOpciones 
      ...
      Begin VB.CommandButton cmdAdd 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":31F48
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton CmdMod 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":38A36
         Style           =   1  'Graphical
         TabIndex        =   21
      ...
      Begin VB.CommandButton CmdDel 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":39300
         Style           =   1  'Graphical
         TabIndex        =   20
      ...
      Begin VB.CommandButton CmdBuscar 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":39FCA
         Style           =   1  'Graphical
         TabIndex        =   19
      ...
      Begin VB.CommandButton CmdSal 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":3A894
         Style           =   1  'Graphical
         TabIndex        =   18
      ...
      Begin VB.CommandButton CmdImprimir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":3AA9E
         Style           =   1  'Graphical
         TabIndex        =   17
      ...
      Begin VB.CommandButton cmdAprueba 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":3C220
         Style           =   1  'Graphical
         TabIndex        =   16
   ...
   Begin VB.Frame FraGrabarCancelar 
      ...
      Begin VB.CommandButton CmdCancelar 
         ...
         Height          =   675
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":3C42A
         Style           =   1  'Graphical
         TabIndex        =   25
         Top             =   2520
         Width           =   765
      ...
      Begin VB.CommandButton CmdGrabar 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "Ac_Estructura_Org.frx":3C634
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   1320
         Width           =   780
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo Dtc_codigo 
         Bindings        =   "Ac_Estructura_Org.frx":3CA76
      ...
      Begin MSDataListLib.DataCombo Dtc_descrip 
         Bindings        =   "Ac_Estructura_Org.frx":3CA91
         DataField       =   "unidad_ORG"
         DataSource      =   "Ado_Auxiliar"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo DtcNivelDes 
         Bindings        =   "Ac_Estructura_Org.frx":3CAAC
      ...
      Begin MSDataListLib.DataCombo DtcNivel 
         Bindings        =   "Ac_Estructura_Org.frx":3CACB
         DataField       =   "nivel_puesto"
         DataSource      =   "Ado_Auxiliar"
         Height          =   315
         Left            =   3240
   ...
   Begin VB.Image Image3 
      Height          =   1065
      Left            =   0
      Picture         =   "Ac_Estructura_Org.frx":3CAEA
      Stretch         =   -1  'True
      Top             =   0
      Width           =   10755
   End
End
Attribute VB_Name = "Ac_Estructura_Org"
