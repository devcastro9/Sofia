...
Begin VB.Form rw_importar_registro_asistencia 
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "rw_importar_registro_asistencia.frx":0C0C
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "rw_importar_registro_asistencia.frx":104E
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   21
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "rw_importar_registro_asistencia.frx":180D
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   20
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "rw_importar_registro_asistencia.frx":2122
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   19
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "rw_importar_registro_asistencia.frx":286E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   18
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "rw_importar_registro_asistencia.frx":30A1
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   17
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "rw_importar_registro_asistencia.frx":3856
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   16
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "rw_importar_registro_asistencia.frx":4123
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   15
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   4275
         Picture         =   "rw_importar_registro_asistencia.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   12
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   2880
         Picture         =   "rw_importar_registro_asistencia.frx":51D1
         ScaleHeight     =   615
         ScaleWidth      =   1305
         TabIndex        =   11
         Top             =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "rw_importar_registro_asistencia.frx":59A7
         Height          =   6495
         Left            =   120
         TabIndex        =   9
         Top             =   240
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.ComboBox cmb_gestion_rep 
         Height          =   315
         ItemData        =   "rw_importar_registro_asistencia.frx":59BF
         Left            =   2400
         List            =   "rw_importar_registro_asistencia.frx":59E4
         TabIndex        =   41
         Top             =   1200
         Width           =   1095
      End
      Begin VB.ComboBox cmb_mes_ini 
         ...
         Height          =   315
         ItemData        =   "rw_importar_registro_asistencia.frx":5A2A
         Left            =   360
         List            =   "rw_importar_registro_asistencia.frx":5A52
         TabIndex        =   39
         Top             =   1200
         Width           =   2100
      End
      ...
      Begin VB.ComboBox cmb_equipo 
         Height          =   315
         ItemData        =   "rw_importar_registro_asistencia.frx":5ABB
         Left            =   3240
         List            =   "rw_importar_registro_asistencia.frx":5ABD
         TabIndex        =   31
         Top             =   2280
         Width           =   2175
      End
      ...
      Begin VB.CommandButton btnImportarDato 
         ...
         Height          =   855
         Left            =   2400
         Picture         =   "rw_importar_registro_asistencia.frx":5ABF
         Style           =   1  'Graphical
         TabIndex        =   26
         Top             =   4800
         Visible         =   0   'False
      ...
      Begin VB.CommandButton btnCargarArchivo 
         ...
         Height          =   855
         Left            =   2400
         Picture         =   "rw_importar_registro_asistencia.frx":64C1
         Style           =   1  'Graphical
         TabIndex        =   25
         Top             =   3480
         Width           =   1575
      ...
      Begin VB.Image Image2 
         Height          =   480
         Left            =   1440
         Picture         =   "rw_importar_registro_asistencia.frx":6903
         Top             =   4920
         Visible         =   0   'False
         Width           =   480
      End
      Begin VB.Image Image1 
         Height          =   480
         Left            =   1440
         Picture         =   "rw_importar_registro_asistencia.frx":6C0D
         Top             =   3720
         Visible         =   0   'False
         Width           =   480
      End
