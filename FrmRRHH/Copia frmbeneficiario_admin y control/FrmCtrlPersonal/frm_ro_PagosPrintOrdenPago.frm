...
Begin VB.Form frm_ro_PagosPrintOrdenPago 
   BackColor       =   &H00800000&
   ...
   End
End
Attribute VB_Name = "frm_ro_PagosPrintOrdenPago"
...
Private Sub Form_Load()
    ...
    CodGestion = frm_ro_LiquidaMain.lblGestion.Caption
    CodUnidad = frm_ro_LiquidaMain.lblCodUniSol.Caption
    CodGrupo = Val(frm_ro_LiquidaMain.lblCodGrupo.Caption)
    NumPago = Val(frm_ro_LiquidaMain.lblEstadoBeneficiario.Tag)
