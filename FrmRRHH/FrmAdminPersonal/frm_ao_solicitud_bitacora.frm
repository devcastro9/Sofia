...
Begin VB.Form frm_ao_solicitud_bitacora 
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.TextBox Txt_campo5 
         ...
         DataSource      =   "frm_ao_solicitud_rrhh.ado_detalle1"
         Height          =   285
         Left            =   8640
         TabIndex        =   33
         Text            =   "0"
      ...
      Begin VB.Label Label7 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Responsable (Personal de RRHH)"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
Private Sub BtnCancelar_Click()
  On Error Resume Next
   ...
   If sino = vbYes Then
        frm_ao_solicitud_rrhh.Ado_detalle1.Recordset.CancelUpdate
        Unload Me
    End If
End Sub
    ...
    Select Case Txt_campo1.Caption
        Case "DRRHH"    'SOLO COMPRAS BB y SS
            If swnuevo = 1 Then
             ...
             frm_ao_solicitud_rrhh.Ado_detalle1.Recordset("negocia_hora_real").Value = IIf(Txt_campo2.Value = "", "09:00", Str(Txt_campo2.Value))      'Trim(HH.Text) + ":" + Trim(MM.Text)   '
        ...
        Case "DNMAN", "DNREP", "DNINS", "DNAJS", "DNEME", "DNMOD"    'VENTA DE SERVICIOS (INST, AJUSTE, REP, EMERG, MANT)
             ...
             frm_to_identificacion_cliente.Ado_detalle1.Recordset("negocia_hora_real").Value = IIf(Txt_campo2.Value = "", "09:00", Txt_campo2.Value)        'Trim(HH.Text) + ":" + Trim(MM.Text)   '
