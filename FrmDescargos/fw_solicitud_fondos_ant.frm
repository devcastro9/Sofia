...
Begin VB.Form fw_solicitud_fondos_ant 
   BackColor       =   &H00000000&
   Caption         =   "Para Borrar"
   ClientHeight    =   10260
   ClientLeft      =   1110
   ...
   End
End
Attribute VB_Name = "fw_solicitud_fondos_ant"
  ...
  If VAR_VAL = "OK" Then
    ...
    If VAR_SW = "ADD" Then
     ...
     Select Case dtc_codigo2.Text
        ...
        Case "4"    'VENTA DE SERVICIOS (INST, AJUSTE, REP, EMERG, MANT)
            If VAR_UNI = "DCONT" Then
                rs_datos!proceso_codigo = "FIN"         'IIf(dtc_codigo5.Text = "", "COM", dtc_codigo5.Text)
                rs_datos!subproceso_codigo = "FIN-03"   'IIf(dtc_codigo6.Text = "", "COM-03", dtc_codigo6.Text)
                rs_datos!etapa_codigo = "FIN-03-03"     'IIf(dtc_codigo7.Text = "", "COM-03-02", dtc_codigo7.Text)
                rs_datos!clasif_codigo = "ADM"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
                rs_datos!doc_codigo = "R-160A"                'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            End If
