...
Begin VB.Form fw_solicitud_fondos 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Financiero - Descargos - Solicitud Fondos"
   ClientHeight    =   10260
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   11280
   Icon            =   "fw_solicitud_fondos.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10935
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "fw_solicitud_fondos.frx":0A02
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "fw_solicitud_fondos.frx":0E44
         Style           =   1  'Graphical
         TabIndex        =   71
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_solicitud_fondos.frx":104E
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   70
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "fw_solicitud_fondos.frx":180D
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   69
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "fw_solicitud_fondos.frx":2122
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   68
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_solicitud_fondos.frx":286E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   67
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "fw_solicitud_fondos.frx":30A1
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   66
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "fw_solicitud_fondos.frx":3856
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   65
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   16800
         Picture         =   "fw_solicitud_fondos.frx":4123
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   64
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "fw_solicitud_fondos.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   60
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "fw_solicitud_fondos.frx":50BB
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   59
         Top             =   0
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "fw_solicitud_fondos.frx":59A7
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "fw_solicitud_fondos.frx":59C1
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "fw_solicitud_fondos.frx":59DA
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "fw_solicitud_fondos.frx":59F3
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "fw_solicitud_fondos.frx":5A0D
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "fw_solicitud_fondos.frx":5A26
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   8160
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "fw_solicitud_fondos.frx":5A3F
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7020
      ...
      Begin MSDataListLib.DataCombo dtc_desc_ben 
         Bindings        =   "fw_solicitud_fondos.frx":5A58
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1560
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "fw_solicitud_fondos.frx":5A71
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6000
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "fw_solicitud_fondos.frx":5A8A
         DataField       =   "solicitud_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4995
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "fw_solicitud_fondos.frx":5AA3
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2040
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "fw_solicitud_fondos.frx":5ABC
         DataField       =   "poa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4200
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "fw_solicitud_fondos.frx":5AD6
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   300
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.CommandButton BtnAddDetalle1 
            Height          =   640
            Left            =   0
            Picture         =   "fw_solicitud_fondos.frx":5AF0
            Style           =   1  'Graphical
            TabIndex        =   78
         ...
         Begin VB.CommandButton BtnAnlDetalle1 
            Height          =   645
            Left            =   0
            Picture         =   "fw_solicitud_fondos.frx":63A0
            Style           =   1  'Graphical
            TabIndex        =   77
         ...
         Begin VB.CommandButton BtnModDetalle1 
            ...
            Height          =   640
            Left            =   1320
            Picture         =   "fw_solicitud_fondos.frx":6B98
            Style           =   1  'Graphical
            TabIndex        =   76
         ...
         Begin VB.CommandButton Command6 
            ...
            Height          =   645
            Left            =   1320
            Picture         =   "fw_solicitud_fondos.frx":75AD
            Style           =   1  'Graphical
            TabIndex        =   75
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "fw_solicitud_fondos.frx":7EDB
         Height          =   1260
         Left            =   3000
         TabIndex        =   50
         Top             =   240
   ...
   Begin VB.Frame FraDet3 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.CommandButton BtnImprimir1 
            ...
            Height          =   645
            Left            =   1320
            Picture         =   "fw_solicitud_fondos.frx":7EF6
            Style           =   1  'Graphical
            TabIndex        =   90
            ToolTipText     =   "Imprime Nota de Venta"
            Top             =   760
         ...
         Begin VB.CommandButton BtnModDetalle 
            Height          =   640
            Left            =   1320
            Picture         =   "fw_solicitud_fondos.frx":8824
            Style           =   1  'Graphical
            TabIndex        =   89
            ToolTipText     =   "Modifica Detalle Elegido"
            Top             =   60
         ...
         Begin VB.CommandButton BtnAddDetalle 
            Height          =   640
            Left            =   0
            Picture         =   "fw_solicitud_fondos.frx":9239
            Style           =   1  'Graphical
            TabIndex        =   88
            ToolTipText     =   "Adiciona Detalle"
            Top             =   60
         ...
         Begin VB.CommandButton BtnAprobar2 
            Height          =   645
            Left            =   0
            Picture         =   "fw_solicitud_fondos.frx":9AE9
            Style           =   1  'Graphical
            TabIndex        =   87
            ToolTipText     =   "Aprueba Registro"
            Top             =   760
         ...
         Begin VB.CommandButton Command3 
            Height          =   645
            Left            =   1350
            Picture         =   "fw_solicitud_fondos.frx":A400
            Style           =   1  'Graphical
            TabIndex        =   86
            ToolTipText     =   "Aprueba Registro"
            Top             =   760
      ...
      Begin MSDataGridLib.DataGrid dg_det3 
         Bindings        =   "fw_solicitud_fondos.frx":ABF8
         Height          =   1350
         Left            =   3000
         TabIndex        =   12
         Top             =   240
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.PictureBox FrmABMDet2 
         ...
         Begin VB.CommandButton BtnAprobar1 
            Height          =   630
            Left            =   0
            Picture         =   "fw_solicitud_fondos.frx":AC13
            Style           =   1  'Graphical
            TabIndex        =   80
            ToolTipText     =   "Aprueba Registro"
            Top             =   600
         ...
         Begin VB.CommandButton Command4 
            ...
            Height          =   525
            Left            =   1320
            Picture         =   "fw_solicitud_fondos.frx":B52A
            Style           =   1  'Graphical
            TabIndex        =   84
            ToolTipText     =   "Imprime Nota de Venta"
            Top             =   660
         ...
         Begin VB.CommandButton BtnAnlDetalle2 
            ...
            Height          =   525
            Left            =   120
            Picture         =   "fw_solicitud_fondos.frx":CCAC
            Style           =   1  'Graphical
            TabIndex        =   83
         ...
         Begin VB.CommandButton BtnAddDetalle2 
            Height          =   630
            Left            =   0
            Picture         =   "fw_solicitud_fondos.frx":D0EE
            Style           =   1  'Graphical
            TabIndex        =   82
            ToolTipText     =   "Adiciona Detalle"
            Top             =   0
         ...
         Begin VB.CommandButton BtnModDetalle2 
            Height          =   640
            Left            =   1320
            Picture         =   "fw_solicitud_fondos.frx":D99E
            Style           =   1  'Graphical
            TabIndex        =   81
            ToolTipText     =   "Modifica Detalle Elegido"
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "fw_solicitud_fondos.frx":E3B3
         Height          =   1200
         Left            =   3000
         TabIndex        =   8
         Top             =   240
         ...
         BeginProperty Column01 
            ...
            Caption         =   "Denominación.Benefciario"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
               HaveTrueFalseNull=   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "fw_solicitud_fondos.frx":E3CE
         Height          =   3450
         Left            =   90
         TabIndex        =   91
         Top             =   240
   ...
   End
End
Attribute VB_Name = "fw_solicitud_fondos"
...
Dim COUNTER, VAR_DOCNUM As Integer
...
''     End If
  ...
  VAR_COD2 = Ado_datos.Recordset!compra_codigo
     ...
     Set rs_compra_det = New Recordset
     If rs_compra_det.State = 1 Then rs_compra_det.Close
     rs_compra_det.Open "Select * from ao_compra_adjudica_bienes WHERE compra_codigo = " & Ado_datos.Recordset!compra_codigo & " AND bien_codigo = '" & rs_det1!bien_codigo & "'", db, adOpenKeyset, adLockOptimistic
     ...
     End If
        ...
        rs_compra_det!compra_codigo = rs_det1!compra_codigo
...
'        marca1 = Ado_datos.Recordset.Bookmark
    ...
    fw_orden_pago_ccd.txt_codigo.Caption = Me.Ado_datos.Recordset!solicitud_codigo  'cod_cabecera
     
     
    fw_orden_pago_ccd.txt_campo1.Text = Me.Ado_datos.Recordset!unidad_codigo  'Unidad
    fw_orden_pago_ccd.Txt_descripcion = Me.dtc_desc1.Text
    fw_orden_pago_ccd.txtCodigo1.Caption = Me.Ado_datos.Recordset!compra_codigo
    fw_orden_pago_ccd.lbl_adjudica.Caption = Me.Ado_detalle3.Recordset!adjudica_codigo
    fw_orden_pago_ccd.dtc_cuenta_cod.BoundText = "NN"
    fw_orden_pago_ccd.dtc_cuenta_desc.BoundText = "NN"
...
'            frm_ao_comex_pagos.Txtestado.Text = "REG"
     ...
     fw_orden_pago_ccd.txt_campo1.BoundText = Me.Ado_detalle2.Recordset!beneficiario_codigo
     fw_orden_pago_ccd.Txt_descripcion.BoundText = Me.Ado_detalle2.Recordset!beneficiario_codigo
     fw_orden_pago_ccd.DTPFechaProg.Value = Date
     fw_orden_pago_ccd.DTPFechaPago.Value = Date
     fw_orden_pago_ccd.TxtDscto.Text = GlTipoCambioOficial
     fw_orden_pago_ccd.TxtDscto.Visible = True
     fw_orden_pago_ccd.Show vbModal
...
'    FrmABMDet3.Enabled = False
    Fra_datos.Enabled = False
    Select Case dtc_codigo2.Text
        Case "30"    'CARGOS DE CUENTA
            VAR_DET = "30000"
            Ado_detalle2.Recordset.AddNew
            ao_solicitud_fondos.txt_codigo.Caption = Me.txt_codigo.Caption
            ao_solicitud_fondos.txt_campo1.Caption = Me.dtc_codigo1.Text
            ao_solicitud_fondos.Txt_descripcion.Caption = Me.dtc_desc1.Text
            ao_solicitud_fondos.lbl_edif.Caption = dtc_codigo3.Text
            ao_solicitud_fondos.lbl_det.Caption = VAR_DET     '"34110"
            ao_solicitud_fondos.Txt_estado.Caption = "REG"
            ao_solicitud_fondos.Show vbModal
        Case "28"    'CAJA CHICA
           VAR_DET = "20000"
            Ado_detalle2.Recordset.AddNew
            ao_solicitud_fondos.txt_codigo.Caption = Me.txt_codigo.Caption
...
'                'Call ABRIR_TABLA_DET
                ...
                fw_adjudica_ccd.txt_codigo.Caption = Me.Ado_datos.Recordset!solicitud_codigo  'cod_cabecera
                fw_adjudica_ccd.txt_campo1.Text = Me.Ado_datos.Recordset!unidad_codigo  'Unidad
                fw_adjudica_ccd.Txt_descripcion.Caption = Me.dtc_desc1.Text
                fw_adjudica_ccd.txtCodigo1.Caption = Me.Ado_datos.Recordset!compra_codigo
                If rs_aux4!correla > 0 Then
                fw_adjudica_ccd.lbl_adjudica.Caption = rs_aux4!correla + 1
                Else
                fw_adjudica_ccd.lbl_adjudica.Caption = "1"
                End If
                fw_adjudica_ccd.txtSW.Text = "C"
                fw_adjudica_ccd.txt_total_dol = VAR_FOBSEG
                fw_adjudica_ccd.txt_total_bs = VAR_FOBSEG2
                fw_adjudica_ccd.txt_pais.Text = VAR_PAIS
                fw_adjudica_ccd.Txtestado.Text = "REG"
                fw_adjudica_ccd.txtfecha_compra.Value = Date
                fw_adjudica_ccd.txt_total_bs = "0"
                fw_adjudica_ccd.cmd_unimed2 = "MES"
                fw_adjudica_ccd.txt_tipo_cambio = GlTipoCambioOficial
                fw_adjudica_ccd.opt_bs.Value = True
                fw_adjudica_ccd.cmb_mes_ini.Text = UCase(MonthName(Month(Date)))
'          If parametro = "COMEX" Then
'            fw_adjudica_ccd.txtFecha.Visible = True
'            fw_adjudica_ccd.txtFecha2.Visible = True
'            fw_adjudica_ccd.txtFecha3.Visible = True
'            fw_adjudica_ccd.txtFecha.Value = Date
'            fw_adjudica_ccd.txtFecha2.Value = Date
'            fw_adjudica_ccd.txtFecha3.Value = Date
'            fw_adjudica_ccd.txt_nro_dui.Enabled = True
'            fw_adjudica_ccd.lblbien(2).Visible = True
'            fw_adjudica_ccd.lblbien(3).Visible = True
'            fw_adjudica_ccd.lblbien(4).Visible = True
'            Else
'            fw_adjudica_ccd.txtFecha.Visible = False
'            fw_adjudica_ccd.txtFecha2.Visible = False
'            fw_adjudica_ccd.txtFecha3.Visible = False
'            fw_adjudica_ccd.txt_nro_dui.Enabled = False
'            fw_adjudica_ccd.lblbien(2).Visible = False
'            fw_adjudica_ccd.lblbien(3).Visible = False
'            fw_adjudica_ccd.lblbien(4).Visible = False
'            End If
            fw_adjudica_ccd.txt_total_bs = SUMbs
            fw_adjudica_ccd.txt_total_dol = SUMdol
...
'                fw_adjudica_ccd.txt_total_bs = rs_aux8!total
                fw_adjudica_ccd.Show vbModal
...
If parametro <> "COMEX" Then
    If Format(Ado_detalle2.Recordset!adjudica_monto_bs, "###,###,##0.00") > lbl_total_bs.Caption Then
    ...
    If Ado_detalle2.Recordset("estado_codigo") <> "REG" Then
        sino = MsgBox("No se puede APROBAR um registro ANULADO o Aprobado", vbCritical, "SOFIA")
        Exit Sub
    End If
If Ado_detalle1.Recordset.RecordCount > 0 Then
sino = MsgBox("Desea APROBAR el Registro ? (Ya no podrá modificarlo)", vbYesNo + vbInformation, "Atención")
...
'correlativo ALMACEN
     ...
     Call BIENES
       ...
       'sino = rs_det1A.RecordCount
        ...
        db.Execute "ap_compras_grla 2,'" & rs_det1A!ges_gestion & "'," & rs_det1A!almacen_codigo & ", '" & Ado_datos.Recordset!doc_codigo_alm & "' ," & CORRELARIVO1 & ",'" & rs_det1A!bien_codigo & "','" & Ado_datos.Recordset!edif_codigo & "'," & Ado_datos.Recordset("compra_codigo") & ",'" & Ado_detalle2.Recordset!beneficiario_codigo & "','" & Ado_detalle2.Recordset!fecha_compra & "'," & rs_det1A!adjudica_cantidad & "," & rs_det1A!bien_total_adjudica_bs & "," & CDbl(rs_det1A!bien_total_adjudica_bs / GlTipoCambioOficial) & ", 'REG', '" & glusuario & "','" & Ado_datos.Recordset!compra_DESCRIPCION & "'," & rs_det1A!bien_precio_adjudica_bs & ""
...
'    End If
        ...
        Set rs_aux12 = New Recordset
        If rs_aux12.State = 1 Then rs_aux12.Close
        rs_aux12.Open "Select correl_doc  from gc_documentos_respaldo WHERE doc_codigo = '" & VAR_DOC & "'", db, adOpenKeyset, adLockOptimistic
        If rs_aux12!correl_doc <> "NULL" Then       'AS CORREL
            CORRELATIVO2 = rs_aux12!correl_doc + 1
        Else
            CORRELATIVO2 = "1"
        End If
        rs_aux12!correl_doc = CORRELATIVO2
        rs_aux12.Update
        ...
        Set rs_correl = New Recordset
        If rs_correl.State = 1 Then rs_correl.Close
        rs_correl.Open "Select * from gc_unidad_ejecutora WHERE unidad_codigo = '" & parametro & "'", db, adOpenKeyset, adLockOptimistic
...
'     rs_aux7.Update
    ...
    End If
     ...
     rs_datos!solicitud_tipo = IIf(IsNull(dtc_codigo2.Text) Or dtc_codigo2.Text = "", Aux, dtc_codigo2.Text)
...
'        Case "DCONT"    'SOLO COMPRAS BB y SS   'FIN-03-01
            ...
            Select Case Aux
                Case 28     'CAJA CHICA
                    rs_datos!doc_codigo = "R-161"
                Case 29     'FONDOS PARA VIAJES
                    rs_datos!doc_codigo = "R-162"
                Case 30     'CARGO DE CUENTA
                    rs_datos!doc_codigo = "R-160"
                Case Else
                    rs_datos!doc_codigo = "R-160"
            End Select
'        End Select
        ...
        If Txt_descripcion.Text = "" Then
            Txt_descripcion.Text = lbl_titulo + ", PARA: " + dtc_desc_ben.Text
        End If
     rs_datos!compra_DESCRIPCION = Txt_descripcion.Text
     rs_datos!compra_observaciones = dtc_desc_ben.Text        ' dtc_desc2.Text + " - " + dtc_desc4.Text       ' txt_obs.Text
...
'     rs_datos!ges_gestion_ant = glGestion       'Year(Date)
     If txt_campo1.Caption < 10 Then        'var_cod
        'rs_datos!unidad_codigo_ant = VAR_UNI + "-00000" + Trim(txt_codigo)
        rs_datos!unidad_codigo_ant = VAR_CITE + "-00000" + Trim(txt_campo1.Caption)
     End If
     If var_cod > 9 And var_cod < 100 Then
        rs_datos!unidad_codigo_ant = VAR_CITE + "-0000" + Trim(txt_campo1)
     End If
     If var_cod > 99 And var_cod < 1000 Then
        rs_datos!unidad_codigo_ant = VAR_CITE + "-000" + Trim(txt_campo1)
     End If
     If var_cod > 999 And var_cod < 10000 Then
        rs_datos!unidad_codigo_ant = VAR_CITE + "-00" + Trim(txt_campo1)
     End If
     If var_cod > 9999 And var_cod < 100000 Then
        rs_datos!unidad_codigo_ant = VAR_CITE + "-0" + Trim(txt_campo1)
     End If
     If var_cod > 99999 Then
        rs_datos!unidad_codigo_ant = VAR_CITE + "-" + Trim(txt_campo1)
     End If
  'End If
...
'    End Select
     ...
     rs_datos!beneficiario_codigo_alm = "0"     'IIf(IsNull(dtc_codigo4.Text), 0, dtc_codigo4.Text)
     'Ado_datos.Recordset.Update
    'db.Execute "UPDATE ao_compra_cabecera SET doc_numero = " & rs_aux7!correl_ing + 1 & " WHERE compra_codigo = " & fw_compras_gral.Ado_detalle2.Recordset!compra_codigo & ""
     ...
     If VAR_SW <> "ADD" Then
        sino = Ado_datos.Recordset!compra_codigo
        db.Execute "update ao_almacen_ingresos set concepto = '" & Txt_descripcion.Text & "' WHERE compra_codigo = " & var_cod
  ...
  If (Ado_datos.Recordset.RecordCount > 0) Then
    If Ado_detalle1.Recordset.RecordCount > 0 Then
        ...
        'MsgBox rs.RecordCount
          ...
          CR01.Formulas(1) = "Subtitulo = DETALLE "
...
'    FrmABMDet.Enabled = False
    ...
    Fra_datos.Enabled = False
            ...
            'fw_orden_pago_ccd.Txt_campo1.Text = Me.Ado_datos.Recordset!unidad_codigo  'Unidad
'            fw_orden_pago_ccd.Txt_descripcion = Me.dtc_desc1.Text
            fw_orden_pago_ccd.txt_codigo.Caption = Me.Ado_datos.Recordset!compra_codigo
            fw_orden_pago_ccd.lbl_adjudica.Caption = Me.Ado_detalle3.Recordset!adjudica_codigo
            fw_orden_pago_ccd.txtCodigo1.Caption = Me.Ado_detalle3.Recordset!pago_codigo
            'fw_orden_pago_ccd.Txt_campo1.Text = Me.Ado_detalle3.Recordset!beneficiario_codigo
            fw_orden_pago_ccd.Txt_descripcion.BoundText = fw_orden_pago_ccd.txt_campo1.BoundText
            
            fw_orden_pago_ccd.DTPFechaProg.Value = IIf(IsNull(Me.Ado_detalle3.Recordset!pago_fecha_prog), Date, Me.Ado_detalle3.Recordset!pago_fecha_prog)
            fw_orden_pago_ccd.DTPFechaPago.Value = IIf(IsNull(Me.Ado_detalle3.Recordset!pago_fecha_efectiva), Date, Me.Ado_detalle3.Recordset!pago_fecha_efectiva)
            fw_orden_pago_ccd.TxtImporteBs.Text = Format(Me.Ado_detalle3.Recordset!pago_monto_bs, "###,###,##0.00")
            fw_orden_pago_ccd.TxtMontoDol.Text = Format(IIf(IsNull(Me.Ado_detalle3.Recordset!pago_monto_dol), 0, Round(Me.Ado_detalle3.Recordset!pago_monto_dol, 2)), "###,###,##0.00")
            fw_orden_pago_ccd.TxtMontoBs.Text = Format(Me.Ado_detalle3.Recordset!pago_total_bs, "###,###,##0.00")
            fw_orden_pago_ccd.TxtMontoDol.Text = Format(IIf(IsNull(Me.Ado_detalle3.Recordset!pago_total_dol), 0, Round(Me.Ado_detalle3.Recordset!pago_monto_dol, 2)), "###,###,##0.00")
            fw_orden_pago_ccd.txt_factura.Text = IIf(IsNull(Me.Ado_detalle3.Recordset!pago_nro_cmpbte_factura), 0, Me.Ado_detalle3.Recordset!pago_nro_cmpbte_factura)
            fw_orden_pago_ccd.txtDoc.Text = IIf(IsNull(Me.Ado_detalle3.Recordset!pago_nro_autorizacion), 0, Me.Ado_detalle3.Recordset!pago_nro_autorizacion)
            
            fw_orden_pago_ccd.TxtConcepto.Text = Me.Ado_detalle3.Recordset!pago_descripcion
            fw_orden_pago_ccd.txt_respaldos.Text = IIf(IsNull(Me.Ado_detalle3.Recordset!pago_respaldos), "FACTURA", Me.Ado_detalle3.Recordset!pago_respaldos)
            
            fw_orden_pago_ccd.Txt_descripcion.BoundText = Me.Ado_detalle3.Recordset!beneficiario_codigo
'            fw_orden_pago_ccd.Txtestado.Text = "REG"
            fw_orden_pago_ccd.dtc_cuenta_cod.BoundText = IIf(IsNull(Me.Ado_detalle3.Recordset("cta_codigo")), "NN", Me.Ado_detalle3.Recordset("cta_codigo"))
            fw_orden_pago_ccd.dtc_cuenta_desc.BoundText = IIf(IsNull(Me.Ado_detalle3.Recordset("cta_codigo")), "NN", Me.Ado_detalle3.Recordset("cta_codigo"))
            fw_orden_pago_ccd.TxtDscto.Text = IIf(IsNull(Me.Ado_detalle3.Recordset("tipo_cambio")), GlTipoCambioOficial, Me.Ado_detalle3.Recordset("tipo_cambio"))
            fw_orden_pago_ccd.TxtDscto.Visible = True
            If Ado_detalle3.Recordset!pago_emite_factura = "S" Then
                fw_orden_pago_ccd.Chk_fac.Value = 1
            Else
                fw_orden_pago_ccd.Chk_fac.Value = 0
            End If
            If Ado_detalle3.Recordset!retension_asumida = "S" Then
                fw_orden_pago_ccd.Chk_Ret.Value = 1
            Else
                fw_orden_pago_ccd.Chk_Ret.Value = 0
            End If
            fw_orden_pago_ccd.Show vbModal
...
'        FrmABMDet3.Enabled = False
        ...
        '    fecha_recibe_almacen, almacen_codigo, poa_codigo, estado_codigo,
         'usr_codigo , fecha_registro, hora_registro, usr_codigo_aprueba, fecha_aprueba
            ...
            fw_adjudica_ccd.txt_codigo.Caption = Me.Ado_detalle2.Recordset("solicitud_codigo")  'cod_cabecera
            fw_adjudica_ccd.txt_campo1.Text = Me.Ado_detalle2.Recordset("unidad_codigo")  'Unidad
            fw_adjudica_ccd.Txt_descripcion.Caption = Me.dtc_desc1.Text
            fw_adjudica_ccd.txtCodigo1.Caption = Me.Ado_detalle2.Recordset("compra_codigo")
            'fw_adjudica_ccd.Txt_estado.Caption = "REG"
            
            fw_adjudica_ccd.lbl_adjudica.Caption = Me.Ado_detalle2.Recordset("adjudica_codigo")
            fw_adjudica_ccd.dtc_codigo5.Text = Me.Ado_detalle2.Recordset("beneficiario_codigo")
            fw_adjudica_ccd.dtc_desc5.BoundText = fw_adjudica_ccd.dtc_codigo5.BoundText
            fw_adjudica_ccd.dtc_aux4.BoundText = fw_adjudica_ccd.dtc_codigo5.BoundText
            fw_adjudica_ccd.dtc_aux5.BoundText = fw_adjudica_ccd.dtc_codigo5.BoundText

            fw_adjudica_ccd.txt_Nota.Text = IIf(IsNull(Me.Ado_detalle2.Recordset("nro_nota_remision")), "", Me.Ado_detalle2.Recordset("nro_nota_remision"))
            fw_adjudica_ccd.txt_total_bs.Text = Format(IIf(IsNull(Me.Ado_detalle2.Recordset("adjudica_monto_bs")), 0, Me.Ado_detalle2.Recordset("adjudica_monto_bs")), "###,###,##0.00")
            fw_adjudica_ccd.txt_total_dol.Text = Format(IIf(IsNull(Me.Ado_detalle2.Recordset!adjudica_monto_dol), 0, Me.Ado_detalle2.Recordset!adjudica_monto_dol), "###,###,##0.00")
            fw_adjudica_ccd.txtFecha.Value = IIf(IsNull(Me.Ado_detalle2.Recordset("fecha_inicio_contrato")), Date, Me.Ado_detalle2.Recordset("fecha_inicio_contrato"))
            fw_adjudica_ccd.txtFecha2.Value = IIf(IsNull(Me.Ado_detalle2.Recordset("fecha_fin_contrato")), Date, Me.Ado_detalle2.Recordset("fecha_fin_contrato"))
            fw_adjudica_ccd.txtFecha3.Value = IIf(IsNull(Me.Ado_detalle2.Recordset("fecha_envio_proveedor")), Date, Me.Ado_detalle2.Recordset("fecha_envio_proveedor"))
            
            fw_adjudica_ccd.cmb_mes_ini = IIf(IsNull(Me.Ado_detalle2.Recordset!mes_inicio_crono), UCase(MonthName(Month(Date))), Me.Ado_detalle2.Recordset!mes_inicio_crono)
            fw_adjudica_ccd.txtCantCuota.Text = IIf(IsNull(Me.Ado_detalle2.Recordset!cantidad_cuotas_pag), "1", Me.Ado_detalle2.Recordset!cantidad_cuotas_pag)
            fw_adjudica_ccd.cmd_unimed2 = IIf(IsNull(Me.Ado_detalle2.Recordset!unimed_codigo_pag), "MES", Me.Ado_detalle2.Recordset!unimed_codigo_pag)
            
            fw_adjudica_ccd.txtSW.Text = Me.Ado_datos.Recordset!venta_tipo
            If Me.Ado_detalle2.Recordset("almacen_codigo") <> "NULL" Then
            fw_adjudica_ccd.dtc_desc_alm.BoundText = Me.Ado_detalle2.Recordset("almacen_codigo")
            End If
            fw_adjudica_ccd.txt_pais.Text = VAR_PAIS
            fw_adjudica_ccd.txtfecha_compra.Value = IIf(IsNull(Me.Ado_detalle2.Recordset!fecha_compra), Date, Me.Ado_detalle2.Recordset!fecha_compra)
            fw_adjudica_ccd.txt_autorizacion.Text = IIf(IsNull(Ado_detalle2.Recordset("nro_autorizacion")), "", Ado_detalle2.Recordset("nro_autorizacion"))
            fw_adjudica_ccd.txt_cod_control.Text = IIf(IsNull(Ado_detalle2.Recordset("codigo_control")), "", Ado_detalle2.Recordset("codigo_control"))
            
            fw_adjudica_ccd.txt_nro_dui.Text = IIf(IsNull(Me.Ado_detalle2.Recordset("nro_dui")), 0, Me.Ado_detalle2.Recordset("nro_dui"))
             fw_adjudica_ccd.txt_importe_no_fiscal.Text = IIf(IsNull(Me.Ado_detalle2.Recordset("importe_no_credito_fisc")), 0, Me.Ado_detalle2.Recordset("importe_no_credito_fisc"))
            fw_adjudica_ccd.txt_descuentos.Text = IIf(IsNull(Me.Ado_detalle2.Recordset("descuento")), 0, Me.Ado_detalle2.Recordset("descuento"))
            If fw_adjudica_ccd.txt_tipo_cambio = "0" Or fw_adjudica_ccd.txt_tipo_cambio = "" Then
                fw_adjudica_ccd.txt_tipo_cambio = GlTipoCambioOficial
            Else
                fw_adjudica_ccd.txt_tipo_cambio = Ado_detalle2.Recordset("tipo_cambio")
            End If
            Ado_detalle2.Recordset!tipo_moneda = "BOB"
            If Ado_detalle2.Recordset("tipo_moneda") = "USD" Then
                fw_adjudica_ccd.opt_usd.Value = True
            End If
            If Ado_detalle2.Recordset("tipo_moneda") = "BOB" Then
                fw_adjudica_ccd.opt_bs.Value = True
            End If
            If fw_compras_gral.Ado_detalle2.Recordset("factura") = "NO" Then
                fw_adjudica_ccd.opt_no.Value = True
            Else
                fw_adjudica_ccd.opt_si.Value = True
            End If
            fw_adjudica_ccd.txtFecha.Value = IIf(IsNull(Me.Ado_detalle2.Recordset!fecha_inicio_contrato), Me.Ado_detalle2.Recordset!fecha_compra, Me.Ado_detalle2.Recordset!fecha_inicio_contrato)
             fw_adjudica_ccd.txtFecha2.Value = IIf(IsNull(Me.Ado_detalle2.Recordset!fecha_fin_contrato), Me.Ado_detalle2.Recordset!fecha_compra, Me.Ado_detalle2.Recordset!fecha_fin_contrato)
             fw_adjudica_ccd.txtFecha3.Value = IIf(IsNull(Me.Ado_detalle2.Recordset!fecha_envio_proveedor), Me.Ado_detalle2.Recordset!fecha_compra, Me.Ado_detalle2.Recordset!fecha_envio_proveedor)
...
If Txt_descripcion.Text = "" Then
    ...
    Txt_descripcion.Text = lbl_titulo + ", PARA: " + dtc_desc_ben
    'If dtc_codigo2 = "28" Then
...
'    FraDet1.Visible = False
    ...
    'If Glaux = "PROVI" Then
        'FraDet1.Caption = "DETALLE DE " + lbl_titulo.Caption
    'Else
...
'
    ...
    rs_datos2.Open "select * from gc_tipo_solicitud where solicitud_tipo ='28' or solicitud_tipo ='29' OR solicitud_tipo ='30' ", db, adOpenStatic
   ...
   ' sino = Ado_datos3.Recordset.RecordCount
    ...
    rs_datos4.Open "select * from gc_beneficiario where estado_codigo = 'APR' AND tipoben_codigo = 1 ORDER BY beneficiario_denominacion", db, adOpenStatic
...
Else
    ...
    rs_det2.Open "select * from ao_compra_adjudica where unidad_codigo = '" & Ado_datos.Recordset!unidad_codigo & "' and compra_codigo = " & Ado_datos.Recordset!compra_codigo & " ", db, adOpenKeyset, adLockOptimistic, adCmdText
    rs_det2.Sort = "adjudica_codigo"
    Set Ado_detalle2.Recordset = rs_det2
    If Ado_detalle2.Recordset.RecordCount > 0 Then
        dg_det2.Visible = True
...
Private Sub OptFilGral1_Click()
    ...
    Select Case Aux
        Case 28    'CAJA CHICA
            queryinicial = "Select * from fv_solicitud_fondos where estado_codigo = 'REG' AND solicitud_tipo = " & Aux & " AND unidad_codigo = '" & parametro & "' "
        Case 29    'FONDOS PARA VIAJES
            queryinicial = "Select * from fv_solicitud_fondos where estado_codigo = 'REG' AND solicitud_tipo = " & Aux & " AND unidad_codigo = '" & parametro & "' "
        Case 30    'CARGO DE CUENTA
            queryinicial = "Select * from fv_solicitud_fondos where estado_codigo = 'REG' AND solicitud_tipo = " & Aux & " AND unidad_codigo = '" & parametro & "' "
...
Private Sub OptFilGral2_Click()
    ...
    Select Case Aux
        Case 28    'CAJA CHICA
            queryinicial = "Select * from fv_solicitud_fondos where solicitud_tipo = " & Aux & " AND unidad_codigo = '" & parametro & "' "
        Case 29    'FONDOS PARA VIAJES
            queryinicial = "Select * from fv_solicitud_fondos where solicitud_tipo = " & Aux & " AND unidad_codigo = '" & parametro & "' "
        Case 30    'CARGO DE CUENTA
            queryinicial = "Select * from fv_solicitud_fondos where solicitud_tipo = " & Aux & " AND unidad_codigo = '" & parametro & "' "
