...
Begin VB.Form frm_po_insumo 
   BackColor       =   &H00000000&
   Caption         =   "Planificación - Plan de Operaciones - Insumo"
   ClientHeight    =   9765
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   15120
   Icon            =   "frm_po_insumo.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   9765
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_po_insumo.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   16395
      TabIndex        =   62
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_po_insumo.frx":1982B
         Style           =   1  'Graphical
         TabIndex        =   63
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_po_insumo.frx":19A35
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_po_insumo.frx":1A059
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_po_insumo.frx":1A639
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   6000
         Picture         =   "frm_po_insumo.frx":1B303
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_po_insumo.frx":1B50D
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_po_insumo.frx":1BACA
         Style           =   1  'Graphical
         TabIndex        =   66
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_po_insumo.frx":1C082
         Style           =   1  'Graphical
         TabIndex        =   65
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_po_insumo.frx":1C28C
         Style           =   1  'Graphical
         TabIndex        =   64
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_po_insumo.frx":1C6CE
      ScaleHeight     =   915
      ScaleWidth      =   16395
      TabIndex        =   58
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_po_insumo.frx":354F7
         Style           =   1  'Graphical
         TabIndex        =   60
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_po_insumo.frx":35701
         Style           =   1  'Graphical
         TabIndex        =   59
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_po_insumo.frx":3590B
         Height          =   8250
         Left            =   120
         TabIndex        =   21
         Top             =   240
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_aux11 
         Bindings        =   "frm_po_insumo.frx":35923
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "frm_po_insumo.frx":3593D
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_po_insumo.frx":35957
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_po_insumo.frx":35970
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_po_insumo.frx":35989
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_po_insumo.frx":359A2
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4035
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_po_insumo.frx":359BB
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_po_insumo.frx":359D4
         DataField       =   "estrategico_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_po_insumo.frx":359ED
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3600
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "frm_po_insumo.frx":35A06
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4035
      ...
      Begin MSDataListLib.DataCombo dtc_codigo8 
         Bindings        =   "frm_po_insumo.frx":35A20
      ...
      Begin MSDataListLib.DataCombo dtc_desc8 
         Bindings        =   "frm_po_insumo.frx":35A39
         DataField       =   "clasif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3045
      ...
      Begin MSDataListLib.DataCombo dtc_codigo9 
         Bindings        =   "frm_po_insumo.frx":35A52
         DataField       =   "doc_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1995
      ...
      Begin MSDataListLib.DataCombo dtc_desc9 
         Bindings        =   "frm_po_insumo.frx":35A6B
         DataField       =   "doc_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3045
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_po_insumo.frx":35A84
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_po_insumo.frx":35A9D
         DataField       =   "org_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "frm_po_insumo.frx":35AB6
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "frm_po_insumo.frx":35ACF
         DataField       =   "especifico_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "frm_po_insumo.frx":35AE8
      ...
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "frm_po_insumo.frx":35B01
         DataField       =   "actividad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_codigo7 
         Bindings        =   "frm_po_insumo.frx":35B1A
         DataField       =   "tarea_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   9000
         TabIndex        =   95
         ...
         BoundColumn     =   "tarea_codigo"
         Text            =   ""
      End
      Begin MSDataListLib.DataCombo dtc_desc7 
         Bindings        =   "frm_po_insumo.frx":35B33
         DataField       =   "tarea_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "frm_po_insumo.frx":35B4C
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "frm_po_insumo.frx":35B66
         DataField       =   "par_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_aux1a 
         Bindings        =   "frm_po_insumo.frx":35B80
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5280
      ...
      Begin VB.Label lbl_descripcion 
         BackColor       =   &H00000000&
         BackStyle       =   0  'Transparent
         Caption         =   "Descripcion del Insumo del POA"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_po_insumo"
...
Private Sub OptFilGral1_Click()
    ...
    queryinicial = "Select * from pc_poa_insumo where estado_codigo = 'REG' "
...
Private Sub OptFilGral2_Click()
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    queryinicial = "Select * from pc_poa_insumo "
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
...
Private Sub txt_campo4_LostFocus()
    If Val(txt_campo4.Text) > 2099 Or Val(txt_campo4.Text) < 1980 Then
