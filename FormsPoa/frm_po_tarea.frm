...
Begin VB.Form frm_po_tarea 
   BackColor       =   &H00000000&
   Caption         =   "Planificación - Plan de Operaciones - Tarea"
   ClientHeight    =   9765
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   15120
   Icon            =   "frm_po_tarea.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   9765
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_po_tarea.frx":1982B
         Style           =   1  'Graphical
         TabIndex        =   63
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_po_tarea.frx":19A35
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_po_tarea.frx":1A059
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_po_tarea.frx":1A639
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   6000
         Picture         =   "frm_po_tarea.frx":1B303
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_po_tarea.frx":1B50D
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_po_tarea.frx":1BACA
         Style           =   1  'Graphical
         TabIndex        =   66
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_po_tarea.frx":1C082
         Style           =   1  'Graphical
         TabIndex        =   65
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_po_tarea.frx":1C28C
         Style           =   1  'Graphical
         TabIndex        =   64
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_po_tarea.frx":1C6CE
      ScaleHeight     =   915
      ScaleWidth      =   16395
      TabIndex        =   58
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_po_tarea.frx":354F7
         Style           =   1  'Graphical
         TabIndex        =   60
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_po_tarea.frx":35701
         Style           =   1  'Graphical
         TabIndex        =   59
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_po_tarea.frx":3590B
         Height          =   7770
         Left            =   120
         TabIndex        =   21
         Top             =   240
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_aux11 
         Bindings        =   "frm_po_tarea.frx":35923
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "frm_po_tarea.frx":3593D
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_po_tarea.frx":35957
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_po_tarea.frx":35970
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_po_tarea.frx":35989
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_po_tarea.frx":359A2
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4035
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_po_tarea.frx":359BB
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_po_tarea.frx":359D4
         DataField       =   "estrategico_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_po_tarea.frx":359ED
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3600
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "frm_po_tarea.frx":35A06
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4035
      ...
      Begin MSDataListLib.DataCombo dtc_codigo8 
         Bindings        =   "frm_po_tarea.frx":35A20
      ...
      Begin MSDataListLib.DataCombo dtc_desc8 
         Bindings        =   "frm_po_tarea.frx":35A39
         DataField       =   "clasif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3045
      ...
      Begin MSDataListLib.DataCombo dtc_codigo9 
         Bindings        =   "frm_po_tarea.frx":35A52
         DataField       =   "doc_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1995
      ...
      Begin MSDataListLib.DataCombo dtc_desc9 
         Bindings        =   "frm_po_tarea.frx":35A6B
         DataField       =   "doc_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3045
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_po_tarea.frx":35A84
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_po_tarea.frx":35A9D
         DataField       =   "pro_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "frm_po_tarea.frx":35AB6
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "frm_po_tarea.frx":35ACF
         DataField       =   "especifico_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "frm_po_tarea.frx":35AE8
         DataField       =   "actividad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   9000
         TabIndex        =   88
         ...
         BoundColumn     =   "actividad_codigo"
         Text            =   ""
      End
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "frm_po_tarea.frx":35B01
         DataField       =   "actividad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin MSDataListLib.DataCombo dtc_aux1a 
         Bindings        =   "frm_po_tarea.frx":35B1A
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5280
      ...
      Begin VB.Label lbl_descripcion 
         BackColor       =   &H00000000&
         BackStyle       =   0  'Transparent
         Caption         =   "Descripcion de la Tarea del POA"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_po_tarea"
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from pc_poa_actividad where estrategico_codigo = " & Ado_datos.Recordset!estrategico_codigo & " AND especifico_codigo = " & Ado_datos.Recordset!especifico_codigo & " AND actividad_codigo = " & dtc_codigo6.Text & " "
        rs_aux1.Open SQL_FOR, db, adOpenKeyset, adLockOptimistic
        If rs_aux1.RecordCount > 0 Then
            var_cod = rs_aux1!correl_tarea + 1
            'Actualiza correaltivo ...
            db.Execute "Update pc_poa_actividad Set correl_tarea = " & var_cod & " Where estrategico_codigo = " & Ado_datos.Recordset!estrategico_codigo & " AND especifico_codigo = " & Ado_datos.Recordset!especifico_codigo & " AND actividad_codigo = " & dtc_codigo6.Text & " "
        Else
            var_cod = 1
        End If
        ...
        txt_codigo.Caption = Trim(dtc_codigo2.Text) + "." + Trim(dtc_codigo5.Text) + "." + Trim(dtc_codigo6.Text) + "." + var_cod
        rs_datos!tarea_codigo = var_cod
...
Private Sub BtnImprimir_Click()
  If (Ado_datos.Recordset.RecordCount > 0) Then
        ...
        CR01.ReportFileName = App.Path & "\Reportes\poa\pr_poa_tarea.rpt"
...
Private Sub OptFilGral1_Click()
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    queryinicial = "Select * from pc_poa_tarea where estado_codigo = 'REG' "
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
...
Private Sub OptFilGral2_Click()
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    queryinicial = "Select * from pc_poa_tarea "
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
