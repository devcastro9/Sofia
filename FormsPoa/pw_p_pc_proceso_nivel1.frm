...
Begin VB.Form pw_p_pc_proceso_nivel1 
   BackColor       =   &H00000000&
   Caption         =   "Planificación - Procesos (Nivel 1)"
   ClientHeight    =   6495
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   12690
   Icon            =   "pw_p_pc_proceso_nivel1.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   6495
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "pw_p_pc_proceso_nivel1.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   12360
      TabIndex        =   19
      Top             =   120
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   27
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6D058
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6D638
         Style           =   1  'Graphical
         TabIndex        =   25
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6E302
         Style           =   1  'Graphical
         TabIndex        =   24
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6E50C
         Style           =   1  'Graphical
         TabIndex        =   23
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6EAC9
         Style           =   1  'Graphical
         TabIndex        =   22
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6F081
         Style           =   1  'Graphical
         TabIndex        =   21
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "pw_p_pc_proceso_nivel1.frx":6F28B
         Style           =   1  'Graphical
         TabIndex        =   20
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "pw_p_pc_proceso_nivel1.frx":6F495
      ScaleHeight     =   915
      ScaleWidth      =   12315
      TabIndex        =   15
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "pw_p_pc_proceso_nivel1.frx":DB4C7
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "pw_p_pc_proceso_nivel1.frx":DB6D1
         Style           =   1  'Graphical
         TabIndex        =   16
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Proceso (Nivel 1)"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "pw_p_pc_proceso_nivel1"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
   If ExisteReg(Ado_datos.Recordset!proceso_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado ..", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from gc_proceso_nivel1 where proceso_codigo = '" & txt_codigo.Text & "'  "
'        Set rs_aux1.DataSource = db.Execute(" EXEC gp_listar_mediante_codigo_gc_direccion_general '" & txt_codigo.Text & "' ")
        ...
        End If
        rs_datos!proceso_codigo = var_cod
        rs_datos!estado_codigo = "REG"
'        rs_datos!Correl = 0
     End If
     rs_datos!proceso_descripcion = Txt_descripcion.Text
     rs_datos!fecha_registro = Date
     rs_datos!usr_codigo = glusuario
     rs_datos.UpdateBatch adAffectAll
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\poa\pr_proceso_nivel1.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from gc_proceso_nivel1  "
