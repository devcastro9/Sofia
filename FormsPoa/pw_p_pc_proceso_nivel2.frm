...
Begin VB.Form pw_p_pc_proceso_nivel2 
   BackColor       =   &H00000000&
   Caption         =   "Planificación - SubProcesos (Nivel 2)"
   ClientHeight    =   7335
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   14835
   Icon            =   "pw_p_pc_proceso_nivel2.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7335
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "pw_p_pc_proceso_nivel2.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   14520
      TabIndex        =   36
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   44
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   43
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6CE48
         Style           =   1  'Graphical
         TabIndex        =   42
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6D400
         Style           =   1  'Graphical
         TabIndex        =   41
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6D9BD
         Style           =   1  'Graphical
         TabIndex        =   40
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6DBC7
         Style           =   1  'Graphical
         TabIndex        =   39
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6E891
         Style           =   1  'Graphical
         TabIndex        =   38
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "pw_p_pc_proceso_nivel2.frx":6EE71
         Style           =   1  'Graphical
         TabIndex        =   37
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "pw_p_pc_proceso_nivel2.frx":6F495
      ScaleHeight     =   915
      ScaleWidth      =   14475
      TabIndex        =   32
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "pw_p_pc_proceso_nivel2.frx":DB4C7
         Style           =   1  'Graphical
         TabIndex        =   34
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "pw_p_pc_proceso_nivel2.frx":DB6D1
         Style           =   1  'Graphical
         TabIndex        =   33
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "pw_p_pc_proceso_nivel2.frx":DB8DB
      ...
      Begin VB.TextBox txt_parametro_menor 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         DataField       =   "subproceso_parametro_menor"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   360
         TabIndex        =   4
      ...
      Begin VB.TextBox txt_nro_dias_habiles 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         DataField       =   "subproceso_nro_dias_habiles"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   2880
         TabIndex        =   6
      ...
      Begin VB.TextBox txt_parametro_mayor 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         DataField       =   "subproceso_parametro_mayor"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   360
         TabIndex        =   5
      ...
      Begin VB.TextBox txt_nro_dias_calendario 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         DataField       =   "subproceso_nro_dias_calendario"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   2880
         TabIndex        =   7
      ...
      Begin VB.TextBox txt_margen_preferencia 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         DataField       =   "subproceso_margen_preferencia"
         DataSource      =   "Ado_datos"
         Height          =   285
         Left            =   5400
         TabIndex        =   9
      ...
      Begin VB.TextBox txt_observacion 
         Appearance      =   0  'Flat
         BackColor       =   &H00FFFFFF&
         DataField       =   "subproceso_observacion"
         DataSource      =   "Ado_datos"
         Height          =   555
         Left            =   360
         TabIndex        =   10
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "pw_p_pc_proceso_nivel2.frx":DB8F4
         DataField       =   "proceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   360
      ...
      Begin VB.Label lbl_enlace1 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Proceso al cual Pertenece del Nivel 1."
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label lbl_descripcion 
         AutoSize        =   -1  'True
         BackColor       =   &H00000000&
         Caption         =   "Denominación Subproceso (Nivel 2)"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "pw_p_pc_proceso_nivel2"
...
Private Sub BtnImprimir_Click()
  ...
  CR01.ReportFileName = App.Path & "\REPORTES\poa\pr_proceso_nivel2.rpt"
...
Private Sub ABRIR_TABLA()
  ...
  queryinicial = "select  * from gc_proceso_nivel2 "
