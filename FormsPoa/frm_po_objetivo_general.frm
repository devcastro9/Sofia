...
Begin VB.Form frm_po_objetivo_general 
   BackColor       =   &H00000000&
   Caption         =   "Planificación - Plan de Operaciones - Objetivo General"
   ClientHeight    =   10050
   ClientLeft      =   1110
   ClientTop       =   345
   ClientWidth     =   15120
   Icon            =   "frm_po_objetivo_general.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10050
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_po_objetivo_general.frx":0A02
      ScaleHeight     =   960
      ScaleWidth      =   14835
      TabIndex        =   61
      Top             =   120
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_po_objetivo_general.frx":6CA34
         Style           =   1  'Graphical
         TabIndex        =   62
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_po_objetivo_general.frx":6CC3E
         Style           =   1  'Graphical
         TabIndex        =   70
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_po_objetivo_general.frx":6D262
         Style           =   1  'Graphical
         TabIndex        =   69
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_po_objetivo_general.frx":6D842
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   6000
         Picture         =   "frm_po_objetivo_general.frx":6E50C
         Style           =   1  'Graphical
         TabIndex        =   67
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_po_objetivo_general.frx":6E716
         Style           =   1  'Graphical
         TabIndex        =   66
         ToolTipText     =   "Imprime Listado"
         Top             =   120
         Width           =   765
      End
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_po_objetivo_general.frx":6ECD3
         Style           =   1  'Graphical
         TabIndex        =   65
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_po_objetivo_general.frx":6F28B
         Style           =   1  'Graphical
         TabIndex        =   64
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_po_objetivo_general.frx":6F495
         Style           =   1  'Graphical
         TabIndex        =   63
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_po_objetivo_general.frx":6F8D7
      ScaleHeight     =   915
      ScaleWidth      =   14835
      TabIndex        =   57
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_po_objetivo_general.frx":DB909
         Style           =   1  'Graphical
         TabIndex        =   59
         Top             =   120
         Width           =   765
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_po_objetivo_general.frx":DBB13
         Style           =   1  'Graphical
         TabIndex        =   58
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_po_objetivo_general.frx":DBD1D
         Height          =   5970
         Left            =   120
         TabIndex        =   19
         Top             =   240
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_aux11 
         Bindings        =   "frm_po_objetivo_general.frx":DBD35
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "frm_po_objetivo_general.frx":DBD4F
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_po_objetivo_general.frx":DBD69
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   6360
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_po_objetivo_general.frx":DBD82
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_po_objetivo_general.frx":DBD9B
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4035
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_po_objetivo_general.frx":DBDB4
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7440
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_po_objetivo_general.frx":DBDCD
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3600
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "frm_po_objetivo_general.frx":DBDE6
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4035
      ...
      Begin MSDataListLib.DataCombo dtc_codigo8 
         Bindings        =   "frm_po_objetivo_general.frx":DBE00
      ...
      Begin MSDataListLib.DataCombo dtc_desc8 
         Bindings        =   "frm_po_objetivo_general.frx":DBE19
         DataField       =   "clasif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3045
      ...
      Begin MSDataListLib.DataCombo dtc_codigo9 
         Bindings        =   "frm_po_objetivo_general.frx":DBE32
         DataField       =   "doc_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1995
      ...
      Begin MSDataListLib.DataCombo dtc_desc9 
         Bindings        =   "frm_po_objetivo_general.frx":DBE4B
         DataField       =   "doc_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3045
      ...
      Begin MSDataListLib.DataCombo dtc_aux1a 
         Bindings        =   "frm_po_objetivo_general.frx":DBE64
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5400
      ...
      Begin VB.Label lbl_descripcion 
         BackColor       =   &H00000000&
         Caption         =   "Descripcion del Objetivo General"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "frm_po_objetivo_general"
...
Private Sub BtnEliminar_Click()
  On Error GoTo UpdateErr
  If Ado_datos.Recordset.RecordCount > 0 Then
    If ExisteReg(Ado_datos.Recordset!estrategico_codigo) Then MsgBox "No se puede ANULAR el Registro que ya fue utilizado previamente ...", vbInformation + vbOKOnly, "Atención": Exit Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
    If VAR_SW = "ADD" Then
        ...
        SQL_FOR = "select * from pc_poa_estrategico  "
        ...
        rs_datos!estrategico_codigo = var_cod
        rs_datos!poa_codigo = var_cod
        ...
        db.Execute "Update fc_correl Set numero_correlativo = " & var_cod & " Where tipo_tramite = 'OBJETIVO'   "
        rs_datos!doc_numero = "0"    'txt_campo1.Caption
        rs_datos!poa_meta = "100"
        rs_datos!poa_codigo_anterior = var_cod
        'rs_datos!archivo_respaldo = "sin_nombre"
        'rs_datos!archivo_respaldo_cargado = "N"
        rs_datos!correl_especifico = 0
        rs_datos!doc_numero = 0
        rs_datos!poa_nivel = 1
...
If (Ado_datos.Recordset.RecordCount > 0) Then
        ...
        CR01.ReportFileName = App.Path & "\Reportes\poa\pr_poa_objetivo_gral.rpt"
...
Private Function ExisteReg(Unidad As String) As Boolean
    ...
    GlSqlAux = "SELECT Count(*) AS Cuantos FROM pc_poa_especifico WHERE estrategico_codigo = '" & Unidad & "' AND estado_codigo = 'APR' "
...
Private Sub OptFilGral1_Click()
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    queryinicial = "Select * from pc_poa_estrategico where estado_codigo = 'REG' "
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
...
Private Sub OptFilGral2_Click()
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    queryinicial = "Select * from pc_poa_estrategico "
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    Set Ado_datos.Recordset = rs_datos.DataSource
    Set dg_datos.DataSource = Ado_datos.Recordset
End Sub
