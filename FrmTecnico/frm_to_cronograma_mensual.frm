...
Begin VB.Form frm_to_cronograma_mensual 
   ...
   Begin VB.Frame FraDet3 
      ...
      Begin VB.ComboBox cmd_campo2 
         ...
         Left            =   3960
         List            =   "frm_to_cronograma_mensual.frx":0E28
         TabIndex        =   60
         Text            =   "0"
         Top             =   360
         Width           =   735
      ...
      End
   End
   Begin VB.Frame FraProgDias 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Elija las DIAS para el Mes y Zona ..."
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   8.25
         Charset         =   0
      ...
      Begin VB.PictureBox Picture4 
         ...
         Top             =   4200
         Width           =   5450
         Begin VB.PictureBox BtnGrabar9 
            Appearance      =   0  'Flat
            BackColor       =   &H80000006&
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   615
            Left            =   1200
            Picture         =   "frm_to_cronograma_mensual.frx":0E38
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   168
            Top             =   0
            Width           =   1280
         End
         Begin VB.PictureBox BtnCancelar9 
            Appearance      =   0  'Flat
            BackColor       =   &H80000006&
            BorderStyle     =   0  'None
            ForeColor       =   &H80000008&
            Height          =   615
            Left            =   2760
            Picture         =   "frm_to_cronograma_mensual.frx":1626
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   167
            Top             =   0
   ...
   Begin VB.Frame FraDet6 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.PictureBox BtnGrabar6 
            ...
            Height          =   615
            Left            =   1920
            Picture         =   "frm_to_cronograma_mensual.frx":1F12
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   152
            Top             =   0
         ...
         Begin VB.PictureBox BtnCancelar6 
            ...
            Height          =   615
            Left            =   3360
            Picture         =   "frm_to_cronograma_mensual.frx":2700
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   142
            Top             =   0
   ...
   Begin VB.Frame FraInsumos 
      ...
      Begin VB.PictureBox Picture2 
         ...
         Begin VB.PictureBox BtnCancelar8 
            ...
            Height          =   615
            Left            =   4320
            Picture         =   "frm_to_cronograma_mensual.frx":2FEC
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   162
            Top             =   0
         ...
         Begin VB.PictureBox BtnGrabar8 
            ...
            Height          =   615
            Left            =   1920
            Picture         =   "frm_to_cronograma_mensual.frx":38D8
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   161
            Top             =   0
   ...
   Begin VB.Frame FraDet7 
      ...
      Begin VB.PictureBox Picture3 
         ...
         Begin VB.PictureBox BtnCancelar7 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "frm_to_cronograma_mensual.frx":40C6
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   140
            Top             =   0
         ...
         Begin VB.PictureBox BtnGrabar7 
            ...
            Height          =   615
            Left            =   1200
            Picture         =   "frm_to_cronograma_mensual.frx":49B2
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   139
            Top             =   0
      ...
      Begin MSDataListLib.DataCombo DTPfecha4 
         Bindings        =   "frm_to_cronograma_mensual.frx":51A0
         Height          =   315
         Left            =   600
         TabIndex        =   129
         Top             =   720
      ...
      Begin MSDataListLib.DataCombo DTPfecha5 
         Bindings        =   "frm_to_cronograma_mensual.frx":51BA
         Height          =   315
         Left            =   3480
         TabIndex        =   130
         Top             =   720
   ...
   Begin VB.Frame FraDet5 
      ...
      Begin VB.PictureBox Picture5 
         ...
         Begin VB.PictureBox BtnGrabar5 
            ...
            Height          =   615
            Left            =   1560
            Picture         =   "frm_to_cronograma_mensual.frx":51D4
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   151
            Top             =   0
         ...
         Begin VB.PictureBox BtnCancelar5 
            ...
            Height          =   615
            Left            =   3000
            Picture         =   "frm_to_cronograma_mensual.frx":59C2
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   144
            Top             =   0
      ...
      Begin MSDataListLib.DataCombo dtc_desc9 
         Bindings        =   "frm_to_cronograma_mensual.frx":62AE
         Height          =   315
         Left            =   240
         TabIndex        =   117
         Top             =   675
      ...
      Begin MSDataListLib.DataCombo DTPfecha2 
         Bindings        =   "frm_to_cronograma_mensual.frx":62C7
         Height          =   315
         Left            =   840
         TabIndex        =   118
         Top             =   1440
      ...
      Begin MSDataListLib.DataCombo DTPfecha3 
         Bindings        =   "frm_to_cronograma_mensual.frx":62E1
         Height          =   315
         Left            =   3720
         TabIndex        =   122
         Top             =   1440
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.PictureBox Picture11 
         ...
         Begin VB.PictureBox BtnCancelar3 
            ...
            Height          =   615
            Left            =   3720
            Picture         =   "frm_to_cronograma_mensual.frx":62FB
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   150
            Top             =   0
         ...
         Begin VB.PictureBox BtnGraba3 
            ...
            Height          =   615
            Left            =   2160
            Picture         =   "frm_to_cronograma_mensual.frx":6BE7
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   149
            Top             =   0
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "frm_to_cronograma_mensual.frx":73D5
         Height          =   315
         Left            =   240
         TabIndex        =   56
         Top             =   680
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "frm_to_cronograma_mensual.frx":73EE
         Height          =   315
         Left            =   5880
         TabIndex        =   57
         Top             =   680
   ...
   Begin VB.Frame FraDet4 
      ...
      Begin VB.PictureBox Picture8 
         ...
         Begin VB.PictureBox BtnCancelar4 
            ...
            Height          =   615
            Left            =   4440
            Picture         =   "frm_to_cronograma_mensual.frx":7407
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   147
            Top             =   0
         ...
         Begin VB.PictureBox BtnGraba4 
            ...
            Height          =   615
            Left            =   2880
            Picture         =   "frm_to_cronograma_mensual.frx":7CF3
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   146
            Top             =   0
      ...
      Begin VB.Frame Frame2 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo6 
            Bindings        =   "frm_to_cronograma_mensual.frx":84E1
         ...
         Begin MSDataListLib.DataCombo dtc_codigo6A 
            Bindings        =   "frm_to_cronograma_mensual.frx":84FA
         ...
         Begin MSDataListLib.DataCombo dtc_codigo6B 
            Bindings        =   "frm_to_cronograma_mensual.frx":8513
         ...
         Begin MSDataListLib.DataCombo dtc_codigo6C 
            Bindings        =   "frm_to_cronograma_mensual.frx":852C
         ...
         Begin MSDataListLib.DataCombo dtc_codigo6D 
            Bindings        =   "frm_to_cronograma_mensual.frx":8545
         ...
         Begin MSDataListLib.DataCombo dtc_desc6 
            Bindings        =   "frm_to_cronograma_mensual.frx":855E
            DataField       =   "bien_codigo1"
            DataSource      =   "Ado_detalle2"
            Height          =   315
            Left            =   1080
         ...
         Begin MSDataListLib.DataCombo dtc_desc6A 
            Bindings        =   "frm_to_cronograma_mensual.frx":8577
            DataField       =   "bien_codigo2"
            DataSource      =   "Ado_detalle2"
            Height          =   315
            Left            =   1080
         ...
         Begin MSDataListLib.DataCombo dtc_desc6B 
            Bindings        =   "frm_to_cronograma_mensual.frx":8590
            DataField       =   "bien_codigo3"
            DataSource      =   "Ado_detalle2"
            Height          =   315
            Left            =   1080
         ...
         Begin MSDataListLib.DataCombo dtc_desc6C 
            Bindings        =   "frm_to_cronograma_mensual.frx":85A9
            DataField       =   "bien_codigo4"
            DataSource      =   "Ado_detalle2"
            Height          =   315
            Left            =   1080
         ...
         Begin MSDataListLib.DataCombo dtc_desc6D 
            Bindings        =   "frm_to_cronograma_mensual.frx":85C2
            DataField       =   "bien_codigo5"
            DataSource      =   "Ado_detalle2"
            Height          =   315
            Left            =   1080
      ...
      Begin VB.TextBox txt_obs 
         ...
         TabIndex        =   83
         Text            =   "frm_to_cronograma_mensual.frx":85DB
         Top             =   1080
         Width           =   8805
      End
      Begin VB.ComboBox cmd_campo1 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_to_cronograma_mensual.frx":85DD
         Left            =   1920
         List            =   "frm_to_cronograma_mensual.frx":85EA
         TabIndex        =   82
         Top             =   360
         Width           =   3255
      End
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.PictureBox FraGrabarCancelar 
         ...
         Begin VB.PictureBox BtnCancelar 
            ...
            Height          =   615
            Left            =   6195
            Picture         =   "frm_to_cronograma_mensual.frx":862F
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   155
            Top             =   0
         ...
         Begin VB.PictureBox BtnGrabar 
            ...
            Height          =   615
            Left            =   4800
            Picture         =   "frm_to_cronograma_mensual.frx":8F1B
            ScaleHeight     =   615
            ScaleWidth      =   1305
            TabIndex        =   154
            Top             =   0
      ...
      Begin VB.TextBox Txt_campo2 
         ...
         ScrollBars      =   2  'Vertical
         TabIndex        =   28
         Text            =   "frm_to_cronograma_mensual.frx":96F1
         Top             =   2640
         Visible         =   0   'False
         Width           =   10320
      End
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_to_cronograma_mensual.frx":96F3
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_to_cronograma_mensual.frx":970C
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_to_cronograma_mensual.frx":9725
         DataField       =   "unidad_codigo_tec"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1920
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_to_cronograma_mensual.frx":973E
         DataField       =   "zpiloto_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1920
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_to_cronograma_mensual.frx":9757
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_to_cronograma_mensual.frx":9770
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7560
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_to_cronograma_mensual.frx":9789
         Height          =   2490
         Left            =   75
         TabIndex        =   1
         Top             =   240
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17760
         Picture         =   "frm_to_cronograma_mensual.frx":97A1
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   53
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4320
         Picture         =   "frm_to_cronograma_mensual.frx":9F63
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   45
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   2880
         Picture         =   "frm_to_cronograma_mensual.frx":A718
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   44
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   1560
         Picture         =   "frm_to_cronograma_mensual.frx":AF4B
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   43
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frm_to_cronograma_mensual.frx":B697
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   42
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   7200
         Picture         =   "frm_to_cronograma_mensual.frx":BFAC
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   41
         Top             =   0
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   10080
         Picture         =   "frm_to_cronograma_mensual.frx":C76B
         Style           =   1  'Graphical
         TabIndex        =   38
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   9360
         Picture         =   "frm_to_cronograma_mensual.frx":C975
         Style           =   1  'Graphical
         TabIndex        =   39
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox fraOpciones2 
         ...
         Begin VB.PictureBox BtnAñadir3 
            ...
            Height          =   615
            Left            =   6120
            Picture         =   "frm_to_cronograma_mensual.frx":CDB7
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   114
         ...
         Begin VB.PictureBox BtnAñadir2 
            ...
            Height          =   615
            Left            =   4680
            Picture         =   "frm_to_cronograma_mensual.frx":D5CA
            ScaleHeight     =   615
            ScaleWidth      =   1320
            TabIndex        =   85
         ...
         Begin VB.PictureBox BtnModDetalle 
            ...
            Height          =   615
            Left            =   1680
            Picture         =   "frm_to_cronograma_mensual.frx":DE97
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   73
            ToolTipText     =   "Define Horario LABORAL y NO LABORAL, para la Zona y este mes..."
            Top             =   0
            Width           =   1430
         End
         Begin VB.PictureBox BtnAnlDetalle 
            ...
            Height          =   615
            Left            =   3240
            Picture         =   "frm_to_cronograma_mensual.frx":E7AC
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   72
         ...
         Begin VB.PictureBox BtnImprimir 
            ...
            Height          =   615
            Left            =   7560
            Picture         =   "frm_to_cronograma_mensual.frx":EEF8
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   71
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "frm_to_cronograma_mensual.frx":F7C5
         Height          =   7545
         Left            =   75
         TabIndex        =   36
         Top             =   960
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin VB.PictureBox fraOpciones3 
         ...
         Begin VB.PictureBox BtnVer2 
            ...
            Height          =   615
            Left            =   120
            Picture         =   "frm_to_cronograma_mensual.frx":F7E0
            ScaleHeight     =   615
            ScaleWidth      =   1575
            TabIndex        =   127
         ...
         Begin VB.PictureBox BtnAnlDetalle4 
            ...
            Height          =   615
            Left            =   2520
            Picture         =   "frm_to_cronograma_mensual.frx":107C9
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   69
         ...
         Begin VB.PictureBox BtnImprimir2 
            ...
            Height          =   615
            Left            =   4560
            Picture         =   "frm_to_cronograma_mensual.frx":10F15
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   68
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_to_cronograma_mensual.frx":117E2
         Height          =   4320
         Left            =   75
         TabIndex        =   15
         Top             =   960
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Begin VB.PictureBox BtnAnlDetalle3 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_to_cronograma_mensual.frx":117FD
         ScaleHeight     =   615
         ScaleWidth      =   1095
         TabIndex        =   137
         Top             =   7800
      ...
      Begin VB.PictureBox BtnModDetalle2 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_to_cronograma_mensual.frx":1224B
         ScaleHeight     =   615
         ScaleWidth      =   1095
         TabIndex        =   136
         Top             =   7080
      ...
      Begin VB.PictureBox BtnAddDetalle3 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "frm_to_cronograma_mensual.frx":12B65
         ScaleHeight     =   615
         ScaleWidth      =   1095
         TabIndex        =   135
         Top             =   6120
      ...
      Begin VB.PictureBox BtnAnlDetalle2 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_to_cronograma_mensual.frx":134BA
         ScaleHeight     =   615
         ScaleWidth      =   1095
         TabIndex        =   134
         Top             =   5160
      ...
      Begin VB.PictureBox BtnAddDetalle 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_to_cronograma_mensual.frx":13DE3
         ScaleHeight     =   615
         ScaleWidth      =   1095
         TabIndex        =   133
         Top             =   4440
      ...
      Begin VB.CommandButton BtnImprimir3 
         ...
         Height          =   640
         Left            =   0
         Picture         =   "frm_to_cronograma_mensual.frx":14730
         Style           =   1  'Graphical
         TabIndex        =   31
...
'        End Select
        ...
        If Ado_datos.Recordset.RecordCount > 0 Then
            ...
            If Ado_datos.Recordset!estado_codigo = "REG" Then
                '-- ACTUALIZAR MES IMPAR EN to_cronograma_mensual
                db.Execute "UPDATE to_cronograma_mensual set to_cronograma_mensual.mes_par_impar = '1' WHERE (fmes_plan = " & VAR_FMES & ") AND (to_cronograma_mensual.fmes_correl = '1' OR to_cronograma_mensual.fmes_correl = '3' OR to_cronograma_mensual.fmes_correl = '5' OR to_cronograma_mensual.fmes_correl = '7' OR to_cronograma_mensual.fmes_correl = '9' OR to_cronograma_mensual.fmes_correl = '11') AND (to_cronograma_mensual.mes_par_impar is null OR to_cronograma_mensual.mes_par_impar <> '1') "
                '-- ACTUALIZAR MES PAR EN to_cronograma_mensual
                db.Execute "UPDATE to_cronograma_mensual set to_cronograma_mensual.mes_par_impar = '2' WHERE (fmes_plan = " & VAR_FMES & ") AND (to_cronograma_mensual.fmes_correl = '2' OR to_cronograma_mensual.fmes_correl = '4' OR to_cronograma_mensual.fmes_correl = '6' OR to_cronograma_mensual.fmes_correl = '8' OR to_cronograma_mensual.fmes_correl = '10' OR to_cronograma_mensual.fmes_correl = '12')  AND (to_cronograma_mensual.mes_par_impar is null OR to_cronograma_mensual.mes_par_impar <> '2') "
                '-- ACTUALIZA CON ACEITE           WWWWWWWWWWWWWWWWWWWWWWWWWW
                db.Execute "UPDATE to_cronograma_mensual set to_cronograma_mensual.con_aceite = 'S' FROM to_cronograma_mensual INNER JOIN tc_zonas_piloto ON to_cronograma_mensual.zpiloto_codigo = tc_zonas_piloto.zpiloto_codigo AND to_cronograma_mensual.mes_par_impar  = tc_zonas_piloto.mes_par_impar WHERE to_cronograma_mensual.fmes_plan = " & VAR_FMES & " "
                '-- ACTUALIZA SIN ACEITE
                db.Execute "UPDATE to_cronograma_mensual set to_cronograma_mensual.con_aceite = 'N' FROM to_cronograma_mensual INNER JOIN tc_zonas_piloto ON to_cronograma_mensual.zpiloto_codigo = tc_zonas_piloto.zpiloto_codigo AND to_cronograma_mensual.mes_par_impar <> tc_zonas_piloto.mes_par_impar WHERE to_cronograma_mensual.fmes_plan = " & VAR_FMES & " "
                'db.Execute "UPDATE to_cronograma_mensual set to_cronograma_mensual.con_aceite = 'S' FROM to_cronograma_mensual INNER JOIN tc_zonas_piloto ON to_cronograma_mensual.zpiloto_codigo = tc_zonas_piloto.zpiloto_codigo AND to_cronograma_mensual.mes_par_impar  = tc_zonas_piloto.mes_par_impar WHERE to_cronograma_mensual.fmes_plan = " & VAR_FMES & " "
                '-- ACTUALIZA EDIFICIOS
                db.Execute "update to_cronograma_diario set to_cronograma_diario.edif_codigo = ac_bienes.edif_codigo FROM to_cronograma_diario INNER JOIN ac_bienes ON to_cronograma_diario.bien_codigo = ac_bienes.bien_codigo WHERE (to_cronograma_diario.edif_codigo <> ac_bienes.edif_codigo OR to_cronograma_diario.edif_codigo IS NULL) "
                db.Execute "update to_cronograma_diario set to_cronograma_diario.edif_descripcion = gc_edificaciones.edif_descripcion FROM to_cronograma_diario INNER JOIN gc_edificaciones ON to_cronograma_diario.edif_codigo = gc_edificaciones.edif_codigo  WHERE (to_cronograma_diario.edif_descripcion <> gc_edificaciones.edif_descripcion OR to_cronograma_diario.edif_descripcion IS NULL) "
                '-- ACTUALIZA TIEMPO DE SERVICIO
                'db.Execute "update to_cronograma_diario set to_cronograma_diario.nro_total_horas = ac_bienes.bien_cantidad_por_empaque from to_cronograma_diario inner join ac_bienes on to_cronograma_diario.bien_codigo = ac_bienes.bien_codigo WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") "
                '-- actualiza ORDEN
                db.Execute "update to_cronograma_diario set to_cronograma_diario.bien_orden = tc_zona_piloto_edif.zona_edif_orden from to_cronograma_diario inner join tc_zona_piloto_edif on to_cronograma_diario.edif_codigo = tc_zona_piloto_edif.edif_codigo  WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") "
                '-- ACTUALIZA UNIDAD DE MEDIDA
                db.Execute "UPDATE to_cronograma_diario_final SET to_cronograma_diario_final.cite_certificado = tc_zona_piloto_edif.unimed_codigo FROM to_cronograma_diario_final INNER JOIN tc_zona_piloto_edif ON to_cronograma_diario_final.edif_codigo = tc_zona_piloto_edif.edif_codigo WHERE to_cronograma_diario_final.fmes_plan =  " & VAR_FMES & "  "
                '-- ACTUALIZA INSUMOS AL CRONOGRAMA FINAL
                If Ado_datos.Recordset!COn_aceite = "S" Then
                    db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.cantidad1 = ac_bienes_insumos_kit.cantidad1, to_cronograma_diario_final.cantidad2 = ac_bienes_insumos_kit.cantidad2, to_cronograma_diario_final.cantidad3 = ac_bienes_insumos_kit.cantidad3, to_cronograma_diario_final.cantidad4 = ac_bienes_insumos_kit.cantidad4, to_cronograma_diario_final.cantidad5 = ac_bienes_insumos_kit.cantidad5 From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo WHERE to_cronograma_diario_final.fmes_plan = " & VAR_FMES & "  "
                Else
                    db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.cantidad1 = ac_bienes_insumos_kit.cantidad1, to_cronograma_diario_final.cantidad2 = ac_bienes_insumos_kit.cantidad2, to_cronograma_diario_final.cantidad3 = '0', to_cronograma_diario_final.cantidad4 = '0', to_cronograma_diario_final.cantidad5 = '0' From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo WHERE to_cronograma_diario_final.fmes_plan = " & VAR_FMES & "  "
                    db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.cantidad1 = ac_bienes_insumos_kit.cantidad1, to_cronograma_diario_final.cantidad2 = ac_bienes_insumos_kit.cantidad2, to_cronograma_diario_final.cantidad3 = ac_bienes_insumos_kit.cantidad3, to_cronograma_diario_final.cantidad4 = ac_bienes_insumos_kit.cantidad4, to_cronograma_diario_final.cantidad5 = ac_bienes_insumos_kit.cantidad5 From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo WHERE to_cronograma_diario_final.fmes_plan = " & VAR_FMES & " and to_cronograma_diario_final.cite_certificado <> 'MES' "
                End If
                '-- ACTUALIZA EDIFICIOS
                db.Execute "update to_cronograma_diario_final set to_cronograma_diario_final.edif_codigo = ac_bienes.edif_codigo FROM to_cronograma_diario_final INNER JOIN ac_bienes ON to_cronograma_diario_final.bien_codigo = ac_bienes.bien_codigo WHERE (to_cronograma_diario_final.edif_codigo <> ac_bienes.edif_codigo OR to_cronograma_diario_final.EDIF_CODIGO IS NULL) "
                db.Execute "update to_cronograma_diario_final set to_cronograma_diario_final.edif_descripcion = gc_edificaciones.edif_descripcion FROM to_cronograma_diario_final INNER JOIN gc_edificaciones ON to_cronograma_diario_final.edif_codigo = gc_edificaciones.edif_codigo WHERE (to_cronograma_diario_final.edif_descripcion <> gc_edificaciones.edif_descripcion OR to_cronograma_diario_final.edif_descripcion IS NULL) "
            End If
            buscados = buscados + 1
            If busca3 = 1 Then
                If buscados = 1 Then
...
Private Sub BtnAnlDetalle_Click()
  If Ado_datos.Recordset!estado_codigo = "REG" Then
    ...
    Else
        ...
        sino = MsgBox("Está seguro para cambiar a Horario NO LABORABLE SOLO el registro elegido ...", vbYesNo + vbQuestion, "Atención")
        If sino = vbYes Then
...
'            End If
  ...
  Else
      MsgBox "No se puede ANULAR el Horario, el cronograma ya fue APROBADO o ANULADO ...", vbExclamation, "Validación de Registro"
  End If
...
Private Sub BtnAnlDetalle4_Click()
 If Ado_datos.Recordset!estado_activo = "REG" And Ado_datos.Recordset!estado_codigo = "REG" Then
   If Ado_detalle1.Recordset!estado_codigo = "REG" Then
      ...
      If sino = vbYes Then
        db.Execute "update to_cronograma_diario set estado_activo = 'ANL', estado_codigo = 'ANL' WHERE fmes_plan = " & VAR_FMES & " AND horario_codigo = " & Ado_detalle1.Recordset!horario_codigo & " AND  bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "'  "
        'db.Execute "update to_cronograma_diario set bien_codigo = '', unidad_codigo_tec = '',  tec_plan_codigo = 0, observaciones = '', bien_orden = 0, estado_activo = 'REG', edif_descripcion = '' WHERE fmes_plan = " & VAR_FMES & " AND horario_codigo = " & Ado_detalle1.Recordset!horario_codigo & " AND bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "'  "
        Call ABRIR_TABLA_DET
      End If
   Else
...
Private Sub BtnAñadir2_Click()
  If Ado_datos.Recordset!estado_codigo = "REG" Then
    ...
    sino = MsgBox("Está seguro de Habilitar a HORARIO LABORABLE SOLO el registro elegido ...", vbYesNo + vbQuestion, "Atención")
    If sino = vbYes Then
...
'        End If
  ...
  Else
      MsgBox "No se puede HABILITAR el Horario, el cronograma ya fue APROBADO o ANULADO ...", vbExclamation, "Validación de Registro"
  End If
End Sub
...
'    rs_aux4.Open "Select * from tc_zonas_piloto WHERE zpiloto_codigo <> " & Ado_datos.Recordset!zpiloto_codigo & "   ", db, adOpenStatic
...
Private Sub BtnAprobar_Click()
  On Error GoTo UpdateErr
   If Ado_datos.Recordset!estado_codigo = "REG" And (glusuario = "OCOLODRO" Or glusuario = "VMEJIA" Or glusuario = "JORAQUERNI" Or glusuario = "ADMIN") Then
...
'           db.Execute "update to_cronograma_diario set bien_orden = " & VAR_CONT & " where fmes_plan = " & rs_aux13!fmes_plan & "  aND (bien_codigo <> '' AND bien_orden <= " & VAR_CONT & " ) "
...
'                  VAR_COD0 = VAR_COD0 + 1
'                  db.Execute "update to_cronograma_diario set bien_orden = " & VAR_COD0 & " where fmes_plan = " & rs_aux13!fmes_plan & " AND bien_codigo = '" & rs_aux12!bien_codigo & "' "
...
Private Sub BtnCancelar9_Click()
    FraProgDias.Visible = False
End Sub
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
     ...
     Set rs_aux5 = New ADODB.Recordset
     If rs_aux5.State = 1 Then rs_aux5.Close
     rs_aux5.Open "select dia_correl from to_cronograma_diario where fmes_plan = " & VAR_FMES & " and estado_activo <> 'ANL' group by dia_correl", db, adOpenStatic
     If rs_aux5.RecordCount > 0 Then
     ...
     Set rs_aux5 = New ADODB.Recordset
     If rs_aux5.State = 1 Then rs_aux5.Close
     rs_aux5.Open "select COUNT(dia_correl) as nro_horarios, SUM(nro_total_horas) as nro_horas from to_cronograma_diario where fmes_plan = " & VAR_FMES & " and estado_activo <> 'ANL' ", db, adOpenStatic
     If rs_aux5.RecordCount > 0 Then
...
'     rs_datos.Update    'Batch 'adAffectAll
     ...
     db.Execute "Update to_cronograma_diario Set beneficiario_codigo_resp = " & dtc_codigo4.Text & ", beneficiario_codigo_resp2 = " & dtc_codigo4.Text & " Where fmes_plan = " & VAR_FMES & "   "
...
Private Sub BtnGrabar2_Click()
     ...
     Set rs_aux2 = New ADODB.Recordset
     If rs_aux2.State = 1 Then rs_aux2.Close
     rs_aux2.Open "select * from to_cronograma_diario where fmes_plan = " & VAR_FMES & " and dia_correl = " & Ado_detalle1.Recordset!dia_correl & " and horario_codigo = " & Ado_detalle1.Recordset!horario_codigo & "   ", db, adOpenKeyset, adLockOptimistic
     If rs_aux2.RecordCount > 0 Then
             ...
             While Not rs_aux3.EOF
                ...
                If cmd_campo2.Text > 2 Then
                   If VAR_COD0 < cmd_campo2.Text And rs_aux3!estado_activo = "REG" Then        '
                        ...
                        db.Execute "update to_cronograma_diario set estado_codigo = 'APR', estado_activo = 'APR'  WHERE fmes_plan = " & VAR_AUX2 & " AND bien_codigo = '" & rs_aux2!bien_codigo & "'  "
...
'    " From to_cronograma_diario_final INNER JOIN tv_cronograma_insumos ON (to_cronograma_diario_final.fmes_plan = tv_cronograma_insumos.fmes_plan and to_cronograma_diario_final.bien_codigo  = tv_cronograma_insumos.bien_codigo) WHERE to_cronograma_diario_final.bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND to_cronograma_diario_final.fmes_plan = " & VAR_AUX2 & " "
    ...
    'OCULTADO ZPILOTO NUEVO
    'db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.cantidad1 = ac_bienes_insumos_kit.cantidad1, to_cronograma_diario_final.cantidad2 = ac_bienes_insumos_kit.cantidad2, to_cronograma_diario_final.cantidad3 = ac_bienes_insumos_kit.cantidad3, to_cronograma_diario_final.cantidad4 = ac_bienes_insumos_kit.cantidad4, to_cronograma_diario_final.cantidad5 = ac_bienes_insumos_kit.cantidad5 " & _
    '" From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON (to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo) WHERE to_cronograma_diario_final.bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND to_cronograma_diario_final.fmes_plan = " & VAR_AUX2 & " "
...
'    End If
    ...
    If rs_aux4.RecordCount > 0 Then
        VAR_ZONA = rs_aux4!zpiloto_codigo
        VAR_PARIMPAR = rs_aux4!mes_par_impar
        VAR_UNIMED = rs_aux4!unimed_codigo
    Else
        VAR_ZONA = "1"
        VAR_PARIMPAR = "1"
        VAR_UNIMED = "MES"
    End If
    'ZONA PILOTO FIN
    If Ado_detalle1.Recordset!COn_aceite = "S" Then
        db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.bien_codigo1 = ac_bienes_insumos_kit.bien_codigo1, to_cronograma_diario_final.bien_codigo2 = ac_bienes_insumos_kit.bien_codigo2, to_cronograma_diario_final.bien_codigo3 = ac_bienes_insumos_kit.bien_codigo3, to_cronograma_diario_final.bien_codigo4 = ac_bienes_insumos_kit.bien_codigo4, to_cronograma_diario_final.bien_codigo5 = ac_bienes_insumos_kit.bien_codigo5 " & _
        " From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON (to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo) WHERE to_cronograma_diario_final.bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND to_cronograma_diario_final.fmes_plan = " & VAR_AUX2 & " "
    
        db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.cantidad1 = ac_bienes_insumos_kit.cantidad1, to_cronograma_diario_final.cantidad2 = ac_bienes_insumos_kit.cantidad2, to_cronograma_diario_final.cantidad3 = ac_bienes_insumos_kit.cantidad3, to_cronograma_diario_final.cantidad4 = ac_bienes_insumos_kit.cantidad4, to_cronograma_diario_final.cantidad5 = ac_bienes_insumos_kit.cantidad5 " & _
        " From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON (to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo) WHERE to_cronograma_diario_final.bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND to_cronograma_diario_final.fmes_plan = " & VAR_AUX2 & " "
    Else
        If VAR_UNIMED = "MES" Then
            db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.bien_codigo1 = ac_bienes_insumos_kit.bien_codigo1, to_cronograma_diario_final.bien_codigo2 = ac_bienes_insumos_kit.bien_codigo2, to_cronograma_diario_final.bien_codigo3 = ac_bienes_insumos_kit.bien_codigo3, to_cronograma_diario_final.bien_codigo4 = ac_bienes_insumos_kit.bien_codigo4, to_cronograma_diario_final.bien_codigo5 = ac_bienes_insumos_kit.bien_codigo5 " & _
            " From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON (to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo) WHERE to_cronograma_diario_final.bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND to_cronograma_diario_final.fmes_plan = " & VAR_AUX2 & " "
        
            db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.cantidad1 = ac_bienes_insumos_kit.cantidad1, to_cronograma_diario_final.cantidad2 = ac_bienes_insumos_kit.cantidad2, to_cronograma_diario_final.cantidad3 = '0', to_cronograma_diario_final.cantidad4 = '0', to_cronograma_diario_final.cantidad5 = '0' " & _
            " From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON (to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo) WHERE to_cronograma_diario_final.bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND to_cronograma_diario_final.fmes_plan = " & VAR_AUX2 & " "
        Else
            db.Execute "Update to_cronograma_diario_final SET to_cronograma_diario_final.bien_codigo1 = ac_bienes_insumos_kit.bien_codigo1, to_cronograma_diario_final.bien_codigo2 = ac_bienes_insumos_kit.bien_codigo2, to_cronograma_diario_final.bien_codigo3 = ac_bienes_insumos_kit.bien_codigo3, to_cronograma_diario_final.bien_codigo4 = ac_bienes_insumos_kit.bien_codigo4, to_cronograma_diario_final.bien_codigo5 = ac_bienes_insumos_kit.bien_codigo5 " & _
            " From to_cronograma_diario_final INNER JOIN ac_bienes_insumos_kit ON (to_cronograma_diario_final.bien_codigo  = ac_bienes_insumos_kit.bien_codigo) WHERE to_cronograma_diario_final.bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND to_cronograma_diario_final.fmes_plan = " & VAR_AUX2 & " "
...
'        '" where (to_cronograma_diario_final.fmes_plan >= " & VAR_AUX2 & "  ) "
'
'        If (Ado_datos.Recordset!fmes_correl = 2 Or Ado_datos.Recordset!fmes_correl = 4 Or Ado_datos.Recordset!fmes_correl = 6 Or Ado_datos.Recordset!fmes_correl = 8 Or Ado_datos.Recordset!fmes_correl = 10 Or Ado_datos.Recordset!fmes_correl = 12) Then
'            db.Execute "Update to_cronograma_diario_final set cantidad3 = '0', cantidad4 = '0' From to_cronograma_diario_final  " & _
'            " where (bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND fmes_plan >= " & VAR_AUX2 & "  ) "
'        End If
'    Else
'        'Programar Meses IMPARES y quitar PARES
'        'db.Execute "Update to_cronograma_diario_final set to_cronograma_diario_final.cantidad3 = '0', to_cronograma_diario_final.cantidad4 = '0' From to_cronograma_diario_final INNER JOIN tv_cronograma_mensual_par ON (to_cronograma_diario_final.fmes_plan = tv_cronograma_mensual_par.fmes_plan ) " & _
'        '" where (to_cronograma_diario_final.fmes_plan >= " & VAR_AUX2 & " ) "
'        If (Ado_datos.Recordset!fmes_correl = 1 Or Ado_datos.Recordset!fmes_correl = 3 Or Ado_datos.Recordset!fmes_correl = 5 Or Ado_datos.Recordset!fmes_correl = 7 Or Ado_datos.Recordset!fmes_correl = 9 Or Ado_datos.Recordset!fmes_correl = 11) Then
'            'Programar Meses IMPARES y quitar PARES
'            db.Execute "Update to_cronograma_diario_final set cantidad3 = '0', cantidad4 = '0' From to_cronograma_diario_final  " & _
'            " where (bien_codigo = '" & Ado_detalle1.Recordset!bien_codigo & "' AND fmes_plan >= " & VAR_AUX2 & " ) "
'        End If
...
Private Sub COPIA_TODOS()
     ...
     Set rs_aux2 = New ADODB.Recordset
     If rs_aux2.State = 1 Then rs_aux2.Close
     rs_aux2.Open "select * from to_cronograma_diario where fmes_plan = " & VAR_FMES & " and bien_codigo <> '' order by bien_orden  ", db, adOpenKeyset, adLockOptimistic       'and dia_correl = " & Ado_detalle1.Recordset!dia_correl & " and horario_codigo = " & Ado_detalle1.Recordset!horario_codigo & "
     If rs_aux2.RecordCount > 0 Then
        'If rs_aux2!estado_codigo = "APR" Then
        '    MsgBox "El registro ya fue ENVIADO, debe elegir otro registro ...", vbExclamation, "Validación de Registro"
        '    Exit Sub
...
Private Sub COPIA_ALGUNOS()
     ...
     Set rs_aux2 = New ADODB.Recordset
     If rs_aux2.State = 1 Then rs_aux2.Close
     rs_aux2.Open "select * from to_cronograma_diario where fmes_plan = " & VAR_FMES & " and bien_codigo <> '' AND estado_activo = 'REG' order by bien_orden  ", db, adOpenKeyset, adLockOptimistic       'and dia_correl = " & Ado_detalle1.Recordset!dia_correl & " and horario_codigo = " & Ado_detalle1.Recordset!horario_codigo & "
     If rs_aux2.RecordCount > 0 Then
        'If rs_aux2!estado_codigo = "APR" Then
        '    MsgBox "El registro ya fue ENVIADO, debe elegir otro registro ...", vbExclamation, "Validación de Registro"
        '    Exit Sub
...
Private Sub BtnGrabar5_Click()
    ...
    If dtc_desc9.Text = "Todos" And DTPfecha2.Text <> "Todos" Then
        ...
        db.Execute "update to_cronograma_diario set to_cronograma_diario.hora_registro  = '00' WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") AND (to_cronograma_diario.bien_codigo <> '')"

        db.Execute "update to_cronograma_diario set to_cronograma_diario.hora_registro  = 'OK' FROM to_cronograma_diario INNER JOIN to_cronograma_diario_final ON to_cronograma_diario.fmes_plan = to_cronograma_diario_final.fmes_plan and to_cronograma_diario.bien_codigo  = to_cronograma_diario_final.bien_codigo WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") AND (to_cronograma_diario.bien_codigo <> '') "

        db.Execute "update to_cronograma_diario set to_cronograma_diario.estado_activo  = 'REG', to_cronograma_diario.estado_codigo  = 'REG' WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") AND (to_cronograma_diario.bien_codigo <> '') AND (to_cronograma_diario.hora_registro  = '00')"

        'db.Execute "UPDATE to_cronograma_diario set estado_activo = 'REG', estado_codigo = 'REG'  where fmes_plan  = " & VAR_FMES & " AND estado_activo = 'APR' and dia_fecha between '" & CDate(dtpFecha2.Text) & "' and '" & CDate(DTPfecha3.Text) & "' "
    ...
    Else
        ...
        'db.Execute "UPDATE to_cronograma_diario set estado_activo = 'REG', estado_codigo = 'REG'  where fmes_plan  = " & VAR_FMES & " AND estado_activo = 'APR' and trim(edif_descripcion) = '" & Trim(dtc_desc9.Text) & "' and dia_fecha between ('" & CDate(dtpFecha2.Text) & "' and '" & CDate(DTPfecha3.Text) & "') "
...
Private Sub BtnGrabar6_Click()
    ...
    If rs_aux6.RecordCount > 0 Then
        ...
        If Option8.Value = True Then
            Call COPIA_ALGUNOS
            db.Execute "UPDATE to_cronograma_diario set to_cronograma_diario.estado_codigo   = 'APR' where to_cronograma_diario.fmes_plan  = " & VAR_FMES & " AND to_cronograma_diario.estado_activo = 'APR' "
        End If
    Else
      ...
      If Option7.Value = True Then
        ...
        " ON to_cronograma_diario_final.fmes_plan  = to_cronograma_diario.fmes_plan AND to_cronograma_diario_final.dia_correl  = to_cronograma_diario.dia_correl AND to_cronograma_diario_final.horario_codigo = to_cronograma_diario.horario_codigo WHERE to_cronograma_diario.fmes_plan = " & VAR_FMES & " AND to_cronograma_diario.estado_activo = 'APR' "
...
Private Sub BtnGrabar9_Click()
    If Option9.Value = True Then
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'REG', observaciones = 'HORARIO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'LUNES' AND (bien_codigo = '' OR bien_codigo IS NULL) "
    Else
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'ANL', observaciones = 'HORARIO NO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'LUNES' AND (bien_codigo = '' OR bien_codigo IS NULL) "
    End If
    If Option13.Value = True Then
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'REG', observaciones = 'HORARIO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'MARTES' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    Else
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'ANL', observaciones = 'HORARIO NO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'MARTES' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    End If
    If Option15.Value = True Then
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'REG', observaciones = 'HORARIO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'MIERCOLES' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    Else
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'ANL', observaciones = 'HORARIO NO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'MIERCOLES' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    End If
    If Option17.Value = True Then
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'REG', observaciones = 'HORARIO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'JUEVES' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    Else
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'ANL', observaciones = 'HORARIO NO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'JUEVES'  AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    End If
    If Option19.Value = True Then
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'REG', observaciones = 'HORARIO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'VIERNES' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    Else
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'ANL', observaciones = 'HORARIO NO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'VIERNES'  AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    End If
    If Option21.Value = True Then
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'REG', observaciones = 'HORARIO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'SABADO' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    Else
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'ANL', observaciones = 'HORARIO NO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'SABADO'  AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    End If
    If Option23.Value = True Then
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'REG', observaciones = 'HORARIO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'DOMINGO' AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    Else
        db.Execute "UPDATE to_cronograma_diario_final SET estado_activo = 'ANL', observaciones = 'HORARIO NO LABORABLE', edif_descripcion = '', EDIF_codigo=''  where fmes_plan = " & VAR_FMES & " AND dia_nombre = 'DOMINGO'  AND (bien_codigo = ''  OR bien_codigo IS NULL) "
    End If
    'db.Execute "UPDATE to_cronograma_diario_final SET where fmes_plan = " & VAR_FMES & " AND dia_nombre='' "
...
'
  Else
      MsgBox "No se puede MODIFICAR CALENDARIO de un cronograma APROBADO o ANULADO ...", vbExclamation, "Validación de Registro"
  End If
End Sub
...
'  lblStatus.Caption = "Modificar registro"
    ...
    '    BtnVer.Visible = True
    Else
      MsgBox "No se puede MODIFICAR un cronograma APROBADO o ANULADO, Consulte con el Administrador del Sistema ...", vbExclamation, "Validación de Registro"
    End If
  Exit Sub
...
Private Sub BtnVer2_Click()
    If Ado_datos.Recordset!estado_codigo = "REG" Then
        ...
        Else
            db.Execute " update to_cronograma_diario set to_cronograma_diario.nro_total_horas = tv_cronograma_y_detalle.bien_cantidad_por_empaque from to_cronograma_diario inner join tv_cronograma_y_detalle on to_cronograma_diario.bien_codigo = tv_cronograma_y_detalle.bien_codigo where to_cronograma_diario.fmes_plan = " & Ado_datos.Recordset!fmes_plan & " AND tv_cronograma_y_detalle.zpiloto_codigo = " & Ado_datos.Recordset!zpiloto_codigo & " "
            db.Execute " update to_cronograma_diario set to_cronograma_diario.bien_orden = tv_cronograma_y_detalle.zona_edif_orden from to_cronograma_diario inner join tv_cronograma_y_detalle on to_cronograma_diario.bien_codigo = tv_cronograma_y_detalle.bien_codigo where to_cronograma_diario.fmes_plan = " & Ado_datos.Recordset!fmes_plan & " AND tv_cronograma_y_detalle.zpiloto_codigo = " & Ado_datos.Recordset!zpiloto_codigo & " "
    
            Call ABRIR_TABLA_DET
            MsgBox "Se Actualizó el <#Horas> por equipo y el <Orden> actual de la Organización de Zonas ...", vbInformation, "Información"
        End If
    Else
      MsgBox "No se puede ACTUALIZAR un cronograma APROBADO o ANULADO, Consulte con el Administrador del Sistema ...", vbExclamation, "Validación de Registro"
    End If
End Sub
...
'         End Select
    ...
    db.Execute "update to_cronograma_diario set to_cronograma_diario.edif_codigo = ac_bienes.edif_codigo FROM to_cronograma_diario INNER JOIN ac_bienes ON to_cronograma_diario.bien_codigo = ac_bienes.bien_codigo WHERE (to_cronograma_diario.edif_codigo <> ac_bienes.edif_codigo OR to_cronograma_diario.EDIF_CODIGO IS NULL) "
    '-- ACTUALIZAR DEPTO EN to_cronograma_mensual
    db.Execute " UPDATE to_cronograma_mensual set to_cronograma_mensual.DEPTO_CODIGO = tc_zonas_piloto.depto_codigo FROM to_cronograma_mensual INNER JOIN tc_zonas_piloto on to_cronograma_mensual.zpiloto_codigo = tc_zonas_piloto.zpiloto_codigo WHERE (to_cronograma_mensual.DEPTO_CODIGO <> tc_zonas_piloto.depto_codigo OR to_cronograma_mensual.DEPTO_CODIGO IS NULL) "

    'Actializa Orden Edificio a Cronograma Diario por equipo
    ...
    db.Execute "update to_cronograma_diario set bien_orden = '0' where bien_orden <> '0' "
    db.Execute "update to_cronograma_diario set to_cronograma_diario.bien_orden = ac_bienes.kit, to_cronograma_diario.observaciones   = ac_bienes.observaciones from to_cronograma_diario inner join ac_bienes on to_cronograma_diario.bien_codigo   = ac_bienes.bien_codigo "
...
On Error GoTo UpdateErr
    If Option3.Value = True Then                        'CRONOGRAMA DIARIO (Ver Todos Horarios Elaborados)
        Set rs_det1 = New ADODB.Recordset
        If rs_det1.State = 1 Then rs_det1.Close
        rs_det1.Open "select * from to_cronograma_diario where fmes_plan = " & VAR_FMES & "  and estado_activo <> 'ANL' AND bien_codigo <> '' ", db, adOpenKeyset, adLockOptimistic, adCmdText
        rs_det1.Sort = "bien_orden"
...
'                db.Execute "update to_cronograma_diario set to_cronograma_diario.bien_orden = tc_zona_piloto_edif.zona_edif_orden from to_cronograma_diario inner join tc_zona_piloto_edif on to_cronograma_diario.edif_codigo = tc_zona_piloto_edif.edif_codigo  WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") "
        ...
        End If
    End If
    If Option4.Value = True Then                        'CRONOGRAMA DIARIO (Ver Solo los Horarios Pendientes)
        Set rs_det1 = New ADODB.Recordset
        If rs_det1.State = 1 Then rs_det1.Close
        'rs_det1.Open "select * from to_cronograma_diario where fmes_plan = '" & Ado_datos.Recordset!fmes_plan & "' and estado_activo <> 'ANL' AND estado_activo <> 'APR'  ", db, adOpenKeyset, adLockOptimistic, adCmdText
        rs_det1.Open "select * from to_cronograma_diario where fmes_plan = " & VAR_FMES & " and estado_codigo =  'REG' AND bien_codigo <> ''  ", db, adOpenKeyset, adLockOptimistic, adCmdText
        rs_det1.Sort = "bien_orden"
        Set Ado_detalle1.Recordset = rs_det1
        If Ado_detalle1.Recordset.RecordCount > 0 Then
            If Ado_datos.Recordset!estado_codigo = "REG" Then
...
'                '-- actualiza ORDEN
'                db.Execute "update to_cronograma_diario set to_cronograma_diario.bien_orden = tc_zona_piloto_edif.zona_edif_orden from to_cronograma_diario inner join tc_zona_piloto_edif on to_cronograma_diario.edif_codigo = tc_zona_piloto_edif.edif_codigo  WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") "
'                db.Execute "update to_cronograma_diario set to_cronograma_diario.con_aceite = to_cronograma_mensual.con_aceite from to_cronograma_diario inner join to_cronograma_mensual on to_cronograma_diario.fmes_plan = to_cronograma_mensual.fmes_plan WHERE (to_cronograma_diario.fmes_plan = " & VAR_FMES & ") "
            End If
            dg_det1.Visible = True
            Set dg_det1.DataSource = Ado_detalle1.Recordset
            db.Execute "update to_cronograma_diario set to_cronograma_diario.edif_codigo  = ac_bienes.edif_codigo FROM to_cronograma_diario INNER JOIN ac_bienes ON to_cronograma_diario.bien_codigo  = ac_bienes.bien_codigo WHERE (to_cronograma_diario.fmes_plan = " & Ado_datos.Recordset!fmes_plan & " )"
        Else
            dg_det1.Visible = False
            Set dg_det1.DataSource = rsNada
        End If
    End If
    If Option1.Value = True Then                        'CRONOGRAMA FINAL (Ver los Horarios Laborables)
...
'                db.Execute "update to_cronograma_diario_final set to_cronograma_diario_final.edif_descripcion = gc_edificaciones.edif_descripcion FROM to_cronograma_diario_final INNER JOIN gc_edificaciones ON to_cronograma_diario_final.edif_codigo = gc_edificaciones.edif_codigo WHERE (to_cronograma_diario_final.edif_descripcion <> gc_edificaciones.edif_descripcion OR to_cronograma_diario_final.edif_descripcion IS NULL) "
        ...
        End If
    End If
    If Option2.Value = True Then                        'CRONOGRAMA FINAL (Ver Todos los Horarios)
        Set rs_det2 = New ADODB.Recordset
        If rs_det2.State = 1 Then rs_det2.Close
...
'                db.Execute "update to_cronograma_diario_final set to_cronograma_diario_final.edif_descripcion = gc_edificaciones.edif_descripcion FROM to_cronograma_diario_final INNER JOIN gc_edificaciones ON to_cronograma_diario_final.edif_codigo = gc_edificaciones.edif_codigo WHERE (to_cronograma_diario_final.edif_descripcion <> gc_edificaciones.edif_descripcion OR to_cronograma_diario_final.edif_descripcion IS NULL) "
        ...
        End If
    End If
    If Option5.Value = True Then                        'CRONOGRAMA FINAL (Ver Solo Horarios Libres)
        Set rs_det2 = New ADODB.Recordset
        If rs_det2.State = 1 Then rs_det2.Close
