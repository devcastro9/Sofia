...
Begin VB.Form frm_to_calendario_zonas 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   555
   ClientWidth     =   14100
   Icon            =   "frm_to_calendario_zonas.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MDIChild        =   -1  'True
   ScaleHeight     =   10950
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_to_calendario_zonas.frx":0A02
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   60
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "frm_to_calendario_zonas.frx":11C4
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   46
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "frm_to_calendario_zonas.frx":1A91
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   45
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frm_to_calendario_zonas.frx":2246
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   44
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_to_calendario_zonas.frx":2A79
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   43
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_to_calendario_zonas.frx":31C5
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   42
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_to_calendario_zonas.frx":3ADA
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   41
         Top             =   0
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "frm_to_calendario_zonas.frx":4299
         Style           =   1  'Graphical
         TabIndex        =   37
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "frm_to_calendario_zonas.frx":46DB
         Style           =   1  'Graphical
         TabIndex        =   36
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_to_calendario_zonas.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   40
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_to_calendario_zonas.frx":50BB
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   39
         Top             =   0
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.PictureBox BtnAnlDetalle 
            ...
            Height          =   615
            Left            =   2640
            Picture         =   "frm_to_calendario_zonas.frx":59A7
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   57
            ToolTipText     =   "Cambia Estado a ""Día NO Laborable"" (ANL)"
            Top             =   0
            Width           =   1215
         End
         Begin VB.PictureBox BtnModDetalle 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "frm_to_calendario_zonas.frx":60F3
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   56
            ToolTipText     =   "Cambiar Estado a ""Día Laborable"" (REG)"
            Top             =   0
            Width           =   1430
         End
         Begin VB.PictureBox BtnAddDetalle 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "frm_to_calendario_zonas.frx":6A08
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   55
            Top             =   0
         ...
         Begin VB.PictureBox Picture2 
            ...
            Height          =   615
            Left            =   3960
            Picture         =   "frm_to_calendario_zonas.frx":71C7
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   54
            ToolTipText     =   "Guarda datos"
            Top             =   0
            Visible         =   0   'False
            Width           =   1280
         End
         Begin VB.PictureBox Picture3 
            ...
            Height          =   615
            Left            =   5640
            Picture         =   "frm_to_calendario_zonas.frx":799D
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   53
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_to_calendario_zonas.frx":8289
         Height          =   6135
         Left            =   75
         TabIndex        =   15
         Top             =   960
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.ComboBox Cmb_Mes_ant 
         Height          =   315
         ItemData        =   "frm_to_calendario_zonas.frx":82A4
         Left            =   1320
         List            =   "frm_to_calendario_zonas.frx":82CC
         TabIndex        =   48
         Text            =   "ENERO"
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.ComboBox Cmb_gestion_Ant 
         Height          =   315
         ItemData        =   "frm_to_calendario_zonas.frx":8335
         Left            =   240
         List            =   "frm_to_calendario_zonas.frx":834B
         TabIndex        =   47
         Text            =   "2016"
         Top             =   720
         Visible         =   0   'False
      ...
      Begin VB.TextBox Txt_campo2 
         ...
         TabIndex        =   27
         Text            =   "frm_to_calendario_zonas.frx":8373
         Top             =   3360
         Width           =   6645
      End
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_to_calendario_zonas.frx":8375
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_to_calendario_zonas.frx":838E
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_to_calendario_zonas.frx":83A7
         DataField       =   "unidad_codigo_tec"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_to_calendario_zonas.frx":83C0
         DataField       =   "zpiloto_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_to_calendario_zonas.frx":83D9
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_to_calendario_zonas.frx":83F2
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5880
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_to_calendario_zonas.frx":840B
         Height          =   2730
         Left            =   120
         TabIndex        =   2
         Top             =   240
   ...
   End
End
Attribute VB_Name = "frm_to_calendario_zonas"
