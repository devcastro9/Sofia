...
Begin VB.Form tw_solicitud_bienes 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "tw_solicitud_bienes.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   65
         Top             =   120
         Width           =   1340
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   1680
         MaskColor       =   &H00000000&
         Picture         =   "tw_solicitud_bienes.frx":07D6
         Style           =   1  'Graphical
         TabIndex        =   64
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.PictureBox BtnImprimir 
            ...
            Height          =   615
            Left            =   8760
            Picture         =   "tw_solicitud_bienes.frx":10C2
            ScaleHeight     =   615
            ScaleWidth      =   1440
            TabIndex        =   68
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "tw_solicitud_bienes.frx":1BCE
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "tw_solicitud_bienes.frx":1BE7
            DataField       =   "unimed_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   1800
         ...
         Begin VB.Label Label2 
            ...
            BackColor       =   &H00000000&
            BackStyle       =   0  'Transparent
            Caption         =   "Descripción del Equipo - Para el Cliente"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "tw_solicitud_bienes.frx":1C00
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "tw_solicitud_bienes.frx":1C19
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "tw_solicitud_bienes.frx":1C32
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "tw_solicitud_bienes.frx":1C4B
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "tw_solicitud_bienes.frx":1C64
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "tw_solicitud_bienes.frx":1C7D
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin VB.Label Label3 
            ...
            BackColor       =   &H00000000&
            BackStyle       =   0  'Transparent
            Caption         =   "Ubicación Física / Características"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "tw_solicitud_bienes.frx":1C96
         DataField       =   "bien_codigo"
         DataSource      =   "tw_identificacion_cliente.ado_detalle2"
         Height          =   315
         Left            =   8400
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "tw_solicitud_bienes.frx":1CAF
         DataField       =   "bien_codigo"
         DataSource      =   "tw_identificacion_cliente.ado_detalle2"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "tw_solicitud_bienes.frx":1CC8
         DataField       =   "bien_codigo"
         DataSource      =   "tw_identificacion_cliente.ado_detalle2"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "tw_solicitud_bienes"
...
Dim VAR_GESTION2, VAR_UNIDAD2, VER_EDIF2 As String

Dim VAR_SOL2 As Integer
...
'If Ado_datos.Recordset.RecordCount > 0 Then
    ...
    rs_aux1.Open "Select * from av_parametros_calculo_rep WHERE bien_codigo = '" & dtc_codigo1.Text & "' ", db, adOpenStatic
...
Private Sub Form_Activate()
    ...
    End If
    If Txt_campo1.Caption = "DNMAN" Or Txt_campo1.Caption = "DMANC" Or Txt_campo1.Caption = "DMANB" Or Txt_campo1.Caption = "DMANS" Then
        Frame3.Visible = True
    Else
        Frame3.Visible = False
        Txt_campo10.Text = "0"
        dtc_codigo2.Text = "MES"
        Txt_campo16.Text = "0"
        Txt_campo19.Text = "0"
        Txt_campo11.Caption = "0"
    End If
End Sub
