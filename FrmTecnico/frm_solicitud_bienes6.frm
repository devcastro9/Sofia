...
Begin VB.Form frm_solicitud_bienes6 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_solicitud_bienes6.frx":0000
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   55
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   1800
         MaskColor       =   &H00000000&
         Picture         =   "frm_solicitud_bienes6.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "frm_solicitud_bienes6.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   56
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox Txt_campo10 
            ...
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   285
            Left            =   240
            TabIndex        =   50
            Text            =   "1"
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "frm_solicitud_bienes6.frx":6C446
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "frm_solicitud_bienes6.frx":6C45F
            DataField       =   "unimed_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   2520
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "frm_solicitud_bienes6.frx":6C478
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "frm_solicitud_bienes6.frx":6C491
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "frm_solicitud_bienes6.frx":6C4AA
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "frm_solicitud_bienes6.frx":6C4C3
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "frm_solicitud_bienes6.frx":6C4DC
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "frm_solicitud_bienes6.frx":6C4F5
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "frm_solicitud_bienes6.frx":6C50E
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   6720
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "frm_solicitud_bienes6.frx":6C527
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
         ...
         Begin VB.Label Label8 
            ...
            BackColor       =   &H80000005&
            BackStyle       =   0  'Transparent
            Caption         =   "La herramienta será utilizada para:"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "frm_solicitud_bienes6.frx":6C540
         DataField       =   "bien_codigo"
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "frm_solicitud_bienes6.frx":6C559
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle5"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_solicitud_bienes6.frx":6C572
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle5"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "frm_solicitud_bienes6"
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
     ...
     If lbl_det.Caption = "30000" Then
         If swnuevo = 1 Then
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("ges_gestion").Value = glGestion
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("unidad_codigo").Value = Txt_campo1.Caption
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("solicitud_codigo").Value = txt_codigo.Caption
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("estado_codigo").Value = "REG"
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("venta_o_compra").Value = "V"
    ...
    '        frm_to_identificacion_cliente.Ado_detalle3.Recordset("archivo_plano_cargado").Value = "N"
         End If
            ...
            Else
                ...
                frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_codigo").Value = IIf(dtc_codigo1.Text = "", "NA1", dtc_codigo1.Text)
                frm_to_identificacion_cliente.Ado_detalle3.Recordset("marca_codigo").Value = IIf(Txt_campo2.Text = "", "S/M", Txt_campo2.Text)
                frm_to_identificacion_cliente.Ado_detalle3.Recordset("modelo_codigo").Value = IIf(Txt_campo3.Text = "", "S/M", Txt_campo3.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "30000", dtc_aux1.Text)
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "34000", dtc_aux2.Text)
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "34800", dtc_aux3.Text)
            ...
            Else
                ...
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            End If
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_precio_venta_base").Value = IIf(Txt_campo10 = "", 0, Txt_campo10)
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("unimed_codigo").Value = IIf(dtc_codigo2 = "", "MES", dtc_codigo2)
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_cantidad").Value = IIf(Txt_campo16 = "", 1, Txt_campo16)
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_total_venta").Value = IIf(Txt_campo11 = "", 0, Txt_campo11)
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_precio_compra").Value = 0
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_total_compra").Value = 0
            
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("fosa_dimension_frente").Value = IIf(dtc_codigo5.Text = "", 7, dtc_codigo5.Text)
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("fosa_dimension_fondo").Value = 0  'Txt_campo15.Text
            ...
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("fecha_registro").Value = Date
            'aw_p_ao_solicitud.Ado_detalle1.Recordset("hora_registro").Value = Date
            frm_to_identificacion_cliente.Ado_detalle3.Recordset("usr_codigo").Value = glusuario
            frm_to_identificacion_cliente.Ado_detalle3.Recordset.UpdateBatch adAffectAll
     End If
    ...
    '        frm_to_identificacion_cliente.Ado_detalle6.Recordset("archivo_plano_cargado").Value = "N"
         End If
            ...
            End If
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "30000", dtc_aux1.Text)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "34000", dtc_aux2.Text)
            frm_to_identificacion_cliente.Ado_detalle6.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "34800", dtc_aux3.Text)
            If Txt_campo16.Text <> "" Then
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            Else
                Txt_campo16.Text = 1
    ...
    '        frm_to_identificacion_cliente.Ado_detalle6.Recordset("archivo_plano_cargado").Value = "N"
         End If
            ...
            End If
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "90000", dtc_aux1.Text)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "99900", dtc_aux2.Text)
            frm_to_identificacion_cliente.Ado_detalle7.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "99990", dtc_aux3.Text)
            If Txt_campo16.Text <> "" Then
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            Else
                Txt_campo16.Text = 1
...
Private Sub ABRIR_TABLA()
    ...
    If lbl_det = "43340" Then
        ...
        rs_datos1.Open "select * from ac_bienes where (par_codigo = '43340' OR par_codigo = '99990') AND edif_codigo = '" & frm_to_identificacion_cliente.dtc_codigo3 & "' ", db, adOpenStatic   'order by descripcion
    End If
