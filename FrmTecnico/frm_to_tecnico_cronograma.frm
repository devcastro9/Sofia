...
Begin VB.Form Frm_to_tecnico_cronograma 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   " Tecnico - Cronograma por Contrato"
   ClientHeight    =   10005
   ClientLeft      =   1560
   ClientTop       =   1725
   ClientWidth     =   15735
   ForeColor       =   &H00000000&
   Icon            =   "frm_to_tecnico_cronograma.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   Moveable        =   0   'False
   ScaleHeight     =   8.42991e8
   ScaleMode       =   0  'User
   ScaleWidth      =   1.05471e8
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnImprimir3 
         ...
         Height          =   615
         Left            =   7200
         Picture         =   "frm_to_tecnico_cronograma.frx":0A02
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   145
         ToolTipText     =   "Lista Edificios por Zona Piloto"
         Top             =   0
         Visible         =   0   'False
         Width           =   1400
      End
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17640
         Picture         =   "frm_to_tecnico_cronograma.frx":12CF
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   142
      ...
      Begin VB.CommandButton BtnImprimir0 
         ...
         Height          =   600
         Left            =   10080
         Picture         =   "frm_to_tecnico_cronograma.frx":1A91
         Style           =   1  'Graphical
         TabIndex        =   100
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "frm_to_tecnico_cronograma.frx":204E
         Style           =   1  'Graphical
         TabIndex        =   99
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10920
         Picture         =   "frm_to_tecnico_cronograma.frx":2258
         Style           =   1  'Graphical
         TabIndex        =   98
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   8400
         Picture         =   "frm_to_tecnico_cronograma.frx":269A
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   9
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   105
         Picture         =   "frm_to_tecnico_cronograma.frx":2E59
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   10
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   1440
         Picture         =   "frm_to_tecnico_cronograma.frx":376E
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   11
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_to_tecnico_cronograma.frx":3EBA
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   12
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "frm_to_tecnico_cronograma.frx":46ED
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   13
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5640
         Picture         =   "frm_to_tecnico_cronograma.frx":4EA2
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   14
         ToolTipText     =   "Lista Edificios por Zona Geográfica"
         Top             =   0
         Visible         =   0   'False
         Width           =   1400
      End
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "frm_to_tecnico_cronograma.frx":576F
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   15
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   5475
         Picture         =   "frm_to_tecnico_cronograma.frx":5F45
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   16
         Top             =   0
   ...
   Begin VB.PictureBox FrmABMDet2 
      ...
      Begin VB.PictureBox BtnEliminar2 
         ...
         Height          =   615
         Left            =   360
         Picture         =   "frm_to_tecnico_cronograma.frx":6831
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   136
      ...
      Begin VB.PictureBox BtnAñadir2 
         ...
         Height          =   615
         Left            =   360
         Picture         =   "frm_to_tecnico_cronograma.frx":6F7D
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   17
      ...
      Begin VB.CommandButton Command2 
         ...
         Height          =   640
         Left            =   600
         Picture         =   "frm_to_tecnico_cronograma.frx":773C
         Style           =   1  'Graphical
         TabIndex        =   78
      ...
      Begin VB.CommandButton BtnAprobar2 
         ...
         Height          =   640
         Left            =   960
         Picture         =   "frm_to_tecnico_cronograma.frx":8EBE
         Style           =   1  'Graphical
         TabIndex        =   81
      ...
      Begin VB.CommandButton BtnAnlDetalle2AA 
         ...
         Height          =   640
         Left            =   960
         Picture         =   "frm_to_tecnico_cronograma.frx":90C8
         Style           =   1  'Graphical
         TabIndex        =   80
      ...
      Begin VB.CommandButton BtnModDetalle2 
         ...
         Height          =   640
         Left            =   120
         Picture         =   "frm_to_tecnico_cronograma.frx":9D92
         Style           =   1  'Graphical
         TabIndex        =   79
   ...
   Begin VB.Frame FrmCobranza 
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_to_tecnico_cronograma.frx":AA5C
         Height          =   1785
         Left            =   120
         TabIndex        =   83
         Top             =   240
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Begin VB.PictureBox BtnModDetalle 
         ...
         Height          =   615
         Left            =   240
         Picture         =   "frm_to_tecnico_cronograma.frx":AA77
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   129
      ...
      Begin VB.CommandButton BtnImprimir2 
         ...
         Height          =   640
         Left            =   585
         Picture         =   "frm_to_tecnico_cronograma.frx":B38C
         Style           =   1  'Graphical
         TabIndex        =   69
         ToolTipText     =   "Imprime Nota de Venta"
         Top             =   465
      ...
      Begin VB.CommandButton BtnAddDetalle 
         ...
         Height          =   640
         Left            =   135
         Picture         =   "frm_to_tecnico_cronograma.frx":CB0E
         Style           =   1  'Graphical
         TabIndex        =   68
      ...
      Begin VB.CommandButton BtnAnlDetalle 
         ...
         Height          =   640
         Left            =   120
         Picture         =   "frm_to_tecnico_cronograma.frx":CF50
         Style           =   1  'Graphical
         TabIndex        =   67
         ToolTipText     =   "Anula la Cobranza Identificada"
         Top             =   828
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frm_to_tecnico_cronograma.frx":DC1A
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "FrmCabecera"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "EQUIPO E INSUMOS PARA EL CRONOGRAMA"
      TabPicture(1)   =   "frm_to_tecnico_cronograma.frx":DC36
      ...
      Begin VB.Frame FrmEdita 
         ...
         Begin VB.ComboBox txt_carta 
            ...
            ForeColor       =   &H00000000&
            Height          =   315
            ItemData        =   "frm_to_tecnico_cronograma.frx":DC52
            Left            =   2280
            List            =   "frm_to_tecnico_cronograma.frx":DC5C
            TabIndex        =   135
            Text            =   "NO"
            Top             =   1515
            Width           =   735
         ...
         Begin VB.Frame Frame1 
            ...
            Begin MSDataListLib.DataCombo dtc_codigo6 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DC68
            ...
            Begin MSDataListLib.DataCombo dtc_codigo6A 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DC81
            ...
            Begin MSDataListLib.DataCombo dtc_codigo6B 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DC9A
            ...
            Begin MSDataListLib.DataCombo dtc_codigo6C 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DCB3
            ...
            Begin MSDataListLib.DataCombo dtc_codigo6D 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DCCC
            ...
            Begin MSDataListLib.DataCombo dtc_desc6 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DCE5
               DataField       =   "bien_codigo1"
               DataSource      =   "ado_datos14"
               Height          =   315
               Left            =   1200
            ...
            Begin MSDataListLib.DataCombo dtc_desc6A 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DCFE
               DataField       =   "bien_codigo2"
               DataSource      =   "ado_datos14"
               Height          =   315
               Left            =   1200
            ...
            Begin MSDataListLib.DataCombo dtc_desc6B 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DD17
               DataField       =   "bien_codigo3"
               DataSource      =   "ado_datos14"
               Height          =   315
               Left            =   1200
            ...
            Begin MSDataListLib.DataCombo dtc_desc6C 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DD30
               DataField       =   "bien_codigo4"
               DataSource      =   "ado_datos14"
               Height          =   315
               Left            =   1200
            ...
            Begin MSDataListLib.DataCombo dtc_desc6D 
               Bindings        =   "frm_to_tecnico_cronograma.frx":DD49
               DataField       =   "bien_codigo5"
               DataSource      =   "ado_datos14"
               Height          =   315
               Left            =   1200
         ...
         Begin VB.PictureBox FraGrabarDet 
            ...
            Begin VB.PictureBox cmdElige 
               ...
               Height          =   615
               Left            =   8160
               Picture         =   "frm_to_tecnico_cronograma.frx":DD62
               ScaleHeight     =   615
               ScaleWidth      =   1440
               TabIndex        =   162
            ...
            Begin VB.PictureBox CmdCancelaDet 
               ...
               Height          =   615
               Left            =   5160
               Picture         =   "frm_to_tecnico_cronograma.frx":E86E
               ScaleHeight     =   615
               ScaleWidth      =   1395
               TabIndex        =   106
               Top             =   0
            ...
            Begin VB.PictureBox CmdGrabaDet 
               ...
               Height          =   615
               Left            =   3720
               Picture         =   "frm_to_tecnico_cronograma.frx":F15A
               ScaleHeight     =   615
               ScaleWidth      =   1275
               TabIndex        =   105
               Top             =   0
         ...
         Begin MSDataListLib.DataCombo dtc_subgrupo15 
            Bindings        =   "frm_to_tecnico_cronograma.frx":F930
         ...
         Begin MSDataListLib.DataCombo dtc_grupo15 
            Bindings        =   "frm_to_tecnico_cronograma.frx":F94A
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   3600
         ...
         Begin MSDataListLib.DataCombo dtc_desc15 
            Bindings        =   "frm_to_tecnico_cronograma.frx":F964
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   3600
         ...
         Begin MSDataListLib.DataCombo Dtc_partida15 
            Bindings        =   "frm_to_tecnico_cronograma.frx":F97E
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo dtc_codigo15 
            Bindings        =   "frm_to_tecnico_cronograma.frx":F998
            DataField       =   "bien_codigo"
            DataSource      =   "ado_datos14"
            Height          =   315
            Left            =   1560
      ...
      Begin VB.Frame FrmCabecera 
         ...
         Begin VB.Frame Frame3 
            BackColor       =   &H00C0C0C0&
            Caption         =   $"frm_to_tecnico_cronograma.frx":F9B2
            ForeColor       =   &H00400000&
            Height          =   1155
            Left            =   120
            TabIndex        =   146
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FA55
         ...
         Begin VB.Frame Fra_datos 
            BackColor       =   &H00C0C0C0&
            Caption         =   $"frm_to_tecnico_cronograma.frx":FA6E
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
            ...
            Begin MSDataListLib.DataCombo dtc_desc7 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FAFC
            ...
            Begin MSDataListLib.DataCombo dtc_desc4 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FB15
               DataField       =   "beneficiario_codigo_resp"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_codigo4 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FB2E
               DataField       =   "beneficiario_codigo_resp"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   8160
            ...
            Begin MSDataListLib.DataCombo dtc_aux4 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FB47
               DataField       =   "beneficiario_codigo_resp"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   7200
            ...
            Begin MSDataListLib.DataCombo dtc_codigo7 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FB60
               DataField       =   "zpiloto_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   3000
         ...
         Begin VB.Frame Fra_Total 
            BackColor       =   &H00C0C0C0&
            Caption         =   "Total.Periodos    Periodicidad        Fecha.Inicio.Crono.      Fecha.Final.Crono.       Mes.Inicio.Cronograma   Prog.Insumos.3y4"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
            ...
            Begin VB.ComboBox cmb_primero 
               ...
               ForeColor       =   &H00000000&
               Height          =   315
               ItemData        =   "frm_to_tecnico_cronograma.frx":FB79
               Left            =   9120
               List            =   "frm_to_tecnico_cronograma.frx":FB83
               TabIndex        =   141
               Text            =   "SI"
               Top             =   1440
               Visible         =   0   'False
            ...
            Begin VB.ComboBox cmb_lunes 
               ...
               ForeColor       =   &H00000000&
               Height          =   315
               ItemData        =   "frm_to_tecnico_cronograma.frx":FB8F
               Left            =   3840
               List            =   "frm_to_tecnico_cronograma.frx":FB99
               TabIndex        =   140
               Text            =   "SI"
               Top             =   1440
               Visible         =   0   'False
            ...
            Begin VB.ComboBox cmb_dia 
               ...
               DataSource      =   "Ado_datos"
               Height          =   315
               ItemData        =   "frm_to_tecnico_cronograma.frx":FBA5
               Left            =   240
               List            =   "frm_to_tecnico_cronograma.frx":FBC1
               TabIndex        =   7
               Text            =   "AUTOMATICO"
               Top             =   480
               Visible         =   0   'False
            ...
            Begin MSDataListLib.DataCombo dtc_desc5 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FC0D
               DataField       =   "horario_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   5760
            ...
            Begin VB.ComboBox cmd_unimed2 
               ...
               ForeColor       =   &H00000000&
               Height          =   315
               ItemData        =   "frm_to_tecnico_cronograma.frx":FC26
               Left            =   1560
               List            =   "frm_to_tecnico_cronograma.frx":FC3C
               TabIndex        =   3
               Text            =   "ANUAL"
               Top             =   240
               Width           =   1215
            ...
            Begin VB.ComboBox cmb_mes_ini 
               ...
               DataSource      =   "Ado_datos"
               Height          =   315
               ItemData        =   "frm_to_tecnico_cronograma.frx":FC64
               Left            =   7200
               List            =   "frm_to_tecnico_cronograma.frx":FC8C
               TabIndex        =   6
               Text            =   "SEPTIEMBRE"
               Top             =   240
               Width           =   1900
            ...
            Begin MSDataListLib.DataCombo dtc_horaD5 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FCF5
               DataField       =   "horario_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   5040
            ...
            Begin MSDataListLib.DataCombo dtc_horaC5 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FD0E
               DataField       =   "horario_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   4320
            ...
            Begin MSDataListLib.DataCombo dtc_horaB5 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FD27
               DataField       =   "horario_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   3600
            ...
            Begin MSDataListLib.DataCombo dtc_horaA5 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FD40
               DataField       =   "horario_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   2880
            ...
            Begin MSDataListLib.DataCombo dtc_codigo5 
               Bindings        =   "frm_to_tecnico_cronograma.frx":FD59
               DataField       =   "horario_codigo"
               DataSource      =   "Ado_datos"
               Height          =   315
               Left            =   2160
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FD72
            DataField       =   "beneficiario_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   6180
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FD8B
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FDA4
            DataField       =   "unidad_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   1635
         ...
         Begin MSDataListLib.DataCombo Dtc_aux2 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FDBD
            DataField       =   "beneficiario_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   7920
         ...
         Begin MSDataListLib.DataCombo dtc_aux3 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FDD6
         ...
         Begin MSDataListLib.DataCombo dtc_codigo3 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FDEF
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   4720
         ...
         Begin MSDataListLib.DataCombo dtc_desc3 
            Bindings        =   "frm_to_tecnico_cronograma.frx":FE08
            DataField       =   "edif_codigo"
            DataSource      =   "Ado_datos"
            Height          =   315
            Left            =   180
         ...
         Begin VB.Label lblLabels 
            ...
            BackColor       =   &H00000000&
            BackStyle       =   0  'Transparent
            Caption         =   "PARAMETROS PARA EL CRONOGRAMA DE MANTENIMIENTO"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_to_tecnico_cronograma.frx":FE21
         Height          =   4305
         Left            =   120
         TabIndex        =   45
         Top             =   240
   ...
   Begin VB.Frame FrmDetalle 
      ...
      Begin MSDataGridLib.DataGrid DtGLista 
         Bindings        =   "frm_to_tecnico_cronograma.frx":FE39
         Height          =   1140
         Left            =   120
         TabIndex        =   24
         Top             =   240
         ...
         BeginProperty Column16 
            ...
            Caption         =   "Caracteristicas.Complementarias.del.Equipo"
            BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
               Type            =   0
               Format          =   ""
               HaveTrueFalseNull=   0
   ...
   End
End
Attribute VB_Name = "Frm_to_tecnico_cronograma"
...
If (Not Ado_datos.Recordset.BOF) And (Not Ado_datos.Recordset.EOF) Then
   If Not IsNull(Ado_datos.Recordset("tec_plan_codigo")) Then
        If Ado_datos.Recordset!tec_cantidad_unidades1 = "2" Then
...
'                End If
        ...
        rs_datos14.Open "select * from tv_tecnico_cronograma_detalle where unidad_codigo_tec = '" & Ado_datos.Recordset!unidad_codigo_tec & "'  AND tec_plan_codigo = " & Ado_datos.Recordset!tec_plan_codigo & " ", db, adOpenKeyset, adLockOptimistic
        'rs_datos14.Open "select * from to_cronograma_detalle where unidad_codigo_tec = '" & Ado_datos.Recordset!unidad_codigo_tec & "'  AND tec_plan_codigo = " & Ado_datos.Recordset!tec_plan_codigo & " ", db, adOpenKeyset, adLockOptimistic
...
'            FrmABMDet2.Visible = False
        ...
        FrmDetalle.Caption = "Detalle del Cronograma Nro. " + Str((Ado_datos.Recordset("tec_plan_codigo")))
...
Private Sub BtnAprobar_Click()
  ...
  If VAR_VAL = "OK" Then
   If rs_datos!estado_codigo = "REG" And rs_datos!estado_detalle = "APR" Then       'And VAR_CONT2 > 0 Then
      ...
      If sino = vbYes Then
        db.Execute "Update to_cronograma Set estado_codigo = 'APR' Where unidad_codigo_tec = '" & VAR_UNITEC & "' and tec_plan_codigo = " & VAR_TECCOD & "   "
        db.Execute "Update to_cronograma_detalle Set estado_codigo = 'APR' Where unidad_codigo_tec = '" & VAR_UNITEC & "' and tec_plan_codigo = " & VAR_TECCOD & "  "
...
Private Sub BtnEliminar_Click()
  If Ado_datos.Recordset.RecordCount > 0 Then
    If Ado_datos.Recordset!estado_detalle = "REG" Then
      ...
      If sino = vbYes Then
          db.Execute "update to_cronograma set estado_codigo = 'ANL' Where unidad_codigo_tec = '" & Ado_datos.Recordset!unidad_codigo_tec & "' And tec_plan_codigo = " & Ado_datos.Recordset!tec_plan_codigo & "  "
          marca1 = Ado_datos.Recordset.Bookmark
          Call OptFilGral1_Click
          Ado_datos.Recordset.Move marca1 - 1
      End If
...
'  If (Ado_datos.Recordset!zona_edif_orden = "" Or IsNull(Ado_datos.Recordset!zona_edif_orden)) Then
...
'        Fra_Total.Enabled = True
        ...
        SSTab1.TabEnabled(0) = True
        SSTab1.TabEnabled(1) = False
        'update to_cronograma_mensual set to_cronograma_mensual.beneficiario_codigo_resp = tc_zonas_piloto.beneficiario_codigo
'from to_cronograma_mensual inner join tc_zonas_piloto on to_cronograma_mensual.zpiloto_codigo  = tc_zonas_piloto.zpiloto_codigo
'        cmb_lunes
    Else
...
Private Sub cmdElige_Click()
    ...
    rs_aux1.Open "Select * from av_parametros_calculo_rep WHERE bien_codigo = '" & dtc_codigo15.Text & "' ", db, adOpenStatic
    If rs_aux1.RecordCount > 0 Then
        '
        'VAR_GESTION2 = Year(Format(Label11.Caption, "dd/mm/yyyy"))                  'lbl_Gestion.Caption       'rs_aux1!ges_gestion
        VAR_GESTION2 = rs_aux1!ges_gestion
        'VAR_UNIDAD2 = dtc_codigo1.Text            'rs_aux1!unidad_codigo
        VAR_UNIDAD2 = rs_aux1!unidad_codigo
        'VAR_SOL2 = txt_codigo.Caption           ' rs_aux1!solicitud_codigo
        VAR_SOL2 = rs_aux1!solicitud_codigo
        'VER_EDIF2 = dtc_codigo3.Text            'rs_aux1!edif_codigo
        ...
        CR01.StoredProcParam(0) = VAR_GESTION2
        CR01.StoredProcParam(1) = VAR_UNIDAD2
        CR01.StoredProcParam(2) = VAR_SOL2
        CR01.StoredProcParam(3) = VER_EDIF2
...
'  End If
        ...
        If swnuevo = 1 Then
            Set rs_aux2 = New ADODB.Recordset
            If rs_aux2.State = 1 Then rs_aux2.Close
            rs_aux2.Open "select * from to_cronograma_detalle where unidad_codigo_tec = '" & Ado_datos.Recordset!unidad_codigo_tec & "' AND tec_plan_codigo = " & Ado_datos.Recordset!tec_plan_codigo & " AND bien_codigo = '" & VAR_COD4 & "' AND ges_gestion = '" & lbl_Gestion.Caption & "' ", db, adOpenKeyset, adLockOptimistic
            If rs_aux2.RecordCount > 0 Then
        ...
        End If
            ...
            db.Execute "update to_cronograma_detalle set bien_cantidad_por_empaque= " & IIf(txt_dias.Text = "", 2, txt_dias.Text) & ", bien_tiempo_dias = " & VAR_DIAS & ", carta= '" & txt_carta.Text & "', " & _
...
'    Set rs_datos14 = New ADODB.Recordset
'    If rs_datos14.State = 1 Then rs_datos14.Close
'    rs_datos14.Open "select * from tv_tecnico_cronograma_detalle where ges_gestion = '" & Ado_datos.Recordset!ges_gestion & "' and unidad_codigo_tec = '" & Ado_datos.Recordset!unidad_codigo_tec & "'  AND tec_plan_codigo = " & Ado_datos.Recordset!tec_plan_codigo & " ", db, adOpenKeyset, adLockOptimistic
'    Set ado_datos14.Recordset = rs_datos14
  Else
...
'         End Select
    End If
    'If IsNull(Ado_datos.Recordset!fecha_inicio_tec) Then
    
    'End If
    parametro = Aux
    db.Execute "update to_cronograma set to_cronograma.zpiloto_codigo = tc_zona_piloto_edif.zpiloto_codigo from to_cronograma  INNER JOIN tc_zona_piloto_edif ON to_cronograma.edif_codigo = tc_zona_piloto_edif.edif_codigo WHERE to_cronograma.unidad_codigo_tec = '" & VAR_UORIGEN & "' OR to_cronograma.unidad_codigo_tec = '" & Aux & "' "
    db.Execute "update to_cronograma set to_cronograma.zona_edif_orden = tc_zona_piloto_edif.zona_edif_orden from to_cronograma  INNER JOIN tc_zona_piloto_edif ON to_cronograma.zpiloto_codigo = tc_zona_piloto_edif.zpiloto_codigo AND to_cronograma.edif_codigo = tc_zona_piloto_edif.edif_codigo WHERE (to_cronograma.unidad_codigo_tec = '" & VAR_UORIGEN & "' OR to_cronograma.unidad_codigo_tec = '" & Aux & "')  AND to_cronograma.estado_codigo <> 'ANL'"
    ...
    db.Execute "update to_cronograma SET to_cronograma.venta_fecha_inicio = ao_ventas_cabecera.venta_fecha_inicio, to_cronograma.venta_fecha_fin = ao_ventas_cabecera.venta_fecha_fin FROM to_cronograma INNER JOIN ao_ventas_cabecera ON to_cronograma.venta_codigo = ao_ventas_cabecera.venta_codigo WHERE (ao_ventas_cabecera.unidad_codigo = 'DNMAN' OR ao_ventas_cabecera.unidad_codigo = 'DMANS' OR ao_ventas_cabecera.unidad_codigo = 'DMANB' OR ao_ventas_cabecera.unidad_codigo = 'DMANC') AND (to_cronograma.venta_fecha_inicio IS NULL OR to_cronograma.venta_fecha_fin IS NULL)"
    db.Execute "update to_cronograma SET to_cronograma.venta_fecha_inicio = ao_ventas_cabecera.venta_fecha_inicio, to_cronograma.venta_fecha_fin = ao_ventas_cabecera.venta_fecha_fin FROM to_cronograma INNER JOIN ao_ventas_cabecera ON to_cronograma.venta_codigo = ao_ventas_cabecera.venta_codigo WHERE (ao_ventas_cabecera.unidad_codigo = 'DVTA' OR ao_ventas_cabecera.unidad_codigo = 'DCOMS' OR ao_ventas_cabecera.unidad_codigo = 'DCOMB' OR ao_ventas_cabecera.unidad_codigo = 'DCOMC') AND (to_cronograma.venta_fecha_inicio IS NULL OR to_cronograma.venta_fecha_fin IS NULL)"
    'update to_cronograma SET to_cronograma.venta_fecha_inicio = ao_ventas_cabecera.venta_fecha_inicio, to_cronograma.venta_fecha_fin = ao_ventas_cabecera.venta_fecha_fin FROM to_cronograma INNER JOIN ao_ventas_cabecera ON to_cronograma.venta_codigo = ao_ventas_cabecera.venta_codigo WHERE ao_ventas_cabecera.unidad_codigo = 'DMANC' AND (to_cronograma.venta_fecha_inicio IS NULL OR to_cronograma.venta_fecha_fin IS NULL)
    db.Execute "update to_cronograma SET mes_inicio_crono_nro = MONTH(fecha_inicio_tec) where mes_inicio_crono_nro is null  "
    db.Execute "update to_cronograma SET dia_nombre  = 'AUTOMATICO' where dia_nombre is null "
    
    db.Execute "UPDATE to_cronograma SET to_cronograma.tec_cantidad_unidades1 = tc_zona_piloto_edif.mes_par_impar FROM to_cronograma INNER JOIN tc_zona_piloto_edif ON to_cronograma.edif_codigo =  tc_zona_piloto_edif.edif_codigo WHERE to_cronograma.ges_gestion = '2022' AND to_cronograma.tec_cantidad_unidades1 IS NULL "
    
    db.Execute "UPDATE to_cronograma SET to_cronograma.codigo_empresa = ao_ventas_cabecera.codigo_empresa FROM to_cronograma INNER JOIN ao_ventas_cabecera ON to_cronograma.venta_codigo =ao_ventas_cabecera.venta_codigo where (to_cronograma.codigo_empresa Is Null OR to_cronograma.codigo_empresa ='0')"

    db.Execute "UPDATE to_cronograma SET to_cronograma.unimed_codigo_vta = ao_ventas_cabecera.unimed_codigo_cobr FROM to_cronograma INNER JOIN ao_ventas_cabecera ON to_cronograma.venta_codigo =ao_ventas_cabecera.venta_codigo where (to_cronograma.unimed_codigo_vta Is Null OR to_cronograma.unimed_codigo_vta ='EQP') "
    db.Execute "UPDATE to_cronograma SET to_cronograma.cantidad_unidades_vta = ao_ventas_cabecera.venta_cantidad_cobr FROM to_cronograma INNER JOIN ao_ventas_cabecera ON to_cronograma.venta_codigo =ao_ventas_cabecera.venta_codigo where (to_cronograma.cantidad_unidades_vta Is Null OR to_cronograma.cantidad_unidades_vta ='0') "
...
'       Ado_datos.Recordset("tec_plan_codigo") = txt_codigo.Caption
    End If
       ...
       db.Execute "Update to_cronograma_detalle Set beneficiario_codigo = '" & dtc_codigo4.Text & "' Where unidad_codigo_tec = '" & Ado_datos.Recordset!unidad_codigo_tec & "' and tec_plan_codigo = " & Ado_datos.Recordset!tec_plan_codigo & "  "
'    If Ado_datos.Recordset("estado_codigo") = "REG" Then
'        Call OptFilGral1_Click
'    Else
'        Call OptFilGral2_Click
...
Private Sub OptFilGral1_Click()
  '===== Proceso para filtrado general de datos (todos los registros ) - 2021   'AND ges_gestion = '2021'
    ...
    Select Case VAR_DPTOC
        Case "1"    ' Chuquisaca
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '5' or left(edif_codigo,1) = '6') and estado_codigo <> 'ANL' ) "
        Case "2"    'La Paz - Tecnico
            If glusuario = "OCOLODRO" Or glusuario = "JORAQUENI" Or glusuario = "LNAVA" Then
                queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') and estado_codigo <> 'ANL' ) "
            Else
                queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '4' or left(edif_codigo,1) = '9' ) and estado_codigo <> 'ANL' ) "
            End If
        Case "3"    'Cochabamba
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "') and estado_codigo <> 'ANL' ) "
        Case "7"    'Santa Cruz
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '8' or left(edif_codigo,1) = '9' or zpiloto_codigo = '34') and estado_codigo <> 'ANL' ) "
        Case "4"    'Oruro - Tecnico
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "') and estado_codigo <> 'ANL' ) "
        Case "5"    ' Potosi
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "6"    ' Tarija
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "8"    ' Beni
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "9"    ' Pando
            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case Else    ' TODO
            queryinicial = "select * From tv_cronograma_edificaciones  "
     End Select
...
'    Select Case VAR_DPTOC
'        Case "1"    ' Chuquisaca
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((estado_codigo = 'REG' AND (unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '5' or left(edif_codigo,1) = '6' ))) "
'        Case "2"    'La Paz - Tecnico
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((estado_codigo = 'REG' AND (unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '4' ))) "
'        Case "3"    'Cochabamba
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((estado_codigo = 'REG' AND (unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND left(edif_codigo,1) = '" & VAR_DPTOC & "')) "
'        Case "7"    'Santa Cruz
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((estado_codigo = 'REG' AND (unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '8' or left(edif_codigo,1) = '9' or zpiloto_codigo = '34'))) "
'        Case "4"    'Oruro - Tecnico
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((estado_codigo = 'REG' AND (unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND left(edif_codigo,1) = '" & VAR_DPTOC & "')) "
'        Case "5"    ' Potosi
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((estado_codigo = 'REG' AND (unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND left(edif_codigo,1) = '" & VAR_DPTOC & "')) "
...
Private Sub OptFilGral2_Click()
    '===== Proceso para filtrado general de datos (todos los registros ) - 2020   'AND ges_gestion = '2020'
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    Select Case VAR_DPTOC
        Case "1"    ' Chuquisaca
            queryinicial = "select * From tv_cronograma_edificaciones_2020 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '5' or left(edif_codigo,1) = '6')  ) "
        Case "2"    'La Paz - Tecnico
            queryinicial = "select * From tv_cronograma_edificaciones_2020 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '4' ) ) "
        Case "3"    'Cochabamba
            queryinicial = "select * From tv_cronograma_edificaciones_2020 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "7"    'Santa Cruz
            queryinicial = "select * From tv_cronograma_edificaciones_2020 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '8' or left(edif_codigo,1) = '9' or zpiloto_codigo = '34')  ) "
        Case "4"    'Oruro - Tecnico
            queryinicial = "select * From tv_cronograma_edificaciones_2020 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "5"    ' Potosi
            queryinicial = "select * From tv_cronograma_edificaciones_2020 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        ...
        Case "9"    ' Pando
            queryinicial = "select * From tv_cronograma_edificaciones_2020 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case Else    ' TODO
            queryinicial = "select * From tv_cronograma_edificaciones_2020  "
     End Select
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos.Sort = "zpiloto_codigo, zona_edif_orden"           'ges_gestion,
    Set Ado_datos.Recordset = rs_datos.DataSource
...
'    Select Case VAR_DPTOC
'        Case "1"    ' Chuquisaca
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '5' or left(edif_codigo,1) = '6')) "
'        Case "2"    'La Paz - Tecnico
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '4' )) "
'        Case "3"    'Cochabamba
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')) "
'        Case "7"    'Santa Cruz
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '8' or left(edif_codigo,1) = '9' or zpiloto_codigo = '34')) "
'        Case "4"    'Oruro - Tecnico
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')) "
'        Case "5"    ' Potosi
'            queryinicial = "select * From tv_cronograma_edificaciones WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')) "
...
Private Sub OptFilGral3_Click()
    '===== Proceso para filtrado general de datos (todos los registros ) - 2019   'AND ges_gestion = '2019'
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    Select Case VAR_DPTOC
        Case "1"    ' Chuquisaca
            queryinicial = "select * From tv_cronograma_edificaciones_2019 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '5' or left(edif_codigo,1) = '6')  ) "
        Case "2"    'La Paz - Tecnico
            queryinicial = "select * From tv_cronograma_edificaciones_2019 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '4' ) ) "
        Case "3"    'Cochabamba
            queryinicial = "select * From tv_cronograma_edificaciones_2019 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "7"    'Santa Cruz
            queryinicial = "select * From tv_cronograma_edificaciones_2019 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '8' or left(edif_codigo,1) = '9' or zpiloto_codigo = '34')  ) "
        Case "4"    'Oruro - Tecnico
            queryinicial = "select * From tv_cronograma_edificaciones_2019 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "5"    ' Potosi
            queryinicial = "select * From tv_cronograma_edificaciones_2019 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        ...
        Case "9"    ' Pando
            queryinicial = "select * From tv_cronograma_edificaciones_2019 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case Else    ' TODO
            queryinicial = "select * From tv_cronograma_edificaciones_2019  "
     End Select
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos.Sort = "zpiloto_codigo, zona_edif_orden"           'ges_gestion,
    Set Ado_datos.Recordset = rs_datos.DataSource
...
Private Sub Option1_Click()
  '===== Proceso para filtrado general de datos (todos los registros ) - 2021   'AND ges_gestion = '2021'
    ...
    Select Case VAR_DPTOC
        Case "1"    ' Chuquisaca
            queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '5' or left(edif_codigo,1) = '6')  ) "
        Case "2"    'La Paz - Tecnico
            If glusuario = "OCOLODRO" Or glusuario = "JORAQUENI" Or glusuario = "LNAVA" Then
                queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "')  ) "
            Else
                queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '4' or left(edif_codigo,1) = '9' ) ) "
            End If
        Case "3"    'Cochabamba
            queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "7"    'Santa Cruz
            queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "' or left(edif_codigo,1) = '8' or left(edif_codigo,1) = '9' or zpiloto_codigo = '34')  ) "
        Case "4"    'Oruro - Tecnico
            queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case "5"    ' Potosi
            queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        ...
        Case "9"    ' Pando
            queryinicial = "select * From tv_cronograma_edificaciones_2021 WHERE ((unidad_codigo_tec = '" & parametro & "' OR unidad_codigo_tec= '" & VAR_UORIGEN & "') AND (left(edif_codigo,1) = '" & VAR_DPTOC & "')  ) "
        Case Else    ' TODO
            queryinicial = "select * From tv_cronograma_edificaciones_2021  "
     End Select
    rs_datos.Open queryinicial, db, adOpenKeyset, adLockOptimistic
    rs_datos.Sort = "zpiloto_codigo, zona_edif_orden"           'ges_gestion,
    Set Ado_datos.Recordset = rs_datos.DataSource
