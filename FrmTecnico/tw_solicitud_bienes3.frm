...
Begin VB.Form tw_solicitud_bienes3 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "tw_solicitud_bienes3.frx":0000
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   55
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   1680
         MaskColor       =   &H00000000&
         Picture         =   "tw_solicitud_bienes3.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "tw_solicitud_bienes3.frx":6C91E
         Style           =   1  'Graphical
         TabIndex        =   56
         Top             =   120
         Width           =   1340
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox Txt_campo10 
            ...
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   285
            Left            =   240
            TabIndex        =   50
            Text            =   "1"
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "tw_solicitud_bienes3.frx":6D0F4
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "tw_solicitud_bienes3.frx":6D10D
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "tw_solicitud_bienes3.frx":6D126
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   7840
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "tw_solicitud_bienes3.frx":6D13F
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "tw_solicitud_bienes3.frx":6D158
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "tw_solicitud_bienes3.frx":6D171
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "tw_solicitud_bienes3.frx":6D18A
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "tw_solicitud_bienes3.frx":6D1A3
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "tw_solicitud_bienes3.frx":6D1BC
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   6720
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "tw_solicitud_bienes3.frx":6D1D5
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin VB.Label Label9 
            ...
            BackColor       =   &H00000000&
            BackStyle       =   0  'Transparent
            Caption         =   "Descripción del Insumo - Para el Cliente"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "tw_solicitud_bienes3.frx":6D1EE
         DataField       =   "bien_codigo"
         DataSource      =   "tw_identificacion_cliente.ado_detalle3"
         Height          =   315
         Left            =   8400
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "tw_solicitud_bienes3.frx":6D207
         DataField       =   "bien_codigo"
         DataSource      =   "tw_identificacion_cliente.ado_detalle3"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "tw_solicitud_bienes3.frx":6D220
         DataField       =   "bien_codigo"
         DataSource      =   "tw_identificacion_cliente.ado_detalle3"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "tw_solicitud_bienes3"
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
     ...
     If lbl_det.Caption = "39800" Then
        ...
        End If
        tw_identificacion_cliente.Ado_detalle5.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "90000", dtc_aux1.Text)
        tw_identificacion_cliente.Ado_detalle5.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "99900", dtc_aux2.Text)
        tw_identificacion_cliente.Ado_detalle5.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "99990", dtc_aux3.Text)
        If Txt_campo16.Text <> "" Then
            Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
        Else
            Txt_campo16.Text = 1
...
Private Sub ABRIR_TABLA()
    ...
    If lbl_det = "30000" Then
        ...
        rs_datos1.Open "select * from ac_bienes where almacen_tipo = 'I' and estado_codigo ='APR' ORDER BY bien_descripcion ", db, adOpenStatic   'order by descripcion
    End If
