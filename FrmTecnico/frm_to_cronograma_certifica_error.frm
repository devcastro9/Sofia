...
Begin VB.Form frm_to_cronograma_certifica 
   BackColor       =   &H00C0C0C0&
   Caption         =   "Tecnico - Cretificación (Ejecución del Servicio)"
   ClientHeight    =   10950
   ClientLeft      =   225
   ClientTop       =   555
   ClientWidth     =   11280
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.TextBox Txt_campo2 
         ...
         TabIndex        =   51
         Text            =   "frm_to_cronograma_certifica.frx":0A02
         Top             =   3960
         Visible         =   0   'False
         Width           =   1440
      End
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_to_cronograma_certifica.frx":0A04
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_to_cronograma_certifica.frx":0A1D
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_to_cronograma_certifica.frx":0A36
         DataField       =   "unidad_codigo_tec"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1920
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_to_cronograma_certifica.frx":0A4F
         DataField       =   "zpiloto_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1920
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_to_cronograma_certifica.frx":0A68
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_to_cronograma_certifica.frx":0A81
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5160
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.ComboBox cmd_campo2 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_to_cronograma_certifica.frx":0A9A
         Left            =   3840
         List            =   "frm_to_cronograma_certifica.frx":0B34
         TabIndex        =   12
         Text            =   "0"
         Top             =   3360
         Width           =   855
      ...
      Begin VB.TextBox Txt_campo1 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   11
         Text            =   "frm_to_cronograma_certifica.frx":0BF7
         Top             =   3360
         Width           =   645
      End
      ...
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "frm_to_cronograma_certifica.frx":0BF9
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "frm_to_cronograma_certifica.frx":0C12
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   6000
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "frm_to_cronograma_certifica.frx":0C2B
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "frm_to_cronograma_certifica.frx":0C44
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   960
      ...
      Begin MSDataListLib.DataCombo dtc_desc7 
         Bindings        =   "frm_to_cronograma_certifica.frx":0C5D
      ...
      Begin MSDataListLib.DataCombo dtc_desc8 
         Bindings        =   "frm_to_cronograma_certifica.frx":0C76
      ...
      Begin MSDataListLib.DataCombo dtc_codigo7 
         Bindings        =   "frm_to_cronograma_certifica.frx":0C8F
         DataField       =   "beneficiario_codigo_rep"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   6000
      ...
      Begin MSDataListLib.DataCombo dtc_codigo8 
         Bindings        =   "frm_to_cronograma_certifica.frx":0CA8
         DataField       =   "beneficiario_codigo_cobr"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   6000
   ...
   Begin VB.PictureBox fra_opciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   710
         Left            =   12360
         Picture         =   "frm_to_cronograma_certifica.frx":0CC1
         Style           =   1  'Graphical
         TabIndex        =   29
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   710
         Left            =   11280
         Picture         =   "frm_to_cronograma_certifica.frx":1103
         Style           =   1  'Graphical
         TabIndex        =   30
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_to_cronograma_certifica.frx":130D
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_to_cronograma_certifica.frx":1ACC
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   1
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frm_to_cronograma_certifica.frx":23E1
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   2
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   3960
         Picture         =   "frm_to_cronograma_certifica.frx":2B2D
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   3
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   7800
         Picture         =   "frm_to_cronograma_certifica.frx":3360
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   4
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   9240
         Picture         =   "frm_to_cronograma_certifica.frx":3B15
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   5
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_to_cronograma_certifica.frx":43E2
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   28
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_to_cronograma_certifica.frx":4BA4
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   25
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_to_cronograma_certifica.frx":537A
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   24
         Top             =   0
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin VB.PictureBox fra_opciones_det 
         ...
         Height          =   660
         Left            =   30
         Picture         =   "frm_to_cronograma_certifica.frx":5C66
         ScaleHeight     =   660
         ScaleWidth      =   11625
         TabIndex        =   32
         Top             =   240
         ...
         Begin VB.PictureBox BtnCancelarDet 
            ...
            Height          =   615
            Left            =   5640
            Picture         =   "frm_to_cronograma_certifica.frx":5FA8
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   17
            Top             =   0
         ...
         Begin VB.PictureBox BtnGrabarDet 
            ...
            Height          =   615
            Left            =   4200
            Picture         =   "frm_to_cronograma_certifica.frx":6894
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   16
            Top             =   0
         ...
         Begin VB.PictureBox BtnAddDetalle 
            ...
            Height          =   615
            Left            =   0
            Picture         =   "frm_to_cronograma_certifica.frx":706A
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   13
            Top             =   0
         ...
         Begin VB.PictureBox BtnModDetalle 
            ...
            Height          =   615
            Left            =   1305
            Picture         =   "frm_to_cronograma_certifica.frx":7829
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   14
            Top             =   0
         ...
         Begin VB.PictureBox BtnAnlDetalle 
            ...
            Height          =   615
            Left            =   2760
            Picture         =   "frm_to_cronograma_certifica.frx":813E
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   15
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_to_cronograma_certifica.frx":888A
         Height          =   6615
         Left            =   120
         TabIndex        =   22
         Top             =   960
...
Private Sub BtnGrabarDet_Click()
  ...
  If VAR_VAL = "OK" Then
    If swnuevo = 1 Then
        ...
        db.Execute "insert into  tc_zona_piloto_edif(zpiloto_codigo, edif_codigo, zona_edif_orden, zona_codigo, beneficiario_codigo, beneficiario_codigo_rep, beneficiario_codigo_cobr, zorden_cambio,  estado_codigo, fecha_registro, usr_codigo) " & _
        "values (" & Ado_datos.Recordset!zpiloto_codigo & ", '" & dtc_codigo5.Text & "', '" & Txt_campo1.Text & "', '0', '" & dtc_codigo6.Text & "', '" & dtc_codigo7.Text & "', '" & dtc_codigo8.Text & "', 0, 'REG', GETDATE(), 'ADMIN')"
        
        db.Execute "update gc_edificaciones set tomado= 'S' where edif_codigo = '" & dtc_codigo5.Text & "' "
    End If
    If swnuevo = 2 Then
        db.Execute "update tc_zona_piloto_edif set edif_codigo= '" & dtc_codigo5.Text & "', zona_edif_orden='" & Txt_campo1.Text & "', beneficiario_codigo= '" & dtc_codigo6.Text & "', beneficiario_codigo_rep= '" & dtc_codigo7.Text & "',beneficiario_codigo_cobr= '" & dtc_codigo8.Text & "', zorden_cambio= " & cmd_campo2.Text & ", fecha_registro='" & Date & "' where correlativo=" & Text1.Text & " "
        If cmd_campo2.Text <> "0" Then
...
Private Sub Form_Load()
    ...
    parametro = Aux
    '
    'db.Execute "update gc_edificaciones set tomado = 'S' FROM gc_edificaciones INNER JOIN tc_zona_piloto_edif ON gc_edificaciones.edif_codigo = tc_zona_piloto_edif.edif_codigo "
...
'    '===== Proceso para filtrado general de datos (registros no aprobados)
    ...
    'where unidad_codigo_tec = '" & parametro & "' AND ges_gestion = '" & VAR_GES & "'
...
Private Sub ABRIR_TABLA_DET()
    ...
    rs_det1.Open "select * from to_cronograma_diario_final where zpiloto_codigo = '" & Ado_datos.Recordset!zpiloto_codigo & "' order by zona_edif_orden ", db, adOpenKeyset, adLockOptimistic, adCmdText
