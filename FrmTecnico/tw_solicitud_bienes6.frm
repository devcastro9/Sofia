...
Begin VB.Form tw_solicitud_bienes6 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "tw_solicitud_bienes6.frx":0000
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   54
      Top             =   120
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "tw_solicitud_bienes6.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   73
         Top             =   120
         Width           =   1340
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   1680
         MaskColor       =   &H00000000&
         Picture         =   "tw_solicitud_bienes6.frx":6C808
         Style           =   1  'Graphical
         TabIndex        =   72
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox Txt_campo10 
            ...
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   285
            Left            =   240
            TabIndex        =   49
            Text            =   "1"
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "tw_solicitud_bienes6.frx":6D0F4
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "tw_solicitud_bienes6.frx":6D10D
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "tw_solicitud_bienes6.frx":6D126
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   7845
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "tw_solicitud_bienes6.frx":6D13F
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "tw_solicitud_bienes6.frx":6D158
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "tw_solicitud_bienes6.frx":6D171
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "tw_solicitud_bienes6.frx":6D18A
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "tw_solicitud_bienes6.frx":6D1A3
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "tw_solicitud_bienes6.frx":6D1BC
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   6720
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "tw_solicitud_bienes6.frx":6D1D5
            DataField       =   "bien_codigo"
            DataSource      =   "tw_identificacion_cliente.ado_detalle6"
            Height          =   315
            Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "tw_solicitud_bienes6.frx":6D1EE
         DataField       =   "bien_codigo"
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "tw_solicitud_bienes6.frx":6D207
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle5"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "tw_solicitud_bienes6.frx":6D220
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle5"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "tw_solicitud_bienes6"
  ...
  If VAR_VAL = "OK" Then
    ...
    '        tw_identificacion_cliente.Ado_detalle3.Recordset("archivo_plano_cargado").Value = "N"
         End If
            ...
            End If
            tw_identificacion_cliente.Ado_detalle3.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "30000", dtc_aux1.Text)
            tw_identificacion_cliente.Ado_detalle3.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "34000", dtc_aux2.Text)
            tw_identificacion_cliente.Ado_detalle3.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "34800", dtc_aux3.Text)
    ...
    If lbl_det.Caption = "34800" Then
         If swnuevo = 1 Then
            ...
            tw_identificacion_cliente.Ado_detalle6.Recordset("ges_gestion").Value = tw_identificacion_cliente.Ado_datos.Recordset("ges_gestion")
    ...
    '        tw_identificacion_cliente.Ado_detalle6.Recordset("archivo_plano_cargado").Value = "N"
         End If
            ...
            End If
            tw_identificacion_cliente.Ado_detalle6.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "30000", dtc_aux1.Text)
            tw_identificacion_cliente.Ado_detalle6.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "34000", dtc_aux2.Text)
            tw_identificacion_cliente.Ado_detalle6.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "34800", dtc_aux3.Text)
            If Txt_campo16.Text <> "" Then
                Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
            Else
                Txt_campo16.Text = 1
...
Private Sub ABRIR_TABLA()
    ...
    If lbl_det = "34800" Then
        ...
        rs_datos1.Open "select * from ac_bienes where  almacen_tipo = 'H' and estado_codigo ='APR' ORDER BY bien_descripcion ", db, adOpenStatic   'order by descripcion 'and estado_codigo = 'APR'
    End If
