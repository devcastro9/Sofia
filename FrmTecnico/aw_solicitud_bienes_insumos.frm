...
Private Sub BtnCancelar_Click()
  On Error Resume Next
   ...
   If sino = vbYes Then
        frm_ao_requerimiento_compra.Ado_detalle2.Recordset.CancelUpdate
        Unload Me
    End If
    frm_ao_requerimiento_compra.fra_opciones.Enabled = True
    frm_ao_requerimiento_compra.FraNavega.Enabled = True
    frm_ao_requerimiento_compra.FraDet2.Enabled = True
    frm_ao_requerimiento_compra.FrmABMDet2.Enabled = True
    frm_ao_requerimiento_compra.FraDet3.Enabled = True
    frm_ao_requerimiento_compra.FrmABMDet3.Enabled = True
    frm_ao_requerimiento_compra.Fra_datos.Enabled = True
...
'                    frm_ao_requerimiento_compra.Ado_detalle7.Recordset("venta_o_compra").Value = "V"
               Case "43340"
                   Set rs_aux4 = New ADODB.Recordset
                    ...
                    rs_aux4!edif_codigo = frm_ao_requerimiento_compra.dtc_codigo3.Text
...
Private Sub valida_campos()
 ...
 End If
  If dtc_codigo5.Text = "" Then
    MsgBox "Debe registrar el " + Label8.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
  End If
  If dtc_codigo2.Text = "" Then
    MsgBox "Debe registrar el " + lbl_desc2.Caption, vbCritical + vbExclamation, "Validación de datos"
    VAR_VAL = "ERR"
  End If
...
Private Sub ABRIR_TABLA()
    ...
    If lbl_det = "43340" Then
        ...
        rs_datos1.Open "select * from ac_bienes where (par_codigo = '43340' OR par_codigo = '99990') AND edif_codigo = '" & frm_ao_requerimiento_compra.dtc_codigo3 & "' ", db, adOpenStatic   'order by descripcion
    End If
