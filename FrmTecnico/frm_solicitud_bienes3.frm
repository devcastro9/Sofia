...
Begin VB.Form frm_solicitud_bienes3 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_solicitud_bienes3.frx":0000
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   55
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   1800
         MaskColor       =   &H00000000&
         Picture         =   "frm_solicitud_bienes3.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   360
         Picture         =   "frm_solicitud_bienes3.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   56
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.TextBox Txt_campo10 
            ...
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   285
            Left            =   240
            TabIndex        =   50
            Text            =   "1"
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "frm_solicitud_bienes3.frx":6C446
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "frm_solicitud_bienes3.frx":6C45F
            DataField       =   "unimed_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   2520
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "frm_solicitud_bienes3.frx":6C478
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "frm_solicitud_bienes3.frx":6C491
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "frm_solicitud_bienes3.frx":6C4AA
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "frm_solicitud_bienes3.frx":6C4C3
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "frm_solicitud_bienes3.frx":6C4DC
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "frm_solicitud_bienes3.frx":6C4F5
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "frm_solicitud_bienes3.frx":6C50E
            DataField       =   "fosa_dimension_frente"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   6720
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "frm_solicitud_bienes3.frx":6C527
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
            Height          =   315
            Left            =   240
         ...
         Begin VB.Label Label8 
            ...
            BackColor       =   &H80000005&
            BackStyle       =   0  'Transparent
            Caption         =   "El Insumo será utilizado para:"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "frm_solicitud_bienes3.frx":6C540
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
         Height          =   315
         Left            =   8400
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "frm_solicitud_bienes3.frx":6C559
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_solicitud_bienes3.frx":6C572
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle3"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "frm_solicitud_bienes3"
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
     ...
     If lbl_det.Caption = "39800" Then
        ...
        End If
        frm_to_identificacion_cliente.Ado_detalle5.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "90000", dtc_aux1.Text)
        frm_to_identificacion_cliente.Ado_detalle5.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "99900", dtc_aux2.Text)
        frm_to_identificacion_cliente.Ado_detalle5.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "99990", dtc_aux3.Text)
        If Txt_campo16.Text <> "" Then
            Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
        Else
            Txt_campo16.Text = 1
