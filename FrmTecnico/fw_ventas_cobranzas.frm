...
'            DTPFechaProg1.backColor = &H404040       '&H80000013      'Fondo Oscuro
        ...
        If (Ado_datos01.Recordset("estado_codigo") = "REG") Then          'REG
            If glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "APALACIOS" Or glusuario = "JYMAMANI" Or glusuario = "RVALDIVIEZO" Or glusuario = "SQUISPE" Or glusuario = "CNUÑEZ" Or glusuario = "SLIMACHI" Or glusuario = "PLEMUZ" Or glusuario = "FCABRERA" Or glusuario = "TCASTILLO" Or glusuario = "GALARCON" Or glusuario = "FDELGADILLO" Then
                BtnAprobar.Visible = True
            Else
                BtnAprobar.Visible = False
            End If
...
'            If (glusuario = "RVALDIVIEZO" Or glusuario = "ADMIN" Or glusuario = "HBUSTILLOS" Or glusuario = "MVALDIVIA" Or glusuario = "SPAREDES") Or glusuario = "VPAREDES" Or glusuario = "CNUÑEZ" Then
...
'                If (glusuario = "RVALDIVIEZO" Or glusuario = "ADMIN" Or glusuario = "HBUSTILLOS" Or glusuario = "CNUÑEZ" Or glusuario = "VPAREDES") Or glusuario = "CNUÑEZ" Then
'                    BtnAprobar.Visible = True
...
Private Sub BtnAñadir1_Click()
  If glusuario = "APALACIOS" Or glusuario = "EMACHICADO" Or glusuario = "MCONDE" Or glusuario = "CLEDEZMA" Or glusuario = "JROSAS" Or glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "TCASTILLO" Or glusuario = "RVALDIVIEZO" Or glusuario = "FCABRERA" Or glusuario = "WVALLEJOS" Or glusuario = "VPEÑA" Or glusuario = "SQUISPE" Or glusuario = "IDELGADILLO" Or glusuario = "JYMAMANI" Or glusuario = "CNUÑEZ" Or glusuario = "SLIMACHI" Or glusuario = "PLEMUZ" Or glusuario = "MVALDIVIA" Or glusuario = "SPAREDES" Or glusuario = "GALARCON" Or glusuario = "GPALLY" Or glusuario = "MMENACHO" Then
     ...
     If Ado_datos02.Recordset.RecordCount > 0 Then
         ...
         Else
            If Ado_datos02.Recordset("estado_codigo") = "REG" And Ado_datos02.Recordset!estado_codigo_bco = "APR" Then
               ...
               End If
            Else
                MsgBox "No se puede contabilizar, verifique los datos y luego, vuelva a intentar !! ", vbExclamation, "Atención!"
            End If
         End If
     Else
...
Private Sub valida_campos()
    ...
    If IsNull(DTPicker1.Value) Or CDate(DTPicker1.Value) = "01/01/1900" Then
        MsgBox "Debe Registrar la Fecha de Cobranza, Vuelva a Intentar ...", vbExclamation, "Atención"
      VAR_VAL = "ERR"
      Exit Sub
    End If
...
Private Sub OptFilGral01_Click()
  '===== Proceso para filtrado de registros Facturados
    ...
    If rs_datos01.State = 1 Then rs_datos01.Close
    Select Case glusuario
        Case "ADMIN", "VPAREDES", "APALACIOS", "JYMAMANI", "SQUISPE", "CNUÑEZ", "SLIMACHI", "PLEMUZ", "GALARCON"
            BtnAprobar.Visible = True
            BtnModificar.Visible = True
...
'===== Proceso para filtrado general de datos (todos los registros RECIBOS)
    ...
    If rs_datos01.State = 1 Then rs_datos01.Close
    Select Case glusuario
        Case "ADMIN", "VPAREDES", "APALACIOS", "JYMAMANI", "SQUISPE", "CNUÑEZ", "SLIMACHI", "PLEMUZ", "GALARCON", "MVALDIVIA", "SPAREDES"
            BtnAprobar.Visible = True
            BtnModificar.Visible = True
...
'    If glusuario = "ADMIN" Or glusuario = "VPAREDES" Or glusuario = "APALACIOS" Or glusuario = "JYMAMANI" Or glusuario = "RVALDIVIEZO" Or glusuario = "SQUISPE" Or glusuario = "CNUÑEZ" Or glusuario = "SLIMACHI" Or glusuario = "PLEMUZ" Or glusuario = "GALARCON" Then
'        BtnModificar.Visible = True
''        BtnAprobar.Visible = True
'        queryinicial = "select * From av_venta_cobranza_fac WHERE (doc_codigo_fac = 'R-103' ) "
'    Else
...
'===== Proceso para filtrado de datos(registros Pendientes para Cobrar)
    ...
    If rs_datos01.State = 1 Then rs_datos01.Close
    Select Case glusuario
        Case "ADMIN", "VPAREDES", "JYMAMANI", "SQUISPE", "CNUÑEZ", "SLIMACHI", "PLEMUZ", "GALARCON"
            BtnAprobar.Visible = True
            BtnModificar.Visible = True
...
'        If glusuario = "RVALDIVIEZO" Or glusuario = "VPAREDES" Or glusuario = "CNUÑEZ" Then
