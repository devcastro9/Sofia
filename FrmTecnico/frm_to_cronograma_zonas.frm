...
Begin VB.Form frm_to_cronograma_zonas 
   BackColor       =   &H00C0C0C0&
   ...
   ClientTop       =   555
   ClientWidth     =   11280
   Icon            =   "frm_to_cronograma_zonas.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form2"
   MDIChild        =   -1  'True
   ScaleHeight     =   12930
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin VB.ComboBox cmd_campo2 
         ...
         ForeColor       =   &H00000000&
         Height          =   315
         ItemData        =   "frm_to_cronograma_zonas.frx":0A02
         Left            =   3840
         List            =   "frm_to_cronograma_zonas.frx":0AD8
         TabIndex        =   11
         Text            =   "0"
         Top             =   4320
         Width           =   855
      ...
      Begin VB.TextBox Txt_campo1 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   19
         Text            =   "frm_to_cronograma_zonas.frx":0BEB
         Top             =   4320
         Width           =   645
      End
      ...
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "frm_to_cronograma_zonas.frx":0BED
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "frm_to_cronograma_zonas.frx":0C06
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   6000
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "frm_to_cronograma_zonas.frx":0C1F
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "frm_to_cronograma_zonas.frx":0C38
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   960
      ...
      Begin MSDataListLib.DataCombo dtc_desc7 
         Bindings        =   "frm_to_cronograma_zonas.frx":0C51
      ...
      Begin MSDataListLib.DataCombo dtc_desc8 
         Bindings        =   "frm_to_cronograma_zonas.frx":0C6A
      ...
      Begin MSDataListLib.DataCombo dtc_codigo7 
         Bindings        =   "frm_to_cronograma_zonas.frx":0C83
         DataField       =   "beneficiario_codigo_rep"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   6000
      ...
      Begin MSDataListLib.DataCombo dtc_codigo8 
         Bindings        =   "frm_to_cronograma_zonas.frx":0C9C
         DataField       =   "beneficiario_codigo_cobr"
         DataSource      =   "Ado_detalle1"
         Height          =   315
         Left            =   6000
   ...
   Begin VB.PictureBox fra_opciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   710
         Left            =   10800
         Picture         =   "frm_to_cronograma_zonas.frx":0CB5
         Style           =   1  'Graphical
         TabIndex        =   52
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   710
         Left            =   9720
         Picture         =   "frm_to_cronograma_zonas.frx":10F7
         Style           =   1  'Graphical
         TabIndex        =   53
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton Command1 
         Appearance      =   0  'Flat
         DownPicture     =   "frm_to_cronograma_zonas.frx":1301
         Height          =   700
         Left            =   8520
         MaskColor       =   &H8000000F&
         Picture         =   "frm_to_cronograma_zonas.frx":1AC0
         Style           =   1  'Graphical
         TabIndex        =   69
         ToolTipText     =   "Nuevo"
         Top             =   0
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_to_cronograma_zonas.frx":2370
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   12
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_to_cronograma_zonas.frx":2B2F
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   13
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2640
         Picture         =   "frm_to_cronograma_zonas.frx":3444
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   14
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   3960
         Picture         =   "frm_to_cronograma_zonas.frx":3B90
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   15
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   5400
         Picture         =   "frm_to_cronograma_zonas.frx":43C3
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   16
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   6840
         Picture         =   "frm_to_cronograma_zonas.frx":4B78
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   17
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_to_cronograma_zonas.frx":5445
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   51
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "frm_to_cronograma_zonas.frx":5C07
         ScaleHeight     =   615
         ScaleWidth      =   1275
         TabIndex        =   48
         Top             =   0
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "frm_to_cronograma_zonas.frx":63DD
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   47
         Top             =   0
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin VB.PictureBox fra_opciones_det 
         ...
         Begin VB.PictureBox BtnCancelarDet 
            ...
            Height          =   615
            Left            =   5880
            Picture         =   "frm_to_cronograma_zonas.frx":6CC9
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   24
            Top             =   0
         ...
         Begin VB.PictureBox BtnGrabarDet 
            ...
            Height          =   615
            Left            =   4440
            Picture         =   "frm_to_cronograma_zonas.frx":75B5
            ScaleHeight     =   615
            ScaleWidth      =   1275
            TabIndex        =   23
            Top             =   0
         ...
         Begin VB.PictureBox BtnAddDetalle 
            ...
            Height          =   615
            Left            =   120
            Picture         =   "frm_to_cronograma_zonas.frx":7D8B
            ScaleHeight     =   615
            ScaleWidth      =   1200
            TabIndex        =   20
            Top             =   0
         ...
         Begin VB.PictureBox BtnModDetalle 
            ...
            Height          =   615
            Left            =   1545
            Picture         =   "frm_to_cronograma_zonas.frx":854A
            ScaleHeight     =   615
            ScaleWidth      =   1425
            TabIndex        =   21
            Top             =   0
         ...
         Begin VB.PictureBox BtnAnlDetalle 
            ...
            Height          =   615
            Left            =   3120
            Picture         =   "frm_to_cronograma_zonas.frx":8E5F
            ScaleHeight     =   615
            ScaleWidth      =   1215
            TabIndex        =   22
            Top             =   0
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_to_cronograma_zonas.frx":95AB
         Height          =   7575
         Left            =   120
         TabIndex        =   33
         Top             =   960
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.TextBox Txt_campo2 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   0
         Text            =   "frm_to_cronograma_zonas.frx":95C6
         Top             =   1320
         Width           =   5685
      End
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_to_cronograma_zonas.frx":95C8
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_to_cronograma_zonas.frx":95E1
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_to_cronograma_zonas.frx":95FA
         DataField       =   "prov_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_to_cronograma_zonas.frx":9613
         DataField       =   "munic_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_to_cronograma_zonas.frx":962C
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_to_cronograma_zonas.frx":9645
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5040
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_to_cronograma_zonas.frx":965E
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_to_cronograma_zonas.frx":9677
         DataField       =   "depto_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5040
      ...
      Begin MSDataListLib.DataCombo dtc_desc9 
         Bindings        =   "frm_to_cronograma_zonas.frx":9690
      ...
      Begin MSDataListLib.DataCombo dtc_codigo9 
         Bindings        =   "frm_to_cronograma_zonas.frx":96A9
         DataField       =   "zona_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   5040
   ...
   End
End
Attribute VB_Name = "frm_to_cronograma_zonas"
