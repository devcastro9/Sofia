...
Begin VB.Form frm_to_identificacion_cliente 
   BackColor       =   &H00000000&
   ...
   ClientTop       =   345
   ClientWidth     =   11280
   Icon            =   "frm_to_identificacion_cliente.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   10950
   ...
   Begin VB.CommandButton BtnImprimir7 
      ...
      Height          =   640
      Left            =   990
      Picture         =   "frm_to_identificacion_cliente.frx":0A02
      Style           =   1  'Graphical
      TabIndex        =   105
   ...
   Begin VB.Frame FraDet7 
      ...
      Begin MSDataGridLib.DataGrid dg_det7 
         Bindings        =   "frm_to_identificacion_cliente.frx":2184
         Height          =   1215
         Left            =   60
         TabIndex        =   104
         Top             =   240
   ...
   Begin VB.PictureBox Picture3 
      ...
      Height          =   1440
      Left            =   120
      Picture         =   "frm_to_identificacion_cliente.frx":219F
      ScaleHeight     =   1380
      ScaleWidth      =   1635
      TabIndex        =   99
      Top             =   8240
      ...
      Begin VB.CommandButton BtnAnlDetalle7 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":6E1D1
         Style           =   1  'Graphical
         TabIndex        =   102
      ...
      Begin VB.CommandButton BtnModDetalle7 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":6E613
         Style           =   1  'Graphical
         TabIndex        =   101
      ...
      Begin VB.CommandButton BtnAddDetalle7 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":6EA55
         Style           =   1  'Graphical
         TabIndex        =   100
   ...
   Begin VB.CommandButton BtnImprimir1 
      ...
      Height          =   640
      Left            =   14790
      Picture         =   "frm_to_identificacion_cliente.frx":6EE97
      Style           =   1  'Graphical
      TabIndex        =   96
   ...
   Begin VB.PictureBox Picture2 
      ...
      Height          =   1440
      Left            =   13920
      Picture         =   "frm_to_identificacion_cliente.frx":70619
      ScaleHeight     =   1380
      ScaleWidth      =   1635
      TabIndex        =   91
      Top             =   6710
      ...
      Begin VB.CommandButton Command1 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":DAA37
         Style           =   1  'Graphical
         TabIndex        =   98
         ToolTipText     =   "Cotizacion y Costos del Servicio"
         Top             =   720
      ...
      Begin VB.CommandButton BtnAnlDetalle6 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":DC1B9
         Style           =   1  'Graphical
         TabIndex        =   94
      ...
      Begin VB.CommandButton BtnModDetalle6 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":DC5FB
         Style           =   1  'Graphical
         TabIndex        =   93
      ...
      Begin VB.CommandButton BtnAddDetalle6 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":DCA3D
         Style           =   1  'Graphical
         TabIndex        =   92
   ...
   Begin VB.PictureBox Picture1 
      ...
      Height          =   1430
      Left            =   13920
      Picture         =   "frm_to_identificacion_cliente.frx":DCE7F
      ScaleHeight     =   1365
      ScaleWidth      =   1635
      TabIndex        =   87
      Top             =   5195
      ...
      Begin VB.CommandButton BtnImprimir4 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":148EB1
         Style           =   1  'Graphical
         TabIndex        =   97
         ToolTipText     =   "Cotizacion y Costos del Servicio"
         Top             =   710
      ...
      Begin VB.CommandButton BtnAddDetalle5 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":14A633
         Style           =   1  'Graphical
         TabIndex        =   90
         ToolTipText     =   "Adiciona Detalle"
         Top             =   40
      ...
      Begin VB.CommandButton BtnModDetalle5 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":14AA75
         Style           =   1  'Graphical
         TabIndex        =   89
         ToolTipText     =   "Modifica Detalle Elegido"
         Top             =   40
      ...
      Begin VB.CommandButton BtnAnlDetalle5 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":14AEB7
         Style           =   1  'Graphical
         TabIndex        =   88
         ToolTipText     =   "Elimina Detalle Elegido"
         Top             =   720
   ...
   Begin VB.Frame FraDet6 
      ...
      Begin MSDataGridLib.DataGrid dg_det6 
         Bindings        =   "frm_to_identificacion_cliente.frx":14B2F9
         Height          =   1215
         Left            =   60
         TabIndex        =   85
         Top             =   240
   ...
   Begin VB.Frame FraDet5 
      ...
      Begin MSDataGridLib.DataGrid dg_det5 
         Bindings        =   "frm_to_identificacion_cliente.frx":14B314
         Height          =   1215
         Left            =   60
         TabIndex        =   86
         Top             =   240
   ...
   Begin VB.CommandButton BtnImprimir3 
      ...
      Height          =   640
      Left            =   990
      Picture         =   "frm_to_identificacion_cliente.frx":14B32F
      Style           =   1  'Graphical
      TabIndex        =   81
      ToolTipText     =   "Cotizacion y Costos del Servicio"
      Top             =   7445
   ...
   Begin VB.CommandButton BtnImprimir2 
      ...
      Height          =   640
      Left            =   990
      Picture         =   "frm_to_identificacion_cliente.frx":14CAB1
      Style           =   1  'Graphical
      TabIndex        =   80
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Height          =   1440
      Left            =   13920
      Picture         =   "frm_to_identificacion_cliente.frx":14E233
      ScaleHeight     =   1380
      ScaleWidth      =   1635
      TabIndex        =   72
      Top             =   8240
      ...
      Begin VB.CommandButton BtnAddDetalle 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":1BA265
         Style           =   1  'Graphical
         TabIndex        =   75
         ToolTipText     =   "Adiciona Detalle"
         Top             =   40
      ...
      Begin VB.CommandButton BtnModDetalle 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":1BA6A7
         Style           =   1  'Graphical
         TabIndex        =   74
         ToolTipText     =   "Modifica Detalle Elegido"
         Top             =   40
      ...
      Begin VB.CommandButton BtnAnlDetalle 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":1BAAE9
         Style           =   1  'Graphical
         TabIndex        =   73
         ToolTipText     =   "Elimina Detalle Elegido"
         Top             =   720
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_to_identificacion_cliente.frx":1BAF2B
         Height          =   1215
         Left            =   75
         TabIndex        =   71
         Top             =   225
   ...
   Begin VB.PictureBox FrmABMDet3 
      ...
      Height          =   1440
      Left            =   120
      Picture         =   "frm_to_identificacion_cliente.frx":1BAF46
      ScaleHeight     =   1380
      ScaleWidth      =   1635
      TabIndex        =   66
      Top             =   6710
      ...
      Begin VB.CommandButton BtnAddDetalle3 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":225364
         Style           =   1  'Graphical
         TabIndex        =   69
         ToolTipText     =   "Adiciona Producto"
         Top             =   40
      ...
      Begin VB.CommandButton BtnModDetalle3 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":2257A6
         Style           =   1  'Graphical
         TabIndex        =   68
         ToolTipText     =   "Modifica Producto Elegido"
         Top             =   40
      ...
      Begin VB.CommandButton BtnAnlDetalle3 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":225BE8
         Style           =   1  'Graphical
         TabIndex        =   67
         ToolTipText     =   "Anula Producto Elegido"
         Top             =   720
   ...
   Begin VB.PictureBox FrmABMDet2 
      ...
      Height          =   1430
      Left            =   120
      Picture         =   "frm_to_identificacion_cliente.frx":22602A
      ScaleHeight     =   1365
      ScaleWidth      =   1635
      TabIndex        =   62
      Top             =   5195
      ...
      Begin VB.CommandButton BtnAnlDetalle2 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":29205C
         Style           =   1  'Graphical
         TabIndex        =   65
         ToolTipText     =   "Elimina Detalle Elegido"
         Top             =   720
      ...
      Begin VB.CommandButton BtnModDetalle2 
         ...
         Height          =   640
         Left            =   840
         Picture         =   "frm_to_identificacion_cliente.frx":29249E
         Style           =   1  'Graphical
         TabIndex        =   64
         ToolTipText     =   "Modifica Detalle Elegido"
         Top             =   40
      ...
      Begin VB.CommandButton BtnAddDetalle2 
         ...
         Height          =   640
         Left            =   50
         Picture         =   "frm_to_identificacion_cliente.frx":2928E0
         Style           =   1  'Graphical
         TabIndex        =   63
         ToolTipText     =   "Adiciona Detalle"
         Top             =   40
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Height          =   1020
      Left            =   120
      Picture         =   "frm_to_identificacion_cliente.frx":292D22
      ScaleHeight     =   960
      ScaleWidth      =   15405
      TabIndex        =   51
      Top             =   60
      ...
      Begin VB.CommandButton BtnAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_to_identificacion_cliente.frx":2FED54
         Style           =   1  'Graphical
         TabIndex        =   52
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   720
         Left            =   5160
         Picture         =   "frm_to_identificacion_cliente.frx":2FEF5E
         Style           =   1  'Graphical
         TabIndex        =   60
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   720
         Left            =   2640
         Picture         =   "frm_to_identificacion_cliente.frx":2FF3A0
         Style           =   1  'Graphical
         TabIndex        =   59
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   3480
         Picture         =   "frm_to_identificacion_cliente.frx":2FF5AA
         Style           =   1  'Graphical
         TabIndex        =   58
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   4320
         Picture         =   "frm_to_identificacion_cliente.frx":2FFB62
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   6000
         Picture         =   "frm_to_identificacion_cliente.frx":30011F
         Style           =   1  'Graphical
         TabIndex        =   56
      ...
      Begin VB.CommandButton BtnEliminar 
         ...
         Height          =   720
         Left            =   1800
         Picture         =   "frm_to_identificacion_cliente.frx":300329
         Style           =   1  'Graphical
         TabIndex        =   55
      ...
      Begin VB.CommandButton BtnModificar 
         ...
         Height          =   720
         Left            =   960
         Picture         =   "frm_to_identificacion_cliente.frx":300FF3
         Style           =   1  'Graphical
         TabIndex        =   54
      ...
      Begin VB.CommandButton BtnAñadir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frm_to_identificacion_cliente.frx":3015D3
         Style           =   1  'Graphical
         TabIndex        =   53
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_to_identificacion_cliente.frx":301BF7
      ScaleHeight     =   915
      ScaleWidth      =   15405
      TabIndex        =   47
      Top             =   60
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3600
         MaskColor       =   &H00000000&
         Picture         =   "frm_to_identificacion_cliente.frx":36DC29
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_to_identificacion_cliente.frx":36DE33
         Style           =   1  'Graphical
         TabIndex        =   48
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame FraDet3 
      ...
      Begin MSDataGridLib.DataGrid dg_det3 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E03D
         Height          =   1215
         Left            =   60
         TabIndex        =   79
         Top             =   240
      ...
      Begin MSDataGridLib.DataGrid dg_det4 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E058
         Height          =   855
         Left            =   240
         TabIndex        =   95
         Top             =   240
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E073
         Height          =   1215
         Left            =   60
         TabIndex        =   25
         Top             =   240
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E08E
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3360
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E0A8
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3600
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E0C1
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E0DA
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E0F4
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2520
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E10D
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   8400
      ...
      Begin MSDataListLib.DataCombo dtc_codigo3 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E126
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3840
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E13F
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4740
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E158
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4560
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E171
         DataField       =   "subproceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4635
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E18A
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1575
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E1A3
         DataField       =   "poa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1920
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E1BD
         DataField       =   "beneficiario_codigo_resp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1920
      ...
      Begin MSDataListLib.DataCombo dtc_desc3 
         Bindings        =   "frm_to_identificacion_cliente.frx":36E1D7
         DataField       =   "edif_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
   ...
   End
End
Attribute VB_Name = "frm_to_identificacion_cliente"
...
Private Sub BtnAddDetalle_Click()
  ...
  If rs_datos!estado_codigo = "REG" Then
    ...
    frm_to_solicitud_bitacora.txt_codigo.Caption = Me.txt_codigo.Caption
    frm_to_solicitud_bitacora.Txt_campo1.Caption = Me.dtc_codigo1.Text
    frm_to_solicitud_bitacora.Txt_descripcion.Caption = Me.dtc_desc1.Text
    frm_to_solicitud_bitacora.Txt_Correl.Caption = 0    'rs_datos!correl_bitacora + 1
    frm_to_solicitud_bitacora.Txt_estado.Caption = "REG"
    frm_to_solicitud_bitacora.lbl_bitacora.Caption = Me.FraDet1.Caption
    Ado_detalle1.Recordset.AddNew
    frm_to_solicitud_bitacora.Show vbModal
...
Private Sub BtnModDetalle_Click()
  If Ado_detalle1.Recordset.RecordCount > 0 Then
    If rs_datos.RecordCount > 0 And rs_datos!estado_codigo = "REG" Then
      ...
      Fra_datos.Enabled = False
      VAR_SOL = Ado_datos.Recordset!solicitud_codigo
      frm_to_solicitud_bitacora.txt_codigo.Caption = Me.Ado_detalle1.Recordset("solicitud_codigo")  'cod_cabecera
      frm_to_solicitud_bitacora.Txt_campo1.Caption = Me.Ado_detalle1.Recordset("unidad_codigo")  'Unidad
      frm_to_solicitud_bitacora.Txt_descripcion.Caption = Me.dtc_desc1.Text
      frm_to_solicitud_bitacora.Txt_Correl.Caption = Me.Ado_detalle1.Recordset("bitacora_codigo")
      'frm_to_solicitud_bitacora.Txt_estado.Caption = "REG"
      'Ado_detalle1.Recordset.AddNew
       
      frm_to_solicitud_bitacora.dtc_codigo1.Text = Me.Ado_detalle1.Recordset("negocia_forma")
      frm_to_solicitud_bitacora.DTPfecha1.Value = Me.Ado_detalle1.Recordset("negocia_fecha_real")
      frm_to_solicitud_bitacora.Txt_campo2.Value = Me.Ado_detalle1.Recordset("negocia_hora_real")
      frm_to_solicitud_bitacora.Txt_monto1.Text = Me.Ado_detalle1.Recordset("negocia_gasto_estimado")
      frm_to_solicitud_bitacora.dtc_codigo2.Text = Me.Ado_detalle1.Recordset("beneficiario_codigo")
      frm_to_solicitud_bitacora.dtc_codigo3.Text = Me.Ado_detalle1.Recordset("beneficiario_codigo_resp")
      frm_to_solicitud_bitacora.Txt_campo3.Text = Me.Ado_detalle1.Recordset("negocia_tarea_realizada")
      frm_to_solicitud_bitacora.Txt_campo4.Text = Me.Ado_detalle1.Recordset("negocia_observaciones")
      frm_to_solicitud_bitacora.Txt_campo5.Text = Me.Ado_detalle1.Recordset("bitacora_cite")
      If swnuevo = 2 Then
          frm_to_solicitud_bitacora.dtc_desc1.BoundText = frm_to_solicitud_bitacora.dtc_codigo1.BoundText
          frm_to_solicitud_bitacora.dtc_desc2.BoundText = frm_to_solicitud_bitacora.dtc_codigo2.BoundText
          frm_to_solicitud_bitacora.dtc_desc3.BoundText = frm_to_solicitud_bitacora.dtc_codigo3.BoundText
'          frm_to_solicitud_bitacora.HH = Left(frm_to_solicitud_bitacora.Txt_campo2.Text, 2)
'          frm_to_solicitud_bitacora.MM = Right(frm_to_solicitud_bitacora.Txt_campo2.Text, 2)
      End If
...
Private Sub ABRIR_TABLA_DET()
    ...
    'rs_det3.Open "select * from av_solicitud_bienes3 where unidad_codigo = '" & parametro & "' and solicitud_codigo = " & VAR_SOL & "  and (par_codigo <> '39810' and par_codigo <> '39820' and par_codigo <> '34800')   ", db, adOpenKeyset, adLockOptimistic, adCmdText        'and estado_codigo = 'APR'
...
'        If VAR_SOL = 0 Then
    ...
    End If
    FraDet1.Caption = "BITÁCORA DE EVENTOS " + dtc_desc2.Text
