...
'           .Parameters("registro")=
            .ActiveConnection = db
            .Execute
'gvi estaba en null y reemplace con 0
...
Public Sub buscacomprobante(codigo As Integer, org As String, gestion As String, tipo As String)
  ...
  rsbuscacomp.Open "select count(*) as numero from co_comprobante_m where cod_trans='" & codigo & "' and org_codigo='" & org & "' and ges_gestion='" & gestion & "' and tipo_comp='" & tipo & "'", db, adOpenKeyset, adLockReadOnly
...
'           .Parameters("registro")=
            .ActiveConnection = db
            .Execute
            regRVT999 = .Parameters("registro")
            numRVT999 = .Parameters("numero")
        End With
End Sub
