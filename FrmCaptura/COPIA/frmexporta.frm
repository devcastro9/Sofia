...
' ************************* PARAMETRIZAR ********************************
    If GlArch = "DEDF" Then
     ...
     'gw_p_gc_edificaciones.Ado_datos.Recordset!ARCHIVO_Foto = gw_p_gc_edificaciones.Ado_datos.Recordset!ARCHIVO_Foto
...
'     End If
    End If
    If GlArch = "DED2" Then
      fs.CopyFile DirOrigen & "\" & File1.FileName, DirDestino & "\" & aw_p_ao_solicitud.Ado_datos.Recordset!archivo_respaldo
     'gw_p_gc_edificaciones.Ado_datos.Recordset!ARCHIVO_Foto = gw_p_gc_edificaciones.Ado_datos.Recordset!ARCHIVO_Foto
     aw_p_ao_solicitud.Ado_datos.Recordset!archivo_respaldo_cargado = "S"
'     If GlServidor = "SRVPRO" Then
'        fs.CopyFile DirOrigen & "\" & File1.FileName, DirDestino2 & "\" & frmBeneficiario.adoLista.Recordset!ARCHIVO_F
'     End If
    End If
...
''     End If
   End If
   If GlArch = "FEDF" Then
     fs.CopyFile DirOrigen & "\" & File1.FileName, DirDestino & "\" & gw_p_gc_edificaciones.Ado_datos.Recordset!ARCHIVO_Foto
     'gw_p_gc_edificaciones.Ado_datos.Recordset!ARCHIVO_Foto = gw_p_gc_edificaciones.Ado_datos.Recordset!ARCHIVO_Foto
     gw_p_gc_edificaciones.Ado_datos.Recordset!archivo_foto_cargado = "S"
'     If GlServidor = "SRVPRO" Then
'        fs.CopyFile DirOrigen & "\" & File1.FileName, DirDestino2 & "\" & frmBeneficiario.adoLista.Recordset!ARCHIVO_F
'     End If
   End If
...
'     End If
   End If
   If GlArch = "FED2" Then
     fs.CopyFile DirOrigen & "\" & File1.FileName, DirDestino & "\" & aw_p_ao_solicitud.Ado_detalle1.Recordset!ARCHIVO_Foto
     aw_p_ao_solicitud.Ado_detalle1.Recordset!archivo_foto_cargado = "S"
'     If GlServidor = "SRVPRO" Then
'        fs.CopyFile DirOrigen & "\" & File1.FileName, DirDestino2 & "\" & frmBeneficiario.adoLista.Recordset!ARCHIVO_F
'     End If
   End If
