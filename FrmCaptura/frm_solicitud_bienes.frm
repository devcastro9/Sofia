...
Begin VB.Form frm_solicitud_bienes 
   BackColor       =   &H00000000&
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Height          =   975
      Left            =   120
      Picture         =   "frm_solicitud_bienes.frx":0000
      ScaleHeight     =   915
      ScaleWidth      =   10635
      TabIndex        =   24
      Top             =   120
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Left            =   3000
         MaskColor       =   &H00000000&
         Picture         =   "frm_solicitud_bienes.frx":6C032
         Style           =   1  'Graphical
         TabIndex        =   26
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   1560
         Picture         =   "frm_solicitud_bienes.frx":6C23C
         Style           =   1  'Graphical
         TabIndex        =   25
         Top             =   120
         Width           =   765
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin VB.Frame Frame3 
         ...
         Begin MSDataListLib.DataCombo dtc_desc2 
            Bindings        =   "frm_solicitud_bienes.frx":6C446
         ...
         Begin MSDataListLib.DataCombo dtc_codigo2 
            Bindings        =   "frm_solicitud_bienes.frx":6C45F
            DataField       =   "unimed_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   1800
      ...
      Begin VB.Frame Frame1 
         ...
         Begin MSDataListLib.DataCombo dtc_codigo1 
            Bindings        =   "frm_solicitud_bienes.frx":6C478
         ...
         Begin MSDataListLib.DataCombo dtc_desc1 
            Bindings        =   "frm_solicitud_bienes.frx":6C491
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo4 
            Bindings        =   "frm_solicitud_bienes.frx":6C4AA
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo Txt_campo2 
            Bindings        =   "frm_solicitud_bienes.frx":6C4C3
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   3360
         ...
         Begin MSDataListLib.DataCombo Txt_campo3 
            Bindings        =   "frm_solicitud_bienes.frx":6C4DC
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   6840
         ...
         Begin MSDataListLib.DataCombo Txt_campo18 
            Bindings        =   "frm_solicitud_bienes.frx":6C4F5
            DataField       =   "bien_codigo"
            DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
            Height          =   315
            Left            =   240
      ...
      Begin MSDataListLib.DataCombo dtc_aux3 
         Bindings        =   "frm_solicitud_bienes.frx":6C50E
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
         Height          =   315
         Left            =   8400
      ...
      Begin MSDataListLib.DataCombo dtc_aux2 
         Bindings        =   "frm_solicitud_bienes.frx":6C527
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
         Height          =   315
         Left            =   7200
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "frm_solicitud_bienes.frx":6C540
         DataField       =   "bien_codigo"
         DataSource      =   "frm_to_identificacion_cliente.ado_detalle2"
         Height          =   315
         Left            =   5400
   ...
   End
End
Attribute VB_Name = "frm_solicitud_bienes"
...
Private Sub BtnGrabar_Click()
  ...
  If VAR_VAL = "OK" Then
     If swnuevo = 1 Then
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("ges_gestion").Value = glGestion
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("unidad_codigo").Value = Txt_campo1.Caption
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("solicitud_codigo").Value = txt_codigo.Caption
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("estado_codigo").Value = "REG"
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("venta_o_compra").Value = "V"
'        frm_to_identificacion_cliente.Ado_detalle2.Recordset("archivo_foto_cargado").Value = "N"
'        frm_to_identificacion_cliente.Ado_detalle2.Recordset("archivo_plano_cargado").Value = "N"
     End If
        If var_val2 = "1" Then
            frm_to_identificacion_cliente.Ado_detalle2.Recordset("bien_codigo").Value = IIf(Txt_campo5.Text = "", "NA1", Txt_campo5.Text)
            frm_to_identificacion_cliente.Ado_detalle2.Recordset("marca_codigo").Value = IIf(Txt_campo8.Text = "", "S/M", Txt_campo8.Text)
            frm_to_identificacion_cliente.Ado_detalle2.Recordset("modelo_codigo").Value = IIf(Txt_campo9.Text = "", "S/M", Txt_campo9.Text)
        Else
            frm_to_identificacion_cliente.Ado_detalle2.Recordset("bien_codigo").Value = IIf(dtc_codigo1.Text = "", "NA1", dtc_codigo1.Text)
            frm_to_identificacion_cliente.Ado_detalle2.Recordset("marca_codigo").Value = IIf(Txt_campo2.Text = "", "S/M", Txt_campo2.Text)
            frm_to_identificacion_cliente.Ado_detalle2.Recordset("modelo_codigo").Value = IIf(Txt_campo3.Text = "", "S/M", Txt_campo3.Text)
            'OJO FALTA GRABAR EN ac_bienes
        End If
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("grupo_codigo").Value = IIf(dtc_aux1.Text = "", "90000", dtc_aux1.Text)
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("subgrupo_codigo").Value = IIf(dtc_aux2.Text = "", "99900", dtc_aux2.Text)
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("par_codigo").Value = IIf(dtc_aux3.Text = "", "99990", dtc_aux3.Text)
        ...
        Else
            ...
            Txt_campo11.Caption = CDbl(Txt_campo10.Text) * CDbl(Txt_campo16.Text)
        End If
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("bien_precio_venta_base").Value = IIf(Txt_campo10 = "", 0, Txt_campo10)
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("unimed_codigo").Value = IIf(dtc_codigo2 = "", "MES", dtc_codigo2)
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("bien_cantidad").Value = IIf(Txt_campo16 = "", 1, Txt_campo16)
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("bien_total_venta").Value = IIf(Txt_campo11 = "", 0, Txt_campo11)
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("bien_cantidad_por_empaque").Value = IIf(Txt_campo19 = "", 2, Txt_campo19)
        'frm_to_identificacion_cliente.Ado_detalle3.Recordset("bien_total_compra").Value = 0    '
        Select Case Txt_campo1.Caption
           Case "DNMAN"
               frm_to_identificacion_cliente.Ado_detalle2.Recordset("fosa_dimension_frente").Value = "10"
           Case "DNREP"
               frm_to_identificacion_cliente.Ado_detalle2.Recordset("fosa_dimension_frente").Value = "7"
           Case "DNINS"
               frm_to_identificacion_cliente.Ado_detalle2.Recordset("fosa_dimension_frente").Value = "4"
           Case "DNAJS"
               frm_to_identificacion_cliente.Ado_detalle2.Recordset("fosa_dimension_frente").Value = "5"
           Case "DNMOD"
               frm_to_identificacion_cliente.Ado_detalle2.Recordset("fosa_dimension_frente").Value = "9"
        End Select
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("fosa_dimension_fondo").Value = 0  'Txt_campo15.Text
        ...
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("fecha_registro").Value = Date
        'aw_p_ao_solicitud.Ado_detalle1.Recordset("hora_registro").Value = Date
        frm_to_identificacion_cliente.Ado_detalle2.Recordset("usr_codigo").Value = glusuario
        frm_to_identificacion_cliente.Ado_detalle2.Recordset.UpdateBatch adAffectAll
