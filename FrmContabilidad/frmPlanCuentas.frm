...
Begin VB.Form FrmPlanCuentas 
   ...
   Begin VB.Frame Fra_Busqueda 
      ...
      Begin VB.ComboBox CboCampo 
         Height          =   315
         ItemData        =   "frmPlanCuentas.frx":0A02
         Left            =   240
         List            =   "frmPlanCuentas.frx":0A0C
      ...
      Begin VB.ComboBox CboOperador 
         Height          =   315
         ItemData        =   "frmPlanCuentas.frx":0A26
         Left            =   1920
         List            =   "frmPlanCuentas.frx":0A30
         Style           =   2  'Dropdown List
         TabIndex        =   34
         Top             =   480
         Width           =   915
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton BtnBuscar 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frmPlanCuentas.frx":0A3D
         Style           =   1  'Graphical
         TabIndex        =   50
      ...
      Begin VB.CommandButton BtnImprimir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frmPlanCuentas.frx":0FF5
         Style           =   1  'Graphical
         TabIndex        =   49
      ...
      Begin VB.CommandButton BtnSalir 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "frmPlanCuentas.frx":15B2
         Style           =   1  'Graphical
         TabIndex        =   48
         Top             =   2760
         Width           =   885
      ...
      Begin VB.Image Image1 
         Height          =   3705
         Left            =   60
         Picture         =   "frmPlanCuentas.frx":17BC
         Stretch         =   -1  'True
         Top             =   60
         Width           =   1020
      End
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Image Image3 
         Height          =   840
         Left            =   0
         Picture         =   "frmPlanCuentas.frx":3DC6
         Stretch         =   -1  'True
         Top             =   0
         Width           =   15360
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo DtCIdConvenio 
         Bindings        =   "frmPlanCuentas.frx":49A08
         Height          =   285
         Left            =   2040
         TabIndex        =   30
         Top             =   1740
      ...
      Begin MSDataListLib.DataCombo DtCDesConvenio 
         Bindings        =   "frmPlanCuentas.frx":49A22
         Height          =   285
         Left            =   3600
         TabIndex        =   31
         Top             =   1740
