...
Begin VB.Form fc_conciliacion_bancaria 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   11760
         Picture         =   "fw_conciliacion_bancaria.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   47
         Top             =   0
         Visible         =   0   'False
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   10800
         Picture         =   "fw_conciliacion_bancaria.frx":020A
         Style           =   1  'Graphical
         TabIndex        =   46
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "fw_conciliacion_bancaria.frx":064C
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   45
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "fw_conciliacion_bancaria.frx":0E0B
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   44
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "fw_conciliacion_bancaria.frx":1720
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   43
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_conciliacion_bancaria.frx":1E6C
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   42
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "fw_conciliacion_bancaria.frx":269F
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   41
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "fw_conciliacion_bancaria.frx":2E54
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   40
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "fw_conciliacion_bancaria.frx":3721
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   39
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.PictureBox FraGrabarCancelar 
         ...
         Begin VB.PictureBox BtnGrabar 
            ...
            Height          =   615
            Left            =   2880
            Picture         =   "fw_conciliacion_bancaria.frx":3EE3
            ScaleHeight     =   615
            ScaleWidth      =   1305
            TabIndex        =   52
            Top             =   0
         ...
         Begin VB.PictureBox BtnCancelar 
            ...
            Height          =   615
            Left            =   4275
            Picture         =   "fw_conciliacion_bancaria.frx":46D1
            ScaleHeight     =   615
            ScaleWidth      =   1395
            TabIndex        =   51
            Top             =   0
   ...
   Begin VB.Frame Fra_ABM 
      ...
      Begin VB.Image Image2 
         Height          =   480
         Left            =   1440
         Picture         =   "fw_conciliacion_bancaria.frx":4FBD
         Top             =   4800
         Visible         =   0   'False
         Width           =   480
      End
      Begin VB.Image Image1 
         Height          =   480
         Left            =   1440
         Picture         =   "fw_conciliacion_bancaria.frx":52C7
         Top             =   3360
         Visible         =   0   'False
         Width           =   480
      End
   ...
   End
End
Attribute VB_Name = "fc_conciliacion_bancaria"
