...
Begin VB.Form FrmConta_BalApertura 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin MSDataListLib.DataCombo DtcProyDes 
         Bindings        =   "FrmConta_BalApertura.frx":197CB
         DataField       =   "denominacion_aux3"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   3795
      ...
      Begin MSDataListLib.DataCombo DtCIdConvenio 
         Bindings        =   "FrmConta_BalApertura.frx":197E1
         Height          =   315
         Left            =   6600
         TabIndex        =   28
         Top             =   240
      ...
      Begin MSDataListLib.DataCombo DtCDesConvenio 
         Bindings        =   "FrmConta_BalApertura.frx":197FB
         Height          =   405
         Left            =   6315
         TabIndex        =   29
         Top             =   420
      ...
      Begin MSDataListLib.DataCombo cbocta1 
         Bindings        =   "FrmConta_BalApertura.frx":19815
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   11040
      ...
      Begin MSDataListLib.DataCombo dtccta 
         Bindings        =   "FrmConta_BalApertura.frx":1982C
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   11880
      ...
      Begin MSDataListLib.DataCombo dtcsub1 
         Bindings        =   "FrmConta_BalApertura.frx":19843
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   12600
      ...
      Begin MSDataListLib.DataCombo dtcsub2 
         Bindings        =   "FrmConta_BalApertura.frx":1985A
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   13320
      ...
      Begin MSDataListLib.DataCombo DtcCtaNom 
         Bindings        =   "FrmConta_BalApertura.frx":19871
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   2580
      ...
      Begin MSDataListLib.DataCombo DtcAux1 
         Bindings        =   "FrmConta_BalApertura.frx":19888
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   11040
      ...
      Begin MSDataListLib.DataCombo DtcAux2 
         Bindings        =   "FrmConta_BalApertura.frx":1989F
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   11880
      ...
      Begin MSDataListLib.DataCombo DtcAux3 
         Bindings        =   "FrmConta_BalApertura.frx":198B6
         DataField       =   "cod_cta"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   12720
      ...
      Begin MSDataListLib.DataCombo DtcGrBien 
         Bindings        =   "FrmConta_BalApertura.frx":198CD
      ...
      Begin MSDataListLib.DataCombo DtcGrBienDes 
         Bindings        =   "FrmConta_BalApertura.frx":198E5
         DataField       =   "denominacion_aux1"
         DataSource      =   "adosolicitud1"
         Height          =   315
         Left            =   3795
   ...
   Begin VB.Frame Frame4 
      ...
      Begin VB.CommandButton BtnBuscarB 
         ...
         Height          =   840
         Left            =   120
         Picture         =   "FrmConta_BalApertura.frx":198FD
         Style           =   1  'Graphical
         TabIndex        =   110
         ToolTipText     =   "Busca un Registro"
         Top             =   480
   ...
   Begin TrueOleDBGrid60.TDBGrid DataGrid3 
      Bindings        =   "FrmConta_BalApertura.frx":19EB5
      Height          =   3375
      Left            =   1080
      OleObjectBlob   =   "FrmConta_BalApertura.frx":19ED1
      TabIndex        =   39
      Top             =   0
      Width           =   14055
   End
   ...
   Begin VB.Frame FrmGraba 
      ...
      Begin VB.CommandButton BtnBuscarA 
         ...
         Height          =   840
         Left            =   120
         Picture         =   "FrmConta_BalApertura.frx":23C73
         Style           =   1  'Graphical
         TabIndex        =   109
         ToolTipText     =   "Busca un Registro"
         Top             =   4560
      ...
      Begin VB.CommandButton BtnImprimirA 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "FrmConta_BalApertura.frx":2422B
         Style           =   1  'Graphical
         TabIndex        =   108
      ...
      Begin VB.CommandButton BtnCancelar 
         ...
         Height          =   675
         Left            =   120
         Picture         =   "FrmConta_BalApertura.frx":247E8
         Style           =   1  'Graphical
         TabIndex        =   107
         Top             =   5760
         Width           =   765
      ...
      Begin VB.CommandButton BtnGrabar 
         ...
         Height          =   675
         Left            =   120
         Picture         =   "FrmConta_BalApertura.frx":249F2
         Style           =   1  'Graphical
         TabIndex        =   106
         Top             =   3000
         Width           =   765
      ...
      Begin VB.CommandButton BtnEnviar 
         ...
         Height          =   720
         Left            =   120
         Picture         =   "FrmConta_BalApertura.frx":24BFC
         Style           =   1  'Graphical
         TabIndex        =   49
         Top             =   2040
         Width           =   770
   ...
   Begin MSComctlLib.ImageList ImlImagenesAv 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":2503E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":25198
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":252F2
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":2544C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":255A6
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":25700
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":2585A
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":259B4
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList ImlImagenesA 
      Left            =   6240
      Top             =   8400
      _ExtentX        =   1005
      _ExtentY        =   1005
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   8
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":25B4E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":25CA8
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":25E02
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":25F5C
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":260B6
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":26210
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":2636A
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "FrmConta_BalApertura.frx":264C4
            Key             =   ""
         EndProperty
      EndProperty
   End
