...
Begin VB.Form fw_nota_credito_debito 
   ...
   Caption         =   " Procesos Financieros - Tesorería - Notas de Credito-Debito"
   ClientHeight    =   10410
   ClientLeft      =   1560
   ClientTop       =   1725
   ClientWidth     =   17115
...
Private Sub OptFilGral04_Click()
    ...
    Set rs_datos02 = New Recordset
    If rs_datos02.State = 1 Then rs_datos02.Close
    If glusuario = "ASANTIVAÑEZ" Or glusuario = "HBUSTILLOS" Or glusuario = "MVALDIVIA" Or glusuario = "SPAREDES" Or glusuario = "DLAURA" Then
...
'      End If
'    Else
'        MsgBox "La Factura Nro. " + Ado_datos02.Recordset!cobranza_nro_factura + " ya fue Impresa", , "Atención"
'        'Call IMPRIME_FACTURA
'        If (Ado_datos02.Recordset("estado_codigo_sol") = "APR" And Ado_datos02.Recordset("estado_codigo_fac") = "REG") Then          'REG
'          Call OptFilGral1_Click
'        Else
