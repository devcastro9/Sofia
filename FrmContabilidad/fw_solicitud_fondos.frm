...
Begin VB.Form fw_solicitud_fondos 
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1440
         Picture         =   "fw_solicitud_fondos.frx":1603
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   70
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "fw_solicitud_fondos.frx":1F18
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   69
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "fw_solicitud_fondos.frx":2664
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   68
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4200
         Picture         =   "fw_solicitud_fondos.frx":2E97
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   67
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "fw_solicitud_fondos.frx":364C
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   66
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "fw_solicitud_fondos.frx":3F19
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   65
      ...
      Begin VB.CommandButton BtnDesAprobar 
         ...
         Height          =   600
         Left            =   15960
         Picture         =   "fw_solicitud_fondos.frx":46DB
         Style           =   1  'Graphical
         TabIndex        =   64
         Top             =   0
         Visible         =   0   'False
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Begin VB.CommandButton BtnModDetalle 
         ...
         Height          =   525
         Left            =   1300
         Picture         =   "fw_solicitud_fondos.frx":5031
         Style           =   1  'Graphical
         TabIndex        =   61
      ...
      Begin VB.CommandButton BtnAddDetalle 
         ...
         Height          =   525
         Left            =   60
         Picture         =   "fw_solicitud_fondos.frx":5946
         Style           =   1  'Graphical
         TabIndex        =   60
      ...
      Begin VB.CommandButton BtnImprimir1 
         ...
         Height          =   525
         Left            =   1300
         Picture         =   "fw_solicitud_fondos.frx":6105
         Style           =   1  'Graphical
         TabIndex        =   59
   ...
   Begin VB.PictureBox FrmABMDet2 
      ...
      Begin VB.CommandButton BtnAddDetalle2 
         ...
         Height          =   525
         Left            =   60
         Picture         =   "fw_solicitud_fondos.frx":69D2
         Style           =   1  'Graphical
         TabIndex        =   56
      ...
      Begin VB.CommandButton BtnModDetalle2 
         ...
         Height          =   525
         Left            =   1300
         Picture         =   "fw_solicitud_fondos.frx":7191
         Style           =   1  'Graphical
         TabIndex        =   57
      ...
      Begin VB.CommandButton BtnAnlDetalle2 
         ...
         Height          =   525
         Left            =   60
         Picture         =   "fw_solicitud_fondos.frx":7AA6
         Style           =   1  'Graphical
         TabIndex        =   55
      ...
      Begin VB.CommandButton BtnImprimir2 
         ...
         Height          =   525
         Left            =   1300
         Picture         =   "fw_solicitud_fondos.frx":81F2
         Style           =   1  'Graphical
         TabIndex        =   54
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   6435
         Picture         =   "fw_solicitud_fondos.frx":8ABF
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   51
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   5160
         Picture         =   "fw_solicitud_fondos.frx":93AB
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   50
         Top             =   0
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "fw_solicitud_fondos.frx":9B81
         Height          =   1215
         Left            =   120
         TabIndex        =   23
         Top             =   240
   ...
   Begin VB.Frame Fra_datos 
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "fw_solicitud_fondos.frx":9B9C
         DataField       =   "beneficiario_codigo"
      ...
      Begin MSDataListLib.DataCombo dtc_desc10 
         Bindings        =   "fw_solicitud_fondos.frx":9BB5
      ...
      Begin MSDataListLib.DataCombo dtc_codigo11 
         Bindings        =   "fw_solicitud_fondos.frx":9BCF
      ...
      Begin MSDataListLib.DataCombo dtc_aux1 
         Bindings        =   "fw_solicitud_fondos.frx":9BE9
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3600
      ...
      Begin MSDataListLib.DataCombo dtc_codigo2 
         Bindings        =   "fw_solicitud_fondos.frx":9C02
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "fw_solicitud_fondos.frx":9C1B
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1440
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "fw_solicitud_fondos.frx":9C34
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4560
      ...
      Begin MSDataListLib.DataCombo dtc_desc2 
         Bindings        =   "fw_solicitud_fondos.frx":9C4D
         DataField       =   "solicitud_tipo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "fw_solicitud_fondos.frx":9C66
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1665
      ...
      Begin MSDataListLib.DataCombo dtc_codigo10 
         Bindings        =   "fw_solicitud_fondos.frx":9C7F
         DataField       =   "poa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   2040
      ...
      Begin MSDataListLib.DataCombo dtc_desc11 
         Bindings        =   "fw_solicitud_fondos.frx":9C99
         DataField       =   "beneficiario_codigo_resp2"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   180
      ...
      Begin VB.Label lblLabels 
         ...
         BackColor       =   &H00000000&
         BackStyle       =   0  'Transparent
         Caption         =   "Correlativo Registro ISO"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
...
'    FrmABMDet3.Enabled = False
    ...
    Select Case dtc_codigo2.Text
        Case "30"    'CARGOS DE CUENTA
            'frm_solicitud_bienes5A
            VAR_DET = "30000"
            'Ado_detalle2.Recordset.AddNew
            fw_solicitud_fondos_partida.txt_codigo.Caption = Me.txt_codigo.Caption      'solicitud_codigo
            fw_solicitud_fondos_partida.Txt_campo1.Caption = Me.dtc_codigo1.Text        'unidad_codigo
            fw_solicitud_fondos_partida.Txt_descripcion.Caption = Me.dtc_desc1.Text     'unidad_unidad_descripcion
            'fw_solicitud_fondos_partida.lbl_edif.Caption = dtc_codigo3.Text             'edif_codigo
            fw_solicitud_fondos_partida.lbl_det.Caption = VAR_DET     '"34110"
            fw_solicitud_fondos_partida.Txt_estado.Caption = "REG"
            fw_solicitud_fondos_partida.Show vbModal
        Case "28"    'CAJA CHICA
            VAR_DET = "20000"
            'Ado_detalle2.Recordset.AddNew
            fw_solicitud_fondos_partida.txt_codigo.Caption = Me.txt_codigo.Caption
            fw_solicitud_fondos_partida.Txt_campo1.Caption = Me.dtc_codigo1.Text
            fw_solicitud_fondos_partida.Txt_descripcion.Caption = Me.dtc_desc1.Text
            fw_solicitud_fondos_partida.lbl_edif.Caption = dtc_codigo3.Text
            fw_solicitud_fondos_partida.lbl_det.Caption = VAR_DET     '"34110"
            fw_solicitud_fondos_partida.Txt_estado.Caption = "REG"
            fw_solicitud_fondos_partida.Show vbModal
        ...
        Case Else    ' SERVICIO MODERNIZACION
    End Select
    swnuevo = 0
    fraOpciones.Enabled = True
    FraNavega.Enabled = True
  ...
  If VAR_VAL = "OK" Then
    ...
    If VAR_SW = "ADD" Then
       ...
       rs_aux1.Open SQL_FOR, db, adOpenKeyset, adLockOptimistic
        ...
        rs_datos!doc_numero = "0"    'txt_campo1.Caption        'CORREL_DOC
        ...
        Select Case Aux
           ...
           Case Else
        End Select
        dtc_codigo9.Caption = rs_datos!doc_codigo
        Set rs_aux3 = New ADODB.Recordset
        SQL_FOR = "select * from gc_documentos_respaldo where doc_codigo = '" & dtc_codigo9.Caption & "'  "
        rs_aux3.Open SQL_FOR, db, adOpenKeyset, adLockOptimistic
        If rs_aux3.RecordCount > 0 Then
            rs_aux3!correl_doc = rs_aux3!correl_doc + 1
            Txt_campo1.Caption = rs_aux3!correl_doc
            rs_aux3.Update
        End If
        rs_datos!doc_numero = Txt_campo1.Caption        'CORREL_DOC
     ...
     rs_datos!poa_codigo = "4.2.3.3."       'dtc_codigo10.Text
...
Private Sub BtnImprimir_Click()
 ...
 If (Ado_datos.Recordset.RecordCount > 0) Then
    If Ado_detalle2.Recordset.RecordCount > 0 Then
        ...
        cr01.ReportFileName = App.Path & "\Reportes\Contabilidad\fr_listado_solicitud_fondo_avance.rpt"
        cr01.WindowShowPrintSetupBtn = True
        cr01.WindowShowRefreshBtn = True
        'MsgBox rs.RecordCount
          cr01.Formulas(1) = "Titulo1 = '" & dtc_desc2 & "' "
...
Private Sub BtnImprimir2_Click()
 ...
 If (Ado_datos.Recordset.RecordCount > 0) Then
   If Ado_detalle2.Recordset.RecordCount > 0 Then
        Dim iResult As Integer
        'Dim co As New ADODB.Command
        CR02.ReportFileName = App.Path & "\Reportes\Contabilidad\fr_solicitud_fondo_avance.rpt"
        CR02.WindowShowPrintSetupBtn = True
        CR02.WindowShowRefreshBtn = True
        var_titulo = "MODULO CONTABILIDAD"
        'MsgBox rs.RecordCount
          'CR01.Formulas(1) = "cod_unidad = '" & adosolicitud.Recordset!codigo_unidad & "' "
          'CR01.Formulas(6) = "tc = " & GlTipoCambioOficial & " "
        CR02.Formulas(1) = "Titulo = '" & var_titulo & "' "
         CR02.Formulas(2) = "SubTitulo = '" & dtc_desc2 & "' "
        'Call CREAVISTAF11          'JQA JUN-2008
'        CR01.StoredProcParam(0) = Me.Ado_datos.Recordset!ges_gestion
        CR02.StoredProcParam(0) = Me.Ado_datos.Recordset!unidad_codigo
        CR02.StoredProcParam(1) = Me.Ado_datos.Recordset!solicitud_codigo
...
'    FrmABMDet3.Enabled = False
    ...
    VAR_DET = "30000"
    Select Case dtc_codigo2.Text
        Case "30", "29", "28"  'CARGO DE CUENTA
            If VAR_DET = "30000" Or "22000" Or "20000" Then
                ao_solicitud_fondos.txt_codigo.Caption = Me.Ado_detalle2.Recordset("solicitud_codigo")  'cod_cabecera
                ao_solicitud_fondos.Txt_campo1.Caption = Me.Ado_detalle2.Recordset("unidad_codigo")  'Unidad
                ao_solicitud_fondos.Txt_descripcion = Me.dtc_desc1.Text
                ao_solicitud_fondos.lbl_edif.Caption = dtc_codigo3.Text
                ao_solicitud_fondos.Txt_campo5.Text = Me.Ado_detalle2.Recordset("bien_codigo")
                ao_solicitud_fondos.dtc_codigo1.Text = Me.Ado_detalle2.Recordset("bien_codigo")
                ao_solicitud_fondos.dtc_desc1.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                ao_solicitud_fondos.dtc_aux1.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                ao_solicitud_fondos.dtc_aux2.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                ao_solicitud_fondos.dtc_aux3.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                ao_solicitud_fondos.Txt_campo2.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                ao_solicitud_fondos.Txt_campo3.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                ao_solicitud_fondos.Txt_campo4.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                ao_solicitud_fondos.Txt_campo18.BoundText = ao_solicitud_fondos.dtc_codigo1.BoundText
                
                ao_solicitud_fondos.Txt_campo6.Text = IIf(IsNull(Me.Ado_detalle2.Recordset!bien_descripcion), "-", Me.Ado_detalle2.Recordset!bien_descripcion)
                ao_solicitud_fondos.Txt_campo7.Text = IIf(IsNull(Me.Ado_detalle2.Recordset!bien_descripcion_anterior), "-", Me.Ado_detalle2.Recordset!bien_descripcion_anterior)
                ao_solicitud_fondos.Txt_campo8.Text = Me.Ado_detalle2.Recordset("marca_codigo")
                ao_solicitud_fondos.Txt_campo9.Text = Me.Ado_detalle2.Recordset("modelo_codigo")
                
                ao_solicitud_fondos.Txt_campo16.Text = Me.Ado_detalle2.Recordset("bien_cantidad")
                ao_solicitud_fondos.Txt_campo10.Text = Me.Ado_detalle2.Recordset("bien_precio_compra")
                ao_solicitud_fondos.Txt_campo11.Caption = Me.Ado_detalle2.Recordset("bien_total_compra")
                
                ao_solicitud_fondos.Txt_campo14.Text = Me.Ado_detalle2.Recordset("unimed_codigo")
                ao_solicitud_fondos.dtc_codigo2.Text = Me.Ado_detalle2.Recordset("unimed_codigo")
                ao_solicitud_fondos.dtc_desc2.BoundText = ao_solicitud_fondos.dtc_codigo2.BoundText
                
                ao_solicitud_fondos.Txt_campo15.Text = Me.Ado_detalle2.Recordset("fosa_dimension_frente")
                
                ao_solicitud_fondos.lbl_det.Caption = VAR_DET
...
Private Sub dtc_desc4_LostFocus()
    dtc_codigo4.BoundText = dtc_desc4.BoundText
    If Txt_descripcion.Text = "" Then
        Txt_descripcion.Text = lbl_titulo.Caption + ", para: " + dtc_desc4
    End If
...
Private Sub ABRIR_TABLAS_AUX()
    ...
    rs_datos2.Open "Select * from gc_tipo_solicitud where solicitud_num = '30' order by solicitud_tipo", db, adOpenStatic
...
Private Sub ABRIR_TABLA_DET()
    ...
    rs_datos5.Open "select * from ao_solicitud_detalle where unidad_codigo = '" & Ado_datos.Recordset!unidad_codigo & "' and solicitud_codigo = " & Ado_datos.Recordset!solicitud_codigo & "   ", db, adOpenKeyset, adLockOptimistic, adCmdText
    Set Ado_detalle2.Recordset = rs_datos5
...
'    rs_datos.AddNew
    ...
    dtc_desc1.BoundText = dtc_codigo1.BoundText
    dtc_aux1.BoundText = dtc_codigo1.BoundText
    dtc_codigo2.Text = Aux
    dtc_desc2.BoundText = dtc_codigo2.BoundText
'    dtc_desc2.Locked = True
'    Select Case Aux         'parametro
'        Case "28"        'INI COMERCIAL
'            dtc_codigo2.Text = 28
'        Case "29"        'INI COMEX
'            dtc_codigo2.Text = 29
'        Case "30"                        'INI GRABA INSTALACIONES
'            '
'            dtc_codigo2.Text = 30
'        Case Else
'            dtc_codigo2.Text = 28
...
Private Sub OptFilGral1_Click()
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    queryinicial = "Select * from ao_solicitud where estado_codigo = 'REG' AND unidad_codigo = '" & parametro & "' and solicitud_tipo = " & Aux & ""
'    Select Case Aux         'parametro
'        Case "30"    'CARGO DE CUENTA
...
Private Sub OptFilGral2_Click()
    Set rs_datos = New Recordset
    If rs_datos.State = 1 Then rs_datos.Close
    queryinicial = "Select * from ao_solicitud where unidad_codigo = '" & parametro & "' and solicitud_tipo = " & Aux & ""
'    Select Case parametro
'        Case "UALMI"    'INSUMOS
