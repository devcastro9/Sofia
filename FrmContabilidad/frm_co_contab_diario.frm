...
Begin VB.Form frm_co_contab_diario 
   ...
   Begin VB.PictureBox fraOpciones 
      ...
      Begin VB.CommandButton BtnVer 
         ...
         Height          =   600
         Left            =   8640
         Picture         =   "frm_co_contab_diario.frx":0C0C
         Style           =   1  'Graphical
         TabIndex        =   215
      ...
      Begin VB.PictureBox BtnAñadir 
         ...
         Height          =   615
         Left            =   0
         Picture         =   "frm_co_contab_diario.frx":104E
         ScaleHeight     =   615
         ScaleWidth      =   1200
         TabIndex        =   214
         Top             =   0
      ...
      Begin VB.PictureBox BtnModificar 
         ...
         Height          =   615
         Left            =   1305
         Picture         =   "frm_co_contab_diario.frx":180D
         ScaleHeight     =   615
         ScaleWidth      =   1425
         TabIndex        =   213
         Top             =   0
      ...
      Begin VB.PictureBox BtnEliminar 
         ...
         Height          =   615
         Left            =   2760
         Picture         =   "frm_co_contab_diario.frx":2122
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   212
         Top             =   0
      ...
      Begin VB.PictureBox BtnAprobar 
         ...
         Height          =   615
         Left            =   6960
         Picture         =   "frm_co_contab_diario.frx":286E
         ScaleHeight     =   615
         ScaleWidth      =   1320
         TabIndex        =   211
         Top             =   0
      ...
      Begin VB.PictureBox BtnBuscar 
         ...
         Height          =   615
         Left            =   4080
         Picture         =   "frm_co_contab_diario.frx":30A1
         ScaleHeight     =   615
         ScaleWidth      =   1215
         TabIndex        =   210
         Top             =   0
      ...
      Begin VB.PictureBox BtnImprimir 
         ...
         Height          =   615
         Left            =   5520
         Picture         =   "frm_co_contab_diario.frx":3856
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   209
         Top             =   0
      ...
      Begin VB.PictureBox BtnSalir 
         ...
         Height          =   615
         Left            =   17880
         Picture         =   "frm_co_contab_diario.frx":4123
         ScaleHeight     =   615
         ScaleWidth      =   1245
         TabIndex        =   208
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   4275
         Picture         =   "frm_co_contab_diario.frx":48E5
         ScaleHeight     =   615
         ScaleWidth      =   1395
         TabIndex        =   205
         Top             =   0
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   2880
         Picture         =   "frm_co_contab_diario.frx":51D1
         ScaleHeight     =   615
         ScaleWidth      =   1305
         TabIndex        =   204
         Top             =   0
   ...
   Begin VB.PictureBox Picture1 
      ...
      Left            =   120
      Negotiate       =   -1  'True
      Picture         =   "frm_co_contab_diario.frx":59A7
      ScaleHeight     =   7.5
   ...
   Begin VB.PictureBox FrmABMDet 
      ...
      Left            =   105
      Negotiate       =   -1  'True
      Picture         =   "frm_co_contab_diario.frx":719D9
      ScaleHeight     =   7.375
      ScaleMode       =   4  'Character
      ScaleWidth      =   15.625
      TabIndex        =   200
   ...
   Begin VB.Frame FraDet2 
      ...
      Begin MSDataGridLib.DataGrid dg_det2 
         Bindings        =   "frm_co_contab_diario.frx":DDA0B
         Height          =   1575
         Left            =   150
         TabIndex        =   199
         Top             =   240
   ...
   Begin VB.Frame FraDet1 
      ...
      Begin MSDataGridLib.DataGrid dg_det1 
         Bindings        =   "frm_co_contab_diario.frx":DDA26
         Height          =   1575
         Left            =   150
         TabIndex        =   197
         Top             =   240
   ...
   Begin VB.Frame FraNavega 
      ...
      Begin MSDataGridLib.DataGrid dg_datos 
         Bindings        =   "frm_co_contab_diario.frx":DDA41
         Height          =   3560
         Left            =   60
         TabIndex        =   21
         Top             =   210
      ...
      Begin VB.Frame TDBFrameHaber 
         ...
         Begin VB.Frame TDBFrameHCaja 
            ...
            Begin MSDataListLib.DataCombo DTCHDesCaja 
               Bindings        =   "frm_co_contab_diario.frx":DDA59
               Height          =   315
               Left            =   2760
               TabIndex        =   86
               Top             =   540
            ...
            Begin MSDataListLib.DataCombo DTCHidcaja 
               Bindings        =   "frm_co_contab_diario.frx":DDA6F
               Height          =   315
               Left            =   120
               TabIndex        =   87
               Top             =   540
         ...
         Begin VB.Frame TDBFrameHConvenio 
            ...
            Begin MSDataListLib.DataCombo DtCHDesConvenio 
               Bindings        =   "frm_co_contab_diario.frx":DDA85
               Height          =   315
               Left            =   1020
               TabIndex        =   80
               Top             =   1080
            ...
            Begin MSDataListLib.DataCombo DtCHIdConvenio 
               Bindings        =   "frm_co_contab_diario.frx":DDA9F
               Height          =   315
               Left            =   1020
               TabIndex        =   81
               Top             =   600
   ...
   Begin VB.Frame Fram_AsientoD 
      ...
      Begin VB.Frame TDBFrameDebeCta 
         ...
         Begin VB.ComboBox CboDSubcta2 
            Height          =   315
            ItemData        =   "frm_co_contab_diario.frx":DDAB9
            Left            =   6060
            List            =   "frm_co_contab_diario.frx":DDABB
            Sorted          =   -1  'True
            TabIndex        =   141
            Top             =   240
            Width           =   855
      ...
      Begin VB.Frame TDBFrameDebe 
         ...
         Begin VB.Frame TDBFrameDCaja 
            ...
            Begin MSDataListLib.DataCombo DTCDDesCaja 
               Bindings        =   "frm_co_contab_diario.frx":DDABD
               Height          =   315
               Left            =   2700
               TabIndex        =   34
               Top             =   600
            ...
            Begin MSDataListLib.DataCombo dtcDIdCaja 
               Bindings        =   "frm_co_contab_diario.frx":DDAD3
               Height          =   315
               Left            =   120
               TabIndex        =   35
               Top             =   600
         ...
         Begin VB.Frame TDBFrameDConvenio 
            ...
            Begin MSDataListLib.DataCombo DtCDDesConvenio 
               Bindings        =   "frm_co_contab_diario.frx":DDAE9
               Height          =   315
               Left            =   1020
               TabIndex        =   28
               Top             =   1080
            ...
            Begin MSDataListLib.DataCombo DtCDIdConvenio 
               Bindings        =   "frm_co_contab_diario.frx":DDB03
               Height          =   315
               Left            =   1020
               TabIndex        =   29
               Top             =   600
   ...
   Begin VB.Frame FraGlobal 
      ...
      Begin MSDataListLib.DataCombo dtc_codigo4 
         Bindings        =   "frm_co_contab_diario.frx":DDB1D
         DataField       =   "beneficiario_codigo"
      ...
      Begin MSDataListLib.DataCombo dtc_desc1 
         Bindings        =   "frm_co_contab_diario.frx":DDB36
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1800
      ...
      Begin MSDataListLib.DataCombo dtc_codigo1 
         Bindings        =   "frm_co_contab_diario.frx":DDB4F
         DataField       =   "unidad_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4440
      ...
      Begin MSDataListLib.DataCombo dtc_desc4 
         Bindings        =   "frm_co_contab_diario.frx":DDB69
         DataField       =   "beneficiario_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   1280
      ...
      Begin MSDataListLib.DataCombo cboNomTipo 
         Bindings        =   "frm_co_contab_diario.frx":DDB82
         DataField       =   "Tipo_Comp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   7020
      ...
      Begin MSDataListLib.DataCombo CboTipo 
         Bindings        =   "frm_co_contab_diario.frx":DDB9B
         DataField       =   "Tipo_Comp"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   8760
      ...
      Begin MSDataListLib.DataCombo dtc_desc5 
         Bindings        =   "frm_co_contab_diario.frx":DDBB5
      ...
      Begin MSDataListLib.DataCombo dtc_desc7 
         Bindings        =   "frm_co_contab_diario.frx":DDBCE
      ...
      Begin MSDataListLib.DataCombo dtc_desc6 
         Bindings        =   "frm_co_contab_diario.frx":DDBE7
      ...
      Begin MSDataListLib.DataCombo dtc_codigo7 
         Bindings        =   "frm_co_contab_diario.frx":DDC00
         DataField       =   "etapa_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3480
      ...
      Begin MSDataListLib.DataCombo dtc_codigo6 
         Bindings        =   "frm_co_contab_diario.frx":DDC19
         DataField       =   "subproceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   3720
      ...
      Begin MSDataListLib.DataCombo dtc_codigo5 
         Bindings        =   "frm_co_contab_diario.frx":DDC32
         DataField       =   "proceso_codigo"
         DataSource      =   "Ado_datos"
         Height          =   315
         Left            =   4080
...
'error 6160 de acceso de datos
    ...
    rs_detalle1.Open "Select * from cv_diario_debe where Cod_Comp = " & Ado_datos.Recordset!Cod_Comp & " order by Cod_Comp_Detalle", db, adOpenStatic
    Set Ado_detalle1.Recordset = rs_detalle1
    'HABER
    Set rs_detalle2 = New ADODB.Recordset
    If rs_detalle2.State = 1 Then rs_detalle2.Close
    rs_detalle2.Open "Select * from cv_diario_haber where Cod_Comp = " & Ado_datos.Recordset!Cod_Comp & " order by Cod_Comp_Detalle", db, adOpenStatic
...
'          SSTabDebe.TabEnabled(1) = True
       ...
       If IIf(IsNull(rs_aux1!d_Aux3), "", rs_aux1!d_Aux3) <> "00" Then
          DatosDebe IIf(IsNull(rs_aux1!d_Aux3), "", rs_aux1!d_Aux3), IIf(IsNull(rs_aux1!D_Cta_Aux3), "", rs_aux1!D_Cta_Aux3)
'          SSTabDebe.TabEnabled(2) = True
        End If
        '-----
