...
Begin VB.Form gw_rep_generales 
   ...
   Begin VB.Frame Fra_01 
      ...
      Begin VB.Image opt_ges 
         Height          =   975
         Left            =   120
         Picture         =   "gw_rep_generales.frx":13C25
         Stretch         =   -1  'True
         Top             =   2640
         Visible         =   0   'False
         Width           =   1815
   ...
   Begin VB.Frame Fra_03 
      ...
      Begin VB.Image rep_fac2 
         Height          =   1335
         Left            =   11640
         Picture         =   "gw_rep_generales.frx":17E4F
         Stretch         =   -1  'True
         Top             =   360
         Width           =   2295
      End
      Begin VB.Image rep_vta_fac_cob 
         Height          =   1335
         Left            =   6120
         Picture         =   "gw_rep_generales.frx":19F62
         Stretch         =   -1  'True
         Top             =   2520
         Width           =   2295
      End
      Begin VB.Image rep_cob 
         Height          =   1335
         Left            =   6120
         Picture         =   "gw_rep_generales.frx":1BCB3
         Stretch         =   -1  'True
         Top             =   360
         Width           =   2295
      End
      Begin VB.Image rep_vta2 
         Height          =   1335
         Left            =   9000
         Picture         =   "gw_rep_generales.frx":1CBEB
         Stretch         =   -1  'True
         Top             =   360
         Width           =   2295
      End
      Begin VB.Image rep_cob2 
         Height          =   1335
         Left            =   10320
         Picture         =   "gw_rep_generales.frx":1E1E3
         Stretch         =   -1  'True
         Top             =   2520
         Width           =   2295
      End
      Begin VB.Image rep_fac_cob 
         Height          =   1335
         Left            =   3360
         Picture         =   "gw_rep_generales.frx":203FA
         Stretch         =   -1  'True
         Top             =   2520
         Width           =   2295
      End
      Begin VB.Image rep_fac 
         Height          =   1335
         Left            =   3360
         Picture         =   "gw_rep_generales.frx":22AF7
         Stretch         =   -1  'True
         Top             =   360
         Width           =   2295
      End
      Begin VB.Image rep_vta 
         Height          =   1335
         Left            =   480
         Picture         =   "gw_rep_generales.frx":23F65
         Stretch         =   -1  'True
      ...
      Begin VB.Image rep_vta_fac 
         Height          =   1335
         Left            =   480
         Picture         =   "gw_rep_generales.frx":25291
         Stretch         =   -1  'True
         Top             =   2520
         Width           =   2295
      End
   ...
   Begin VB.Frame Fra_02 
      ...
      Begin VB.Image opt_serv 
         Height          =   975
         Left            =   120
         Picture         =   "gw_rep_generales.frx":27997
         Stretch         =   -1  'True
         Top             =   3600
         Visible         =   0   'False
         Width           =   1815
      ...
      Begin VB.Image opt_unid 
         Height          =   1095
         Left            =   120
         Picture         =   "gw_rep_generales.frx":2D979
         Stretch         =   -1  'True
         Top             =   5640
         Visible         =   0   'False
         Width           =   1815
      ...
      Begin VB.Image opt_dpto 
         Height          =   975
         Left            =   120
         Picture         =   "gw_rep_generales.frx":330EB
         Stretch         =   -1  'True
         Top             =   1680
         Visible         =   0   'False
         Width           =   1815
    ...
    Select Case VAR_OPT1
        ...
        Case 2
            ...
            Select Case VAR_OPT2
                Case 1
                    'POR DEPTOS
                    CryUnidad.ReportFileName = App.Path & "\Reportes\Gerenciales\gr_ventas_por_depto_y_mes_fac.rpt"
                    titulo2 = "DEPARTAMENTOS VS. MESES"
