...
Begin VB.Form fw_pagos_gral 
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   1680
         Picture         =   "fw_pagos_gral.frx":0000
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   39
         Top             =   120
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "fw_pagos_gral.frx":08EC
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   38
         Top             =   120
   ...
   End
End
Attribute VB_Name = "fw_pagos_gral"
...
If Valida Then
   ...
   If swnuevo = 1 Then
      ...
      'fw_compras_gral.Ado_detalle3.Recordset("compra_codigo").Value = txt_codigo.Caption         'fw_compras_gral.Ado_datos.Recordset!compra_codigo
      fw_compras_gral.Ado_detalle3.Recordset("adjudica_codigo") = lbl_adjudica.Caption           ' fw_compras_gral.Ado_detalle2.Recordset!adjudica_codigo
      fw_compras_gral.Ado_detalle3.Recordset("pago_codigo") = txtCodigo1.Caption
      fw_compras_gral.Ado_detalle3.Recordset("beneficiario_codigo") = txt_campo1.Text
   Else
   ...
   End If
    ...
    fw_compras_gral.Ado_detalle3.Recordset("pago_monto_bs").Value = TxtMontoBs.Text
    fw_compras_gral.Ado_detalle3.Recordset("pago_monto_dol").Value = TxtMontoDol.Text
    fw_compras_gral.Ado_detalle3.Recordset("pago_descuento_bs").Value = 0
    fw_compras_gral.Ado_detalle3.Recordset("pago_total_bs").Value = TxtMontoBs.Text
    fw_compras_gral.Ado_detalle3.Recordset("pago_total_dol").Value = TxtMontoDol.Text
    fw_compras_gral.Ado_detalle3.Recordset("pago_nro_cmpbte_factura").Value = txt_factura.Text         'Factura
    fw_compras_gral.Ado_detalle3.Recordset("pago_nro_autorizacion").Value = txtDoc.Text                'Autorizacion
