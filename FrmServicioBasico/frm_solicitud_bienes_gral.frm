...
Private Sub BtnGrabar_Click()
 ...
 If VAR_VAL = "OK" Then
    If swnuevo = 1 Then
'        NRO_REG = fw_compras_gral.Ado_detalle1.Recordset.RecordCount
...
'    rs_compra_cab.Open "Select * from ao_compra_cabecera where ges_gestion = '" & Year(Date) & "' and solicitud_codigo =" & rs_datos!solicitud_codigo & " and unidad_codigo = '" & rs_datos!unidad_codigo & "' and unidad_codigo_adm ='" & rs_datos!unidad_codigo & "'", db, adOpenKeyset, adLockOptimistic
    ...
    'rs_compra_det
     ...
     If MOD_NEW.Caption = "NEW" Then
        ...
        rs_aux8.Open "Select max(compra_codigo_det) as correla from ao_compra_detalle WHERE compra_codigo = " & fw_compras_gral.Ado_datos.Recordset!compra_codigo & "", db, adOpenKeyset, adLockOptimistic
        ...
        rs_aux7.Open "Select * from ao_compra_detalle WHERE compra_codigo = " & fw_compras_gral.Ado_datos.Recordset!compra_codigo & " AND bien_codigo = '" & dtc_codigo1.Text & "' AND compra_codigo_det <> " & rs_compra_det!compra_codigo_det & "", db, adOpenKeyset, adLockOptimistic
     ...
     Else
        rs_compra_det.Open "Select * from ao_compra_detalle WHERE compra_codigo = " & fw_compras_gral.Ado_datos.Recordset!compra_codigo & " AND compra_codigo_det = " & fw_compras_gral.Ado_detalle1.Recordset!compra_codigo_det & "", db, adOpenKeyset, adLockOptimistic
      
        Set rs_aux7 = New ADODB.Recordset
        If rs_aux7.State = 1 Then rs_aux7.Close
        rs_aux7.Open "Select * from ao_compra_detalle WHERE compra_codigo = " & fw_compras_gral.Ado_datos.Recordset!compra_codigo & " AND bien_codigo = '" & dtc_codigo1.Text & "' AND compra_codigo_det <> " & fw_compras_gral.Ado_detalle1.Recordset!compra_codigo_det & "", db, adOpenKeyset, adLockOptimistic
        If rs_aux7.RecordCount > 0 Then
            sino = MsgBox("Este Item Ya Existe En Esta Compra", vbCritical, "SOFIA")
            'rs_compra_det.Cancel
            Exit Sub
...
'    End If
    ...
    'rs_aux2.MoveFirst
      'While Not rs_aux2.EOF
        ...
        rs_compra_det!compra_codigo = fw_compras_gral.Ado_datos.Recordset!compra_codigo
...
'        rs_aux2.MoveNext
        'fw_compras_gral.ABRIR_TABLA_DET
      'Wend
...
Private Sub Form_Activate()
    ...
    End If
'    If fw_compras_gral.Ado_detalle1!compra_tdc < 2 Then
        txt_tdc.Text = "6.96"
'    Else
'        Txt_tdc.Text = fw_compras_gral.Ado_detalle1!compra_tdc
'    End If
    Text2.Visible = False
    Txt_campo11.Visible = False
...
Private Sub Form_Load()
    ...
    If rs_UNIDAD.RecordCount > 0 Then
        ...
        If parametro = "DCONT" Then
            VAR_BENEF = "4999270"
        Else
            VAR_BENEF = fw_compras_gral.dtc_codigo11.Text
        End If
    End If
