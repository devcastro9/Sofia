...
Begin VB.Form fw_orden_pago_ccd 
   BackColor       =   &H00C0C0C0&
   ...
   Begin VB.TextBox TxtImporteBs 
      ...
      BeginProperty DataFormat 
         ...
         SubFormatType   =   0
      EndProperty
      DataSource      =   "fw_solicitud_fondos.Ado_detalle3"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   360
         Picture         =   "fw_orden_pago_ccd.frx":0000
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   40
         Top             =   120
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   1635
         Picture         =   "fw_orden_pago_ccd.frx":07D6
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   39
         Top             =   120
   ...
   Begin VB.Frame FrmCobros 
      ...
      Begin MSDataListLib.DataCombo txt_campo1 
         Bindings        =   "fw_orden_pago_ccd.frx":10C2
      ...
      Begin MSDataListLib.DataCombo Txt_descripcion 
         Bindings        =   "fw_orden_pago_ccd.frx":10DC
         DataField       =   "beneficiario_codigo"
         DataSource      =   "fw_solicitud_fondos.Ado_detalle3"
         Height          =   315
         Left            =   1800
      ...
      Begin MSDataListLib.DataCombo dtc_cuenta_cod 
         Bindings        =   "fw_orden_pago_ccd.frx":110D
      ...
      Begin MSDataListLib.DataCombo dtc_cuenta_desc 
         Bindings        =   "fw_orden_pago_ccd.frx":1127
         DataField       =   "cta_codigo"
         DataSource      =   "fw_solicitud_fondos.Ado_detalle3"
         Height          =   315
         Left            =   960
   ...
   End
End
Attribute VB_Name = "fw_orden_pago_ccd"
...
If Valida Then
   ...
   If swnuevo = 1 Then
      ...
      fw_solicitud_fondos.Ado_detalle3.Recordset("ges_gestion") = glGestion
      fw_solicitud_fondos.Ado_detalle3.Recordset("compra_codigo").Value = fw_solicitud_fondos.Ado_datos.Recordset!compra_codigo
      fw_solicitud_fondos.Ado_detalle3.Recordset("adjudica_codigo") = fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_codigo")          ' fw_solicitud_fondos.Ado_detalle2.Recordset!adjudica_codigo
      fw_solicitud_fondos.Ado_detalle3.Recordset("pago_codigo") = fw_solicitud_fondos.Ado_detalle3.Recordset.RecordCount
      fw_solicitud_fondos.Ado_detalle3.Recordset("beneficiario_codigo") = fw_solicitud_fondos.Ado_detalle2.Recordset("beneficiario_codigo")
   Else
   ...
   End If
    If Chk_fac.Value = 1 Then
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_emite_factura").Value = "S"
    Else
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_emite_factura").Value = "N"
    End If
    If Chk_Ret.Value = 1 Then
        fw_solicitud_fondos.Ado_detalle3.Recordset("retension_asumida").Value = "S"
    Else
        fw_solicitud_fondos.Ado_detalle3.Recordset("retension_asumida").Value = "N"
    End If
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_descripcion") = TxtConcepto.Text
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_fecha_prog") = DTPFechaProg.Value
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_fecha_efectiva").Value = DTPFechaPago.Value

    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_descuento_bs").Value = CDbl(TxtDsctoBs)
    
   If TxtMontoDol.Text = "" Or TxtMontoDol.Text = "0" Then
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_total_dol").Value = CDbl(TxtMontoBs.Text) / GlTipoCambioOficial
   Else
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_total_dol").Value = TxtMontoDol.Text
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_total_bs").Value = TxtMontoBs.Text
   End If
   
   If TxtMontoBs.Text = "" Or TxtMontoBs.Text = "0" Then
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_total_bs").Value = CDbl(TxtMontoBs.Text) * GlTipoCambioOficial
   Else
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_total_dol").Value = TxtMontoDol.Text
        fw_solicitud_fondos.Ado_detalle3.Recordset("pago_total_bs").Value = TxtMontoBs.Text
   End If
   'fw_solicitud_fondos.Ado_detalle3.Recordset("pago_monto_bs").Value = fw_solicitud_fondos.Ado_detalle3.Recordset("pago_total_bs").Value
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_monto_bs").Value = TxtImporteBs.Text
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_monto_dol").Value = CDbl(TxtImporteBs.Text) / GlTipoCambioOficial
    
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_nro_cmpbte_factura").Value = txt_factura.Text         'Factura
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_nro_autorizacion").Value = IIf(txtDoc.Text = "", "0", txtDoc.Text)            'Autorizacion
    
    fw_solicitud_fondos.Ado_detalle3.Recordset("pago_respaldos") = txt_respaldos.Text
    'Ado_datos.Recordset!Literal = Literal(CStr(Ado_datos.Recordset!cobranza_total_bs)) + " BOLIVIANOS"
    fw_solicitud_fondos.Ado_detalle3.Recordset("literal").Value = Literal(CStr(fw_solicitud_fondos.Ado_detalle3.Recordset!pago_total_dol)) + " DOLARES AMERICANOS"
    fw_solicitud_fondos.Ado_detalle3.Recordset("poa_codigo").Value = "4.1.1"
    
    fw_solicitud_fondos.Ado_detalle3.Recordset("estado_codigo") = "REG"
    fw_solicitud_fondos.Ado_detalle3.Recordset("usr_codigo") = glusuario
    fw_solicitud_fondos.Ado_detalle3.Recordset("fecha_registro") = Format(Date, "dd/mm/yyyy")
    fw_solicitud_fondos.Ado_detalle3.Recordset("hora_registro") = Format(Time, "HH:mm:ss")
    fw_solicitud_fondos.Ado_detalle3.Recordset("cta_codigo") = dtc_cuenta_cod.Text
    fw_solicitud_fondos.Ado_detalle3.Recordset("tipo_cambio") = TxtDscto.Text
    
'    sino = MsgBox("Desea APROBAR el Registro ? (Ya no podrá modificarlo)", vbYesNo + vbQuestion, "Atención")
'    If sino = vbYes Then
'        Select Case fw_solicitud_fondos.Ado_datos.Recordset("modalidad_codigo")
'            Case "INVD"    'INVITACION DIRECTA
'                fw_solicitud_fondos.Ado_detalle3.Recordset("estado_codigo") = "APR"
'                Call GRABA_FICHA
...
'    End If
    ...
    fw_solicitud_fondos.Ado_detalle3.Recordset.Update
   Para_Aceptado = "S"
...
Private Sub GRABA_FICHA()
    ...
    rs_aux3.Open "SELECT * FROM ro_rrhh_apertura_sobres where rrhh_codigo = " & fw_solicitud_fondos.Ado_datos.Recordset!rrhh_codigo & "  ", db, adOpenStatic
...
''    db.Execute "Insert INTO ro_personal_contratado_new (rrhh_codigo, beneficiario_codigo, puesto_codigo, estado_codigo, usr_codigo, fecha_registro) Values ('" & fw_solicitud_fondos.Ado_datos.Recordset!rrhh_codigo & "', '" & txtCI.Text & "', '" & GlPuesto & "',  'REG', '" & glusuario & "',  '" & Date & "')"
''    db.Execute "Insert INTO ro_personal_contratado (rrhh_codigo, beneficiario_codigo, puesto_codigo, estado_codigo, usr_codigo, fecha_registro) Values ('" & fw_solicitud_fondos.Ado_datos.Recordset!rrhh_codigo & "', '" & txtCI.Text & "', '" & GlPuesto & "',  'REG', '" & glusuario & "',  '" & Date & "')"
'
...
'        db.Execute "Insert INTO ro_personal_contratado (rrhh_codigo, beneficiario_codigo, puesto_codigo, unidad_codigo, cargo_codigo, fecha_ingreso, fecha_expiracion, ocup_codigo, beneficiario_haber_mensual, estado_codigo, usr_codigo, fecha_registro) Values ('" & fw_solicitud_fondos.Ado_datos.Recordset!rrhh_codigo & "', '" & txtCI.Text & "', '" & GlPuesto & "', '" & rs_aux2!unidad_codigo & "',  '" & rs_aux2!cargo_codigo & "',  '" & fw_solicitud_fondos.Ado_detalle2.Recordset!beneficiario_fecha_inicio & "', '" & fw_solicitud_fondos.Ado_detalle2.Recordset!beneficiario_fecha_fin & "', '" & VAR_OCUP & "', " & fw_solicitud_fondos.Ado_detalle2.Recordset!beneficiario_monto_adjudica_dol & ", 'REG', '" & glusuario & "',  '" & Date & "')"
'        'db.Execute "Insert INTO ro_personal_contratado_NEW (rrhh_codigo, beneficiario_codigo, puesto_codigo, unidad_codigo, cargo_codigo, estado_codigo, usr_codigo, fecha_registro) Values ('" & fw_solicitud_fondos.Ado_datos.Recordset!rrhh_codigo & "', '" & txtCI.Text & "', '" & GlPuesto & "', '" & rs_aux2!unidad_codigo & "',  '" & rs_aux2!cargo_codigo & "',  'REG', '" & glusuario & "',  '" & Date & "')"
'    Else
'        db.Execute "Insert INTO ro_personal_contratado (rrhh_codigo, beneficiario_codigo, puesto_codigo, estado_codigo, usr_codigo, fecha_registro) Values ('" & fw_solicitud_fondos.Ado_datos.Recordset!rrhh_codigo & "', '" & txtCI.Text & "', '" & GlPuesto & "',  'REG', '" & glusuario & "',  '" & Date & "')"
'    End If
...
'    rs_clasif1.Open "SELECT * FROM gc_beneficiario where tipoben_codigo >0 ORDER BY beneficiario_denominacion ", db, adOpenStatic
