...
Begin VB.Form fw_adjudica_gral 
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.Label lbl_bitacora 
         ...
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "REGISTRO DE LA FACTURA"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   12
            Charset         =   0
...
'Next i
   ...
   If txt_total_bs.Text > "0" Then
        Call CRONO_PAGO
   Else
        db.Execute "DELETE FROM ao_compra_planilla_pagos where adjudica_codigo = '" & lbl_adjudica.Caption & "' AND compra_codigo = " & fw_compras_gral.Ado_datos.Recordset!compra_codigo & ""
   End If
...
Private Sub CRONO_PAGO()
    ...
    Select Case RTrim(cmb_mes_ini.Text)
        ...
        Case "DICIEMBRE"
            txt_mes.Text = 12
      End Select
    db.Execute "DELETE ao_compra_planilla_pagos where adjudica_codigo = '" & fw_compras_gral.Ado_detalle2.Recordset!adjudica_codigo & "' AND compra_codigo = " & fw_compras_gral.Ado_datos.Recordset!compra_codigo & ""
