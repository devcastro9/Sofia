...
Begin VB.Form fw_adjudica_ccd 
   BackColor       =   &H00C0C0C0&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Fondos a Rendir - Autorización"
   ClientHeight    =   8115
   ClientLeft      =   45
   ClientTop       =   360
   ClientWidth     =   11010
   ...
   Begin VB.Frame fra_provedor 
      ...
      Begin VB.PictureBox Picture1 
         ...
         Begin VB.PictureBox Picture3 
            ...
            Height          =   615
            Left            =   120
            Picture         =   "fw_adjudica_ccd.frx":0000
            ScaleHeight     =   615
            ScaleWidth      =   1335
            TabIndex        =   67
            Top             =   120
         ...
         Begin VB.PictureBox Picture2 
            ...
            Height          =   615
            Left            =   1680
            Picture         =   "fw_adjudica_ccd.frx":07D6
            ScaleHeight     =   615
            ScaleWidth      =   1455
            TabIndex        =   66
            Top             =   120
      ...
      Begin VB.Label Label13 
         AutoSize        =   -1  'True
         BackColor       =   &H00C0C0C0&
         Caption         =   "No.de Autorización de Factura:"
         BeginProperty Font 
            Name            =   "MS Sans Serif"
            Size            =   9.75
            Charset         =   0
   ...
   Begin VB.PictureBox FraGrabarCancelar 
      ...
      Begin VB.PictureBox BtnCancelar 
         ...
         Height          =   615
         Left            =   1680
         Picture         =   "fw_adjudica_ccd.frx":10C2
         ScaleHeight     =   615
         ScaleWidth      =   1455
         TabIndex        =   52
         Top             =   120
      ...
      Begin VB.PictureBox BtnGrabar 
         ...
         Height          =   615
         Left            =   120
         Picture         =   "fw_adjudica_ccd.frx":19AE
         ScaleHeight     =   615
         ScaleWidth      =   1335
         TabIndex        =   51
         Top             =   120
      ...
      Begin VB.Label lbl_bitacora 
         ...
         AutoSize        =   -1  'True
         BackStyle       =   0  'Transparent
         Caption         =   "AUTORIZACION DE DESENBOLSO"
         BeginProperty Font 
            Name            =   "Arial"
            Size            =   12
            Charset         =   0
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Frame fra_almacen 
         ...
         Begin MSDataListLib.DataCombo dtc_desc_alm 
            Bindings        =   "fw_adjudica_ccd.frx":2184
         ...
         Begin MSDataListLib.DataCombo dtc_cod_alm 
            Bindings        =   "fw_adjudica_ccd.frx":219E
            DataField       =   "almacen_codigo"
            DataSource      =   "fw_solicitud_fondos.Ado_detalle2"
            Height          =   315
            Left            =   6720
      ...
      Begin VB.ComboBox cmd_unimed2 
         ...
         DataSource      =   "fw_solicitud_fondos.Ado_detalle2"
         Height          =   315
         ItemData        =   "fw_adjudica_ccd.frx":21B8
         Left            =   6840
         List            =   "fw_adjudica_ccd.frx":21CB
         TabIndex        =   15
         Top             =   6495
         Width           =   1875
      End
      ...
      Begin VB.ComboBox cmb_mes_ini 
         ...
         DataSource      =   "fw_solicitud_fondos.Ado_detalle2"
         Height          =   315
         ItemData        =   "fw_adjudica_ccd.frx":21ED
         Left            =   720
         List            =   "fw_adjudica_ccd.frx":2215
         TabIndex        =   13
         Top             =   6480
         Width           =   1620
      End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin MSDataListLib.DataCombo dtc_desc5 
            Bindings        =   "fw_adjudica_ccd.frx":227E
         ...
         Begin VB.CommandButton CmdAdd4 
            ...
            Height          =   375
            Left            =   8760
            Picture         =   "fw_adjudica_ccd.frx":2298
            Style           =   1  'Graphical
            TabIndex        =   61
         ...
         Begin MSDataListLib.DataCombo dtc_aux4 
            Bindings        =   "fw_adjudica_ccd.frx":2822
            DataField       =   "beneficiario_codigo"
            DataSource      =   "fw_solicitud_fondos.Ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_codigo5 
            Bindings        =   "fw_adjudica_ccd.frx":283C
            DataField       =   "beneficiario_codigo"
            DataSource      =   "fw_solicitud_fondos.Ado_detalle2"
            Height          =   315
            Left            =   240
         ...
         Begin MSDataListLib.DataCombo dtc_aux5 
            Bindings        =   "fw_adjudica_ccd.frx":2856
            DataField       =   "beneficiario_codigo"
            DataSource      =   "fw_solicitud_fondos.Ado_detalle2"
            Height          =   315
            Left            =   3480
         ...
         Begin MSDataListLib.DataCombo dtc_auto5 
            Bindings        =   "fw_adjudica_ccd.frx":2870
            DataField       =   "beneficiario_codigo"
            DataSource      =   "fw_compras_gral.ado_detalle2"
            Height          =   315
            Left            =   4320
         ...
         Begin VB.Label Label4 
            AutoSize        =   -1  'True
            BackColor       =   &H00C0C0C0&
            Caption         =   "Denominacion Beneficiario"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   9.75
               Charset         =   0
   ...
   End
End
Attribute VB_Name = "fw_adjudica_ccd"
...
'cancela la edicion de datos
    Para_Aceptado = "N"
    fw_solicitud_fondos.Ado_detalle2.Recordset.CancelBatch
'    txtSW = "0"
    Unload Me
End Sub
...
If Valida Then
   ...
   If swnuevo = 1 Then
     ...
     fw_solicitud_fondos.Ado_detalle2.Recordset("ges_gestion") = glGestion
     fw_solicitud_fondos.Ado_detalle2.Recordset("unidad_codigo") = txt_campo1.Text
     fw_solicitud_fondos.Ado_detalle2.Recordset("solicitud_codigo") = txt_codigo
     fw_solicitud_fondos.Ado_detalle2.Recordset("compra_codigo").Value = fw_solicitud_fondos.Ado_datos.Recordset!compra_codigo
     fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_codigo") = lbl_adjudica.Caption
     
      VAR_COMPRA = fw_solicitud_fondos.Ado_datos.Recordset!compra_codigo
   Else
      ...
      VAR_COMPRA = fw_solicitud_fondos.Ado_detalle2.Recordset("compra_codigo")
   End If
   ...
   Select Case txt_campo1.Text
        ...
        Case "COMEX"
            ...
            fw_solicitud_fondos.Ado_detalle2.Recordset!proceso_codigo = "CMX"         'IIf(dtc_codigo5.Text = "", "COM", dtc_codigo5.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!subproceso_codigo = "CMX-01"   'IIf(dtc_codigo6.Text = "", "COM-03", dtc_codigo6.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!etapa_codigo = "CMX-01-01"     'IIf(dtc_codigo7.Text = "", "COM-03-02", dtc_codigo7.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "COM"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-223"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "4.1.1"
             
            
        Case "DCONT"    'SOLO COMPRAS BB y SS   'FIN-03-01
        
            fw_solicitud_fondos.Ado_detalle2.Recordset!proceso_codigo = "FIN"         'IIf(dtc_codigo5.Text = "", "COM", dtc_codigo5.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!subproceso_codigo = "FIN-03"   'IIf(dtc_codigo6.Text = "", "COM-03", dtc_codigo6.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!etapa_codigo = "FIN-03-02"     'IIf(dtc_codigo7.Text = "", "COM-03-02", dtc_codigo7.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "ADM"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-113"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "4.2.3"          'dtc_codigo10.Text
            'fw_solicitud_fondos.Ado_detalle2.Recordset!solicitud_observaciones = dtc_desc2.Text + " - " + dtc_desc4.Text       ' txt_obs.Text
        
        Case "DVTA"    ' COMPRA-VENTA BB Y SS - COMERCIAL
        
            fw_solicitud_fondos.Ado_detalle2.Recordset!proceso_codigo = "COM"         'IIf(dtc_codigo5.Text = "", "COM", dtc_codigo5.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!subproceso_codigo = "COM-01"   'IIf(dtc_codigo6.Text = "", "COM-03", dtc_codigo6.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!etapa_codigo = "COM-01-02"     'IIf(dtc_codigo7.Text = "", "COM-03-02", dtc_codigo7.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "COM"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-234"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
           ' fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.1.1"
        
        Case "DNINS", "DINSB", "DINSC", "DINSS"
            
            fw_solicitud_fondos.Ado_detalle2.Recordset!proceso_codigo = "COM"         'IIf(dtc_codigo5.Text = "", "COM", dtc_codigo5.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!subproceso_codigo = "COM-03"   'IIf(dtc_codigo6.Text = "", "COM-03", dtc_codigo6.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!etapa_codigo = "COM-03-01"     'IIf(dtc_codigo7.Text = "", "COM-03-02", dtc_codigo7.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-362"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.2"
        ...
        Case "DNAJS", "DAJSB", "DAJSC", "DAJSS"
            ...
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-362"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.6"
        ...
        Case "DNMAN", "DMANB", "DMANC", "DMANS"
            ...
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-362"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.3"
        ...
        Case "DNREP", "DREPB", "DREPC", "DREPS"
            ...
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-362"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.4"
        ...
        Case "DNEME", "DEMEB", "DEMEC", "DEMES"
            ...
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-362"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.1"
        ...
        Case "DNMOD", "DMODB", "DMODC", "DMODS"
            ...
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"          'IIf(dtc_codigo8.Text = "", "TEC", dtc_codigo8.Text)
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-362"           'IIf(dtc_codigo9.Text = "", "R-XXX", dtc_codigo9.Text)
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.7"
        
        Case "UALMI", "ALMIB", "ALMIC", "ALMIS" 'INSUMOS
        
            fw_solicitud_fondos.Ado_detalle2.Recordset!proceso_codigo = "TEC"
            fw_solicitud_fondos.Ado_detalle2.Recordset!subproceso_codigo = "TEC-06"
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"
            fw_solicitud_fondos.Ado_detalle2.Recordset!etapa_codigo = "TEC-06-01"
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-306"
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.8"
            
        Case "UALMR", "ALMRB", "ALMRC", "ALMRS" 'REPUESTOS
        
            fw_solicitud_fondos.Ado_detalle2.Recordset!proceso_codigo = "TEC"
            fw_solicitud_fondos.Ado_detalle2.Recordset!subproceso_codigo = "TEC-07"
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"
            fw_solicitud_fondos.Ado_detalle2.Recordset!etapa_codigo = "TEC-07-01"
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-306"
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.5"
        
        Case "UALMH", "ALMB", "ALMC", "ALMS" 'HERRAMIENTAS
        
            fw_solicitud_fondos.Ado_detalle2.Recordset!proceso_codigo = "TEC"
            fw_solicitud_fondos.Ado_detalle2.Recordset!subproceso_codigo = "TEC-08"
            fw_solicitud_fondos.Ado_detalle2.Recordset!clasif_codigo = "TEC"
            fw_solicitud_fondos.Ado_detalle2.Recordset!etapa_codigo = "TEC-08-01"
            fw_solicitud_fondos.Ado_detalle2.Recordset!doc_codigo = "R-306"
            'fw_solicitud_fondos.Ado_detalle2.Recordset!poa_codigo = "3.2.9"
        
        End Select
  
   
'   fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_fecha").Value = Format(Date, "dd/mm/yyyy")
'   fw_solicitud_fondos.Ado_detalle2.Recordset("proceso_codigo") = "CMX"
'   fw_solicitud_fondos.Ado_detalle2.Recordset("subproceso_codigo") = "CMX-01"
'   fw_solicitud_fondos.Ado_detalle2.Recordset("etapa_codigo").Value = "CMX-01-01"
'
'   fw_solicitud_fondos.Ado_detalle2.Recordset("clasif_codigo").Value = "CMX"
   
   fw_solicitud_fondos.Ado_detalle2.Recordset!fecha_inicio_contrato = txtFecha.Value
   fw_solicitud_fondos.Ado_detalle2.Recordset!fecha_fin_contrato = txtFecha2.Value
   fw_solicitud_fondos.Ado_detalle2.Recordset!fecha_envio_proveedor = txtFecha3.Value
   
   fw_solicitud_fondos.Ado_detalle2.Recordset("beneficiario_codigo").Value = dtc_codigo5.Text
   VAR_BENEF = fw_solicitud_fondos.Ado_detalle2.Recordset!beneficiario_codigo

   fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_descripcion").Value = dtc_desc5.Text         'frm_ao_compra_servicio.Ado_datos.Recordset!compra_descripcion
   fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_cantidad_total").Value = fw_solicitud_fondos.Ado_datos.Recordset!compra_cantidad_total
    
   'fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs") = txt_total_bs.Text
   
   fw_solicitud_fondos.Ado_detalle2.Recordset("tipo_cambio").Value = txt_tipo_cambio.Text
   
   fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs").Value = CDbl(txt_total_bs.Text)
   fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_dol").Value = CDbl(txt_total_dol.Text)
   
   If opt_bs.Value = True Then
   fw_solicitud_fondos.Ado_detalle2.Recordset("tipo_moneda").Value = "BOB"
   End If
   
   If opt_usd.Value = True Then
   fw_solicitud_fondos.Ado_detalle2.Recordset("tipo_moneda").Value = "USD"
   End If
   
   fw_solicitud_fondos.Ado_detalle2.Recordset("nro_nota_remision") = txt_Nota.Text
   fw_solicitud_fondos.Ado_detalle2.Recordset("fecha_inicio_contrato").Value = txtFecha.Value
   fw_solicitud_fondos.Ado_detalle2.Recordset("fecha_fin_contrato").Value = txtFecha2.Value
   fw_solicitud_fondos.Ado_detalle2.Recordset("fecha_envio_proveedor") = txtFecha3.Value
    
   fw_solicitud_fondos.Ado_detalle2.Recordset("mes_inicio_crono") = cmb_mes_ini
   fw_solicitud_fondos.Ado_detalle2.Recordset("cantidad_cuotas_pag") = txtCantCuota
   fw_solicitud_fondos.Ado_detalle2.Recordset("unimed_codigo_pag") = cmd_unimed2
    
   fw_solicitud_fondos.Ado_detalle2.Recordset("usr_codigo") = glusuario
   fw_solicitud_fondos.Ado_detalle2.Recordset("fecha_registro") = Date
   fw_solicitud_fondos.Ado_detalle2.Recordset("hora_registro") = Format(Time, "HH:mm:ss")
   fw_solicitud_fondos.Ado_detalle2.Recordset("fecha_compra") = txtfecha_compra.Value
   fw_solicitud_fondos.Ado_detalle2.Recordset("compra_codigo_det") = fw_solicitud_fondos.Ado_detalle1.Recordset.RecordCount + 1 'fw_solicitud_fondos.Ado_detalle1.Recordset("compra_codigo_det")
   fw_solicitud_fondos.Ado_detalle2.Recordset("estado_codigo") = "REG"
   fw_solicitud_fondos.Ado_detalle2.Recordset("nro_autorizacion") = txt_autorizacion.Text
   
   fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs_87") = Val(txt_total_bs.Text) * 0.87
   fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_dol_87") = fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs_87") / GlTipoCambioOficial
   
   fw_solicitud_fondos.Ado_detalle2.Recordset("nro_dui") = IIf(txt_nro_dui.Text = "", "0", txt_nro_dui.Text)
   fw_solicitud_fondos.Ado_detalle2.Recordset("importe_no_credito_fisc") = IIf(txt_importe_no_fiscal.Text = "", "0", txt_importe_no_fiscal.Text)
   fw_solicitud_fondos.Ado_detalle2.Recordset("sub_total") = Val(fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs") - fw_solicitud_fondos.Ado_detalle2.Recordset("importe_no_credito_fisc"))
   fw_solicitud_fondos.Ado_detalle2.Recordset("descuento") = IIf(txt_descuentos.Text = "", "0", txt_descuentos.Text)
   fw_solicitud_fondos.Ado_detalle2.Recordset("importe_cred_fisc") = fw_solicitud_fondos.Ado_detalle2.Recordset("sub_total") - fw_solicitud_fondos.Ado_detalle2.Recordset("descuento")
   fw_solicitud_fondos.Ado_detalle2.Recordset("credito_fiscal_13") = fw_solicitud_fondos.Ado_detalle2.Recordset("importe_cred_fisc") * 0.13
   fw_solicitud_fondos.Ado_detalle2.Recordset("tipo_compra") = "1"
   fw_solicitud_fondos.Ado_detalle2.Recordset("literal") = Literal(fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs").Value)
   
   'If fw_solicitud_fondos.Ado_detalle1.Recordset("bien_codigo") = "479" Or fw_solicitud_fondos.Ado_detalle1.Recordset("bien_codigo") = "3410007" Then
    'fw_solicitud_fondos.Ado_detalle2.Recordset("literal_neto") = Literal(fw_solicitud_fondos.Ado_detalle2.Recordset("importe_cred_fisc").Value)
   'Else
        fw_solicitud_fondos.Ado_detalle2.Recordset("literal_neto") = Literal(fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs_87").Value)
   'End If
   If opt_si.Value = True Then
   fw_solicitud_fondos.Ado_detalle2.Recordset("factura") = "SI"
   Else
   fw_solicitud_fondos.Ado_detalle2.Recordset("factura") = "NO"
   End If
...
'    End If
'Next i
fw_solicitud_fondos.Ado_detalle2.Recordset("codigo_control") = IIf(txt_cod_control.Text = "", 0, txt_cod_control.Text)
   'fw_solicitud_fondos.Ado_detalle2.Recordset("tipo_compra") = ""
   
   fw_solicitud_fondos.Ado_detalle2.Recordset.Update
   Para_Aceptado = "S"
   If txt_total_bs.Text > "0" Then
   Call CRONO_PAGO
   Else
   db.Execute "DELETE FROM ao_compra_planilla_pagos where adjudica_codigo = '" & lbl_adjudica.Caption & "' AND compra_codigo = " & fw_solicitud_fondos.Ado_datos.Recordset!compra_codigo & ""
   End If
...
Private Sub CRONO_PAGO()
    Select Case RTrim(cmb_mes_ini.Text)
        ...
        Case "DICIEMBRE"
            txt_mes.Text = 12
    End Select
    db.Execute "DELETE ao_compra_planilla_pagos where adjudica_codigo = '" & fw_solicitud_fondos.Ado_detalle2.Recordset!adjudica_codigo & "' AND compra_codigo = " & fw_solicitud_fondos.Ado_datos.Recordset!compra_codigo & ""
...
CUOTA = 0
monto_cuota = fw_solicitud_fondos.Ado_detalle2.Recordset("adjudica_monto_bs").Value / Val(txtCantCuota.Text)
...
'End If
        ...
        'rs_aux2!compra_codigo = fw_solicitud_fondos.Ado_datos.Recordset!compra_codigo
        ...
        rs_aux2!pago_total_dol = monto_cuota / GlTipoCambioOficial
        ...
        If fw_solicitud_fondos.Ado_detalle2.Recordset!factura = "SI" Then
...
'    'Select Case Glaux
'    rs_clasif6.Open "SELECT * FROM ac_almacenes where beneficiario_codigo = " & fw_solicitud_fondos.dtc_codigo11.Text & " ORDER BY almacen_descripcion ", db, adOpenStatic
...
If parametro <> "COMEX" Then
  Set rs_clasif6 = New ADODB.Recordset
    ...
    'Select Case Glaux
    'rs_clasif6.Open "SELECT * FROM ac_almacenes where beneficiario_codigo = " & fw_solicitud_fondos.dtc_codigo11.Text & " ORDER BY almacen_descripcion ", db, adOpenStatic
    rs_clasif6.Open "SELECT * FROM ac_almacenes where beneficiario_codigo = '4999270' ORDER BY almacen_descripcion ", db, adOpenStatic
     Set Ado_clasif6.Recordset = rs_clasif6
